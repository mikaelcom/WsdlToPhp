...
if(false)
{
	echo "\r\n Clean Name for '2And'is-go54  83od+*/you=yθηιs_3' is " . WsdlToPhpModel::cleanString("2And'is-go54  83od+*/you=yιηθs_3") . " \r\n";
	return;
}
/**
 * OVH SOAP API
...
if(true)
{
	...
	WsdlToPhpGenerator::setOptionCategory(WsdlToPhpGenerator::OPT_CAT_START_NAME);
	WsdlToPhpGenerator::setOptionSubCategory(WsdlToPhpGenerator::OPT_SUB_CAT_END_NAME);
	WsdlToPhpGenerator::setOptionAddComments(array('date'=>date('Y-m-d'),'author'=>'Mikaλl DELSOL','version'=>1));
