<?php
/**
 * Class file for AmazonLSTypeActivateHostedProduct
 * @date 10/07/2012
 */
/**
 * Class AmazonLSTypeActivateHostedProduct
 * @date 10/07/2012
 */
class AmazonLSTypeActivateHostedProduct extends AmazonLSWsdlClass
{
	/**
	 * The ActivationKey
	 * @var string
	 ...
	 * @return AmazonLSTypeActivateHostedProduct
	 */
