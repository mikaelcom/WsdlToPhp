<?php
/**
 * File for AmazonLSWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonLSWsdlClass to communicate with SOAP service
 * Documentation : The LS web service allows DevPay clients to interact with the AWS Auth System. DevPay enabled products can retrieve new identity components for an end user and product subscription information.
 * @date 10/07/2012
 */
class AmazonLSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonLSWsdlClass::setLastError()
	 * @uses AmazonLSWsdlClass::initSoapClient()
	 * @uses AmazonLSWsdlClass::initInternArrayToIterate()
	 * @uses AmazonLSWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonLSWsdlClass::classMap()
	 * @uses AmazonLSWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonLSClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonLSClassMap::classMap();
	 ...
	 * @uses AmazonLSWsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonLSWsdlClass::WSDL_COMPRESSION
	 * @uses AmazonLSWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonLSWsdlClass::WSDL_ENCODING
	 * @uses AmazonLSWsdlClass::WSDL_EXCPTS
	 * @uses AmazonLSWsdlClass::WSDL_FEATURES
	 * @uses AmazonLSWsdlClass::WSDL_LOGIN
	 * @uses AmazonLSWsdlClass::WSDL_PASSWD
	 * @uses AmazonLSWsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonLSWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonLSWsdlClass::WSDL_TRACE
	 * @uses AmazonLSWsdlClass::WSDL_TYPEMAP
	 * @uses AmazonLSWsdlClass::WSDL_URL
	 * @uses AmazonLSWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses AmazonLSWsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonLSWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonLSWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonLSWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonLSWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonLSWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonLSWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonLSWsdlClass::offsetGet()
	 * @uses AmazonLSWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonLSWsdlClass::getAttributeName()
	 * @uses AmazonLSWsdlClass::__toString()
	 * @uses AmazonLSWsdlClass::_set()
	 * @uses AmazonLSWsdlClass::_get()
	 * @uses AmazonLSWsdlClass::setInternArrayToIterate()
	 * @uses AmazonLSWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonLSWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonLSWsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonLSWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
