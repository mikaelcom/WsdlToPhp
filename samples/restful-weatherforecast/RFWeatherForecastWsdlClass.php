<?php
/**
 * File for RFWeatherForecastWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFWeatherForecastWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFWeatherForecastWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFWeatherForecastWsdlClass::setLastError()
	 * @uses RFWeatherForecastWsdlClass::initSoapClient()
	 * @uses RFWeatherForecastWsdlClass::initInternArrayToIterate()
	 * @uses RFWeatherForecastWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFWeatherForecastWsdlClass::classMap()
	 * @uses RFWeatherForecastWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFWeatherForecastClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFWeatherForecastClassMap::classMap();
	 ...
	 * @uses RFWeatherForecastWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFWeatherForecastWsdlClass::WSDL_COMPRESSION
	 * @uses RFWeatherForecastWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFWeatherForecastWsdlClass::WSDL_ENCODING
	 * @uses RFWeatherForecastWsdlClass::WSDL_EXCPTS
	 * @uses RFWeatherForecastWsdlClass::WSDL_FEATURES
	 * @uses RFWeatherForecastWsdlClass::WSDL_LOGIN
	 * @uses RFWeatherForecastWsdlClass::WSDL_PASSWD
	 * @uses RFWeatherForecastWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFWeatherForecastWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFWeatherForecastWsdlClass::WSDL_TRACE
	 * @uses RFWeatherForecastWsdlClass::WSDL_TYPEMAP
	 * @uses RFWeatherForecastWsdlClass::WSDL_URL
	 * @uses RFWeatherForecastWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses RFWeatherForecastWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::internArrayToIterateIsArray()
	 * @uses RFWeatherForecastWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFWeatherForecastWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFWeatherForecastWsdlClass::offsetExists()
	 ...
	 * @uses RFWeatherForecastWsdlClass::getAttributeName()
	 * @uses RFWeatherForecastWsdlClass::__toString()
	 * @uses RFWeatherForecastWsdlClass::_set()
	 * @uses RFWeatherForecastWsdlClass::_get()
	 * @uses RFWeatherForecastWsdlClass::setInternArrayToIterate()
	 * @uses RFWeatherForecastWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFWeatherForecastWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::item()
	 * @uses RFWeatherForecastWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses RFWeatherForecastWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFWeatherForecastWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
