<?php
/**
 * Class file for RFWeatherForecastTypeDefaultFaultContract
 * @date 15/08/2012
 */
/**
 * Class RFWeatherForecastTypeDefaultFaultContract
 * @date 15/08/2012
 */
class RFWeatherForecastTypeDefaultFaultContract extends RFWeatherForecastWsdlClass
{
	/**
	 * The ErrorId
	 * @var int
	 ...
	 * @param RFWeatherForecastTypeGuid CorrelationId
	 * @return RFWeatherForecastTypeDefaultFaultContract
	 */
	...
	/**
	 * Get CorrelationId
	 * @return RFWeatherForecastTypeguid
	 */
