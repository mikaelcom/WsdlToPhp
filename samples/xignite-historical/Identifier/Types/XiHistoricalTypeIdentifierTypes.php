<?php
/**
 * Class file for XiHistoricalTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiHistoricalTypeIdentifierTypes extends XiHistoricalWsdlClass
{
	/**
