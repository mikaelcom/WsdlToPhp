<?php
/**
 * Class file for XiHistoricalTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeCommon
 * @date 08/07/2012
 */
class XiHistoricalTypeCommon extends XiHistoricalWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiHistoricalTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiHistoricalTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiHistoricalTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiHistoricalTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiHistoricalTypeOutcomeTypes
	 */
