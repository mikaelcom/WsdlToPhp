<?php
/**
 * Class file for XiHistoricalTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeHeader
 * @date 08/07/2012
 */
class XiHistoricalTypeHeader extends XiHistoricalWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
