<?php
/**
 * File for XiHistoricalWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiHistoricalWsdlClass to communicate with SOAP service
 * Documentation : This web service provides historical security pricing for US equities.
 * @date 08/07/2012
 */
class XiHistoricalWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiHistoricalWsdlClass::setLastError()
	 * @uses XiHistoricalWsdlClass::initSoapClient()
	 * @uses XiHistoricalWsdlClass::initInternArrayToIterate()
	 * @uses XiHistoricalWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiHistoricalWsdlClass::classMap()
	 * @uses XiHistoricalWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiHistoricalClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiHistoricalClassMap::classMap();
	 ...
	 * @uses XiHistoricalWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiHistoricalWsdlClass::WSDL_COMPRESSION
	 * @uses XiHistoricalWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiHistoricalWsdlClass::WSDL_ENCODING
	 * @uses XiHistoricalWsdlClass::WSDL_EXCPTS
	 * @uses XiHistoricalWsdlClass::WSDL_FEATURES
	 * @uses XiHistoricalWsdlClass::WSDL_LOGIN
	 * @uses XiHistoricalWsdlClass::WSDL_PASSWD
	 * @uses XiHistoricalWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiHistoricalWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiHistoricalWsdlClass::WSDL_TRACE
	 * @uses XiHistoricalWsdlClass::WSDL_TYPEMAP
	 * @uses XiHistoricalWsdlClass::WSDL_URL
	 * @uses XiHistoricalWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiHistoricalWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::internArrayToIterateIsArray()
	 * @uses XiHistoricalWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiHistoricalWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiHistoricalWsdlClass::offsetExists()
	 ...
	 * @uses XiHistoricalWsdlClass::getAttributeName()
	 * @uses XiHistoricalWsdlClass::__toString()
	 * @uses XiHistoricalWsdlClass::_set()
	 * @uses XiHistoricalWsdlClass::_get()
	 * @uses XiHistoricalWsdlClass::setInternArrayToIterate()
	 * @uses XiHistoricalWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiHistoricalWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::item()
	 * @uses XiHistoricalWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiHistoricalWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiHistoricalWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
