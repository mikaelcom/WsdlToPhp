<?php
/**
 * Class file for XiHistoricalTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeSecurity
 * @date 08/07/2012
 */
class XiHistoricalTypeSecurity extends XiHistoricalTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiHistoricalWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
