<?php
/**
 * Class file for XiHistoricalTypeGetDividendHistoryRange
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetDividendHistoryRange
 * @date 08/07/2012
 */
class XiHistoricalTypeGetDividendHistoryRange extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetDividendHistoryRange
	 */
