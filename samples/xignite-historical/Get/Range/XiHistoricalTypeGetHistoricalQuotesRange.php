<?php
/**
 * Class file for XiHistoricalTypeGetHistoricalQuotesRange
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetHistoricalQuotesRange
 * @date 08/07/2012
 */
class XiHistoricalTypeGetHistoricalQuotesRange extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetHistoricalQuotesRange
	 */
