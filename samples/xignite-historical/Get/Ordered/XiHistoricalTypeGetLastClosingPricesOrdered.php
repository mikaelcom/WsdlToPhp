<?php
/**
 * Class file for XiHistoricalTypeGetLastClosingPricesOrdered
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetLastClosingPricesOrdered
 * @date 08/07/2012
 */
class XiHistoricalTypeGetLastClosingPricesOrdered extends XiHistoricalWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetLastClosingPricesOrdered
	 */
