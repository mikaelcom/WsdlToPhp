<?php
/**
 * Class file for XiHistoricalTypeGetHistoricalQuotesRangeAdjusted
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetHistoricalQuotesRangeAdjusted
 * @date 08/07/2012
 */
class XiHistoricalTypeGetHistoricalQuotesRangeAdjusted extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetHistoricalQuotesRangeAdjusted
	 */
