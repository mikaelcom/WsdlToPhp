<?php
/**
 * Class file for XiHistoricalTypeGetLastClosingPricesOrderedAdjusted
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetLastClosingPricesOrderedAdjusted
 * @date 08/07/2012
 */
class XiHistoricalTypeGetLastClosingPricesOrderedAdjusted extends XiHistoricalWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetLastClosingPricesOrderedAdjusted
	 */
