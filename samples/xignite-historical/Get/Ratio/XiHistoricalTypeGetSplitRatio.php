<?php
/**
 * Class file for XiHistoricalTypeGetSplitRatio
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetSplitRatio
 * @date 08/07/2012
 */
class XiHistoricalTypeGetSplitRatio extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetSplitRatio
	 */
