<?php
/**
 * Class file for XiHistoricalTypeGetLastClosingPrice
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetLastClosingPrice
 * @date 08/07/2012
 */
class XiHistoricalTypeGetLastClosingPrice extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetLastClosingPrice
	 */
