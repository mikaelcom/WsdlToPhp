<?php
/**
 * Class file for XiHistoricalTypeGetHistoricalStatistics
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetHistoricalStatistics
 * @date 08/07/2012
 */
class XiHistoricalTypeGetHistoricalStatistics extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetHistoricalStatistics
	 */
