<?php
/**
 * Class file for XiHistoricalTypeGetHistoricalHighLow
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetHistoricalHighLow
 * @date 08/07/2012
 */
class XiHistoricalTypeGetHistoricalHighLow extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetHistoricalHighLow
	 */
