<?php
/**
 * Class file for XiHistoricalTypeGetDividendHistory
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetDividendHistory
 * @date 08/07/2012
 */
class XiHistoricalTypeGetDividendHistory extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetDividendHistory
	 */
