<?php
/**
 * Class file for XiHistoricalTypeGetSplitHistory
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetSplitHistory
 * @date 08/07/2012
 */
class XiHistoricalTypeGetSplitHistory extends XiHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHistoricalTypeGetSplitHistory
	 */
