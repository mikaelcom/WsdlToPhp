<?php
/**
 * Class file for XiHistoricalTypeGetTopGainersByMarketCapitalization
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetTopGainersByMarketCapitalization
 * @date 08/07/2012
 */
class XiHistoricalTypeGetTopGainersByMarketCapitalization extends XiHistoricalWsdlClass
{
	/**
	 * The AsOfDate
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiHistoricalTypeGetTopGainersByMarketCapitalization
	 */
