<?php
/**
 * Class file for XiHistoricalTypeGetTopLosersByMarketCapitalization
 * @date 08/07/2012
 */
/**
 * Class XiHistoricalTypeGetTopLosersByMarketCapitalization
 * @date 08/07/2012
 */
class XiHistoricalTypeGetTopLosersByMarketCapitalization extends XiHistoricalWsdlClass
{
	/**
	 * The AsOfDate
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiHistoricalTypeGetTopLosersByMarketCapitalization
	 */
