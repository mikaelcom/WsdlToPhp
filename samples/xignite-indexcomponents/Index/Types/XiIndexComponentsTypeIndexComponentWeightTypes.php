<?php
/**
 * Class file for XiIndexComponentsTypeIndexComponentWeightTypes
 * @date 08/07/2012
 */
/**
 * Class XiIndexComponentsTypeIndexComponentWeightTypes
 * @date 08/07/2012
 */
class XiIndexComponentsTypeIndexComponentWeightTypes extends XiIndexComponentsWsdlClass
{
	/**
