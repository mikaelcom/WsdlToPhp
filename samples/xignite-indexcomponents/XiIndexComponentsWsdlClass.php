<?php
/**
 * File for XiIndexComponentsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiIndexComponentsWsdlClass to communicate with SOAP service
 * Documentation : This web service provides index component information.
 * @date 08/07/2012
 */
class XiIndexComponentsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiIndexComponentsWsdlClass::setLastError()
	 * @uses XiIndexComponentsWsdlClass::initSoapClient()
	 * @uses XiIndexComponentsWsdlClass::initInternArrayToIterate()
	 * @uses XiIndexComponentsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiIndexComponentsWsdlClass::classMap()
	 * @uses XiIndexComponentsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiIndexComponentsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiIndexComponentsClassMap::classMap();
	 ...
	 * @uses XiIndexComponentsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiIndexComponentsWsdlClass::WSDL_COMPRESSION
	 * @uses XiIndexComponentsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiIndexComponentsWsdlClass::WSDL_ENCODING
	 * @uses XiIndexComponentsWsdlClass::WSDL_EXCPTS
	 * @uses XiIndexComponentsWsdlClass::WSDL_FEATURES
	 * @uses XiIndexComponentsWsdlClass::WSDL_LOGIN
	 * @uses XiIndexComponentsWsdlClass::WSDL_PASSWD
	 * @uses XiIndexComponentsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiIndexComponentsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiIndexComponentsWsdlClass::WSDL_TRACE
	 * @uses XiIndexComponentsWsdlClass::WSDL_TYPEMAP
	 * @uses XiIndexComponentsWsdlClass::WSDL_URL
	 * @uses XiIndexComponentsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiIndexComponentsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiIndexComponentsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiIndexComponentsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiIndexComponentsWsdlClass::offsetExists()
	 ...
	 * @uses XiIndexComponentsWsdlClass::getAttributeName()
	 * @uses XiIndexComponentsWsdlClass::__toString()
	 * @uses XiIndexComponentsWsdlClass::_set()
	 * @uses XiIndexComponentsWsdlClass::_get()
	 * @uses XiIndexComponentsWsdlClass::setInternArrayToIterate()
	 * @uses XiIndexComponentsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiIndexComponentsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::item()
	 * @uses XiIndexComponentsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiIndexComponentsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiIndexComponentsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
