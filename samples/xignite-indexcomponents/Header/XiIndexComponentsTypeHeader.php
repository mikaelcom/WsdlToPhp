<?php
/**
 * Class file for XiIndexComponentsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiIndexComponentsTypeHeader
 * @date 08/07/2012
 */
class XiIndexComponentsTypeHeader extends XiIndexComponentsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiIndexComponentsTypeHeader
	 */
