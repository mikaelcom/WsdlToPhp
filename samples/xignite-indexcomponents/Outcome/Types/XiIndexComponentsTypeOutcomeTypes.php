<?php
/**
 * Class file for XiIndexComponentsTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiIndexComponentsTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiIndexComponentsTypeOutcomeTypes extends XiIndexComponentsWsdlClass
{
	/**
