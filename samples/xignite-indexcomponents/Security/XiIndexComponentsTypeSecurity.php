<?php
/**
 * Class file for XiIndexComponentsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiIndexComponentsTypeSecurity
 * @date 08/07/2012
 */
class XiIndexComponentsTypeSecurity extends XiIndexComponentsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiIndexComponentsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
