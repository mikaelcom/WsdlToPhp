<?php
/**
 * Class file for XiIndexComponentsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiIndexComponentsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiIndexComponentsTypeIdentifierTypes extends XiIndexComponentsWsdlClass
{
	/**
