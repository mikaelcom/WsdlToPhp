<?php
/**
 * Class file for XiSecurityTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeCommon
 * @date 08/07/2012
 */
class XiSecurityTypeCommon extends XiSecurityWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiSecurityTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiSecurityTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiSecurityTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiSecurityTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiSecurityTypeOutcomeTypes
	 */
