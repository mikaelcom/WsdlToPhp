<?php
/**
 * Class file for XiSecurityTypeMapSecurityDetail
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeMapSecurityDetail
 * @date 08/07/2012
 */
class XiSecurityTypeMapSecurityDetail extends XiSecurityWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiSecurityTypeMapSecurityDetail
	 */
