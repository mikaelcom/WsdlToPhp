<?php
/**
 * Class file for XiSecurityTypeMapSecurity
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeMapSecurity
 * @date 08/07/2012
 */
class XiSecurityTypeMapSecurity extends XiSecurityWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiSecurityTypeMapSecurity
	 */
