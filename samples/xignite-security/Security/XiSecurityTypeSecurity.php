<?php
/**
 * Class file for XiSecurityTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeSecurity
 * @date 08/07/2012
 */
class XiSecurityTypeSecurity extends XiSecurityTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiSecurityWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
