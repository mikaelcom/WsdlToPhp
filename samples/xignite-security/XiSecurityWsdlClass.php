<?php
/**
 * File for XiSecurityWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiSecurityWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class XiSecurityWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiSecurityWsdlClass::setLastError()
	 * @uses XiSecurityWsdlClass::initSoapClient()
	 * @uses XiSecurityWsdlClass::initInternArrayToIterate()
	 * @uses XiSecurityWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiSecurityWsdlClass::classMap()
	 * @uses XiSecurityWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiSecurityClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiSecurityClassMap::classMap();
	 ...
	 * @uses XiSecurityWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiSecurityWsdlClass::WSDL_COMPRESSION
	 * @uses XiSecurityWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiSecurityWsdlClass::WSDL_ENCODING
	 * @uses XiSecurityWsdlClass::WSDL_EXCPTS
	 * @uses XiSecurityWsdlClass::WSDL_FEATURES
	 * @uses XiSecurityWsdlClass::WSDL_LOGIN
	 * @uses XiSecurityWsdlClass::WSDL_PASSWD
	 * @uses XiSecurityWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiSecurityWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiSecurityWsdlClass::WSDL_TRACE
	 * @uses XiSecurityWsdlClass::WSDL_TYPEMAP
	 * @uses XiSecurityWsdlClass::WSDL_URL
	 * @uses XiSecurityWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiSecurityWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiSecurityWsdlClass::internArrayToIterateIsArray()
	 * @uses XiSecurityWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiSecurityWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiSecurityWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiSecurityWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiSecurityWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiSecurityWsdlClass::offsetExists()
	 ...
	 * @uses XiSecurityWsdlClass::getAttributeName()
	 * @uses XiSecurityWsdlClass::__toString()
	 * @uses XiSecurityWsdlClass::_set()
	 * @uses XiSecurityWsdlClass::_get()
	 * @uses XiSecurityWsdlClass::setInternArrayToIterate()
	 * @uses XiSecurityWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiSecurityWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiSecurityWsdlClass::item()
	 * @uses XiSecurityWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiSecurityWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiSecurityWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
