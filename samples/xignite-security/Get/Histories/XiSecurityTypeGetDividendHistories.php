<?php
/**
 * Class file for XiSecurityTypeGetDividendHistories
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeGetDividendHistories
 * @date 08/07/2012
 */
class XiSecurityTypeGetDividendHistories extends XiSecurityWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiSecurityTypeGetDividendHistories
	 */
