<?php
/**
 * Class file for XiSecurityTypeGetExtendedDividendHistory
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeGetExtendedDividendHistory
 * @date 08/07/2012
 */
class XiSecurityTypeGetExtendedDividendHistory extends XiSecurityWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiSecurityTypeGetExtendedDividendHistory
	 */
