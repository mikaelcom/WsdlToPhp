<?php
/**
 * Class file for XiSecurityTypeGetDividendHistory
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeGetDividendHistory
 * @date 08/07/2012
 */
class XiSecurityTypeGetDividendHistory extends XiSecurityWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiSecurityTypeGetDividendHistory
	 */
