<?php
/**
 * Class file for XiSecurityTypeListSecurities
 * @date 08/07/2012
 */
/**
 * Class XiSecurityTypeListSecurities
 * @date 08/07/2012
 */
class XiSecurityTypeListSecurities extends XiSecurityWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiSecurityTypeListSecurities
	 */
