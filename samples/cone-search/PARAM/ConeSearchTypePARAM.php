<?php
/**
 * Class file for ConeSearchTypePARAM
 * @date 13/10/2012
 */
/**
 * Class ConeSearchTypePARAM
 * @date 13/10/2012
 */
class ConeSearchTypePARAM extends ConeSearchWsdlClass
{
	/**
	 * The DESCRIPTION
	 * Meta informations :
	 ...
	 * @param string utype
	 * @param string value
	 * @param token arraysize
	 * @return ConeSearchTypePARAM
	 */
	public function __construct($_DESCRIPTION = null,$_VALUES = null,$_LINK = null,$_ID = null,$_unit = null,$_datatype = null,$_precision = null,$_width = null,$_ref = null,$_name = null,$_ucd = null,$_utype = null,$_value = null,$_arraysize = null)
	{
		parent::__construct(array('DESCRIPTION'=>$_DESCRIPTION,'VALUES'=>$_VALUES,'LINK'=>$_LINK,'ID'=>$_ID,'unit'=>$_unit,'datatype'=>$_datatype,'precision'=>$_precision,'width'=>$_width,'ref'=>$_ref,'name'=>$_name,'ucd'=>$_ucd,'utype'=>$_utype,'value'=>$_value,'arraysize'=>$_arraysize));
	}
	/**
	 * Set DESCRIPTION
