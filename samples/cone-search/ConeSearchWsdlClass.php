<?php
/**
 * File for ConeSearchWsdlClass to communicate with SOAP service
 * @date 13/10/2012
 */
/**
 * File for ConeSearchWsdlClass to communicate with SOAP service
 * Documentation : This is a <b>XML Web Service</b> interface to do a Cone Search from the <b>DR1 Sloan Digital Sky Survey </b> catalog.<br>Send comments to <b>Maria Nieto-Santisteban</b> -- nieto@pha.jhu.edu
 * @date 13/10/2012
 */
class ConeSearchWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses ConeSearchWsdlClass::setLastError()
	 * @uses ConeSearchWsdlClass::initSoapClient()
	 * @uses ConeSearchWsdlClass::initInternArrayToIterate()
	 * @uses ConeSearchWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses ConeSearchWsdlClass::classMap()
	 * @uses ConeSearchWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('ConeSearchClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = ConeSearchClassMap::classMap();
	 ...
	 * @uses ConeSearchWsdlClass::WSDL_CACHE_WSDL
	 * @uses ConeSearchWsdlClass::WSDL_COMPRESSION
	 * @uses ConeSearchWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses ConeSearchWsdlClass::WSDL_ENCODING
	 * @uses ConeSearchWsdlClass::WSDL_EXCPTS
	 * @uses ConeSearchWsdlClass::WSDL_FEATURES
	 * @uses ConeSearchWsdlClass::WSDL_LOGIN
	 * @uses ConeSearchWsdlClass::WSDL_PASSWD
	 * @uses ConeSearchWsdlClass::WSDL_SOAP_VERSION
	 * @uses ConeSearchWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses ConeSearchWsdlClass::WSDL_TRACE
	 * @uses ConeSearchWsdlClass::WSDL_TYPEMAP
	 * @uses ConeSearchWsdlClass::WSDL_URL
	 * @uses ConeSearchWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses ConeSearchWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses ConeSearchWsdlClass::internArrayToIterateIsArray()
	 * @uses ConeSearchWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses ConeSearchWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses ConeSearchWsdlClass::getInternArrayToIterateOffset()
	 * @uses ConeSearchWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses ConeSearchWsdlClass::getInternArrayToIterateOffset()
	 * @uses ConeSearchWsdlClass::offsetExists()
	 ...
	 * @uses ConeSearchWsdlClass::getAttributeName()
	 * @uses ConeSearchWsdlClass::__toString()
	 * @uses ConeSearchWsdlClass::_set()
	 * @uses ConeSearchWsdlClass::_get()
	 * @uses ConeSearchWsdlClass::setInternArrayToIterate()
	 * @uses ConeSearchWsdlClass::setInternArrayToIterateIsArray()
	 * @uses ConeSearchWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses ConeSearchWsdlClass::item()
	 * @uses ConeSearchWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses ConeSearchWsdlClass::getInternArrayToIterateIsArray()
	 * @uses ConeSearchWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
