<?php
/**
 * File for SPSitesWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPSitesWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPSitesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPSitesWsdlClass::setLastError()
	 * @uses SPSitesWsdlClass::initSoapClient()
	 * @uses SPSitesWsdlClass::initInternArrayToIterate()
	 * @uses SPSitesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPSitesWsdlClass::classMap()
	 * @uses SPSitesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPSitesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPSitesClassMap::classMap();
	 ...
	 * @uses SPSitesWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPSitesWsdlClass::WSDL_COMPRESSION
	 * @uses SPSitesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPSitesWsdlClass::WSDL_ENCODING
	 * @uses SPSitesWsdlClass::WSDL_EXCPTS
	 * @uses SPSitesWsdlClass::WSDL_FEATURES
	 * @uses SPSitesWsdlClass::WSDL_LOGIN
	 * @uses SPSitesWsdlClass::WSDL_PASSWD
	 * @uses SPSitesWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPSitesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPSitesWsdlClass::WSDL_TRACE
	 * @uses SPSitesWsdlClass::WSDL_TYPEMAP
	 * @uses SPSitesWsdlClass::WSDL_URL
	 * @uses SPSitesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPSitesWsdlClass::internArrayToIterateIsArray()
	 * @uses SPSitesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPSitesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPSitesWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPSitesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPSitesWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPSitesWsdlClass::offsetExists()
	 ...
	 * @uses SPSitesWsdlClass::getAttributeName()
	 * @uses SPSitesWsdlClass::__toString()
	 * @uses SPSitesWsdlClass::_set()
	 * @uses SPSitesWsdlClass::_get()
	 * @uses SPSitesWsdlClass::setInternArrayToIterate()
	 * @uses SPSitesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPSitesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPSitesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPSitesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
