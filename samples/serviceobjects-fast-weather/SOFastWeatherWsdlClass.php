<?php
/**
 * File for SOFastWeatherWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOFastWeatherWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOFastWeatherWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOFastWeatherWsdlClass::setLastError()
	 * @uses SOFastWeatherWsdlClass::initSoapClient()
	 * @uses SOFastWeatherWsdlClass::initInternArrayToIterate()
	 * @uses SOFastWeatherWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOFastWeatherWsdlClass::classMap()
	 * @uses SOFastWeatherWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOFastWeatherClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOFastWeatherClassMap::classMap();
	 ...
	 * @uses SOFastWeatherWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOFastWeatherWsdlClass::WSDL_COMPRESSION
	 * @uses SOFastWeatherWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOFastWeatherWsdlClass::WSDL_ENCODING
	 * @uses SOFastWeatherWsdlClass::WSDL_EXCPTS
	 * @uses SOFastWeatherWsdlClass::WSDL_FEATURES
	 * @uses SOFastWeatherWsdlClass::WSDL_LOGIN
	 * @uses SOFastWeatherWsdlClass::WSDL_PASSWD
	 * @uses SOFastWeatherWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOFastWeatherWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOFastWeatherWsdlClass::WSDL_TRACE
	 * @uses SOFastWeatherWsdlClass::WSDL_TYPEMAP
	 * @uses SOFastWeatherWsdlClass::WSDL_URL
	 * @uses SOFastWeatherWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOFastWeatherWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::internArrayToIterateIsArray()
	 * @uses SOFastWeatherWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFastWeatherWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFastWeatherWsdlClass::offsetExists()
	 ...
	 * @uses SOFastWeatherWsdlClass::getAttributeName()
	 * @uses SOFastWeatherWsdlClass::__toString()
	 * @uses SOFastWeatherWsdlClass::_set()
	 * @uses SOFastWeatherWsdlClass::_get()
	 * @uses SOFastWeatherWsdlClass::setInternArrayToIterate()
	 * @uses SOFastWeatherWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOFastWeatherWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::item()
	 * @uses SOFastWeatherWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastWeatherWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOFastWeatherWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
