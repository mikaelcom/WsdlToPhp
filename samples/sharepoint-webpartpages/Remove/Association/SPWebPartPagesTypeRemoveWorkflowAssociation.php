<?php
/**
 * Class file for SPWebPartPagesTypeRemoveWorkflowAssociation
 * @date 06/07/2012
 */
/**
 * Class SPWebPartPagesTypeRemoveWorkflowAssociation
 * @date 06/07/2012
 */
class SPWebPartPagesTypeRemoveWorkflowAssociation extends SPWebPartPagesWsdlClass
{
	/**
	 * The configUrl
	 * @var string
	 ...
	 * @return SPWebPartPagesTypeRemoveWorkflowAssociation
	 */
