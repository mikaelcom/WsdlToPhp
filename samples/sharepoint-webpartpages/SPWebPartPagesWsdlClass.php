<?php
/**
 * File for SPWebPartPagesWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPWebPartPagesWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPWebPartPagesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPWebPartPagesWsdlClass::setLastError()
	 * @uses SPWebPartPagesWsdlClass::initSoapClient()
	 * @uses SPWebPartPagesWsdlClass::initInternArrayToIterate()
	 * @uses SPWebPartPagesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPWebPartPagesWsdlClass::classMap()
	 * @uses SPWebPartPagesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPWebPartPagesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPWebPartPagesClassMap::classMap();
	 ...
	 * @uses SPWebPartPagesWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPWebPartPagesWsdlClass::WSDL_COMPRESSION
	 * @uses SPWebPartPagesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPWebPartPagesWsdlClass::WSDL_ENCODING
	 * @uses SPWebPartPagesWsdlClass::WSDL_EXCPTS
	 * @uses SPWebPartPagesWsdlClass::WSDL_FEATURES
	 * @uses SPWebPartPagesWsdlClass::WSDL_LOGIN
	 * @uses SPWebPartPagesWsdlClass::WSDL_PASSWD
	 * @uses SPWebPartPagesWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPWebPartPagesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPWebPartPagesWsdlClass::WSDL_TRACE
	 * @uses SPWebPartPagesWsdlClass::WSDL_TYPEMAP
	 * @uses SPWebPartPagesWsdlClass::WSDL_URL
	 * @uses SPWebPartPagesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPWebPartPagesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::internArrayToIterateIsArray()
	 * @uses SPWebPartPagesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPWebPartPagesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPWebPartPagesWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPWebPartPagesWsdlClass::offsetGet()
	 * @uses SPWebPartPagesWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::getAttributeName()
	 * @uses SPWebPartPagesWsdlClass::__toString()
	 * @uses SPWebPartPagesWsdlClass::_set()
	 * @uses SPWebPartPagesWsdlClass::_get()
	 * @uses SPWebPartPagesWsdlClass::setInternArrayToIterate()
	 * @uses SPWebPartPagesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPWebPartPagesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::item()
	 * @uses SPWebPartPagesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPWebPartPagesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPWebPartPagesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
