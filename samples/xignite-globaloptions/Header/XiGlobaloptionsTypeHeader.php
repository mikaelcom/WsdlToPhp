<?php
/**
 * Class file for XiGlobaloptionsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeHeader
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeHeader extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobaloptionsTypeHeader
	 */
