<?php
/**
 * Class file for XiGlobaloptionsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeSecurity
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeSecurity extends XiGlobaloptionsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiGlobaloptionsWsdlClass::__construct(array('CIK'=>$_CIK,'CUSIP'=>$_CUSIP,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'MarketIdentificationCode'=>$_MarketIdentificationCode,'MostLiquidExchange'=>$_MostLiquidExchange,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
