<?php
/**
 * File for XiGlobaloptionsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobaloptionsWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class XiGlobaloptionsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobaloptionsWsdlClass::setLastError()
	 * @uses XiGlobaloptionsWsdlClass::initSoapClient()
	 * @uses XiGlobaloptionsWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobaloptionsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobaloptionsWsdlClass::classMap()
	 * @uses XiGlobaloptionsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobaloptionsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobaloptionsClassMap::classMap();
	 ...
	 * @uses XiGlobaloptionsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobaloptionsWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobaloptionsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobaloptionsWsdlClass::WSDL_ENCODING
	 * @uses XiGlobaloptionsWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobaloptionsWsdlClass::WSDL_FEATURES
	 * @uses XiGlobaloptionsWsdlClass::WSDL_LOGIN
	 * @uses XiGlobaloptionsWsdlClass::WSDL_PASSWD
	 * @uses XiGlobaloptionsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobaloptionsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobaloptionsWsdlClass::WSDL_TRACE
	 * @uses XiGlobaloptionsWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobaloptionsWsdlClass::WSDL_URL
	 * @uses XiGlobaloptionsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobaloptionsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobaloptionsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobaloptionsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobaloptionsWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobaloptionsWsdlClass::getAttributeName()
	 * @uses XiGlobaloptionsWsdlClass::__toString()
	 * @uses XiGlobaloptionsWsdlClass::_set()
	 * @uses XiGlobaloptionsWsdlClass::_get()
	 * @uses XiGlobaloptionsWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobaloptionsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobaloptionsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::item()
	 * @uses XiGlobaloptionsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobaloptionsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobaloptionsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
