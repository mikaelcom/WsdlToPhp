<?php
/**
 * Class file for XiGlobaloptionsTypeGetExtendedEquityOptionBySymbols
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetExtendedEquityOptionBySymbols
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetExtendedEquityOptionBySymbols extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Symbols
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetExtendedEquityOptionBySymbols
	 */
