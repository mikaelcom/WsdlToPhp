<?php
/**
 * Class file for XiGlobaloptionsTypeGetEquityOptionSymbol
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetEquityOptionSymbol
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetEquityOptionSymbol extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetEquityOptionSymbol
	 */
