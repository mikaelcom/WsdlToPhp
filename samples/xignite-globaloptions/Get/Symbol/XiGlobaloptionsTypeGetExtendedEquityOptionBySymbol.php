<?php
/**
 * Class file for XiGlobaloptionsTypeGetExtendedEquityOptionBySymbol
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetExtendedEquityOptionBySymbol
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetExtendedEquityOptionBySymbol extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetExtendedEquityOptionBySymbol
	 */
