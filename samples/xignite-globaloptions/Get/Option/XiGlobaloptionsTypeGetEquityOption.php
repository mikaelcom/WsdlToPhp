<?php
/**
 * Class file for XiGlobaloptionsTypeGetEquityOption
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetEquityOption
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetEquityOption extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetEquityOption
	 */
