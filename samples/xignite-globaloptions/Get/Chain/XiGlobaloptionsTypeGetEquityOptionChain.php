<?php
/**
 * Class file for XiGlobaloptionsTypeGetEquityOptionChain
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetEquityOptionChain
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetEquityOptionChain extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetEquityOptionChain
	 */
