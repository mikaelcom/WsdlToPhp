<?php
/**
 * Class file for XiGlobaloptionsTypeGetAllEquityOptionChain
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetAllEquityOptionChain
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetAllEquityOptionChain extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetAllEquityOptionChain
	 */
