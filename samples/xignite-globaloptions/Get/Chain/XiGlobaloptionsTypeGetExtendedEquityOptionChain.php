<?php
/**
 * Class file for XiGlobaloptionsTypeGetExtendedEquityOptionChain
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeGetExtendedEquityOptionChain
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeGetExtendedEquityOptionChain extends XiGlobaloptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobaloptionsTypeGetExtendedEquityOptionChain
	 */
