<?php
/**
 * Class file for XiGlobaloptionsTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeOutcomeTypes extends XiGlobaloptionsWsdlClass
{
	/**
