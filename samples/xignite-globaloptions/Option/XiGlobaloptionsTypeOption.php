<?php
/**
 * Class file for XiGlobaloptionsTypeOption
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeOption
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeOption extends XiGlobaloptionsTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
