<?php
/**
 * Class file for XiGlobaloptionsTypeOptionSymbol
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeOptionSymbol
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeOptionSymbol extends XiGlobaloptionsTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	...
	{
		XiGlobaloptionsWsdlClass::__construct(array('Symbol'=>$_Symbol,'SymbologyType'=>$_SymbologyType,'BaseSymbol'=>$_BaseSymbol,'Type'=>$_Type,'ExpirationDate'=>$_ExpirationDate,'Month'=>$_Month,'Year'=>$_Year,'StrikePrice'=>$_StrikePrice));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
