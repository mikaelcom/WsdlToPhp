<?php
/**
 * Class file for XiGlobaloptionsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobaloptionsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobaloptionsTypeIdentifierTypes extends XiGlobaloptionsWsdlClass
{
	/**
