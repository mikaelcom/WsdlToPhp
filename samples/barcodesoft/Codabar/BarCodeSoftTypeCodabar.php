<?php
/**
 * Class file for BarCodeSoftTypeCodabar
 * @date 02/08/2012
 */
/**
 * Class BarCodeSoftTypeCodabar
 * @date 02/08/2012
 */
class BarCodeSoftTypeCodabar extends BarCodeSoftWsdlClass
{
	/**
	 * The textToEncode
	 * Meta informations :
