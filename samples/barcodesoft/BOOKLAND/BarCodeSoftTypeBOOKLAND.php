<?php
/**
 * Class file for BarCodeSoftTypeBOOKLAND
 * @date 02/08/2012
 */
/**
 * Class BarCodeSoftTypeBOOKLAND
 * @date 02/08/2012
 */
class BarCodeSoftTypeBOOKLAND extends BarCodeSoftWsdlClass
{
	/**
	 * The textToEncode
	 * Meta informations :
	 ...
	 * @return BarCodeSoftTypeBOOKLAND
	 */
