<?php
/**
 * Class file for BarCodeSoftTypeTelepen
 * @date 02/08/2012
 */
/**
 * Class BarCodeSoftTypeTelepen
 * @date 02/08/2012
 */
class BarCodeSoftTypeTelepen extends BarCodeSoftWsdlClass
{
	/**
	 * The textToEncode
	 * Meta informations :
