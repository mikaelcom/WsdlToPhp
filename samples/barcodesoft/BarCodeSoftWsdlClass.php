<?php
/**
 * File for BarCodeSoftWsdlClass to communicate with SOAP service
 * @date 02/08/2012
 */
/**
 * File for BarCodeSoftWsdlClass to communicate with SOAP service
 * Documentation : BarCodeSoft Webservice for Online BarCode Generation
 * @date 02/08/2012
 */
class BarCodeSoftWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses BarCodeSoftWsdlClass::setLastError()
	 * @uses BarCodeSoftWsdlClass::initSoapClient()
	 * @uses BarCodeSoftWsdlClass::initInternArrayToIterate()
	 * @uses BarCodeSoftWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses BarCodeSoftWsdlClass::classMap()
	 * @uses BarCodeSoftWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('BarCodeSoftClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = BarCodeSoftClassMap::classMap();
	 ...
	 * @uses BarCodeSoftWsdlClass::WSDL_CACHE_WSDL
	 * @uses BarCodeSoftWsdlClass::WSDL_COMPRESSION
	 * @uses BarCodeSoftWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses BarCodeSoftWsdlClass::WSDL_ENCODING
	 * @uses BarCodeSoftWsdlClass::WSDL_EXCPTS
	 * @uses BarCodeSoftWsdlClass::WSDL_FEATURES
	 * @uses BarCodeSoftWsdlClass::WSDL_LOGIN
	 * @uses BarCodeSoftWsdlClass::WSDL_PASSWD
	 * @uses BarCodeSoftWsdlClass::WSDL_SOAP_VERSION
	 * @uses BarCodeSoftWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses BarCodeSoftWsdlClass::WSDL_TRACE
	 * @uses BarCodeSoftWsdlClass::WSDL_TYPEMAP
	 * @uses BarCodeSoftWsdlClass::WSDL_URL
	 * @uses BarCodeSoftWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses BarCodeSoftWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::internArrayToIterateIsArray()
	 * @uses BarCodeSoftWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::getInternArrayToIterateOffset()
	 * @uses BarCodeSoftWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::getInternArrayToIterateOffset()
	 * @uses BarCodeSoftWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see BarCodeSoftWsdlClass::offsetGet()
	 * @uses BarCodeSoftWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::getAttributeName()
	 * @uses BarCodeSoftWsdlClass::__toString()
	 * @uses BarCodeSoftWsdlClass::_set()
	 * @uses BarCodeSoftWsdlClass::_get()
	 * @uses BarCodeSoftWsdlClass::setInternArrayToIterate()
	 * @uses BarCodeSoftWsdlClass::setInternArrayToIterateIsArray()
	 * @uses BarCodeSoftWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::item()
	 * @uses BarCodeSoftWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses BarCodeSoftWsdlClass::getInternArrayToIterateIsArray()
	 * @uses BarCodeSoftWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
