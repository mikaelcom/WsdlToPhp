<?php
/**
 * Class file for XiGlobalrealtimeTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeOutcomeTypes extends XiGlobalrealtimeWsdlClass
{
	/**
