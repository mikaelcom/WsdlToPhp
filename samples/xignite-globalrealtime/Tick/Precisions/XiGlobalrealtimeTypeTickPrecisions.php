<?php
/**
 * Class file for XiGlobalrealtimeTypeTickPrecisions
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeTickPrecisions
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeTickPrecisions extends XiGlobalrealtimeWsdlClass
{
	/**
