<?php
/**
 * Class file for XiGlobalrealtimeTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeHeader
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeHeader extends XiGlobalrealtimeWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobalrealtimeTypeHeader
	 */
