<?php
/**
 * File for XiGlobalrealtimeWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalrealtimeWsdlClass to communicate with SOAP service
 * Documentation : This web service provides global realtime stock quotes and for U.S. and international equities.
 * @date 08/07/2012
 */
class XiGlobalrealtimeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalrealtimeWsdlClass::setLastError()
	 * @uses XiGlobalrealtimeWsdlClass::initSoapClient()
	 * @uses XiGlobalrealtimeWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalrealtimeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalrealtimeWsdlClass::classMap()
	 * @uses XiGlobalrealtimeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalrealtimeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalrealtimeClassMap::classMap();
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_TRACE
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_URL
	 * @uses XiGlobalrealtimeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalrealtimeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalrealtimeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalrealtimeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalrealtimeWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::getAttributeName()
	 * @uses XiGlobalrealtimeWsdlClass::__toString()
	 * @uses XiGlobalrealtimeWsdlClass::_set()
	 * @uses XiGlobalrealtimeWsdlClass::_get()
	 * @uses XiGlobalrealtimeWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalrealtimeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalrealtimeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::item()
	 * @uses XiGlobalrealtimeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalrealtimeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalrealtimeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
