<?php
/**
 * Class file for XiGlobalrealtimeTypeGlobalTick
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeGlobalTick
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeGlobalTick extends XiGlobalrealtimeTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	...
	{
		XiGlobalrealtimeWsdlClass::__construct(array('Symbol'=>$_Symbol,'Name'=>$_Name,'MarketIdentificationCode'=>$_MarketIdentificationCode,'Currency'=>$_Currency,'Date'=>$_Date,'Time'=>$_Time,'UTCDate'=>$_UTCDate,'UTCTime'=>$_UTCTime,'Last'=>$_Last,'High'=>$_High,'Low'=>$_Low,'First'=>$_First,'Quantity'=>$_Quantity,'Trades'=>$_Trades,'TWAP'=>$_TWAP,'VWAP'=>$_VWAP));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
