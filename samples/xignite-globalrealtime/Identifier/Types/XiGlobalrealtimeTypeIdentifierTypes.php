<?php
/**
 * Class file for XiGlobalrealtimeTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeIdentifierTypes extends XiGlobalrealtimeWsdlClass
{
	/**
