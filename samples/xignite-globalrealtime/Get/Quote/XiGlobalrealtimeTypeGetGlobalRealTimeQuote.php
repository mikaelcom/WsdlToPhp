<?php
/**
 * Class file for XiGlobalrealtimeTypeGetGlobalRealTimeQuote
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeGetGlobalRealTimeQuote
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeGetGlobalRealTimeQuote extends XiGlobalrealtimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeTypeGetGlobalRealTimeQuote
	 */
