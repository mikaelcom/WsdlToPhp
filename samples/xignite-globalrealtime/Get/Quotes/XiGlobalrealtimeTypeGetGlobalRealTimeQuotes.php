<?php
/**
 * Class file for XiGlobalrealtimeTypeGetGlobalRealTimeQuotes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeTypeGetGlobalRealTimeQuotes
 * @date 08/07/2012
 */
class XiGlobalrealtimeTypeGetGlobalRealTimeQuotes extends XiGlobalrealtimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeTypeGetGlobalRealTimeQuotes
	 */
