<?php
/**
 * File for BioIDWSWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for BioIDWSWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class BioIDWSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses BioIDWSWsdlClass::setLastError()
	 * @uses BioIDWSWsdlClass::initSoapClient()
	 * @uses BioIDWSWsdlClass::initInternArrayToIterate()
	 * @uses BioIDWSWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses BioIDWSWsdlClass::classMap()
	 * @uses BioIDWSWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('BioIDWSClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = BioIDWSClassMap::classMap();
	 ...
	 * @uses BioIDWSWsdlClass::WSDL_CACHE_WSDL
	 * @uses BioIDWSWsdlClass::WSDL_COMPRESSION
	 * @uses BioIDWSWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses BioIDWSWsdlClass::WSDL_ENCODING
	 * @uses BioIDWSWsdlClass::WSDL_EXCPTS
	 * @uses BioIDWSWsdlClass::WSDL_FEATURES
	 * @uses BioIDWSWsdlClass::WSDL_LOGIN
	 * @uses BioIDWSWsdlClass::WSDL_PASSWD
	 * @uses BioIDWSWsdlClass::WSDL_SOAP_VERSION
	 * @uses BioIDWSWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses BioIDWSWsdlClass::WSDL_TRACE
	 * @uses BioIDWSWsdlClass::WSDL_TYPEMAP
	 * @uses BioIDWSWsdlClass::WSDL_URL
	 * @uses BioIDWSWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses BioIDWSWsdlClass::internArrayToIterateIsArray()
	 * @uses BioIDWSWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses BioIDWSWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses BioIDWSWsdlClass::getInternArrayToIterateOffset()
	 * @uses BioIDWSWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses BioIDWSWsdlClass::getInternArrayToIterateOffset()
	 * @uses BioIDWSWsdlClass::offsetExists()
	 ...
	 * @uses BioIDWSWsdlClass::getAttributeName()
	 * @uses BioIDWSWsdlClass::__toString()
	 * @uses BioIDWSWsdlClass::_set()
	 * @uses BioIDWSWsdlClass::_get()
	 * @uses BioIDWSWsdlClass::setInternArrayToIterate()
	 * @uses BioIDWSWsdlClass::setInternArrayToIterateIsArray()
	 * @uses BioIDWSWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses BioIDWSWsdlClass::getInternArrayToIterateIsArray()
	 * @uses BioIDWSWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
