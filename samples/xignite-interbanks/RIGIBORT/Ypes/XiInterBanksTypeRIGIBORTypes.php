<?php
/**
 * Class file for XiInterBanksTypeRIGIBORTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeRIGIBORTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeRIGIBORTypes extends XiInterBanksWsdlClass
{
	/**
	...
	{
		return in_array($_value,array(self::VALUE_OVERNIGHT,self::VALUE_ONEMONTH,self::VALUE_THREEMONTH,self::VALUE_SIXMONTH,self::VALUE_ONEYEAR));
	}
	/**
