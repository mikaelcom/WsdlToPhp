<?php
/**
 * Class file for XiInterBanksTypeVILIBORTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeVILIBORTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeVILIBORTypes extends XiInterBanksWsdlClass
{
	/**
	...
	{
		return in_array($_value,array(self::VALUE_OVERNIGHT,self::VALUE_ONEWEEK,self::VALUE_TWOWEEK,self::VALUE_ONEMONTH,self::VALUE_THREEMONTH,self::VALUE_SIXMONTH,self::VALUE_ONEYEAR));
	}
	/**
