<?php
/**
 * Class file for XiInterBanksTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiInterBanksTypePredefinedLightModel extends XiInterBanksWsdlClass
{
	/**
