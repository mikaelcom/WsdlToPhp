<?php
/**
 * Class file for XiInterBanksTypePredefinedProjection
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypePredefinedProjection
 * @date 08/07/2012
 */
class XiInterBanksTypePredefinedProjection extends XiInterBanksWsdlClass
{
	/**
