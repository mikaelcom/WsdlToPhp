<?php
/**
 * Class file for XiInterBanksTypeGetTodaysRate
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeGetTodaysRate
 * @date 08/07/2012
 */
class XiInterBanksTypeGetTodaysRate extends XiInterBanksWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @return XiInterBanksTypeGetTodaysRate
	 */
