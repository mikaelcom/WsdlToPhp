<?php
/**
 * Class file for XiInterBanksTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeCommon
 * @date 08/07/2012
 */
class XiInterBanksTypeCommon extends XiInterBanksWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiInterBanksTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiInterBanksTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiInterBanksTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiInterBanksTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiInterBanksTypeOutcomeTypes
	 */
