<?php
/**
 * Class file for XiInterBanksTypeTRLIBIDTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeTRLIBIDTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeTRLIBIDTypes extends XiInterBanksWsdlClass
{
	/**
	...
	{
		return in_array($_value,array(self::VALUE_OVERNIGHT,self::VALUE_ONEWEEK,self::VALUE_ONEMONTH,self::VALUE_TWOMONTH,self::VALUE_THREEMONTH,self::VALUE_SIXMONTH,self::VALUE_NINEMONTH,self::VALUE_ONEYEAR));
	}
	/**
