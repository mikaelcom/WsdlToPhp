<?php
/**
 * Class file for XiInterBanksTypeStockChartStyles
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeStockChartStyles
 * @date 08/07/2012
 */
class XiInterBanksTypeStockChartStyles extends XiInterBanksWsdlClass
{
	/**
