<?php
/**
 * Class file for XiInterBanksTypeDrawRateChart
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeDrawRateChart
 * @date 08/07/2012
 */
class XiInterBanksTypeDrawRateChart extends XiInterBanksWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiInterBanksTypeDrawRateChart
	 */
	public function __construct($_RateType,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height)
	{
		parent::__construct(array('RateType'=>$_RateType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height));
	}
	/**
	 * Set RateType
