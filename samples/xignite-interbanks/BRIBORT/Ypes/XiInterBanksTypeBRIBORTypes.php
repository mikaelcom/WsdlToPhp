<?php
/**
 * Class file for XiInterBanksTypeBRIBORTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeBRIBORTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeBRIBORTypes extends XiInterBanksWsdlClass
{
	/**
	...
	/**
	 * Constructor
	 * @return XiInterBanksTypeBRIBORTypes
	 */
