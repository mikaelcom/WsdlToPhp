<?php
/**
 * Class file for XiInterBanksTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeChartDesign
 * @date 08/07/2012
 */
class XiInterBanksTypeChartDesign extends XiInterBanksTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiInterBanksTypeLinePattern
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiInterBanksTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiInterBanksTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiInterBanksTypeTickPeriod
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiInterBanksTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiInterBanksTypeLinePattern GridHorizontalStyle
	 * @param XiInterBanksTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiInterBanksTypeImageFrameType FrameType
	 * @param XiInterBanksTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiInterBanksTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiInterBanksTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiInterBanksTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiInterBanksTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiInterBanksTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiInterBanksTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiInterBanksTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiInterBanksTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiInterBanksTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiInterBanksTypePredefinedProjection
	 */
	...
	{
		return ($this->TickPrecision = XiInterBanksTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	 * @return XiInterBanksTypeTickPeriod
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiInterBanksTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiInterBanksTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiInterBanksTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiInterBanksTypePredefinedLightModel
	 */
