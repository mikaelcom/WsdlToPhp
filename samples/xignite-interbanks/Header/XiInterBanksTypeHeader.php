<?php
/**
 * Class file for XiInterBanksTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeHeader
 * @date 08/07/2012
 */
class XiInterBanksTypeHeader extends XiInterBanksWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
