<?php
/**
 * Class file for XiInterBanksTypePRIBORTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypePRIBORTypes
 * @date 08/07/2012
 */
class XiInterBanksTypePRIBORTypes extends XiInterBanksWsdlClass
{
	/**
	...
	/**
	 * Constructor
	 * @return XiInterBanksTypePRIBORTypes
	 */
