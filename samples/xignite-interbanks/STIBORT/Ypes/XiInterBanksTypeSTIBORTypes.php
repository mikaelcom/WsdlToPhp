<?php
/**
 * Class file for XiInterBanksTypeSTIBORTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeSTIBORTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeSTIBORTypes extends XiInterBanksWsdlClass
{
	/**
	...
	{
		return in_array($_value,array(self::VALUE_TOMORROWNEXT,self::VALUE_ONEWEEK,self::VALUE_ONEMONTH,self::VALUE_TWOMONTH,self::VALUE_THREEMONTH,self::VALUE_SIXMONTH,self::VALUE_NINEMONTH,self::VALUE_ONEYEAR));
	}
	/**
