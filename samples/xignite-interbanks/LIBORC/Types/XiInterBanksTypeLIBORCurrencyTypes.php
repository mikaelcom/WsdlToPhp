<?php
/**
 * Class file for XiInterBanksTypeLIBORCurrencyTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeLIBORCurrencyTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeLIBORCurrencyTypes extends XiInterBanksWsdlClass
{
	/**
