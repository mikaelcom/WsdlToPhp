<?php
/**
 * Class file for XiInterBanksTypeTAIBORTypes
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeTAIBORTypes
 * @date 08/07/2012
 */
class XiInterBanksTypeTAIBORTypes extends XiInterBanksWsdlClass
{
	/**
	...
	/**
	 * Constructor
	 * @return XiInterBanksTypeTAIBORTypes
	 */
	...
	{
		return in_array($_value,array(self::VALUE_OVERNIGHT,self::VALUE_ONEWEEK,self::VALUE_TWOWEEK,self::VALUE_ONEMONTH,self::VALUE_TWOMONTH,self::VALUE_THREEMONTH,self::VALUE_SIXMONTH,self::VALUE_NINEMONTH,self::VALUE_ONEYEAR));
	}
	/**
