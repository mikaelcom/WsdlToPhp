<?php
/**
 * Class file for XiInterBanksTypeInterestRate
 * @date 08/07/2012
 */
/**
 * Class XiInterBanksTypeInterestRate
 * @date 08/07/2012
 */
class XiInterBanksTypeInterestRate extends XiInterBanksTypeCommon
{
	/**
	 * The Type
	 * Meta informations :
	...
	{
		XiInterBanksWsdlClass::__construct(array('Type'=>$_Type,'Date'=>$_Date,'Value'=>$_Value,'Price'=>$_Price,'Spread'=>$_Spread,'Change'=>$_Change,'Text'=>$_Text,'Description'=>$_Description));
	}
	/**
	 * Set Type
