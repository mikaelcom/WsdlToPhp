<?php
/**
 * File for XiInterBanksWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiInterBanksWsdlClass to communicate with SOAP service
 * Documentation : Provide information about global interbank interest rates.
 * @date 08/07/2012
 */
class XiInterBanksWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiInterBanksWsdlClass::setLastError()
	 * @uses XiInterBanksWsdlClass::initSoapClient()
	 * @uses XiInterBanksWsdlClass::initInternArrayToIterate()
	 * @uses XiInterBanksWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiInterBanksWsdlClass::classMap()
	 * @uses XiInterBanksWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiInterBanksClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiInterBanksClassMap::classMap();
	 ...
	 * @uses XiInterBanksWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiInterBanksWsdlClass::WSDL_COMPRESSION
	 * @uses XiInterBanksWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiInterBanksWsdlClass::WSDL_ENCODING
	 * @uses XiInterBanksWsdlClass::WSDL_EXCPTS
	 * @uses XiInterBanksWsdlClass::WSDL_FEATURES
	 * @uses XiInterBanksWsdlClass::WSDL_LOGIN
	 * @uses XiInterBanksWsdlClass::WSDL_PASSWD
	 * @uses XiInterBanksWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiInterBanksWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiInterBanksWsdlClass::WSDL_TRACE
	 * @uses XiInterBanksWsdlClass::WSDL_TYPEMAP
	 * @uses XiInterBanksWsdlClass::WSDL_URL
	 * @uses XiInterBanksWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiInterBanksWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::internArrayToIterateIsArray()
	 * @uses XiInterBanksWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiInterBanksWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiInterBanksWsdlClass::offsetExists()
	 ...
	 * @uses XiInterBanksWsdlClass::getAttributeName()
	 * @uses XiInterBanksWsdlClass::__toString()
	 * @uses XiInterBanksWsdlClass::_set()
	 * @uses XiInterBanksWsdlClass::_get()
	 * @uses XiInterBanksWsdlClass::setInternArrayToIterate()
	 * @uses XiInterBanksWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiInterBanksWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::item()
	 * @uses XiInterBanksWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiInterBanksWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiInterBanksWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
