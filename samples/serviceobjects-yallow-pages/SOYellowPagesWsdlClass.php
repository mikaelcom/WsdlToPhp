<?php
/**
 * File for SOYellowPagesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOYellowPagesWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOYellowPagesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOYellowPagesWsdlClass::setLastError()
	 * @uses SOYellowPagesWsdlClass::initSoapClient()
	 * @uses SOYellowPagesWsdlClass::initInternArrayToIterate()
	 * @uses SOYellowPagesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOYellowPagesWsdlClass::classMap()
	 * @uses SOYellowPagesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOYellowPagesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOYellowPagesClassMap::classMap();
	 ...
	 * @uses SOYellowPagesWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOYellowPagesWsdlClass::WSDL_COMPRESSION
	 * @uses SOYellowPagesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOYellowPagesWsdlClass::WSDL_ENCODING
	 * @uses SOYellowPagesWsdlClass::WSDL_EXCPTS
	 * @uses SOYellowPagesWsdlClass::WSDL_FEATURES
	 * @uses SOYellowPagesWsdlClass::WSDL_LOGIN
	 * @uses SOYellowPagesWsdlClass::WSDL_PASSWD
	 * @uses SOYellowPagesWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOYellowPagesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOYellowPagesWsdlClass::WSDL_TRACE
	 * @uses SOYellowPagesWsdlClass::WSDL_TYPEMAP
	 * @uses SOYellowPagesWsdlClass::WSDL_URL
	 * @uses SOYellowPagesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOYellowPagesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::internArrayToIterateIsArray()
	 * @uses SOYellowPagesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOYellowPagesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOYellowPagesWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOYellowPagesWsdlClass::offsetGet()
	 * @uses SOYellowPagesWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::getAttributeName()
	 * @uses SOYellowPagesWsdlClass::__toString()
	 * @uses SOYellowPagesWsdlClass::_set()
	 * @uses SOYellowPagesWsdlClass::_get()
	 * @uses SOYellowPagesWsdlClass::setInternArrayToIterate()
	 * @uses SOYellowPagesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOYellowPagesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::item()
	 * @uses SOYellowPagesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOYellowPagesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOYellowPagesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
