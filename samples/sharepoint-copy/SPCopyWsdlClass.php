<?php
/**
 * File for SPCopyWsdlClass to communicate with SOAP service
 * @date 07/07/2012
 */
/**
 * File for SPCopyWsdlClass to communicate with SOAP service
 ...
 * @date 07/07/2012
 */
class SPCopyWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPCopyWsdlClass::setLastError()
	 * @uses SPCopyWsdlClass::initSoapClient()
	 * @uses SPCopyWsdlClass::initInternArrayToIterate()
	 * @uses SPCopyWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPCopyWsdlClass::classMap()
	 * @uses SPCopyWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPCopyClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPCopyClassMap::classMap();
	 ...
	 * @uses SPCopyWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPCopyWsdlClass::WSDL_COMPRESSION
	 * @uses SPCopyWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPCopyWsdlClass::WSDL_ENCODING
	 * @uses SPCopyWsdlClass::WSDL_EXCPTS
	 * @uses SPCopyWsdlClass::WSDL_FEATURES
	 * @uses SPCopyWsdlClass::WSDL_LOGIN
	 * @uses SPCopyWsdlClass::WSDL_PASSWD
	 * @uses SPCopyWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPCopyWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPCopyWsdlClass::WSDL_TRACE
	 * @uses SPCopyWsdlClass::WSDL_TYPEMAP
	 * @uses SPCopyWsdlClass::WSDL_URL
	 * @uses SPCopyWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPCopyWsdlClass::internArrayToIterateIsArray()
	 * @uses SPCopyWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPCopyWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPCopyWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPCopyWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPCopyWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPCopyWsdlClass::offsetExists()
	 ...
	 * @uses SPCopyWsdlClass::getAttributeName()
	 * @uses SPCopyWsdlClass::__toString()
	 * @uses SPCopyWsdlClass::_set()
	 * @uses SPCopyWsdlClass::_get()
	 * @uses SPCopyWsdlClass::setInternArrayToIterate()
	 * @uses SPCopyWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPCopyWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPCopyWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPCopyWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
