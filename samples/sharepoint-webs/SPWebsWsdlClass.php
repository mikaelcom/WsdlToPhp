<?php
/**
 * File for SPWebsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPWebsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPWebsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPWebsWsdlClass::setLastError()
	 * @uses SPWebsWsdlClass::initSoapClient()
	 * @uses SPWebsWsdlClass::initInternArrayToIterate()
	 * @uses SPWebsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPWebsWsdlClass::classMap()
	 * @uses SPWebsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPWebsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPWebsClassMap::classMap();
	 ...
	 * @uses SPWebsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPWebsWsdlClass::WSDL_COMPRESSION
	 * @uses SPWebsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPWebsWsdlClass::WSDL_ENCODING
	 * @uses SPWebsWsdlClass::WSDL_EXCPTS
	 * @uses SPWebsWsdlClass::WSDL_FEATURES
	 * @uses SPWebsWsdlClass::WSDL_LOGIN
	 * @uses SPWebsWsdlClass::WSDL_PASSWD
	 * @uses SPWebsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPWebsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPWebsWsdlClass::WSDL_TRACE
	 * @uses SPWebsWsdlClass::WSDL_TYPEMAP
	 * @uses SPWebsWsdlClass::WSDL_URL
	 * @uses SPWebsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPWebsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPWebsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPWebsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPWebsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPWebsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPWebsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPWebsWsdlClass::offsetExists()
	 ...
	 * @uses SPWebsWsdlClass::getAttributeName()
	 * @uses SPWebsWsdlClass::__toString()
	 * @uses SPWebsWsdlClass::_set()
	 * @uses SPWebsWsdlClass::_get()
	 * @uses SPWebsWsdlClass::setInternArrayToIterate()
	 * @uses SPWebsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPWebsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPWebsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPWebsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
