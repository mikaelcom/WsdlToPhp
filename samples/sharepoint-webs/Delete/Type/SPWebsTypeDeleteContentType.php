<?php
/**
 * Class file for SPWebsTypeDeleteContentType
 * @date 06/07/2012
 */
/**
 * Class SPWebsTypeDeleteContentType
 * @date 06/07/2012
 */
class SPWebsTypeDeleteContentType extends SPWebsWsdlClass
{
	/**
	 * The contentTypeId
	 * @var string
	 ...
	 * @return SPWebsTypeDeleteContentType
	 */
