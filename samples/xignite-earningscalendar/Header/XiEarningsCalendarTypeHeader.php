<?php
/**
 * Class file for XiEarningsCalendarTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeHeader
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeHeader extends XiEarningsCalendarWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiEarningsCalendarTypeHeader
	 */
