<?php
/**
 * File for XiEarningsCalendarWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiEarningsCalendarWsdlClass to communicate with SOAP service
 * Documentation : Provides earning calendar information for publicly traded US companies.
 * @date 08/07/2012
 */
class XiEarningsCalendarWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiEarningsCalendarWsdlClass::setLastError()
	 * @uses XiEarningsCalendarWsdlClass::initSoapClient()
	 * @uses XiEarningsCalendarWsdlClass::initInternArrayToIterate()
	 * @uses XiEarningsCalendarWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiEarningsCalendarWsdlClass::classMap()
	 * @uses XiEarningsCalendarWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiEarningsCalendarClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiEarningsCalendarClassMap::classMap();
	 ...
	 * @uses XiEarningsCalendarWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiEarningsCalendarWsdlClass::WSDL_COMPRESSION
	 * @uses XiEarningsCalendarWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiEarningsCalendarWsdlClass::WSDL_ENCODING
	 * @uses XiEarningsCalendarWsdlClass::WSDL_EXCPTS
	 * @uses XiEarningsCalendarWsdlClass::WSDL_FEATURES
	 * @uses XiEarningsCalendarWsdlClass::WSDL_LOGIN
	 * @uses XiEarningsCalendarWsdlClass::WSDL_PASSWD
	 * @uses XiEarningsCalendarWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiEarningsCalendarWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiEarningsCalendarWsdlClass::WSDL_TRACE
	 * @uses XiEarningsCalendarWsdlClass::WSDL_TYPEMAP
	 * @uses XiEarningsCalendarWsdlClass::WSDL_URL
	 * @uses XiEarningsCalendarWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiEarningsCalendarWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::internArrayToIterateIsArray()
	 * @uses XiEarningsCalendarWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEarningsCalendarWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEarningsCalendarWsdlClass::offsetExists()
	 ...
	 * @uses XiEarningsCalendarWsdlClass::getAttributeName()
	 * @uses XiEarningsCalendarWsdlClass::__toString()
	 * @uses XiEarningsCalendarWsdlClass::_set()
	 * @uses XiEarningsCalendarWsdlClass::_get()
	 * @uses XiEarningsCalendarWsdlClass::setInternArrayToIterate()
	 * @uses XiEarningsCalendarWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiEarningsCalendarWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::item()
	 * @uses XiEarningsCalendarWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiEarningsCalendarWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiEarningsCalendarWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
