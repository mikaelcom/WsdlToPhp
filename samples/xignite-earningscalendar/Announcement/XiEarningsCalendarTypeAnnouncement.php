<?php
/**
 * Class file for XiEarningsCalendarTypeAnnouncement
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeAnnouncement
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeAnnouncement extends XiEarningsCalendarTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * @param XiEarningsCalendarTypeConferenceCallInformation ConferenceCall
	 * @return XiEarningsCalendarTypeAnnouncement
	 */
	public function __construct($_Security = null,$_EarningsQuarter,$_EarningsDateQuarter,$_EarningsDate = null,$_TimeType,$_DateType,$_ConfirmationDate = null,$_ConferenceCall = null)
	{
		XiEarningsCalendarWsdlClass::__construct(array('Security'=>$_Security,'EarningsQuarter'=>$_EarningsQuarter,'EarningsDateQuarter'=>$_EarningsDateQuarter,'EarningsDate'=>$_EarningsDate,'TimeType'=>$_TimeType,'DateType'=>$_DateType,'ConfirmationDate'=>$_ConfirmationDate,'ConferenceCall'=>$_ConferenceCall));
	}
	/**
	 * Set Security
	...
	/**
	 * Set ConferenceCall
	 * @param ConferenceCallInformation ConferenceCall
	 * @return ConferenceCallInformation
	 */
	public function setConferenceCall($_ConferenceCall)
	{
		return ($this->ConferenceCall = $_ConferenceCall);
	}
	/**
	 * Get ConferenceCall
	 * @return XiEarningsCalendarTypeConferenceCallInformation
	 */
	public function getConferenceCall()
	{
