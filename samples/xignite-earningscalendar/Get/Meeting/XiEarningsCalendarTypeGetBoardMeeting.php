<?php
/**
 * Class file for XiEarningsCalendarTypeGetBoardMeeting
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeGetBoardMeeting
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeGetBoardMeeting extends XiEarningsCalendarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEarningsCalendarTypeGetBoardMeeting
	 */
