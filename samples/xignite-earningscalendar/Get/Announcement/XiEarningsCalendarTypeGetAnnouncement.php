<?php
/**
 * Class file for XiEarningsCalendarTypeGetAnnouncement
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeGetAnnouncement
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeGetAnnouncement extends XiEarningsCalendarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEarningsCalendarTypeGetAnnouncement
	 */
