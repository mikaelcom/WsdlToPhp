<?php
/**
 * Class file for XiEarningsCalendarTypeGetEarningCall
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeGetEarningCall
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeGetEarningCall extends XiEarningsCalendarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEarningsCalendarTypeGetEarningCall
	 */
