<?php
/**
 * Class file for XiEarningsCalendarTypeGetReplayInformation
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeGetReplayInformation
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeGetReplayInformation extends XiEarningsCalendarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEarningsCalendarTypeGetReplayInformation
	 */
