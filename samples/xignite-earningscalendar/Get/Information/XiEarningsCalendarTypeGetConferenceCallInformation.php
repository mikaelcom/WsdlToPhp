<?php
/**
 * Class file for XiEarningsCalendarTypeGetConferenceCallInformation
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeGetConferenceCallInformation
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeGetConferenceCallInformation extends XiEarningsCalendarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEarningsCalendarTypeGetConferenceCallInformation
	 */
