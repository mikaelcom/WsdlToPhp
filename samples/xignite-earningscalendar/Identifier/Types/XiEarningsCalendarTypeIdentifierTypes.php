<?php
/**
 * Class file for XiEarningsCalendarTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeIdentifierTypes extends XiEarningsCalendarWsdlClass
{
	/**
