<?php
/**
 * Class file for XiEarningsCalendarTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeSecurity
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeSecurity extends XiEarningsCalendarTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiEarningsCalendarWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
