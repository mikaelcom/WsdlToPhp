<?php
/**
 * Class file for XiEarningsCalendarTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiEarningsCalendarTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiEarningsCalendarTypeOutcomeTypes extends XiEarningsCalendarWsdlClass
{
	/**
