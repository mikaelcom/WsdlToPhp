<?php
/**
 * Class file for XiFundDataTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeCommon
 * @date 08/07/2012
 */
class XiFundDataTypeCommon extends XiFundDataWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFundDataTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiFundDataTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiFundDataTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiFundDataTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiFundDataTypeOutcomeTypes
	 */
