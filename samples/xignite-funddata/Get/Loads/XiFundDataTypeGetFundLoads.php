<?php
/**
 * Class file for XiFundDataTypeGetFundLoads
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeGetFundLoads
 * @date 08/07/2012
 */
class XiFundDataTypeGetFundLoads extends XiFundDataWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundDataTypeGetFundLoads
	 */
