<?php
/**
 * Class file for XiFundDataTypeGetFundCategory
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeGetFundCategory
 * @date 08/07/2012
 */
class XiFundDataTypeGetFundCategory extends XiFundDataWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundDataTypeGetFundCategory
	 */
