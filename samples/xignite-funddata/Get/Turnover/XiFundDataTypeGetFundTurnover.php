<?php
/**
 * Class file for XiFundDataTypeGetFundTurnover
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeGetFundTurnover
 * @date 08/07/2012
 */
class XiFundDataTypeGetFundTurnover extends XiFundDataWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundDataTypeGetFundTurnover
	 */
