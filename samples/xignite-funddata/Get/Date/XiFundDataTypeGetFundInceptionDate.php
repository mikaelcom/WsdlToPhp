<?php
/**
 * Class file for XiFundDataTypeGetFundInceptionDate
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeGetFundInceptionDate
 * @date 08/07/2012
 */
class XiFundDataTypeGetFundInceptionDate extends XiFundDataWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundDataTypeGetFundInceptionDate
	 */
