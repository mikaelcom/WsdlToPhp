<?php
/**
 * Class file for XiFundDataTypeGetFundFamily
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeGetFundFamily
 * @date 08/07/2012
 */
class XiFundDataTypeGetFundFamily extends XiFundDataWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundDataTypeGetFundFamily
	 */
