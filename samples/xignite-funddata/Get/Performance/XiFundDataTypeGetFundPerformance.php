<?php
/**
 * Class file for XiFundDataTypeGetFundPerformance
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeGetFundPerformance
 * @date 08/07/2012
 */
class XiFundDataTypeGetFundPerformance extends XiFundDataWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundDataTypeGetFundPerformance
	 */
