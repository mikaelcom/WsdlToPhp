<?php
/**
 * File for XiFundDataWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiFundDataWsdlClass to communicate with SOAP service
 * Documentation : This web service provides fundamental fund data.
 * @date 08/07/2012
 */
class XiFundDataWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiFundDataWsdlClass::setLastError()
	 * @uses XiFundDataWsdlClass::initSoapClient()
	 * @uses XiFundDataWsdlClass::initInternArrayToIterate()
	 * @uses XiFundDataWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiFundDataWsdlClass::classMap()
	 * @uses XiFundDataWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiFundDataClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiFundDataClassMap::classMap();
	 ...
	 * @uses XiFundDataWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiFundDataWsdlClass::WSDL_COMPRESSION
	 * @uses XiFundDataWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiFundDataWsdlClass::WSDL_ENCODING
	 * @uses XiFundDataWsdlClass::WSDL_EXCPTS
	 * @uses XiFundDataWsdlClass::WSDL_FEATURES
	 * @uses XiFundDataWsdlClass::WSDL_LOGIN
	 * @uses XiFundDataWsdlClass::WSDL_PASSWD
	 * @uses XiFundDataWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiFundDataWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiFundDataWsdlClass::WSDL_TRACE
	 * @uses XiFundDataWsdlClass::WSDL_TYPEMAP
	 * @uses XiFundDataWsdlClass::WSDL_URL
	 * @uses XiFundDataWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiFundDataWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiFundDataWsdlClass::internArrayToIterateIsArray()
	 * @uses XiFundDataWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiFundDataWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundDataWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundDataWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiFundDataWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundDataWsdlClass::offsetExists()
	 ...
	 * @uses XiFundDataWsdlClass::getAttributeName()
	 * @uses XiFundDataWsdlClass::__toString()
	 * @uses XiFundDataWsdlClass::_set()
	 * @uses XiFundDataWsdlClass::_get()
	 * @uses XiFundDataWsdlClass::setInternArrayToIterate()
	 * @uses XiFundDataWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiFundDataWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiFundDataWsdlClass::item()
	 * @uses XiFundDataWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundDataWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiFundDataWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
