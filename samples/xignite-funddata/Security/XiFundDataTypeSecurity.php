<?php
/**
 * Class file for XiFundDataTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiFundDataTypeSecurity
 * @date 08/07/2012
 */
class XiFundDataTypeSecurity extends XiFundDataTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiFundDataWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
