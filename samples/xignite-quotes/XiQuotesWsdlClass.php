<?php
/**
 * File for XiQuotesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiQuotesWsdlClass to communicate with SOAP service
 * Documentation : This web service provides multiple quote related operations including several quote formats (simple, extended), market summary information, and top market movers, losers, and gainers.
 * @date 08/07/2012
 */
class XiQuotesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiQuotesWsdlClass::setLastError()
	 * @uses XiQuotesWsdlClass::initSoapClient()
	 * @uses XiQuotesWsdlClass::initInternArrayToIterate()
	 * @uses XiQuotesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiQuotesWsdlClass::classMap()
	 * @uses XiQuotesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiQuotesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiQuotesClassMap::classMap();
	 ...
	 * @uses XiQuotesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiQuotesWsdlClass::WSDL_COMPRESSION
	 * @uses XiQuotesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiQuotesWsdlClass::WSDL_ENCODING
	 * @uses XiQuotesWsdlClass::WSDL_EXCPTS
	 * @uses XiQuotesWsdlClass::WSDL_FEATURES
	 * @uses XiQuotesWsdlClass::WSDL_LOGIN
	 * @uses XiQuotesWsdlClass::WSDL_PASSWD
	 * @uses XiQuotesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiQuotesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiQuotesWsdlClass::WSDL_TRACE
	 * @uses XiQuotesWsdlClass::WSDL_TYPEMAP
	 * @uses XiQuotesWsdlClass::WSDL_URL
	 * @uses XiQuotesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiQuotesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiQuotesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiQuotesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiQuotesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiQuotesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiQuotesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiQuotesWsdlClass::offsetExists()
	 ...
	 * @uses XiQuotesWsdlClass::getAttributeName()
	 * @uses XiQuotesWsdlClass::__toString()
	 * @uses XiQuotesWsdlClass::_set()
	 * @uses XiQuotesWsdlClass::_get()
	 * @uses XiQuotesWsdlClass::setInternArrayToIterate()
	 * @uses XiQuotesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiQuotesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiQuotesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiQuotesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
