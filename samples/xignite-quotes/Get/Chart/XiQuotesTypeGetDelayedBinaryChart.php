<?php
/**
 * Class file for XiQuotesTypeGetDelayedBinaryChart
 * @date 08/07/2012
 */
/**
 * Class XiQuotesTypeGetDelayedBinaryChart
 * @date 08/07/2012
 */
class XiQuotesTypeGetDelayedBinaryChart extends XiQuotesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiQuotesTypeGetDelayedBinaryChart
	 */
