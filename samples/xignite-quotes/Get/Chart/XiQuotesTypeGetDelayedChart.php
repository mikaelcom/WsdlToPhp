<?php
/**
 * Class file for XiQuotesTypeGetDelayedChart
 * @date 08/07/2012
 */
/**
 * Class XiQuotesTypeGetDelayedChart
 * @date 08/07/2012
 */
class XiQuotesTypeGetDelayedChart extends XiQuotesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiQuotesTypeGetDelayedChart
	 */
