<?php
/**
 * Class file for XiQuotesTypeGetHistoricalTicksAsOfDate
 * @date 08/07/2012
 */
/**
 * Class XiQuotesTypeGetHistoricalTicksAsOfDate
 * @date 08/07/2012
 */
class XiQuotesTypeGetHistoricalTicksAsOfDate extends XiQuotesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiQuotesTypeGetHistoricalTicksAsOfDate
	 */
