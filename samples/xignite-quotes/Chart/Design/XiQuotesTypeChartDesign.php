<?php
/**
 * Class file for XiQuotesTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiQuotesTypeChartDesign
 * @date 08/07/2012
 */
class XiQuotesTypeChartDesign extends XiQuotesTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiQuotesTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiQuotesTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiQuotesTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiQuotesTypeLinePattern GridHorizontalStyle
	 * @param XiQuotesTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiQuotesTypeImageFrameType FrameType
	 * @param XiQuotesTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiQuotesTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiQuotesTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiQuotesTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiQuotesTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiQuotesTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiQuotesTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiQuotesTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiQuotesTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiQuotesTypePredefinedProjection
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiQuotesTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiQuotesTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiQuotesTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiQuotesTypePredefinedLightModel
	 */
