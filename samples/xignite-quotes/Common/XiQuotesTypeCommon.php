<?php
/**
 * Class file for XiQuotesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiQuotesTypeCommon
 * @date 08/07/2012
 */
class XiQuotesTypeCommon extends XiQuotesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiQuotesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiQuotesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiQuotesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiQuotesTypeOutcomeTypes
	 */
