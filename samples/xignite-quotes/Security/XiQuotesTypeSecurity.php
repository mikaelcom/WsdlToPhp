<?php
/**
 * Class file for XiQuotesTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiQuotesTypeSecurity
 * @date 08/07/2012
 */
class XiQuotesTypeSecurity extends XiQuotesTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiQuotesWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
