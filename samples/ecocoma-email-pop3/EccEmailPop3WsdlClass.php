<?php
/**
 * File for EccEmailPop3WsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccEmailPop3WsdlClass to communicate with SOAP service
 * Documentation : Cocoma POP3 Web Services.
 * @date 03/07/2012
 */
class EccEmailPop3WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccEmailPop3WsdlClass::setLastError()
	 * @uses EccEmailPop3WsdlClass::initSoapClient()
	 * @uses EccEmailPop3WsdlClass::initInternArrayToIterate()
	 * @uses EccEmailPop3WsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccEmailPop3WsdlClass::classMap()
	 * @uses EccEmailPop3WsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccEmailPop3ClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccEmailPop3ClassMap::classMap();
	 ...
	 * @uses EccEmailPop3WsdlClass::WSDL_CACHE_WSDL
	 * @uses EccEmailPop3WsdlClass::WSDL_COMPRESSION
	 * @uses EccEmailPop3WsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccEmailPop3WsdlClass::WSDL_ENCODING
	 * @uses EccEmailPop3WsdlClass::WSDL_EXCPTS
	 * @uses EccEmailPop3WsdlClass::WSDL_FEATURES
	 * @uses EccEmailPop3WsdlClass::WSDL_LOGIN
	 * @uses EccEmailPop3WsdlClass::WSDL_PASSWD
	 * @uses EccEmailPop3WsdlClass::WSDL_SOAP_VERSION
	 * @uses EccEmailPop3WsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccEmailPop3WsdlClass::WSDL_TRACE
	 * @uses EccEmailPop3WsdlClass::WSDL_TYPEMAP
	 * @uses EccEmailPop3WsdlClass::WSDL_URL
	 * @uses EccEmailPop3WsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccEmailPop3WsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::internArrayToIterateIsArray()
	 * @uses EccEmailPop3WsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::getInternArrayToIterateOffset()
	 * @uses EccEmailPop3WsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::getInternArrayToIterateOffset()
	 * @uses EccEmailPop3WsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccEmailPop3WsdlClass::offsetGet()
	 * @uses EccEmailPop3WsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::getAttributeName()
	 * @uses EccEmailPop3WsdlClass::__toString()
	 * @uses EccEmailPop3WsdlClass::_set()
	 * @uses EccEmailPop3WsdlClass::_get()
	 * @uses EccEmailPop3WsdlClass::setInternArrayToIterate()
	 * @uses EccEmailPop3WsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccEmailPop3WsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::item()
	 * @uses EccEmailPop3WsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailPop3WsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccEmailPop3WsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
