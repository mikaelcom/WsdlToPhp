<?php
/**
 * File for UsgsRequestWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for UsgsRequestWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class UsgsRequestWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses UsgsRequestWsdlClass::setLastError()
	 * @uses UsgsRequestWsdlClass::initSoapClient()
	 * @uses UsgsRequestWsdlClass::initInternArrayToIterate()
	 * @uses UsgsRequestWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses UsgsRequestWsdlClass::classMap()
	 * @uses UsgsRequestWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('UsgsRequestClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = UsgsRequestClassMap::classMap();
	 ...
	 * @uses UsgsRequestWsdlClass::WSDL_CACHE_WSDL
	 * @uses UsgsRequestWsdlClass::WSDL_COMPRESSION
	 * @uses UsgsRequestWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses UsgsRequestWsdlClass::WSDL_ENCODING
	 * @uses UsgsRequestWsdlClass::WSDL_EXCPTS
	 * @uses UsgsRequestWsdlClass::WSDL_FEATURES
	 * @uses UsgsRequestWsdlClass::WSDL_LOGIN
	 * @uses UsgsRequestWsdlClass::WSDL_PASSWD
	 * @uses UsgsRequestWsdlClass::WSDL_SOAP_VERSION
	 * @uses UsgsRequestWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses UsgsRequestWsdlClass::WSDL_TRACE
	 * @uses UsgsRequestWsdlClass::WSDL_TYPEMAP
	 * @uses UsgsRequestWsdlClass::WSDL_URL
	 * @uses UsgsRequestWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses UsgsRequestWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::internArrayToIterateIsArray()
	 * @uses UsgsRequestWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsRequestWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsRequestWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see UsgsRequestWsdlClass::offsetGet()
	 * @uses UsgsRequestWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::getAttributeName()
	 * @uses UsgsRequestWsdlClass::__toString()
	 * @uses UsgsRequestWsdlClass::_set()
	 * @uses UsgsRequestWsdlClass::_get()
	 * @uses UsgsRequestWsdlClass::setInternArrayToIterate()
	 * @uses UsgsRequestWsdlClass::setInternArrayToIterateIsArray()
	 * @uses UsgsRequestWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::item()
	 * @uses UsgsRequestWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsRequestWsdlClass::getInternArrayToIterateIsArray()
	 * @uses UsgsRequestWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
