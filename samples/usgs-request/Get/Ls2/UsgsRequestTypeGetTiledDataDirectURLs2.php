<?php
/**
 * Class file for UsgsRequestTypeGetTiledDataDirectURLs2
 * @date 08/07/2012
 */
/**
 * Class UsgsRequestTypeGetTiledDataDirectURLs2
 * @date 08/07/2012
 */
class UsgsRequestTypeGetTiledDataDirectURLs2 extends UsgsRequestWsdlClass
{
	/**
	 * The requestInfoXml
	 * @var string
	 ...
	 * @return UsgsRequestTypeGetTiledDataDirectURLs2
	 */
