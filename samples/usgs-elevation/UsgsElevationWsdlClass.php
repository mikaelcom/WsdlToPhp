...
class UsgsElevationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	...
	/**
	 * Constructor
	 * @uses UsgsElevationWsdlClass::setLastError()
	 * @uses UsgsElevationWsdlClass::initSoapClient()
	 * @uses UsgsElevationWsdlClass::initInternArrayToIterate()
	 * @uses UsgsElevationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses UsgsElevationWsdlClass::classMap()
	 * @uses UsgsElevationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('UsgsElevationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = UsgsElevationClassMap::classMap();
	 ...
	 * @uses UsgsElevationWsdlClass::WSDL_CACHE_WSDL
	 * @uses UsgsElevationWsdlClass::WSDL_COMPRESSION
	 * @uses UsgsElevationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses UsgsElevationWsdlClass::WSDL_ENCODING
	 * @uses UsgsElevationWsdlClass::WSDL_EXCPTS
	 * @uses UsgsElevationWsdlClass::WSDL_FEATURES
	 * @uses UsgsElevationWsdlClass::WSDL_LOGIN
	 * @uses UsgsElevationWsdlClass::WSDL_PASSWD
	 * @uses UsgsElevationWsdlClass::WSDL_SOAP_VERSION
	 * @uses UsgsElevationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses UsgsElevationWsdlClass::WSDL_TRACE
	 * @uses UsgsElevationWsdlClass::WSDL_TYPEMAP
	 * @uses UsgsElevationWsdlClass::WSDL_URL
	 * @uses UsgsElevationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses UsgsElevationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::internArrayToIterateIsArray()
	 * @uses UsgsElevationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsElevationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsElevationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see UsgsElevationWsdlClass::offsetGet()
	 * @uses UsgsElevationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::getAttributeName()
	 * @uses UsgsElevationWsdlClass::__toString()
	 * @uses UsgsElevationWsdlClass::_set()
	 * @uses UsgsElevationWsdlClass::_get()
	 * @uses UsgsElevationWsdlClass::setInternArrayToIterate()
	 * @uses UsgsElevationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses UsgsElevationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::item()
	 * @uses UsgsElevationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsElevationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses UsgsElevationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
