<?php
/**
 * Class file for XWebCheckOutTypeShipping
 * @date 09/07/2012
 */
/**
 * Class XWebCheckOutTypeShipping
 * @date 09/07/2012
 */
class XWebCheckOutTypeShipping extends XWebCheckOutWsdlClass
{
	/**
	 * The First_Name
	 * @var First_Name
	 ...
	 * @param Fax Fax
	 * @param Email Email
	 * @param anonymous20 Date_Created
