<?php
/**
 * Class file for XWebCheckOutTypeLoadBasketsPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebCheckOutTypeLoadBasketsPagedRequest
 * @date 09/07/2012
 */
class XWebCheckOutTypeLoadBasketsPagedRequest extends XWebCheckOutWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebCheckOutTypeLoadBasketsPagedRequest
	 */
