<?php
/**
 * File for XWebCheckOutWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebCheckOutWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebCheckOutWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebCheckOutWsdlClass::setLastError()
	 * @uses XWebCheckOutWsdlClass::initSoapClient()
	 * @uses XWebCheckOutWsdlClass::initInternArrayToIterate()
	 * @uses XWebCheckOutWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebCheckOutWsdlClass::classMap()
	 * @uses XWebCheckOutWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebCheckOutClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebCheckOutClassMap::classMap();
	 ...
	 * @uses XWebCheckOutWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebCheckOutWsdlClass::WSDL_COMPRESSION
	 * @uses XWebCheckOutWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebCheckOutWsdlClass::WSDL_ENCODING
	 * @uses XWebCheckOutWsdlClass::WSDL_EXCPTS
	 * @uses XWebCheckOutWsdlClass::WSDL_FEATURES
	 * @uses XWebCheckOutWsdlClass::WSDL_LOGIN
	 * @uses XWebCheckOutWsdlClass::WSDL_PASSWD
	 * @uses XWebCheckOutWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebCheckOutWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebCheckOutWsdlClass::WSDL_TRACE
	 * @uses XWebCheckOutWsdlClass::WSDL_TYPEMAP
	 * @uses XWebCheckOutWsdlClass::WSDL_URL
	 * @uses XWebCheckOutWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebCheckOutWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebCheckOutWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebCheckOutWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebCheckOutWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebCheckOutWsdlClass::offsetGet()
	 * @uses XWebCheckOutWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::getAttributeName()
	 * @uses XWebCheckOutWsdlClass::__toString()
	 * @uses XWebCheckOutWsdlClass::_set()
	 * @uses XWebCheckOutWsdlClass::_get()
	 * @uses XWebCheckOutWsdlClass::setInternArrayToIterate()
	 * @uses XWebCheckOutWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebCheckOutWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::item()
	 * @uses XWebCheckOutWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebCheckOutWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebCheckOutWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
