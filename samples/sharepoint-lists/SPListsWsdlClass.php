<?php
/**
 * File for SPListsWsdlClass to communicate with SOAP service
 * @date 07/07/2012
 */
/**
 * File for SPListsWsdlClass to communicate with SOAP service
 ...
 * @date 07/07/2012
 */
class SPListsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPListsWsdlClass::setLastError()
	 * @uses SPListsWsdlClass::initSoapClient()
	 * @uses SPListsWsdlClass::initInternArrayToIterate()
	 * @uses SPListsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPListsWsdlClass::classMap()
	 * @uses SPListsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPListsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPListsClassMap::classMap();
	 ...
	 * @uses SPListsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPListsWsdlClass::WSDL_COMPRESSION
	 * @uses SPListsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPListsWsdlClass::WSDL_ENCODING
	 * @uses SPListsWsdlClass::WSDL_EXCPTS
	 * @uses SPListsWsdlClass::WSDL_FEATURES
	 * @uses SPListsWsdlClass::WSDL_LOGIN
	 * @uses SPListsWsdlClass::WSDL_PASSWD
	 * @uses SPListsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPListsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPListsWsdlClass::WSDL_TRACE
	 * @uses SPListsWsdlClass::WSDL_TYPEMAP
	 * @uses SPListsWsdlClass::WSDL_URL
	 * @uses SPListsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPListsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPListsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPListsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPListsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPListsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPListsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPListsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPListsWsdlClass::offsetGet()
	 * @uses SPListsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPListsWsdlClass::getAttributeName()
	 * @uses SPListsWsdlClass::__toString()
	 * @uses SPListsWsdlClass::_set()
	 * @uses SPListsWsdlClass::_get()
	 * @uses SPListsWsdlClass::setInternArrayToIterate()
	 * @uses SPListsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPListsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPListsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPListsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
