<?php
/**
 * Class file for SPListsTypeGetListContentType
 * @date 07/07/2012
 */
/**
 * Class SPListsTypeGetListContentType
 * @date 07/07/2012
 */
class SPListsTypeGetListContentType extends SPListsWsdlClass
{
	/**
	 * The listName
	 * @var string
	 ...
	 * @return SPListsTypeGetListContentType
	 */
