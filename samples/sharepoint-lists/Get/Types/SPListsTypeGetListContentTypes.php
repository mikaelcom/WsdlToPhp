<?php
/**
 * Class file for SPListsTypeGetListContentTypes
 * @date 07/07/2012
 */
/**
 * Class SPListsTypeGetListContentTypes
 * @date 07/07/2012
 */
class SPListsTypeGetListContentTypes extends SPListsWsdlClass
{
	/**
	 * The listName
	 * @var string
	 ...
	 * @return SPListsTypeGetListContentTypes
	 */
