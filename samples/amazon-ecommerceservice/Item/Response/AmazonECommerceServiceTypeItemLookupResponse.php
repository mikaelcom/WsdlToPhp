<?php
/**
 * Class file for AmazonECommerceServiceTypeItemLookupResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeItemLookupResponse
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeItemLookupResponse extends AmazonECommerceServiceWsdlClass
{
	/**
