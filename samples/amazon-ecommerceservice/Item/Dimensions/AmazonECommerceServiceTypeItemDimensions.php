<?php
/**
 * Class file for AmazonECommerceServiceTypeItemDimensions
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeItemDimensions
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeItemDimensions extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The Height
	 * Meta informations :
