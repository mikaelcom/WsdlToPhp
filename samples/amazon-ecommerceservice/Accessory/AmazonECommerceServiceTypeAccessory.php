<?php
/**
 * Class file for AmazonECommerceServiceTypeAccessory
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeAccessory
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeAccessory extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The ASIN
	 * Meta informations :
