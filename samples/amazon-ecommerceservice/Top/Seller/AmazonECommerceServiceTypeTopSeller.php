<?php
/**
 * Class file for AmazonECommerceServiceTypeTopSeller
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeTopSeller
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeTopSeller extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The ASIN
	 * Meta informations :
