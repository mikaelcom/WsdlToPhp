<?php
/**
 * Class file for AmazonECommerceServiceTypeCollectionItem
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCollectionItem
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCollectionItem extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The ASIN
	 * Meta informations :
