<?php
/**
 * Class file for AmazonECommerceServiceTypeCollectionParent
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCollectionParent
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCollectionParent extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The ASIN
	 * Meta informations :
