<?php
/**
 * Class file for AmazonECommerceServiceTypeSimilarityLookup
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeSimilarityLookup
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeSimilarityLookup extends AmazonECommerceServiceWsdlClass
{
	/**
	 ...
	 * @param AmazonECommerceServiceTypeSimilarityLookupRequest Shared
	 * @param AmazonECommerceServiceTypeSimilarityLookupRequest Request
	 * @return AmazonECommerceServiceTypeSimilarityLookup
	 */
