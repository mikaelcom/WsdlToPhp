<?php
/**
 * Class file for AmazonECommerceServiceTypeNewRelease
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeNewRelease
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeNewRelease extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The ASIN
	 * Meta informations :
