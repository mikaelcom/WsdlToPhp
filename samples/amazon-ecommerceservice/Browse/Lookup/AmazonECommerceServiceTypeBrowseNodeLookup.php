<?php
/**
 * Class file for AmazonECommerceServiceTypeBrowseNodeLookup
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeBrowseNodeLookup
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeBrowseNodeLookup extends AmazonECommerceServiceWsdlClass
{
	/**
	 ...
	 * @param AmazonECommerceServiceTypeBrowseNodeLookupRequest Shared
	 * @param AmazonECommerceServiceTypeBrowseNodeLookupRequest Request
	 * @return AmazonECommerceServiceTypeBrowseNodeLookup
	 */
