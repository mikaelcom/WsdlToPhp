<?php
/**
 * File for AmazonECommerceServiceWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonECommerceServiceWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class AmazonECommerceServiceWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonECommerceServiceWsdlClass::setLastError()
	 * @uses AmazonECommerceServiceWsdlClass::initSoapClient()
	 * @uses AmazonECommerceServiceWsdlClass::initInternArrayToIterate()
	 * @uses AmazonECommerceServiceWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonECommerceServiceWsdlClass::classMap()
	 * @uses AmazonECommerceServiceWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonECommerceServiceClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonECommerceServiceClassMap::classMap();
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_COMPRESSION
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_ENCODING
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_EXCPTS
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_FEATURES
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_LOGIN
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_PASSWD
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_TRACE
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_TYPEMAP
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_URL
	 * @uses AmazonECommerceServiceWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses AmazonECommerceServiceWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonECommerceServiceWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonECommerceServiceWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonECommerceServiceWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonECommerceServiceWsdlClass::offsetGet()
	 * @uses AmazonECommerceServiceWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::getAttributeName()
	 * @uses AmazonECommerceServiceWsdlClass::__toString()
	 * @uses AmazonECommerceServiceWsdlClass::_set()
	 * @uses AmazonECommerceServiceWsdlClass::_get()
	 * @uses AmazonECommerceServiceWsdlClass::setInternArrayToIterate()
	 * @uses AmazonECommerceServiceWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonECommerceServiceWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::item()
	 * @uses AmazonECommerceServiceWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonECommerceServiceWsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonECommerceServiceWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
