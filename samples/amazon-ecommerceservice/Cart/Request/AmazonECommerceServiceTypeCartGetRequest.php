<?php
/**
 * Class file for AmazonECommerceServiceTypeCartGetRequest
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartGetRequest
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartGetRequest extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The CartId
	 * Meta informations :
