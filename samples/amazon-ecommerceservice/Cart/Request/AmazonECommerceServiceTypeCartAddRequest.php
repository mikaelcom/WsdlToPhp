<?php
/**
 * Class file for AmazonECommerceServiceTypeCartAddRequest
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartAddRequest
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartAddRequest extends AmazonECommerceServiceWsdlClass
{
	/**
	 * The CartId
	 * Meta informations :
