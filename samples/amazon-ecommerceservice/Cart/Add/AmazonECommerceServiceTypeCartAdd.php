<?php
/**
 * Class file for AmazonECommerceServiceTypeCartAdd
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartAdd
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartAdd extends AmazonECommerceServiceWsdlClass
{
	/**
	 ...
	 * @param AmazonECommerceServiceTypeCartAddRequest Shared
	 * @param AmazonECommerceServiceTypeCartAddRequest Request
	 * @return AmazonECommerceServiceTypeCartAdd
	 */
