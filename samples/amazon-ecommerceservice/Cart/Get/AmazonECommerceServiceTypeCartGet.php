<?php
/**
 * Class file for AmazonECommerceServiceTypeCartGet
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartGet
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartGet extends AmazonECommerceServiceWsdlClass
{
	/**
	 ...
	 * @param AmazonECommerceServiceTypeCartGetRequest Shared
	 * @param AmazonECommerceServiceTypeCartGetRequest Request
	 * @return AmazonECommerceServiceTypeCartGet
	 */
