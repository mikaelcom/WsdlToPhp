<?php
/**
 * Class file for AmazonECommerceServiceTypeCartModify
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartModify
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartModify extends AmazonECommerceServiceWsdlClass
{
	/**
	 ...
	 * @param AmazonECommerceServiceTypeCartModifyRequest Shared
	 * @param AmazonECommerceServiceTypeCartModifyRequest Request
	 * @return AmazonECommerceServiceTypeCartModify
	 */
