<?php
/**
 * Class file for AmazonECommerceServiceTypeCartModifyResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartModifyResponse
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartModifyResponse extends AmazonECommerceServiceWsdlClass
{
	/**
