<?php
/**
 * Class file for AmazonECommerceServiceTypeCartCreateResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartCreateResponse
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartCreateResponse extends AmazonECommerceServiceWsdlClass
{
	/**
