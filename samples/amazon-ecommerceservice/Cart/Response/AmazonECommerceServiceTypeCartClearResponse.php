<?php
/**
 * Class file for AmazonECommerceServiceTypeCartClearResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartClearResponse
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartClearResponse extends AmazonECommerceServiceWsdlClass
{
	/**
