<?php
/**
 * Class file for AmazonECommerceServiceTypeCartGetResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonECommerceServiceTypeCartGetResponse
 * @date 10/07/2012
 */
class AmazonECommerceServiceTypeCartGetResponse extends AmazonECommerceServiceWsdlClass
{
	/**
