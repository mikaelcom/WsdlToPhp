<?php
/**
 * File for XWeb1003WsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWeb1003WsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWeb1003WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWeb1003WsdlClass::setLastError()
	 * @uses XWeb1003WsdlClass::initSoapClient()
	 * @uses XWeb1003WsdlClass::initInternArrayToIterate()
	 * @uses XWeb1003WsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWeb1003WsdlClass::classMap()
	 * @uses XWeb1003WsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWeb1003ClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWeb1003ClassMap::classMap();
	 ...
	 * @uses XWeb1003WsdlClass::WSDL_CACHE_WSDL
	 * @uses XWeb1003WsdlClass::WSDL_COMPRESSION
	 * @uses XWeb1003WsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWeb1003WsdlClass::WSDL_ENCODING
	 * @uses XWeb1003WsdlClass::WSDL_EXCPTS
	 * @uses XWeb1003WsdlClass::WSDL_FEATURES
	 * @uses XWeb1003WsdlClass::WSDL_LOGIN
	 * @uses XWeb1003WsdlClass::WSDL_PASSWD
	 * @uses XWeb1003WsdlClass::WSDL_SOAP_VERSION
	 * @uses XWeb1003WsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWeb1003WsdlClass::WSDL_TRACE
	 * @uses XWeb1003WsdlClass::WSDL_TYPEMAP
	 * @uses XWeb1003WsdlClass::WSDL_URL
	 * @uses XWeb1003WsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XWeb1003WsdlClass::internArrayToIterateIsArray()
	 * @uses XWeb1003WsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWeb1003WsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWeb1003WsdlClass::getInternArrayToIterateOffset()
	 * @uses XWeb1003WsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWeb1003WsdlClass::getInternArrayToIterateOffset()
	 * @uses XWeb1003WsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWeb1003WsdlClass::offsetGet()
	 * @uses XWeb1003WsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWeb1003WsdlClass::getAttributeName()
	 * @uses XWeb1003WsdlClass::__toString()
	 * @uses XWeb1003WsdlClass::_set()
	 * @uses XWeb1003WsdlClass::_get()
	 * @uses XWeb1003WsdlClass::setInternArrayToIterate()
	 * @uses XWeb1003WsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWeb1003WsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWeb1003WsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWeb1003WsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
