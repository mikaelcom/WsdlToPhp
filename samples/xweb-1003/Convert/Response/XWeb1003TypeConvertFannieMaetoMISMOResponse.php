<?php
/**
 * Class file for XWeb1003TypeConvertFannieMaetoMISMOResponse
 * @date 09/07/2012
 */
/**
 * Class XWeb1003TypeConvertFannieMaetoMISMOResponse
 * @date 09/07/2012
 */
class XWeb1003TypeConvertFannieMaetoMISMOResponse extends XWeb1003WsdlClass
{
	/**
	 * The Application
	 * Meta informations :
