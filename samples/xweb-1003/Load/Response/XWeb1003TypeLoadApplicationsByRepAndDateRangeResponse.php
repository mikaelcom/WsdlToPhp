<?php
/**
 * Class file for XWeb1003TypeLoadApplicationsByRepAndDateRangeResponse
 * @date 09/07/2012
 */
/**
 * Class XWeb1003TypeLoadApplicationsByRepAndDateRangeResponse
 * @date 09/07/2012
 */
class XWeb1003TypeLoadApplicationsByRepAndDateRangeResponse extends XWeb1003WsdlClass
{
	/**
	 * The Application
	 * Meta informations :
