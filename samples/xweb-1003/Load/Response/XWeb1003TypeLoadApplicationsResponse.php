<?php
/**
 * Class file for XWeb1003TypeLoadApplicationsResponse
 * @date 09/07/2012
 */
/**
 * Class XWeb1003TypeLoadApplicationsResponse
 * @date 09/07/2012
 */
class XWeb1003TypeLoadApplicationsResponse extends XWeb1003WsdlClass
{
	/**
	 * The Application
	 * Meta informations :
