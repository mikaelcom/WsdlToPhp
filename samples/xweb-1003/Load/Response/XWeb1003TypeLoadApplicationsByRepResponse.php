<?php
/**
 * Class file for XWeb1003TypeLoadApplicationsByRepResponse
 * @date 09/07/2012
 */
/**
 * Class XWeb1003TypeLoadApplicationsByRepResponse
 * @date 09/07/2012
 */
class XWeb1003TypeLoadApplicationsByRepResponse extends XWeb1003WsdlClass
{
	/**
	 * The Application
	 * Meta informations :
