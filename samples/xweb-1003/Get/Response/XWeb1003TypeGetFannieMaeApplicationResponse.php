<?php
/**
 * Class file for XWeb1003TypeGetFannieMaeApplicationResponse
 * @date 09/07/2012
 */
/**
 * Class XWeb1003TypeGetFannieMaeApplicationResponse
 * @date 09/07/2012
 */
class XWeb1003TypeGetFannieMaeApplicationResponse extends XWeb1003WsdlClass
{
	/**
	 * The Application
	 * Meta informations :
