<?php
/**
 * Class file for XWeb1003TypeGetMISMOApplicationResponse
 * @date 09/07/2012
 */
/**
 * Class XWeb1003TypeGetMISMOApplicationResponse
 * @date 09/07/2012
 */
class XWeb1003TypeGetMISMOApplicationResponse extends XWeb1003WsdlClass
{
	/**
	 * The Application
	 * Meta informations :
