<?php
/**
 * Class file for XiTranscriptsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiTranscriptsTypeHeader
 * @date 08/07/2012
 */
class XiTranscriptsTypeHeader extends XiTranscriptsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiTranscriptsTypeHeader
	 */
