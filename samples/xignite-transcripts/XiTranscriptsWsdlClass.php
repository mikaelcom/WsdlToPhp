<?php
/**
 * File for XiTranscriptsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiTranscriptsWsdlClass to communicate with SOAP service
 * Documentation : This web service provides access to Seeking Alpha earning call transcript information.
 * @date 08/07/2012
 */
class XiTranscriptsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiTranscriptsWsdlClass::setLastError()
	 * @uses XiTranscriptsWsdlClass::initSoapClient()
	 * @uses XiTranscriptsWsdlClass::initInternArrayToIterate()
	 * @uses XiTranscriptsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiTranscriptsWsdlClass::classMap()
	 * @uses XiTranscriptsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiTranscriptsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiTranscriptsClassMap::classMap();
	 ...
	 * @uses XiTranscriptsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiTranscriptsWsdlClass::WSDL_COMPRESSION
	 * @uses XiTranscriptsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiTranscriptsWsdlClass::WSDL_ENCODING
	 * @uses XiTranscriptsWsdlClass::WSDL_EXCPTS
	 * @uses XiTranscriptsWsdlClass::WSDL_FEATURES
	 * @uses XiTranscriptsWsdlClass::WSDL_LOGIN
	 * @uses XiTranscriptsWsdlClass::WSDL_PASSWD
	 * @uses XiTranscriptsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiTranscriptsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiTranscriptsWsdlClass::WSDL_TRACE
	 * @uses XiTranscriptsWsdlClass::WSDL_TYPEMAP
	 * @uses XiTranscriptsWsdlClass::WSDL_URL
	 * @uses XiTranscriptsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiTranscriptsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiTranscriptsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiTranscriptsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiTranscriptsWsdlClass::offsetExists()
	 ...
	 * @uses XiTranscriptsWsdlClass::getAttributeName()
	 * @uses XiTranscriptsWsdlClass::__toString()
	 * @uses XiTranscriptsWsdlClass::_set()
	 * @uses XiTranscriptsWsdlClass::_get()
	 * @uses XiTranscriptsWsdlClass::setInternArrayToIterate()
	 * @uses XiTranscriptsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiTranscriptsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::item()
	 * @uses XiTranscriptsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiTranscriptsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiTranscriptsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
