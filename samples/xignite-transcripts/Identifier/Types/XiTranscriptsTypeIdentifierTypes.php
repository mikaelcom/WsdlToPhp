<?php
/**
 * Class file for XiTranscriptsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiTranscriptsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiTranscriptsTypeIdentifierTypes extends XiTranscriptsWsdlClass
{
	/**
