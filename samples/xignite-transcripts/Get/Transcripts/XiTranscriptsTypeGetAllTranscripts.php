<?php
/**
 * Class file for XiTranscriptsTypeGetAllTranscripts
 * @date 08/07/2012
 */
/**
 * Class XiTranscriptsTypeGetAllTranscripts
 * @date 08/07/2012
 */
class XiTranscriptsTypeGetAllTranscripts extends XiTranscriptsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiTranscriptsTypeGetAllTranscripts
	 */
