<?php
/**
 * Class file for XiTranscriptsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiTranscriptsTypeSecurity
 * @date 08/07/2012
 */
class XiTranscriptsTypeSecurity extends XiTranscriptsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiTranscriptsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
