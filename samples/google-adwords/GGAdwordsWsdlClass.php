<?php
/**
 * File for GGAdwordsWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for GGAdwordsWsdlClass to communicate with SOAP service
 * Documentation : Use this service to manage campaigns. A {@linkplain Campaign campaign} organizes one or more ad groups together and has its own budget, bidding strategy, serving date range, and targeting settings (managed using <a href="CampaignTargetService.html">CampaignTargetService</a>). You can also set up campaign-wide negative criteria (using <a href="CampaignCriterionService.html">CampaignCriterionService</a>) and campaign-wide ad extensions (using <a href="CampaignAdExtensionService.html">CampaignAdExtensionService</a>).
 * @date 03/07/2012
 */
class GGAdwordsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses GGAdwordsWsdlClass::setLastError()
	 * @uses GGAdwordsWsdlClass::initSoapClient()
	 * @uses GGAdwordsWsdlClass::initInternArrayToIterate()
	 * @uses GGAdwordsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses GGAdwordsWsdlClass::classMap()
	 * @uses GGAdwordsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('GGAdwordsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = GGAdwordsClassMap::classMap();
	 ...
	 * @uses GGAdwordsWsdlClass::WSDL_CACHE_WSDL
	 * @uses GGAdwordsWsdlClass::WSDL_COMPRESSION
	 * @uses GGAdwordsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses GGAdwordsWsdlClass::WSDL_ENCODING
	 * @uses GGAdwordsWsdlClass::WSDL_EXCPTS
	 * @uses GGAdwordsWsdlClass::WSDL_FEATURES
	 * @uses GGAdwordsWsdlClass::WSDL_LOGIN
	 * @uses GGAdwordsWsdlClass::WSDL_PASSWD
	 * @uses GGAdwordsWsdlClass::WSDL_SOAP_VERSION
	 * @uses GGAdwordsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses GGAdwordsWsdlClass::WSDL_TRACE
	 * @uses GGAdwordsWsdlClass::WSDL_TYPEMAP
	 * @uses GGAdwordsWsdlClass::WSDL_URL
	 * @uses GGAdwordsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::internArrayToIterateIsArray()
	 * @uses GGAdwordsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::getInternArrayToIterateOffset()
	 * @uses GGAdwordsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::getInternArrayToIterateOffset()
	 * @uses GGAdwordsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see GGAdwordsWsdlClass::offsetGet()
	 * @uses GGAdwordsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::getAttributeName()
	 * @uses GGAdwordsWsdlClass::__toString()
	 * @uses GGAdwordsWsdlClass::_set()
	 * @uses GGAdwordsWsdlClass::_get()
	 * @uses GGAdwordsWsdlClass::setInternArrayToIterate()
	 * @uses GGAdwordsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses GGAdwordsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::item()
	 * @uses GGAdwordsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses GGAdwordsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses GGAdwordsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
