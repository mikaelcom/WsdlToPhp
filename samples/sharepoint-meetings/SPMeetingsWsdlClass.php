<?php
/**
 * File for SPMeetingsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPMeetingsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPMeetingsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPMeetingsWsdlClass::setLastError()
	 * @uses SPMeetingsWsdlClass::initSoapClient()
	 * @uses SPMeetingsWsdlClass::initInternArrayToIterate()
	 * @uses SPMeetingsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPMeetingsWsdlClass::classMap()
	 * @uses SPMeetingsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPMeetingsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPMeetingsClassMap::classMap();
	 ...
	 * @uses SPMeetingsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPMeetingsWsdlClass::WSDL_COMPRESSION
	 * @uses SPMeetingsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPMeetingsWsdlClass::WSDL_ENCODING
	 * @uses SPMeetingsWsdlClass::WSDL_EXCPTS
	 * @uses SPMeetingsWsdlClass::WSDL_FEATURES
	 * @uses SPMeetingsWsdlClass::WSDL_LOGIN
	 * @uses SPMeetingsWsdlClass::WSDL_PASSWD
	 * @uses SPMeetingsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPMeetingsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPMeetingsWsdlClass::WSDL_TRACE
	 * @uses SPMeetingsWsdlClass::WSDL_TYPEMAP
	 * @uses SPMeetingsWsdlClass::WSDL_URL
	 * @uses SPMeetingsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPMeetingsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPMeetingsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPMeetingsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPMeetingsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPMeetingsWsdlClass::offsetGet()
	 * @uses SPMeetingsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::getAttributeName()
	 * @uses SPMeetingsWsdlClass::__toString()
	 * @uses SPMeetingsWsdlClass::_set()
	 * @uses SPMeetingsWsdlClass::_get()
	 * @uses SPMeetingsWsdlClass::setInternArrayToIterate()
	 * @uses SPMeetingsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPMeetingsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::item()
	 * @uses SPMeetingsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPMeetingsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPMeetingsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
