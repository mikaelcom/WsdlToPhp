<?php
/**
 * Class file for SPMeetingsTypeAddMeeting
 * @date 06/07/2012
 */
/**
 * Class SPMeetingsTypeAddMeeting
 * @date 06/07/2012
 */
class SPMeetingsTypeAddMeeting extends SPMeetingsWsdlClass
{
	/**
	 * The organizerEmail
	 * @var string
	 ...
	 * @return SPMeetingsTypeAddMeeting
	 */
	public function __construct($_organizerEmail = null,$_uid = null,$_sequence = null,$_utcDateStamp = null,$_title = null,$_location = null,$_utcDateStart = null,$_utcDateEnd = null,$_nonGregorian = null)
	{
		parent::__construct(array('organizerEmail'=>$_organizerEmail,'uid'=>$_uid,'sequence'=>$_sequence,'utcDateStamp'=>$_utcDateStamp,'title'=>$_title,'location'=>$_location,'utcDateStart'=>$_utcDateStart,'utcDateEnd'=>$_utcDateEnd,'nonGregorian'=>$_nonGregorian));
	}
	/**
	 * Set organizerEmail
	 * @param string organizerEmail
