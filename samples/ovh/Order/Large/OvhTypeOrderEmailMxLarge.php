<?php
/**
 * Class file for OvhTypeOrderEmailMxLarge
 * @date 02/07/2012
 */
/**
 * Class OvhTypeOrderEmailMxLarge
 * @date 02/07/2012
 */
class OvhTypeOrderEmailMxLarge extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeOrderEmailMxLarge
	 */
