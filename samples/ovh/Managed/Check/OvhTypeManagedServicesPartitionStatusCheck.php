<?php
/**
 * Class file for OvhTypeManagedServicesPartitionStatusCheck
 * @date 02/07/2012
 */
/**
 * Class OvhTypeManagedServicesPartitionStatusCheck
 * @date 02/07/2012
 */
class OvhTypeManagedServicesPartitionStatusCheck extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeManagedServicesPartitionStatusCheck
	 */
