<?php
/**
 * Class file for OvhTypeMailingListModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeMailingListModify
 * @date 02/07/2012
 */
class OvhTypeMailingListModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeMailingListModify
	 */
