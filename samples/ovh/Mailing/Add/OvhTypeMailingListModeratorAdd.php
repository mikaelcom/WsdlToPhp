<?php
/**
 * Class file for OvhTypeMailingListModeratorAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeMailingListModeratorAdd
 * @date 02/07/2012
 */
class OvhTypeMailingListModeratorAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string ml
	 * @param string email
	 * @return OvhTypeMailingListModeratorAdd
	 */
