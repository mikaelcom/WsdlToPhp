<?php
/**
 * Class file for OvhTypeMailingListModeratorListResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeMailingListModeratorListResponse
 * @date 02/07/2012
 */
class OvhTypeMailingListModeratorListResponse extends OvhWsdlClass
{
	/**
	 * The return
