<?php
/**
 * Class file for OvhTypeMailingListModeratorDel
 * @date 02/07/2012
 */
/**
 * Class OvhTypeMailingListModeratorDel
 * @date 02/07/2012
 */
class OvhTypeMailingListModeratorDel extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string ml
	 * @param string email
	 * @return OvhTypeMailingListModeratorDel
	 */
