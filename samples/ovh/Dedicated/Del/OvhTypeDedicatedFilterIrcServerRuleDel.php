<?php
/**
 * Class file for OvhTypeDedicatedFilterIrcServerRuleDel
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedFilterIrcServerRuleDel
 * @date 02/07/2012
 */
class OvhTypeDedicatedFilterIrcServerRuleDel extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string toIp
	 * @return OvhTypeDedicatedFilterIrcServerRuleDel
	 */
