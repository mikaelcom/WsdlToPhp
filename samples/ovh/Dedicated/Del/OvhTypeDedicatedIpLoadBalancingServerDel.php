<?php
/**
 * Class file for OvhTypeDedicatedIpLoadBalancingServerDel
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedIpLoadBalancingServerDel
 * @date 02/07/2012
 */
class OvhTypeDedicatedIpLoadBalancingServerDel extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedIpLoadBalancingServerDel
	 */
