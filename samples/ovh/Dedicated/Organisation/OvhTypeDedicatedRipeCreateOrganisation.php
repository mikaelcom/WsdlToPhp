<?php
/**
 * Class file for OvhTypeDedicatedRipeCreateOrganisation
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedRipeCreateOrganisation
 * @date 02/07/2012
 */
class OvhTypeDedicatedRipeCreateOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedRipeCreateOrganisation
	 */
