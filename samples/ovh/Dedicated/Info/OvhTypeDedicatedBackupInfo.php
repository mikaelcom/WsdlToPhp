<?php
/**
 * Class file for OvhTypeDedicatedBackupInfo
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupInfo
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedBackupInfo
	 */
