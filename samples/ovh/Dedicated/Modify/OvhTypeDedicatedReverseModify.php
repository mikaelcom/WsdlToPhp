<?php
/**
 * Class file for OvhTypeDedicatedReverseModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedReverseModify
 * @date 02/07/2012
 */
class OvhTypeDedicatedReverseModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedReverseModify
	 */
