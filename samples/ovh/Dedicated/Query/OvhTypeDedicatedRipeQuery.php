<?php
/**
 * Class file for OvhTypeDedicatedRipeQuery
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedRipeQuery
 * @date 02/07/2012
 */
class OvhTypeDedicatedRipeQuery extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string search
	 * @param string type
	 * @return OvhTypeDedicatedRipeQuery
	 */
