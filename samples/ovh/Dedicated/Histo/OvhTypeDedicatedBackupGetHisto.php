<?php
/**
 * Class file for OvhTypeDedicatedBackupGetHisto
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupGetHisto
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupGetHisto extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedBackupGetHisto
	 */
