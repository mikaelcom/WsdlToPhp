<?php
/**
 * Class file for OvhTypeDedicatedBackupSet
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupSet
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupSet extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string src
	 * @return OvhTypeDedicatedBackupSet
	 */
