<?php
/**
 * Class file for OvhTypeDedicatedMailinglistGetAllowedResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedMailinglistGetAllowedResponse
 * @date 02/07/2012
 */
class OvhTypeDedicatedMailinglistGetAllowedResponse extends OvhWsdlClass
{
	/**
	 * The return
