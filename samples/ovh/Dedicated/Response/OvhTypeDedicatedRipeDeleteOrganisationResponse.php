<?php
/**
 * Class file for OvhTypeDedicatedRipeDeleteOrganisationResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedRipeDeleteOrganisationResponse
 * @date 02/07/2012
 */
class OvhTypeDedicatedRipeDeleteOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
