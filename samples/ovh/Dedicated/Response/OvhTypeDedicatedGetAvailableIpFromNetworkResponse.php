<?php
/**
 * Class file for OvhTypeDedicatedGetAvailableIpFromNetworkResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedGetAvailableIpFromNetworkResponse
 * @date 02/07/2012
 */
class OvhTypeDedicatedGetAvailableIpFromNetworkResponse extends OvhWsdlClass
{
	/**
	 * The return
