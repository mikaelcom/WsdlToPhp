<?php
/**
 * Class file for OvhTypeDedicatedBackupGetCalendarResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupGetCalendarResponse
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupGetCalendarResponse extends OvhWsdlClass
{
	/**
	 * The return
