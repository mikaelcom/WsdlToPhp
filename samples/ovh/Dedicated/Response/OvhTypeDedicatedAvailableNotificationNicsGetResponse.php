<?php
/**
 * Class file for OvhTypeDedicatedAvailableNotificationNicsGetResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedAvailableNotificationNicsGetResponse
 * @date 02/07/2012
 */
class OvhTypeDedicatedAvailableNotificationNicsGetResponse extends OvhWsdlClass
{
	/**
	 * The return
