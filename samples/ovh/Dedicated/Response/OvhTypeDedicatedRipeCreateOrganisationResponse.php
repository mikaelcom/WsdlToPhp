<?php
/**
 * Class file for OvhTypeDedicatedRipeCreateOrganisationResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedRipeCreateOrganisationResponse
 * @date 02/07/2012
 */
class OvhTypeDedicatedRipeCreateOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
