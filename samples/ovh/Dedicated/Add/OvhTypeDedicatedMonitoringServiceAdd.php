<?php
/**
 * Class file for OvhTypeDedicatedMonitoringServiceAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedMonitoringServiceAdd
 * @date 02/07/2012
 */
class OvhTypeDedicatedMonitoringServiceAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string url
	 * @param string email
	 * @return OvhTypeDedicatedMonitoringServiceAdd
	 */
