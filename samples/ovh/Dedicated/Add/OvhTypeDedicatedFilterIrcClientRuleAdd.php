<?php
/**
 * Class file for OvhTypeDedicatedFilterIrcClientRuleAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedFilterIrcClientRuleAdd
 * @date 02/07/2012
 */
class OvhTypeDedicatedFilterIrcClientRuleAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string fromIp
	 * @param string toIp
	 * @return OvhTypeDedicatedFilterIrcClientRuleAdd
	 */
