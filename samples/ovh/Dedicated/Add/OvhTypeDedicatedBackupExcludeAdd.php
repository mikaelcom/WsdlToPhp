<?php
/**
 * Class file for OvhTypeDedicatedBackupExcludeAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupExcludeAdd
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupExcludeAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedBackupExcludeAdd
	 */
