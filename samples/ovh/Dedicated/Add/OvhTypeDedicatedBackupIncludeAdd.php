<?php
/**
 * Class file for OvhTypeDedicatedBackupIncludeAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupIncludeAdd
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupIncludeAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedBackupIncludeAdd
	 */
