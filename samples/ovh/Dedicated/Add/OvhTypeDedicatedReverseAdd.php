<?php
/**
 * Class file for OvhTypeDedicatedReverseAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedReverseAdd
 * @date 02/07/2012
 */
class OvhTypeDedicatedReverseAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedReverseAdd
	 */
