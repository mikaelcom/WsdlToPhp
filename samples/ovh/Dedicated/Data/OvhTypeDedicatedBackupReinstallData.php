<?php
/**
 * Class file for OvhTypeDedicatedBackupReinstallData
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedBackupReinstallData
 * @date 02/07/2012
 */
class OvhTypeDedicatedBackupReinstallData extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeDedicatedBackupReinstallData
	 */
