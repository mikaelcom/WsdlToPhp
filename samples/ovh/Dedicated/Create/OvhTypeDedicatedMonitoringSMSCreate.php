<?php
/**
 * Class file for OvhTypeDedicatedMonitoringSMSCreate
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDedicatedMonitoringSMSCreate
 * @date 02/07/2012
 */
class OvhTypeDedicatedMonitoringSMSCreate extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string status
	 * @return OvhTypeDedicatedMonitoringSMSCreate
	 */
