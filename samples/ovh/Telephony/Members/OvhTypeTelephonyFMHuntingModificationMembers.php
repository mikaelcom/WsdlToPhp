<?php
/**
 * Class file for OvhTypeTelephonyFMHuntingModificationMembers
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyFMHuntingModificationMembers
 * @date 02/07/2012
 */
class OvhTypeTelephonyFMHuntingModificationMembers extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyFMHuntingModificationMembers
	 */
