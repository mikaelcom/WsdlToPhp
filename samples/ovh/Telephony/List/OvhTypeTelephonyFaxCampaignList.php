<?php
/**
 * Class file for OvhTypeTelephonyFaxCampaignList
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyFaxCampaignList
 * @date 02/07/2012
 */
class OvhTypeTelephonyFaxCampaignList extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyFaxCampaignList
	 */
