<?php
/**
 * Class file for OvhTypeTelephonyVoicemailMailboxList
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyVoicemailMailboxList
 * @date 02/07/2012
 */
class OvhTypeTelephonyVoicemailMailboxList extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyVoicemailMailboxList
	 */
