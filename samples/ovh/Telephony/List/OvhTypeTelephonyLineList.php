<?php
/**
 * Class file for OvhTypeTelephonyLineList
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyLineList
 * @date 02/07/2012
 */
class OvhTypeTelephonyLineList extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyLineList
	 */
