<?php
/**
 * Class file for OvhTypeTelephonyBillList
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyBillList
 * @date 02/07/2012
 */
class OvhTypeTelephonyBillList extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string date
	 * @return OvhTypeTelephonyBillList
	 */
