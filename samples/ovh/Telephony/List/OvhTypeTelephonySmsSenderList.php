<?php
/**
 * Class file for OvhTypeTelephonySmsSenderList
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsSenderList
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsSenderList extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonySmsSenderList
	 */
