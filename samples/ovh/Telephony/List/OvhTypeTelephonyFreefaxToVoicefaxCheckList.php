<?php
/**
 * Class file for OvhTypeTelephonyFreefaxToVoicefaxCheckList
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyFreefaxToVoicefaxCheckList
 * @date 02/07/2012
 */
class OvhTypeTelephonyFreefaxToVoicefaxCheckList extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyFreefaxToVoicefaxCheckList
	 */
