<?php
/**
 * Class file for OvhTypeTelephonyPortabilityOrder
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyPortabilityOrder
 * @date 02/07/2012
 */
class OvhTypeTelephonyPortabilityOrder extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
