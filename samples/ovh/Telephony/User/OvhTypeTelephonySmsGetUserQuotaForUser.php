<?php
/**
 * Class file for OvhTypeTelephonySmsGetUserQuotaForUser
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsGetUserQuotaForUser
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsGetUserQuotaForUser extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * @var string
	 ...
	 * @return OvhTypeTelephonySmsGetUserQuotaForUser
	 */
