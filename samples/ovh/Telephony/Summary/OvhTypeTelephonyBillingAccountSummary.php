<?php
/**
 * Class file for OvhTypeTelephonyBillingAccountSummary
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyBillingAccountSummary
 * @date 02/07/2012
 */
class OvhTypeTelephonyBillingAccountSummary extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyBillingAccountSummary
	 */
