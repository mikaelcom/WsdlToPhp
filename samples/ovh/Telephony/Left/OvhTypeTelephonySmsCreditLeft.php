<?php
/**
 * Class file for OvhTypeTelephonySmsCreditLeft
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsCreditLeft
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsCreditLeft extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonySmsCreditLeft
	 */
