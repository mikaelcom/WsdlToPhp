<?php
/**
 * Class file for OvhTypeTelephonySmsUserCreditLeft
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsUserCreditLeft
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsUserCreditLeft extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * @var string
	 ...
	 * @return OvhTypeTelephonySmsUserCreditLeft
	 */
