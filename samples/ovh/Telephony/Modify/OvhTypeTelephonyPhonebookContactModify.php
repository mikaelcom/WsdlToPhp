<?php
/**
 * Class file for OvhTypeTelephonyPhonebookContactModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyPhonebookContactModify
 * @date 02/07/2012
 */
class OvhTypeTelephonyPhonebookContactModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string group
	 * @return OvhTypeTelephonyPhonebookContactModify
	 */
