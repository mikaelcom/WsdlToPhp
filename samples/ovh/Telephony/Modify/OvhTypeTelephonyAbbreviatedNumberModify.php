<?php
/**
 * Class file for OvhTypeTelephonyAbbreviatedNumberModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyAbbreviatedNumberModify
 * @date 02/07/2012
 */
class OvhTypeTelephonyAbbreviatedNumberModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyAbbreviatedNumberModify
	 */
