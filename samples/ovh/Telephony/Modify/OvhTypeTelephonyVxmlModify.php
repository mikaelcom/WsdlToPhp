<?php
/**
 * Class file for OvhTypeTelephonyVxmlModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyVxmlModify
 * @date 02/07/2012
 */
class OvhTypeTelephonyVxmlModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string url
	 * @return OvhTypeTelephonyVxmlModify
	 */
