<?php
/**
 * Class file for OvhTypeTelephonyAbbreviatedNumberOnGroupModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyAbbreviatedNumberOnGroupModify
 * @date 02/07/2012
 */
class OvhTypeTelephonyAbbreviatedNumberOnGroupModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyAbbreviatedNumberOnGroupModify
	 */
