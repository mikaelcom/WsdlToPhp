<?php
/**
 * Class file for OvhTypeTelephonyBillingAccountInfo
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyBillingAccountInfo
 * @date 02/07/2012
 */
class OvhTypeTelephonyBillingAccountInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyBillingAccountInfo
	 */
