<?php
/**
 * Class file for OvhTypeTelephonySecurityDepositInfo
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySecurityDepositInfo
 * @date 02/07/2012
 */
class OvhTypeTelephonySecurityDepositInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonySecurityDepositInfo
	 */
