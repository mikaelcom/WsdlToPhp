<?php
/**
 * Class file for OvhTypeTelephonyHuntingModificationAnonymousCallRejection
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyHuntingModificationAnonymousCallRejection
 * @date 02/07/2012
 */
class OvhTypeTelephonyHuntingModificationAnonymousCallRejection extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyHuntingModificationAnonymousCallRejection
	 */
