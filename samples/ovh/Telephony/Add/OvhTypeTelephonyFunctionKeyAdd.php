<?php
/**
 * Class file for OvhTypeTelephonyFunctionKeyAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyFunctionKeyAdd
 * @date 02/07/2012
 */
class OvhTypeTelephonyFunctionKeyAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyFunctionKeyAdd
	 */
