<?php
/**
 * Class file for OvhTypeTelephonyPhonebookOnGroupContactAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyPhonebookOnGroupContactAdd
 * @date 02/07/2012
 */
class OvhTypeTelephonyPhonebookOnGroupContactAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyPhonebookOnGroupContactAdd
	 */
