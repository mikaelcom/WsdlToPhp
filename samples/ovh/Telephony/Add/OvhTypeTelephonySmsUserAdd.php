<?php
/**
 * Class file for OvhTypeTelephonySmsUserAdd
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsUserAdd
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsUserAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonySmsUserAdd
	 */
