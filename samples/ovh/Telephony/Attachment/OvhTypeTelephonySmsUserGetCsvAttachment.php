<?php
/**
 * Class file for OvhTypeTelephonySmsUserGetCsvAttachment
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsUserGetCsvAttachment
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsUserGetCsvAttachment extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * @var string
	 ...
	 * @param string id
	 * @return OvhTypeTelephonySmsUserGetCsvAttachment
	 */
