<?php
/**
 * Class file for OvhTypeTelephonyClick2CallUserPassword
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyClick2CallUserPassword
 * @date 02/07/2012
 */
class OvhTypeTelephonyClick2CallUserPassword extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyClick2CallUserPassword
	 */
