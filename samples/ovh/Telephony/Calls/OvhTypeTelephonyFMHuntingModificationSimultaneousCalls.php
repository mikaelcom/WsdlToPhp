<?php
/**
 * Class file for OvhTypeTelephonyFMHuntingModificationSimultaneousCalls
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyFMHuntingModificationSimultaneousCalls
 * @date 02/07/2012
 */
class OvhTypeTelephonyFMHuntingModificationSimultaneousCalls extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyFMHuntingModificationSimultaneousCalls
	 */
