<?php
/**
 * Class file for OvhTypeTelephonySmsUserMultiSend
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsUserMultiSend
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsUserMultiSend extends OvhWsdlClass
{
	/**
	 * The login
	 * @var string
	 ...
	 * @param OvhTypeMyArrayOfStringType numberTo
	 ...
	 * @return OvhTypeTelephonySmsUserMultiSend
	 */
	public function __construct($_login = null,$_password = null,$_smsAccount = null,$_numberFrom = null,$_numberTo = null,$_message = null,$_smsValidity = null,$_smsClass = null,$_smsDeferred = null,$_smsPriority = null,$_smsCoding = null,$_tag = null,$_numberToCsv = null)
	{
		parent::__construct(array('login'=>$_login,'password'=>$_password,'smsAccount'=>$_smsAccount,'numberFrom'=>$_numberFrom,'numberTo'=>new OvhTypeMyArrayOfStringType($_numberTo),'message'=>$_message,'smsValidity'=>$_smsValidity,'smsClass'=>$_smsClass,'smsDeferred'=>$_smsDeferred,'smsPriority'=>$_smsPriority,'smsCoding'=>$_smsCoding,'tag'=>$_tag,'numberToCsv'=>$_numberToCsv));
	}
	/**
	 * Set login
	 * @param string login
	...
	/**
	 * Set numberTo
	 * @param MyArrayOfStringType numberTo
