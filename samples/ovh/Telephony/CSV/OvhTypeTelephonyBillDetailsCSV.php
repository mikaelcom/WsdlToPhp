<?php
/**
 * Class file for OvhTypeTelephonyBillDetailsCSV
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyBillDetailsCSV
 * @date 02/07/2012
 */
class OvhTypeTelephonyBillDetailsCSV extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string date
	 * @return OvhTypeTelephonyBillDetailsCSV
	 */
