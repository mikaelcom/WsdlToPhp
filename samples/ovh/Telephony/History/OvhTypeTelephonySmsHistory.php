<?php
/**
 * Class file for OvhTypeTelephonySmsHistory
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsHistory
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsHistory extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string tag
	 * @return OvhTypeTelephonySmsHistory
	 */
