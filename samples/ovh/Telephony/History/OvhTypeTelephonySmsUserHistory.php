<?php
/**
 * Class file for OvhTypeTelephonySmsUserHistory
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsUserHistory
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsUserHistory extends OvhWsdlClass
{
	/**
	 * The login
	 * @var string
	 ...
	 * @param string tag
	 * @return OvhTypeTelephonySmsUserHistory
	 */
