<?php
/**
 * Class file for OvhTypeTelephonyReversmentsRefundIsPending
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyReversmentsRefundIsPending
 * @date 02/07/2012
 */
class OvhTypeTelephonyReversmentsRefundIsPending extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyReversmentsRefundIsPending
	 */
