<?php
/**
 * Class file for OvhTypeTelephonySmsGetQuotaNotification
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsGetQuotaNotification
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsGetQuotaNotification extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string login
	 * @return OvhTypeTelephonySmsGetQuotaNotification
	 */
