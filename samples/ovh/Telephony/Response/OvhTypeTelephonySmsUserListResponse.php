<?php
/**
 * Class file for OvhTypeTelephonySmsUserListResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsUserListResponse
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsUserListResponse extends OvhWsdlClass
{
	/**
	 * The return
