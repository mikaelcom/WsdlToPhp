<?php
/**
 * Class file for OvhTypeTelephonySmsAccountListResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsAccountListResponse
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsAccountListResponse extends OvhWsdlClass
{
	/**
	 * The return
