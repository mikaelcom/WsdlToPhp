<?php
/**
 * Class file for OvhTypeTelephonySmsHistoryResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonySmsHistoryResponse
 * @date 02/07/2012
 */
class OvhTypeTelephonySmsHistoryResponse extends OvhWsdlClass
{
	/**
	 * The return
