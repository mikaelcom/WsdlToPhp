<?php
/**
 * Class file for OvhTypeTelephonyRestrictionListResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyRestrictionListResponse
 * @date 02/07/2012
 */
class OvhTypeTelephonyRestrictionListResponse extends OvhWsdlClass
{
	/**
	 * The return
