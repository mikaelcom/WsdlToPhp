<?php
/**
 * Class file for OvhTypeTelephonyHuntingGroupListResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyHuntingGroupListResponse
 * @date 02/07/2012
 */
class OvhTypeTelephonyHuntingGroupListResponse extends OvhWsdlClass
{
	/**
	 * The return
