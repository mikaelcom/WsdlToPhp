<?php
/**
 * Class file for OvhTypeTelephonyClick2CallUserListResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyClick2CallUserListResponse
 * @date 02/07/2012
 */
class OvhTypeTelephonyClick2CallUserListResponse extends OvhWsdlClass
{
	/**
	 * The return
