<?php
/**
 * Class file for OvhTypeTelephonyVoicemailOptionsListReturn
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyVoicemailOptionsListReturn
 * @date 02/07/2012
 */
class OvhTypeTelephonyVoicemailOptionsListReturn extends OvhWsdlClass
{
	/**
	 * The redirection1
	 * @var string
