<?php
/**
 * Class file for OvhTypeTelephonyVoicemailMessagesDownloadReturn
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyVoicemailMessagesDownloadReturn
 * @date 02/07/2012
 */
class OvhTypeTelephonyVoicemailMessagesDownloadReturn extends OvhWsdlClass
{
	/**
	 * The fileName
	 * @var string
