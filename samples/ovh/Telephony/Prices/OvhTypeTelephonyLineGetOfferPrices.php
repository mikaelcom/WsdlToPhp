<?php
/**
 * Class file for OvhTypeTelephonyLineGetOfferPrices
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyLineGetOfferPrices
 * @date 02/07/2012
 */
class OvhTypeTelephonyLineGetOfferPrices extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyLineGetOfferPrices
	 */
