<?php
/**
 * Class file for OvhTypeTelephonyFMHuntingModificationMode
 * @date 02/07/2012
 */
/**
 * Class OvhTypeTelephonyFMHuntingModificationMode
 * @date 02/07/2012
 */
class OvhTypeTelephonyFMHuntingModificationMode extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeTelephonyFMHuntingModificationMode
	 */
