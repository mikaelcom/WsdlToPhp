<?php
/**
 * Class file for OvhTypeEmailDomainListByMasterNicResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeEmailDomainListByMasterNicResponse
 * @date 02/07/2012
 */
class OvhTypeEmailDomainListByMasterNicResponse extends OvhWsdlClass
{
	/**
	 * The return
