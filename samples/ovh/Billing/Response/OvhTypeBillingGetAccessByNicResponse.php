<?php
/**
 * Class file for OvhTypeBillingGetAccessByNicResponse
 * @date 02/07/2012
 */
/**
 * Class OvhTypeBillingGetAccessByNicResponse
 * @date 02/07/2012
 */
class OvhTypeBillingGetAccessByNicResponse extends OvhWsdlClass
{
	/**
	 * The return
