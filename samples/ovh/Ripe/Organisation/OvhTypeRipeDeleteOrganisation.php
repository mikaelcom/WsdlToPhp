<?php
/**
 * Class file for OvhTypeRipeDeleteOrganisation
 * @date 02/07/2012
 */
/**
 * Class OvhTypeRipeDeleteOrganisation
 * @date 02/07/2012
 */
class OvhTypeRipeDeleteOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeRipeDeleteOrganisation
	 */
