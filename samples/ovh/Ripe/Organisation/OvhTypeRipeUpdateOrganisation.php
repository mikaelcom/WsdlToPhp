<?php
/**
 * Class file for OvhTypeRipeUpdateOrganisation
 * @date 02/07/2012
 */
/**
 * Class OvhTypeRipeUpdateOrganisation
 * @date 02/07/2012
 */
class OvhTypeRipeUpdateOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeRipeUpdateOrganisation
	 */
