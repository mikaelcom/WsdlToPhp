<?php
/**
 * Class file for OvhTypeRipeCreateOrganisation
 * @date 02/07/2012
 */
/**
 * Class OvhTypeRipeCreateOrganisation
 * @date 02/07/2012
 */
class OvhTypeRipeCreateOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeRipeCreateOrganisation
	 */
