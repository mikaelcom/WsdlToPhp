<?php
/**
 * Class file for OvhTypeRipeUpdateInetnum
 * @date 02/07/2012
 */
/**
 * Class OvhTypeRipeUpdateInetnum
 * @date 02/07/2012
 */
class OvhTypeRipeUpdateInetnum extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string descr
	 * @param string ripeId
	 * @return OvhTypeRipeUpdateInetnum
	 */
