<?php
/**
 * Class file for OvhTypeResponderEmailModify
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResponderEmailModify
 * @date 02/07/2012
 */
class OvhTypeResponderEmailModify extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string nic
	 * @return OvhTypeResponderEmailModify
	 */
