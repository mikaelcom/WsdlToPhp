<?php
/**
 * Class file for OvhTypeResponderEmailInfo
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResponderEmailInfo
 * @date 02/07/2012
 */
class OvhTypeResponderEmailInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeResponderEmailInfo
	 */
