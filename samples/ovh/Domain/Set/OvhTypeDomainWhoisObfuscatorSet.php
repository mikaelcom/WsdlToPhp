<?php
/**
 * Class file for OvhTypeDomainWhoisObfuscatorSet
 * @date 02/07/2012
 */
/**
 * Class OvhTypeDomainWhoisObfuscatorSet
 * @date 02/07/2012
 */
class OvhTypeDomainWhoisObfuscatorSet extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string domain
	 * @param string field
	 * @return OvhTypeDomainWhoisObfuscatorSet
	 */
