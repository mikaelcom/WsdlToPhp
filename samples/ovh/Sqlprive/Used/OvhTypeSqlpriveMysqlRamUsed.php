<?php
/**
 * Class file for OvhTypeSqlpriveMysqlRamUsed
 * @date 02/07/2012
 */
/**
 * Class OvhTypeSqlpriveMysqlRamUsed
 * @date 02/07/2012
 */
class OvhTypeSqlpriveMysqlRamUsed extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string server
	 * @return OvhTypeSqlpriveMysqlRamUsed
	 */
