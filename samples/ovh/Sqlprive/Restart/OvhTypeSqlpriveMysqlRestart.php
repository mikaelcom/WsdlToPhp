<?php
/**
 * Class file for OvhTypeSqlpriveMysqlRestart
 * @date 02/07/2012
 */
/**
 * Class OvhTypeSqlpriveMysqlRestart
 * @date 02/07/2012
 */
class OvhTypeSqlpriveMysqlRestart extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string server
	 * @return OvhTypeSqlpriveMysqlRestart
	 */
