<?php
/**
 * Class file for OvhTypeSqlpriveAlertInfo
 * @date 02/07/2012
 */
/**
 * Class OvhTypeSqlpriveAlertInfo
 * @date 02/07/2012
 */
class OvhTypeSqlpriveAlertInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string server
	 * @return OvhTypeSqlpriveAlertInfo
	 */
