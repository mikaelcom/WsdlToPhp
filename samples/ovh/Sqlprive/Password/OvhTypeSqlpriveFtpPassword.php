<?php
/**
 * Class file for OvhTypeSqlpriveFtpPassword
 * @date 02/07/2012
 */
/**
 * Class OvhTypeSqlpriveFtpPassword
 * @date 02/07/2012
 */
class OvhTypeSqlpriveFtpPassword extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeSqlpriveFtpPassword
	 */
