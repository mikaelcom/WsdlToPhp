<?php
/**
 * Class file for OvhTypeSqlpriveMysqlLogs
 * @date 02/07/2012
 */
/**
 * Class OvhTypeSqlpriveMysqlLogs
 * @date 02/07/2012
 */
class OvhTypeSqlpriveMysqlLogs extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param string server
	 * @return OvhTypeSqlpriveMysqlLogs
	 */
