<?php
/**
 * Class file for OvhTypePrepaidDomainTransfer
 * @date 02/07/2012
 */
/**
 * Class OvhTypePrepaidDomainTransfer
 * @date 02/07/2012
 */
class OvhTypePrepaidDomainTransfer extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypePrepaidDomainTransfer
	 */
