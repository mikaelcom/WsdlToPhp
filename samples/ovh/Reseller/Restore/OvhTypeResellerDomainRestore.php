<?php
/**
 * Class file for OvhTypeResellerDomainRestore
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResellerDomainRestore
 * @date 02/07/2012
 */
class OvhTypeResellerDomainRestore extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeResellerDomainRestore
	 */
