<?php
/**
 * Class file for OvhTypeResellerDomainTransfer
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResellerDomainTransfer
 * @date 02/07/2012
 */
class OvhTypeResellerDomainTransfer extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeResellerDomainTransfer
	 */
