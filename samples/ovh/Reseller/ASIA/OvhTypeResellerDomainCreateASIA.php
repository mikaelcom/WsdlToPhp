<?php
/**
 * Class file for OvhTypeResellerDomainCreateASIA
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResellerDomainCreateASIA
 * @date 02/07/2012
 */
class OvhTypeResellerDomainCreateASIA extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeResellerDomainCreateASIA
	 */
