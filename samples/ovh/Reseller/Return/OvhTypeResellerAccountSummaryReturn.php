<?php
/**
 * Class file for OvhTypeResellerAccountSummaryReturn
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResellerAccountSummaryReturn
 * @date 02/07/2012
 */
class OvhTypeResellerAccountSummaryReturn extends OvhWsdlClass
{
	/**
	 * The nic
	 * @var string
	 ...
	 * @return OvhTypeResellerAccountSummaryReturn
	 */
