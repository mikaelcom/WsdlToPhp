<?php
/**
 * Class file for OvhTypeResellerDomainTransferIT
 * @date 02/07/2012
 */
/**
 * Class OvhTypeResellerDomainTransferIT
 * @date 02/07/2012
 */
class OvhTypeResellerDomainTransferIT extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeResellerDomainTransferIT
	 */
