<?php
/**
 * Class file for OvhTypeServiceGroupCreate
 * @date 02/07/2012
 */
/**
 * Class OvhTypeServiceGroupCreate
 * @date 02/07/2012
 */
class OvhTypeServiceGroupCreate extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeServiceGroupCreate
	 */
