<?php
/**
 * Class file for OvhTypeServiceGroupRemoveService
 * @date 02/07/2012
 */
/**
 * Class OvhTypeServiceGroupRemoveService
 * @date 02/07/2012
 */
class OvhTypeServiceGroupRemoveService extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @return OvhTypeServiceGroupRemoveService
	 */
