<?php
/**
 * Class file for OvhTypeSupportGetThreadTree
 * @date 02/07/2012
 */
/**
 * Class OvhTypeSupportGetThreadTree
 * @date 02/07/2012
 */
class OvhTypeSupportGetThreadTree extends OvhWsdlClass
{
	/**
	 * The session
	 * @var string
	 ...
	 * @param int threadId
	 * @return OvhTypeSupportGetThreadTree
	 */
