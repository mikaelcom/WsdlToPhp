<?php
/**
 * File for EccDomainHostWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccDomainHostWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Host Lookup Web Services.
 * @date 03/07/2012
 */
class EccDomainHostWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccDomainHostWsdlClass::setLastError()
	 * @uses EccDomainHostWsdlClass::initSoapClient()
	 * @uses EccDomainHostWsdlClass::initInternArrayToIterate()
	 * @uses EccDomainHostWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccDomainHostWsdlClass::classMap()
	 * @uses EccDomainHostWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccDomainHostClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccDomainHostClassMap::classMap();
	 ...
	 * @uses EccDomainHostWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccDomainHostWsdlClass::WSDL_COMPRESSION
	 * @uses EccDomainHostWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccDomainHostWsdlClass::WSDL_ENCODING
	 * @uses EccDomainHostWsdlClass::WSDL_EXCPTS
	 * @uses EccDomainHostWsdlClass::WSDL_FEATURES
	 * @uses EccDomainHostWsdlClass::WSDL_LOGIN
	 * @uses EccDomainHostWsdlClass::WSDL_PASSWD
	 * @uses EccDomainHostWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccDomainHostWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccDomainHostWsdlClass::WSDL_TRACE
	 * @uses EccDomainHostWsdlClass::WSDL_TYPEMAP
	 * @uses EccDomainHostWsdlClass::WSDL_URL
	 * @uses EccDomainHostWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccDomainHostWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::internArrayToIterateIsArray()
	 * @uses EccDomainHostWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccDomainHostWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccDomainHostWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccDomainHostWsdlClass::offsetGet()
	 * @uses EccDomainHostWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::getAttributeName()
	 * @uses EccDomainHostWsdlClass::__toString()
	 * @uses EccDomainHostWsdlClass::_set()
	 * @uses EccDomainHostWsdlClass::_get()
	 * @uses EccDomainHostWsdlClass::setInternArrayToIterate()
	 * @uses EccDomainHostWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccDomainHostWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::item()
	 * @uses EccDomainHostWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainHostWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccDomainHostWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
