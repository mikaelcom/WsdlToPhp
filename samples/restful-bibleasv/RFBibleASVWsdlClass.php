<?php
/**
 * File for RFBibleASVWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFBibleASVWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFBibleASVWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFBibleASVWsdlClass::setLastError()
	 * @uses RFBibleASVWsdlClass::initSoapClient()
	 * @uses RFBibleASVWsdlClass::initInternArrayToIterate()
	 * @uses RFBibleASVWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFBibleASVWsdlClass::classMap()
	 * @uses RFBibleASVWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFBibleASVClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFBibleASVClassMap::classMap();
	 ...
	 * @uses RFBibleASVWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFBibleASVWsdlClass::WSDL_COMPRESSION
	 * @uses RFBibleASVWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFBibleASVWsdlClass::WSDL_ENCODING
	 * @uses RFBibleASVWsdlClass::WSDL_EXCPTS
	 * @uses RFBibleASVWsdlClass::WSDL_FEATURES
	 * @uses RFBibleASVWsdlClass::WSDL_LOGIN
	 * @uses RFBibleASVWsdlClass::WSDL_PASSWD
	 * @uses RFBibleASVWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFBibleASVWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFBibleASVWsdlClass::WSDL_TRACE
	 * @uses RFBibleASVWsdlClass::WSDL_TYPEMAP
	 * @uses RFBibleASVWsdlClass::WSDL_URL
	 * @uses RFBibleASVWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses RFBibleASVWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses RFBibleASVWsdlClass::internArrayToIterateIsArray()
	 * @uses RFBibleASVWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFBibleASVWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFBibleASVWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFBibleASVWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFBibleASVWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFBibleASVWsdlClass::offsetExists()
	 ...
	 * @uses RFBibleASVWsdlClass::getAttributeName()
	 * @uses RFBibleASVWsdlClass::__toString()
	 * @uses RFBibleASVWsdlClass::_set()
	 * @uses RFBibleASVWsdlClass::_get()
	 * @uses RFBibleASVWsdlClass::setInternArrayToIterate()
	 * @uses RFBibleASVWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFBibleASVWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFBibleASVWsdlClass::item()
	 * @uses RFBibleASVWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses RFBibleASVWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFBibleASVWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
