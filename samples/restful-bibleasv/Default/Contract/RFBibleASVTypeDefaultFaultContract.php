<?php
/**
 * Class file for RFBibleASVTypeDefaultFaultContract
 * @date 15/08/2012
 */
/**
 * Class RFBibleASVTypeDefaultFaultContract
 * @date 15/08/2012
 */
class RFBibleASVTypeDefaultFaultContract extends RFBibleASVWsdlClass
{
	/**
	 * The ErrorId
	 * @var int
	 ...
	 * @param RFBibleASVTypeGuid CorrelationId
	 * @return RFBibleASVTypeDefaultFaultContract
	 */
