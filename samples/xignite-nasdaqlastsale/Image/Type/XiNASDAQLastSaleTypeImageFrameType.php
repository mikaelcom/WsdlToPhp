<?php
/**
 * Class file for XiNASDAQLastSaleTypeImageFrameType
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeImageFrameType
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeImageFrameType extends XiNASDAQLastSaleWsdlClass
{
	/**
