<?php
/**
 * Class file for XiNASDAQLastSaleTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeOutcomeTypes extends XiNASDAQLastSaleWsdlClass
{
	/**
