<?php
/**
 * Class file for XiNASDAQLastSaleTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeHeader
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeHeader extends XiNASDAQLastSaleWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiNASDAQLastSaleTypeHeader
	 */
