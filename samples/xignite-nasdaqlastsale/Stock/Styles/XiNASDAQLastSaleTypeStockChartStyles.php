<?php
/**
 * Class file for XiNASDAQLastSaleTypeStockChartStyles
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeStockChartStyles
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeStockChartStyles extends XiNASDAQLastSaleWsdlClass
{
	/**
