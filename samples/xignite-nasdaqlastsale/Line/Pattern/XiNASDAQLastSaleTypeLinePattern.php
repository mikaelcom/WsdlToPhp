<?php
/**
 * Class file for XiNASDAQLastSaleTypeLinePattern
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeLinePattern
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeLinePattern extends XiNASDAQLastSaleWsdlClass
{
	/**
