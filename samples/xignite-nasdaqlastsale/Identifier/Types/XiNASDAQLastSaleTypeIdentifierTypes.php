<?php
/**
 * Class file for XiNASDAQLastSaleTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeIdentifierTypes extends XiNASDAQLastSaleWsdlClass
{
	/**
