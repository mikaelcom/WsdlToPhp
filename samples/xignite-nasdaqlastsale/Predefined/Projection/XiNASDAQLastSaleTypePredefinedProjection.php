<?php
/**
 * Class file for XiNASDAQLastSaleTypePredefinedProjection
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypePredefinedProjection
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypePredefinedProjection extends XiNASDAQLastSaleWsdlClass
{
	/**
