<?php
/**
 * Class file for XiNASDAQLastSaleTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypePredefinedLightModel extends XiNASDAQLastSaleWsdlClass
{
	/**
