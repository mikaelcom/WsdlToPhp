<?php
/**
 * File for XiNASDAQLastSaleWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiNASDAQLastSaleWsdlClass to communicate with SOAP service
 * Documentation : Provides real-time access to last sale NASDAQ, AMEX, and NYSE information.
 * @date 08/07/2012
 */
class XiNASDAQLastSaleWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiNASDAQLastSaleWsdlClass::setLastError()
	 * @uses XiNASDAQLastSaleWsdlClass::initSoapClient()
	 * @uses XiNASDAQLastSaleWsdlClass::initInternArrayToIterate()
	 * @uses XiNASDAQLastSaleWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiNASDAQLastSaleWsdlClass::classMap()
	 * @uses XiNASDAQLastSaleWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiNASDAQLastSaleClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiNASDAQLastSaleClassMap::classMap();
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_COMPRESSION
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_ENCODING
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_EXCPTS
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_FEATURES
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_LOGIN
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_PASSWD
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_TRACE
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_TYPEMAP
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_URL
	 * @uses XiNASDAQLastSaleWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiNASDAQLastSaleWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::internArrayToIterateIsArray()
	 * @uses XiNASDAQLastSaleWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiNASDAQLastSaleWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiNASDAQLastSaleWsdlClass::offsetExists()
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::getAttributeName()
	 * @uses XiNASDAQLastSaleWsdlClass::__toString()
	 * @uses XiNASDAQLastSaleWsdlClass::_set()
	 * @uses XiNASDAQLastSaleWsdlClass::_get()
	 * @uses XiNASDAQLastSaleWsdlClass::setInternArrayToIterate()
	 * @uses XiNASDAQLastSaleWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiNASDAQLastSaleWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::item()
	 * @uses XiNASDAQLastSaleWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiNASDAQLastSaleWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiNASDAQLastSaleWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
