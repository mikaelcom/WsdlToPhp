<?php
/**
 * Class file for XiNASDAQLastSaleTypeGetLastSaleChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeGetLastSaleChartCustom
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeGetLastSaleChartCustom extends XiNASDAQLastSaleWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiNASDAQLastSaleTypeGetLastSaleChartCustom
	 */
