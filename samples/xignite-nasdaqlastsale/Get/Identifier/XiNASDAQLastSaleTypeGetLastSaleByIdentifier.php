<?php
/**
 * Class file for XiNASDAQLastSaleTypeGetLastSaleByIdentifier
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeGetLastSaleByIdentifier
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeGetLastSaleByIdentifier extends XiNASDAQLastSaleWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiNASDAQLastSaleTypeGetLastSaleByIdentifier
	 */
