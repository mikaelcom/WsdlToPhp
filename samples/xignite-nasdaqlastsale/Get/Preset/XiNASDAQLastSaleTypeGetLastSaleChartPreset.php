<?php
/**
 * Class file for XiNASDAQLastSaleTypeGetLastSaleChartPreset
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeGetLastSaleChartPreset
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeGetLastSaleChartPreset extends XiNASDAQLastSaleWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiNASDAQLastSaleTypeGetLastSaleChartPreset
	 */
