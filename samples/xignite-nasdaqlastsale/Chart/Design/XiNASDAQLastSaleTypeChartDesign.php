<?php
/**
 * Class file for XiNASDAQLastSaleTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeChartDesign
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeChartDesign extends XiNASDAQLastSaleTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiNASDAQLastSaleTypeLinePattern
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiNASDAQLastSaleTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiNASDAQLastSaleTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiNASDAQLastSaleTypeTickPeriod
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiNASDAQLastSaleTypeHorzAlign
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiNASDAQLastSaleTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiNASDAQLastSaleTypeLinePattern GridHorizontalStyle
	 * @param XiNASDAQLastSaleTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiNASDAQLastSaleTypeImageFrameType FrameType
	 * @param XiNASDAQLastSaleTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiNASDAQLastSaleTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiNASDAQLastSaleTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiNASDAQLastSaleTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiNASDAQLastSaleTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiNASDAQLastSaleTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiNASDAQLastSaleTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiNASDAQLastSaleTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiNASDAQLastSaleTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiNASDAQLastSaleTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiNASDAQLastSaleTypePredefinedProjection
	 */
	...
	{
		return ($this->TickPrecision = XiNASDAQLastSaleTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiNASDAQLastSaleTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiNASDAQLastSaleTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiNASDAQLastSaleTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiNASDAQLastSaleTypePredefinedLightModel
	 */
