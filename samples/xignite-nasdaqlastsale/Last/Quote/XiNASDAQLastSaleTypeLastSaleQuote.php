<?php
/**
 * Class file for XiNASDAQLastSaleTypeLastSaleQuote
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeLastSaleQuote
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeLastSaleQuote extends XiNASDAQLastSaleTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	...
	{
		XiNASDAQLastSaleWsdlClass::__construct(array('Symbol'=>$_Symbol,'CompanyName'=>$_CompanyName,'Date'=>$_Date,'Time'=>$_Time,'Open'=>$_Open,'Close'=>$_Close,'PreviousClose'=>$_PreviousClose,'High'=>$_High,'Low'=>$_Low,'Last'=>$_Last,'Change'=>$_Change,'PercentChange'=>$_PercentChange,'Volume'=>$_Volume));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
