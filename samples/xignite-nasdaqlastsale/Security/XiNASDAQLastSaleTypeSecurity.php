<?php
/**
 * Class file for XiNASDAQLastSaleTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiNASDAQLastSaleTypeSecurity
 * @date 08/07/2012
 */
class XiNASDAQLastSaleTypeSecurity extends XiNASDAQLastSaleTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiNASDAQLastSaleWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
