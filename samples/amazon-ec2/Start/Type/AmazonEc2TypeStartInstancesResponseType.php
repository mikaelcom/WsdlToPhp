<?php
/**
 * Class file for AmazonEc2TypeStartInstancesResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeStartInstancesResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeStartInstancesResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
