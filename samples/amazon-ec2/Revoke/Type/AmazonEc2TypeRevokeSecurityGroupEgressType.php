<?php
/**
 * Class file for AmazonEc2TypeRevokeSecurityGroupEgressType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeRevokeSecurityGroupEgressType
 * @date 10/07/2012
 */
class AmazonEc2TypeRevokeSecurityGroupEgressType extends AmazonEc2WsdlClass
{
	/**
	 * The groupId
	 * @var string
	 ...
	 * @return AmazonEc2TypeRevokeSecurityGroupEgressType
	 */
