<?php
/**
 * Class file for AmazonEc2TypeRevokeSecurityGroupIngressType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeRevokeSecurityGroupIngressType
 * @date 10/07/2012
 */
class AmazonEc2TypeRevokeSecurityGroupIngressType extends AmazonEc2WsdlClass
{
	/**
	 * The userId
	 * Meta informations :
	 ...
	 * @return AmazonEc2TypeRevokeSecurityGroupIngressType
	 */
