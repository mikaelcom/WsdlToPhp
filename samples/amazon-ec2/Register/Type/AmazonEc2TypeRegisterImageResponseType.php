<?php
/**
 * Class file for AmazonEc2TypeRegisterImageResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeRegisterImageResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeRegisterImageResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
