<?php
/**
 * Class file for AmazonEc2TypeDeleteInternetGatewayType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDeleteInternetGatewayType
 * @date 10/07/2012
 */
class AmazonEc2TypeDeleteInternetGatewayType extends AmazonEc2WsdlClass
{
	/**
	 ...
	 * @return AmazonEc2TypeDeleteInternetGatewayType
	 */
