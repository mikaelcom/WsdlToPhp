<?php
/**
 * Class file for AmazonEc2TypeDeleteVpnConnectionType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDeleteVpnConnectionType
 * @date 10/07/2012
 */
class AmazonEc2TypeDeleteVpnConnectionType extends AmazonEc2WsdlClass
{
	/**
	 * The vpnConnectionId
	 * @var string
	 ...
	 * @return AmazonEc2TypeDeleteVpnConnectionType
	 */
