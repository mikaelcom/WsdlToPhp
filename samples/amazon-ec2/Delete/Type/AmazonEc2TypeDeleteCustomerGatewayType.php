<?php
/**
 * Class file for AmazonEc2TypeDeleteCustomerGatewayType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDeleteCustomerGatewayType
 * @date 10/07/2012
 */
class AmazonEc2TypeDeleteCustomerGatewayType extends AmazonEc2WsdlClass
{
	/**
	 ...
	 * @return AmazonEc2TypeDeleteCustomerGatewayType
	 */
