<?php
/**
 * Class file for AmazonEc2TypeDetachInternetGatewayType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDetachInternetGatewayType
 * @date 10/07/2012
 */
class AmazonEc2TypeDetachInternetGatewayType extends AmazonEc2WsdlClass
{
	/**
	 ...
	 * @param string vpcId
	 * @return AmazonEc2TypeDetachInternetGatewayType
	 */
