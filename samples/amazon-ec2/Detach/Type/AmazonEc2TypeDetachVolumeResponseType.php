<?php
/**
 * Class file for AmazonEc2TypeDetachVolumeResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDetachVolumeResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeDetachVolumeResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
