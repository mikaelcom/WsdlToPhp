<?php
/**
 * Class file for AmazonEc2TypeDetachVpnGatewayType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDetachVpnGatewayType
 * @date 10/07/2012
 */
class AmazonEc2TypeDetachVpnGatewayType extends AmazonEc2WsdlClass
{
	/**
	 * The vpnGatewayId
	 * @var string
	 ...
	 * @param string vpcId
	 * @return AmazonEc2TypeDetachVpnGatewayType
	 */
