<?php
/**
 * Class file for AmazonEc2TypeImportInstanceGroupItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeImportInstanceGroupItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeImportInstanceGroupItemType extends AmazonEc2WsdlClass
{
	/**
	 * The groupId
	 * Meta informations :
