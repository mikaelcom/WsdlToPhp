<?php
/**
 * File for AmazonEc2WsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonEc2WsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class AmazonEc2WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonEc2WsdlClass::setLastError()
	 * @uses AmazonEc2WsdlClass::initSoapClient()
	 * @uses AmazonEc2WsdlClass::initInternArrayToIterate()
	 * @uses AmazonEc2WsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonEc2WsdlClass::classMap()
	 * @uses AmazonEc2WsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonEc2ClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonEc2ClassMap::classMap();
	 ...
	 * @uses AmazonEc2WsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonEc2WsdlClass::WSDL_COMPRESSION
	 * @uses AmazonEc2WsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonEc2WsdlClass::WSDL_ENCODING
	 * @uses AmazonEc2WsdlClass::WSDL_EXCPTS
	 * @uses AmazonEc2WsdlClass::WSDL_FEATURES
	 * @uses AmazonEc2WsdlClass::WSDL_LOGIN
	 * @uses AmazonEc2WsdlClass::WSDL_PASSWD
	 * @uses AmazonEc2WsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonEc2WsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonEc2WsdlClass::WSDL_TRACE
	 * @uses AmazonEc2WsdlClass::WSDL_TYPEMAP
	 * @uses AmazonEc2WsdlClass::WSDL_URL
	 * @uses AmazonEc2WsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonEc2WsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonEc2WsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonEc2WsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonEc2WsdlClass::offsetGet()
	 * @uses AmazonEc2WsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::getAttributeName()
	 * @uses AmazonEc2WsdlClass::__toString()
	 * @uses AmazonEc2WsdlClass::_set()
	 * @uses AmazonEc2WsdlClass::_get()
	 * @uses AmazonEc2WsdlClass::setInternArrayToIterate()
	 * @uses AmazonEc2WsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonEc2WsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::item()
	 * @uses AmazonEc2WsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonEc2WsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonEc2WsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
