<?php
/**
 * Class file for AmazonEc2TypeInstancePlacementType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeInstancePlacementType
 * @date 10/07/2012
 */
class AmazonEc2TypeInstancePlacementType extends AmazonEc2WsdlClass
{
	/**
