<?php
/**
 * Class file for AmazonEc2TypeCreateVolumePermissionItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeCreateVolumePermissionItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeCreateVolumePermissionItemType extends AmazonEc2WsdlClass
{
	/**
	 * The userId
	 * @var string
