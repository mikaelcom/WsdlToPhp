<?php
/**
 * Class file for AmazonEc2TypeCreateRouteType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeCreateRouteType
 * @date 10/07/2012
 */
class AmazonEc2TypeCreateRouteType extends AmazonEc2WsdlClass
{
	/**
	 * The routeTableId
	 * @var string
	 ...
	 * @return AmazonEc2TypeCreateRouteType
	 */
