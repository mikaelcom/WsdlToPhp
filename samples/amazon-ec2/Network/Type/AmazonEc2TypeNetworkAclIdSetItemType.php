<?php
/**
 * Class file for AmazonEc2TypeNetworkAclIdSetItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeNetworkAclIdSetItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeNetworkAclIdSetItemType extends AmazonEc2WsdlClass
{
	/**
	 * The networkAclId
	 * @var string
