<?php
/**
 * Class file for AmazonEc2TypeNetworkInterfaceIdSetItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeNetworkInterfaceIdSetItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeNetworkInterfaceIdSetItemType extends AmazonEc2WsdlClass
{
	/**
