<?php
/**
 * Class file for AmazonEc2TypeTerminateInstancesResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeTerminateInstancesResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeTerminateInstancesResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
