<?php
/**
 * Class file for AmazonEc2TypeCancelBundleTaskResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeCancelBundleTaskResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeCancelBundleTaskResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
