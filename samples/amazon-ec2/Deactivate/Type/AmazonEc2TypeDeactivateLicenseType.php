<?php
/**
 * Class file for AmazonEc2TypeDeactivateLicenseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDeactivateLicenseType
 * @date 10/07/2012
 */
class AmazonEc2TypeDeactivateLicenseType extends AmazonEc2WsdlClass
{
	/**
	 * The licenseId
	 * @var string
	 ...
	 * @param int capacity
	 * @return AmazonEc2TypeDeactivateLicenseType
	 */
