<?php
/**
 * Class file for AmazonEc2TypeDhcpOptionsIdSetItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDhcpOptionsIdSetItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeDhcpOptionsIdSetItemType extends AmazonEc2WsdlClass
{
	/**
	 * The dhcpOptionsId
	 * @var string
