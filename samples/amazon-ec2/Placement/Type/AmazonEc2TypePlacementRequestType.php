<?php
/**
 * Class file for AmazonEc2TypePlacementRequestType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypePlacementRequestType
 * @date 10/07/2012
 */
class AmazonEc2TypePlacementRequestType extends AmazonEc2WsdlClass
{
	/**
