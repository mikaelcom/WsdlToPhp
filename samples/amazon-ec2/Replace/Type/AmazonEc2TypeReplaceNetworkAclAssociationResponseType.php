<?php
/**
 * Class file for AmazonEc2TypeReplaceNetworkAclAssociationResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeReplaceNetworkAclAssociationResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeReplaceNetworkAclAssociationResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
