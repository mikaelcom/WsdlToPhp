<?php
/**
 * Class file for AmazonEc2TypeReplaceNetworkAclEntryType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeReplaceNetworkAclEntryType
 * @date 10/07/2012
 */
class AmazonEc2TypeReplaceNetworkAclEntryType extends AmazonEc2WsdlClass
{
	/**
	 * The networkAclId
	 * @var string
	 ...
	 * @return AmazonEc2TypeReplaceNetworkAclEntryType
	 */
