<?php
/**
 * Class file for AmazonEc2TypeDescribeBundleTasksItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDescribeBundleTasksItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeDescribeBundleTasksItemType extends AmazonEc2WsdlClass
{
	/**
	 * The bundleId
	 * @var string
