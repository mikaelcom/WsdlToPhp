<?php
/**
 * Class file for AmazonEc2TypeDescribeSecurityGroupsSetItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDescribeSecurityGroupsSetItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeDescribeSecurityGroupsSetItemType extends AmazonEc2WsdlClass
{
	/**
	 * The groupName
	 * @var string
