<?php
/**
 * Class file for AmazonEc2TypeDescribeInstancesItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDescribeInstancesItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeDescribeInstancesItemType extends AmazonEc2WsdlClass
{
	/**
	 * The instanceId
	 * @var string
