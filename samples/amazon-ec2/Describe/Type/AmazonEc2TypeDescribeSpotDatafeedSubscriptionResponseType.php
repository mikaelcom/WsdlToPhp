<?php
/**
 * Class file for AmazonEc2TypeDescribeSpotDatafeedSubscriptionResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDescribeSpotDatafeedSubscriptionResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeDescribeSpotDatafeedSubscriptionResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
