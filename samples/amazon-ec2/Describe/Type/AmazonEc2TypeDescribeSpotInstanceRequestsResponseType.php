<?php
/**
 * Class file for AmazonEc2TypeDescribeSpotInstanceRequestsResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDescribeSpotInstanceRequestsResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeDescribeSpotInstanceRequestsResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
