<?php
/**
 * Class file for AmazonEc2TypeDescribePlacementGroupItemType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeDescribePlacementGroupItemType
 * @date 10/07/2012
 */
class AmazonEc2TypeDescribePlacementGroupItemType extends AmazonEc2WsdlClass
{
	/**
	 * The groupName
	 * @var string
