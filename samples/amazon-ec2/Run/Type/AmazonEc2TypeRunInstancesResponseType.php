<?php
/**
 * Class file for AmazonEc2TypeRunInstancesResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeRunInstancesResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeRunInstancesResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The requestId
	 * @var string
	 ...
	 */
	public function __construct($_requestId = null,$_reservationId = null,$_ownerId = null,$_groupSet = null,$_instancesSet = null,$_requesterId = null)
	{
		parent::__construct(array('requestId'=>$_requestId,'reservationId'=>$_reservationId,'ownerId'=>$_ownerId,'groupSet'=>$_groupSet,'instancesSet'=>$_instancesSet,'requesterId'=>$_requesterId));
	}
	/**
	 * Set requestId
	 * @param string requestId
