<?php
/**
 * Class file for AmazonEc2TypeLaunchSpecificationResponseType
 * @date 10/07/2012
 */
/**
 * Class AmazonEc2TypeLaunchSpecificationResponseType
 * @date 10/07/2012
 */
class AmazonEc2TypeLaunchSpecificationResponseType extends AmazonEc2WsdlClass
{
	/**
	 * The imageId
	 * @var string
	 ...
	 */
	public function __construct($_imageId = null,$_keyName = null,$_groupSet = null,$_addressingType = null,$_instanceType = null,$_placement = null,$_kernelId = null,$_ramdiskId = null,$_blockDeviceMapping = null,$_monitoring = null,$_subnetId = null,$_networkInterfaceSet = null,$_iamInstanceProfile = null)
	{
		parent::__construct(array('imageId'=>$_imageId,'keyName'=>$_keyName,'groupSet'=>$_groupSet,'addressingType'=>$_addressingType,'instanceType'=>$_instanceType,'placement'=>$_placement,'kernelId'=>$_kernelId,'ramdiskId'=>$_ramdiskId,'blockDeviceMapping'=>$_blockDeviceMapping,'monitoring'=>$_monitoring,'subnetId'=>$_subnetId,'networkInterfaceSet'=>$_networkInterfaceSet,'iamInstanceProfile'=>$_iamInstanceProfile));
	}
	/**
	 * Set imageId
	 * @param string imageId
