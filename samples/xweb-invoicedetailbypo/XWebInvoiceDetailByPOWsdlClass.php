<?php
/**
 * File for XWebInvoiceDetailByPOWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebInvoiceDetailByPOWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebInvoiceDetailByPOWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebInvoiceDetailByPOWsdlClass::setLastError()
	 * @uses XWebInvoiceDetailByPOWsdlClass::initSoapClient()
	 * @uses XWebInvoiceDetailByPOWsdlClass::initInternArrayToIterate()
	 * @uses XWebInvoiceDetailByPOWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebInvoiceDetailByPOWsdlClass::classMap()
	 * @uses XWebInvoiceDetailByPOWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebInvoiceDetailByPOClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebInvoiceDetailByPOClassMap::classMap();
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_COMPRESSION
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_ENCODING
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_EXCPTS
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_FEATURES
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_LOGIN
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_PASSWD
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_TRACE
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_TYPEMAP
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_URL
	 * @uses XWebInvoiceDetailByPOWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebInvoiceDetailByPOWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebInvoiceDetailByPOWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebInvoiceDetailByPOWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebInvoiceDetailByPOWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebInvoiceDetailByPOWsdlClass::offsetGet()
	 * @uses XWebInvoiceDetailByPOWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::getAttributeName()
	 * @uses XWebInvoiceDetailByPOWsdlClass::__toString()
	 * @uses XWebInvoiceDetailByPOWsdlClass::_set()
	 * @uses XWebInvoiceDetailByPOWsdlClass::_get()
	 * @uses XWebInvoiceDetailByPOWsdlClass::setInternArrayToIterate()
	 * @uses XWebInvoiceDetailByPOWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebInvoiceDetailByPOWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::item()
	 * @uses XWebInvoiceDetailByPOWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebInvoiceDetailByPOWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebInvoiceDetailByPOWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
