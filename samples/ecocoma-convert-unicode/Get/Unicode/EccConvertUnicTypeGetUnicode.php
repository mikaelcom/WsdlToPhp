<?php
/**
 * Class file for EccConvertUnicTypeGetUnicode
 * @date 03/07/2012
 */
/**
 * Class EccConvertUnicTypeGetUnicode
 * @date 03/07/2012
 */
class EccConvertUnicTypeGetUnicode extends EccConvertUnicWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Source
	 * @return EccConvertUnicTypeGetUnicode
	 */
