<?php
/**
 * Class file for EccConvertUnicTypeGetUtf8
 * @date 03/07/2012
 */
/**
 * Class EccConvertUnicTypeGetUtf8
 * @date 03/07/2012
 */
class EccConvertUnicTypeGetUtf8 extends EccConvertUnicWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Source
	 * @return EccConvertUnicTypeGetUtf8
	 */
