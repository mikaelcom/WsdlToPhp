<?php
/**
 * File for EccConvertUnicWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccConvertUnicWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Unicode Convert Web Services.
 * @date 03/07/2012
 */
class EccConvertUnicWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccConvertUnicWsdlClass::setLastError()
	 * @uses EccConvertUnicWsdlClass::initSoapClient()
	 * @uses EccConvertUnicWsdlClass::initInternArrayToIterate()
	 * @uses EccConvertUnicWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccConvertUnicWsdlClass::classMap()
	 * @uses EccConvertUnicWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccConvertUnicClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccConvertUnicClassMap::classMap();
	 ...
	 * @uses EccConvertUnicWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccConvertUnicWsdlClass::WSDL_COMPRESSION
	 * @uses EccConvertUnicWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccConvertUnicWsdlClass::WSDL_ENCODING
	 * @uses EccConvertUnicWsdlClass::WSDL_EXCPTS
	 * @uses EccConvertUnicWsdlClass::WSDL_FEATURES
	 * @uses EccConvertUnicWsdlClass::WSDL_LOGIN
	 * @uses EccConvertUnicWsdlClass::WSDL_PASSWD
	 * @uses EccConvertUnicWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccConvertUnicWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccConvertUnicWsdlClass::WSDL_TRACE
	 * @uses EccConvertUnicWsdlClass::WSDL_TYPEMAP
	 * @uses EccConvertUnicWsdlClass::WSDL_URL
	 * @uses EccConvertUnicWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccConvertUnicWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::internArrayToIterateIsArray()
	 * @uses EccConvertUnicWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertUnicWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertUnicWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccConvertUnicWsdlClass::offsetGet()
	 * @uses EccConvertUnicWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::getAttributeName()
	 * @uses EccConvertUnicWsdlClass::__toString()
	 * @uses EccConvertUnicWsdlClass::_set()
	 * @uses EccConvertUnicWsdlClass::_get()
	 * @uses EccConvertUnicWsdlClass::setInternArrayToIterate()
	 * @uses EccConvertUnicWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccConvertUnicWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::item()
	 * @uses EccConvertUnicWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnicWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccConvertUnicWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
