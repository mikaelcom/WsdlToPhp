<?php
/**
 * Class file for XiBondMasterTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeHeader
 * @date 08/07/2012
 */
class XiBondMasterTypeHeader extends XiBondMasterWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
