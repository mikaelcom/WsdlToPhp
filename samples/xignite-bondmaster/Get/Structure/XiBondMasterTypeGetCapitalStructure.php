<?php
/**
 * Class file for XiBondMasterTypeGetCapitalStructure
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeGetCapitalStructure
 * @date 08/07/2012
 */
class XiBondMasterTypeGetCapitalStructure extends XiBondMasterWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeGetCapitalStructure
	 */
