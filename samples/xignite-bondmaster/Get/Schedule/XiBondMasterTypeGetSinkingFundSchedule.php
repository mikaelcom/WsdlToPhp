<?php
/**
 * Class file for XiBondMasterTypeGetSinkingFundSchedule
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeGetSinkingFundSchedule
 * @date 08/07/2012
 */
class XiBondMasterTypeGetSinkingFundSchedule extends XiBondMasterWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeGetSinkingFundSchedule
	 */
