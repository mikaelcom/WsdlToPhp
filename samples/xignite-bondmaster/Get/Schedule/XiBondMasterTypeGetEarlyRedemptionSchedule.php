<?php
/**
 * Class file for XiBondMasterTypeGetEarlyRedemptionSchedule
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeGetEarlyRedemptionSchedule
 * @date 08/07/2012
 */
class XiBondMasterTypeGetEarlyRedemptionSchedule extends XiBondMasterWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeGetEarlyRedemptionSchedule
	 */
