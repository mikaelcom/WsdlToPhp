<?php
/**
 * Class file for XiBondMasterTypeGetIssueManagersAgents
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeGetIssueManagersAgents
 * @date 08/07/2012
 */
class XiBondMasterTypeGetIssueManagersAgents extends XiBondMasterWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeGetIssueManagersAgents
	 */
