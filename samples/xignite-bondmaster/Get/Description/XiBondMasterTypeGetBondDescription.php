<?php
/**
 * Class file for XiBondMasterTypeGetBondDescription
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeGetBondDescription
 * @date 08/07/2012
 */
class XiBondMasterTypeGetBondDescription extends XiBondMasterWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeGetBondDescription
	 */
