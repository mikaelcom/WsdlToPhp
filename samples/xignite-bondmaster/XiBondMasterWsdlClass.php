<?php
/**
 * File for XiBondMasterWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiBondMasterWsdlClass to communicate with SOAP service
 * Documentation : XigniteBondMaster web service provides security master data and associated reference data for US investment grade corporate bonds, US treasury bonds and US agency bonds.
 * @date 08/07/2012
 */
class XiBondMasterWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiBondMasterWsdlClass::setLastError()
	 * @uses XiBondMasterWsdlClass::initSoapClient()
	 * @uses XiBondMasterWsdlClass::initInternArrayToIterate()
	 * @uses XiBondMasterWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiBondMasterWsdlClass::classMap()
	 * @uses XiBondMasterWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiBondMasterClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiBondMasterClassMap::classMap();
	 ...
	 * @uses XiBondMasterWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiBondMasterWsdlClass::WSDL_COMPRESSION
	 * @uses XiBondMasterWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiBondMasterWsdlClass::WSDL_ENCODING
	 * @uses XiBondMasterWsdlClass::WSDL_EXCPTS
	 * @uses XiBondMasterWsdlClass::WSDL_FEATURES
	 * @uses XiBondMasterWsdlClass::WSDL_LOGIN
	 * @uses XiBondMasterWsdlClass::WSDL_PASSWD
	 * @uses XiBondMasterWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiBondMasterWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiBondMasterWsdlClass::WSDL_TRACE
	 * @uses XiBondMasterWsdlClass::WSDL_TYPEMAP
	 * @uses XiBondMasterWsdlClass::WSDL_URL
	 * @uses XiBondMasterWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiBondMasterWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::internArrayToIterateIsArray()
	 * @uses XiBondMasterWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBondMasterWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBondMasterWsdlClass::offsetExists()
	 ...
	 * @uses XiBondMasterWsdlClass::getAttributeName()
	 * @uses XiBondMasterWsdlClass::__toString()
	 * @uses XiBondMasterWsdlClass::_set()
	 * @uses XiBondMasterWsdlClass::_get()
	 * @uses XiBondMasterWsdlClass::setInternArrayToIterate()
	 * @uses XiBondMasterWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiBondMasterWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::item()
	 * @uses XiBondMasterWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondMasterWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiBondMasterWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
