<?php
/**
 * Class file for XiBondMasterTypeBondInstrumentBrief
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeBondInstrumentBrief
 * @date 08/07/2012
 */
class XiBondMasterTypeBondInstrumentBrief extends XiBondMasterWsdlClass
{
	/**
	 * The Description
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeBondInstrumentBrief
	 */
