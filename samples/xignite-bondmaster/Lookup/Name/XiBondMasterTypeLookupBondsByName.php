<?php
/**
 * Class file for XiBondMasterTypeLookupBondsByName
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeLookupBondsByName
 * @date 08/07/2012
 */
class XiBondMasterTypeLookupBondsByName extends XiBondMasterWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return XiBondMasterTypeLookupBondsByName
	 */
