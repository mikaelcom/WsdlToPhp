<?php
/**
 * Class file for XiBondMasterTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiBondMasterTypeCommon
 * @date 08/07/2012
 */
class XiBondMasterTypeCommon extends XiBondMasterWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBondMasterTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiBondMasterTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiBondMasterTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiBondMasterTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiBondMasterTypeOutcomeTypes
	 */
