<?php
/**
 * File for SOAddressValidateWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for SOAddressValidateWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class SOAddressValidateWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOAddressValidateWsdlClass::setLastError()
	 * @uses SOAddressValidateWsdlClass::initSoapClient()
	 * @uses SOAddressValidateWsdlClass::initInternArrayToIterate()
	 * @uses SOAddressValidateWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOAddressValidateWsdlClass::classMap()
	 * @uses SOAddressValidateWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOAddressValidateClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOAddressValidateClassMap::classMap();
	 ...
	 * @uses SOAddressValidateWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOAddressValidateWsdlClass::WSDL_COMPRESSION
	 * @uses SOAddressValidateWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOAddressValidateWsdlClass::WSDL_ENCODING
	 * @uses SOAddressValidateWsdlClass::WSDL_EXCPTS
	 * @uses SOAddressValidateWsdlClass::WSDL_FEATURES
	 * @uses SOAddressValidateWsdlClass::WSDL_LOGIN
	 * @uses SOAddressValidateWsdlClass::WSDL_PASSWD
	 * @uses SOAddressValidateWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOAddressValidateWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOAddressValidateWsdlClass::WSDL_TRACE
	 * @uses SOAddressValidateWsdlClass::WSDL_TYPEMAP
	 * @uses SOAddressValidateWsdlClass::WSDL_URL
	 * @uses SOAddressValidateWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOAddressValidateWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::internArrayToIterateIsArray()
	 * @uses SOAddressValidateWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOAddressValidateWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOAddressValidateWsdlClass::offsetExists()
	 ...
	 * @uses SOAddressValidateWsdlClass::getAttributeName()
	 * @uses SOAddressValidateWsdlClass::__toString()
	 * @uses SOAddressValidateWsdlClass::_set()
	 * @uses SOAddressValidateWsdlClass::_get()
	 * @uses SOAddressValidateWsdlClass::setInternArrayToIterate()
	 * @uses SOAddressValidateWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOAddressValidateWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::item()
	 * @uses SOAddressValidateWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressValidateWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOAddressValidateWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
