<?php
/**
 * Class file for XiMetalsTypeFutureQuote
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeFutureQuote
 * @date 08/07/2012
 */
class XiMetalsTypeFutureQuote extends XiMetalsTypeCommon
{
	/**
	 * The Future
	 * Meta informations :
	...
	{
		XiMetalsWsdlClass::__construct(array('Future'=>$_Future,'Date'=>$_Date,'Time'=>$_Time,'Open'=>$_Open,'High'=>$_High,'Low'=>$_Low,'Last'=>$_Last,'Settle'=>$_Settle,'Volume'=>$_Volume,'OpenInterest'=>$_OpenInterest,'PreviousClose'=>$_PreviousClose,'Change'=>$_Change,'PercentChange'=>$_PercentChange,'Currency'=>$_Currency));
	}
	/**
	 * Set Future
	 * @param Future Future
