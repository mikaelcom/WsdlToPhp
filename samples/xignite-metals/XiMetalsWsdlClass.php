<?php
/**
 * File for XiMetalsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiMetalsWsdlClass to communicate with SOAP service
 * Documentation : Provide information about the price of precious metals and coins.
 * @date 08/07/2012
 */
class XiMetalsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiMetalsWsdlClass::setLastError()
	 * @uses XiMetalsWsdlClass::initSoapClient()
	 * @uses XiMetalsWsdlClass::initInternArrayToIterate()
	 * @uses XiMetalsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiMetalsWsdlClass::classMap()
	 * @uses XiMetalsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiMetalsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiMetalsClassMap::classMap();
	 ...
	 * @uses XiMetalsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiMetalsWsdlClass::WSDL_COMPRESSION
	 * @uses XiMetalsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiMetalsWsdlClass::WSDL_ENCODING
	 * @uses XiMetalsWsdlClass::WSDL_EXCPTS
	 * @uses XiMetalsWsdlClass::WSDL_FEATURES
	 * @uses XiMetalsWsdlClass::WSDL_LOGIN
	 * @uses XiMetalsWsdlClass::WSDL_PASSWD
	 * @uses XiMetalsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiMetalsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiMetalsWsdlClass::WSDL_TRACE
	 * @uses XiMetalsWsdlClass::WSDL_TYPEMAP
	 * @uses XiMetalsWsdlClass::WSDL_URL
	 * @uses XiMetalsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiMetalsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiMetalsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiMetalsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiMetalsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiMetalsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiMetalsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiMetalsWsdlClass::offsetExists()
	 ...
	 * @uses XiMetalsWsdlClass::getAttributeName()
	 * @uses XiMetalsWsdlClass::__toString()
	 * @uses XiMetalsWsdlClass::_set()
	 * @uses XiMetalsWsdlClass::_get()
	 * @uses XiMetalsWsdlClass::setInternArrayToIterate()
	 * @uses XiMetalsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiMetalsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiMetalsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiMetalsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
