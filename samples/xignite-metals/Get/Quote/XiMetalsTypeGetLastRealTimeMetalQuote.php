<?php
/**
 * Class file for XiMetalsTypeGetLastRealTimeMetalQuote
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetLastRealTimeMetalQuote
 * @date 08/07/2012
 */
class XiMetalsTypeGetLastRealTimeMetalQuote extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetLastRealTimeMetalQuote
	 */
