<?php
/**
 * Class file for XiMetalsTypeGetLondonFixingChartPreset
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetLondonFixingChartPreset
 * @date 08/07/2012
 */
class XiMetalsTypeGetLondonFixingChartPreset extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiMetalsTypeGetLondonFixingChartPreset
	 */
	public function __construct($_Type,$_PeriodType,$_Currency,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height,$_Preset = null)
	{
		parent::__construct(array('Type'=>$_Type,'PeriodType'=>$_PeriodType,'Currency'=>$_Currency,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Preset'=>$_Preset));
	}
	/**
	 * Set Type
