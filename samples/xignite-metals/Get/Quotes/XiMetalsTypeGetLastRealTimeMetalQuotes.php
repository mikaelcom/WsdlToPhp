<?php
/**
 * Class file for XiMetalsTypeGetLastRealTimeMetalQuotes
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetLastRealTimeMetalQuotes
 * @date 08/07/2012
 */
class XiMetalsTypeGetLastRealTimeMetalQuotes extends XiMetalsWsdlClass
{
	/**
	 * The Types
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetLastRealTimeMetalQuotes
	 */
