<?php
/**
 * Class file for XiMetalsTypeGetIntradayMetalFutureChart
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetIntradayMetalFutureChart
 * @date 08/07/2012
 */
class XiMetalsTypeGetIntradayMetalFutureChart extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiMetalsTypeGetIntradayMetalFutureChart
	 */
	public function __construct($_Type,$_StartTime = null,$_EndTime = null,$_Style,$_Width,$_Height,$_Preset = null)
	{
		parent::__construct(array('Type'=>$_Type,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Preset'=>$_Preset));
	}
	/**
	 * Set Type
