<?php
/**
 * Class file for XiMetalsTypeGetMetalSpotChart
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetMetalSpotChart
 * @date 08/07/2012
 */
class XiMetalsTypeGetMetalSpotChart extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiMetalsTypeGetMetalSpotChart
	 */
