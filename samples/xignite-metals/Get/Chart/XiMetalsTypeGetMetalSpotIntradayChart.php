<?php
/**
 * Class file for XiMetalsTypeGetMetalSpotIntradayChart
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetMetalSpotIntradayChart
 * @date 08/07/2012
 */
class XiMetalsTypeGetMetalSpotIntradayChart extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @param string Preset
	 * @return XiMetalsTypeGetMetalSpotIntradayChart
	 */
	public function __construct($_Type,$_Currency,$_StartTime = null,$_EndTime = null,$_TimeZone = null,$_Style,$_Width,$_Height,$_PeriodType = null,$_TickPeriods,$_Preset = null)
	{
		parent::__construct(array('Type'=>$_Type,'Currency'=>$_Currency,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'TimeZone'=>$_TimeZone,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'PeriodType'=>$_PeriodType,'TickPeriods'=>$_TickPeriods,'Preset'=>$_Preset));
	}
	/**
	 * Set Type
