<?php
/**
 * Class file for XiMetalsTypeGetHistoricalMetalFutureChartBinary
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetHistoricalMetalFutureChartBinary
 * @date 08/07/2012
 */
class XiMetalsTypeGetHistoricalMetalFutureChartBinary extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiMetalsTypeGetHistoricalMetalFutureChartBinary
	 */
