<?php
/**
 * Class file for XiMetalsTypeGetMetalSpotChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetMetalSpotChartCustomBinary
 * @date 08/07/2012
 */
class XiMetalsTypeGetMetalSpotChartCustomBinary extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetMetalSpotChartCustomBinary
	 */
