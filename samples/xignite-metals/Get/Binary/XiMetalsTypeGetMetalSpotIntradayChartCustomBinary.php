<?php
/**
 * Class file for XiMetalsTypeGetMetalSpotIntradayChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetMetalSpotIntradayChartCustomBinary
 * @date 08/07/2012
 */
class XiMetalsTypeGetMetalSpotIntradayChartCustomBinary extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetMetalSpotIntradayChartCustomBinary
	 */
