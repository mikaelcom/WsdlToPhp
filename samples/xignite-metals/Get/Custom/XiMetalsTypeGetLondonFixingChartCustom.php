<?php
/**
 * Class file for XiMetalsTypeGetLondonFixingChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetLondonFixingChartCustom
 * @date 08/07/2012
 */
class XiMetalsTypeGetLondonFixingChartCustom extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetLondonFixingChartCustom
	 */
	public function __construct($_Type,$_PeriodType,$_Currency,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height,$_Design = null)
	{
		parent::__construct(array('Type'=>$_Type,'PeriodType'=>$_PeriodType,'Currency'=>$_Currency,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Design'=>$_Design));
	}
	/**
	 * Set Type
