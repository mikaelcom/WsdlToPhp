<?php
/**
 * Class file for XiMetalsTypeGetIntradayMetalFutureChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetIntradayMetalFutureChartCustom
 * @date 08/07/2012
 */
class XiMetalsTypeGetIntradayMetalFutureChartCustom extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetIntradayMetalFutureChartCustom
	 */
