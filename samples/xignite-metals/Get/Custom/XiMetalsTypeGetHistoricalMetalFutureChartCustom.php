<?php
/**
 * Class file for XiMetalsTypeGetHistoricalMetalFutureChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetHistoricalMetalFutureChartCustom
 * @date 08/07/2012
 */
class XiMetalsTypeGetHistoricalMetalFutureChartCustom extends XiMetalsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetHistoricalMetalFutureChartCustom
	 */
