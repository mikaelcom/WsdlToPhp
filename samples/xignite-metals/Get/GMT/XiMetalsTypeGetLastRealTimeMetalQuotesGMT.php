<?php
/**
 * Class file for XiMetalsTypeGetLastRealTimeMetalQuotesGMT
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeGetLastRealTimeMetalQuotesGMT
 * @date 08/07/2012
 */
class XiMetalsTypeGetLastRealTimeMetalQuotesGMT extends XiMetalsWsdlClass
{
	/**
	 * The Types
	 * Meta informations :
	 ...
	 * @return XiMetalsTypeGetLastRealTimeMetalQuotesGMT
	 */
