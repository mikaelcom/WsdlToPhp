<?php
/**
 * Class file for XiMetalsTypeBaseMetalPrice
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeBaseMetalPrice
 * @date 08/07/2012
 */
class XiMetalsTypeBaseMetalPrice extends XiMetalsTypeCommon
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 */
	public function __construct($_Type,$_Symbol = null,$_Currency,$_Date = null,$_Time = null,$_Value,$_Unit = null,$_Source = null)
	{
		XiMetalsWsdlClass::__construct(array('Type'=>$_Type,'Symbol'=>$_Symbol,'Currency'=>$_Currency,'Date'=>$_Date,'Time'=>$_Time,'Value'=>$_Value,'Unit'=>$_Unit,'Source'=>$_Source));
	}
	/**
	 * Set Type
