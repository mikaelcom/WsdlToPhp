<?php
/**
 * Class file for XiMetalsTypeIntradayChart
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeIntradayChart
 * @date 08/07/2012
 */
class XiMetalsTypeIntradayChart extends XiMetalsTypeStockChart
{
	/**
	 * The Future
	 * Meta informations :
	...
	{
		XiMetalsWsdlClass::__construct(array('Future'=>$_Future,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'Width'=>$_Width,'Height'=>$_Height,'Title'=>$_Title,'Style'=>$_Style,'Url'=>$_Url));
	}
	/**
	 * Set Future
	 * @param Future Future
