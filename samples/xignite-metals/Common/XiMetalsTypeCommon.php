<?php
/**
 * Class file for XiMetalsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiMetalsTypeCommon
 * @date 08/07/2012
 */
class XiMetalsTypeCommon extends XiMetalsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiMetalsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiMetalsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiMetalsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiMetalsTypeOutcomeTypes
	 */
