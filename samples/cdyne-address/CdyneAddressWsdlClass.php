...
class CdyneAddressWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	...
	/**
	 * Constructor
	 * @uses CdyneAddressWsdlClass::setLastError()
	 * @uses CdyneAddressWsdlClass::initSoapClient()
	 * @uses CdyneAddressWsdlClass::initInternArrayToIterate()
	 * @uses CdyneAddressWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneAddressWsdlClass::classMap()
	 * @uses CdyneAddressWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneAddressClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneAddressClassMap::classMap();
	 ...
	 * @uses CdyneAddressWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneAddressWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneAddressWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneAddressWsdlClass::WSDL_ENCODING
	 * @uses CdyneAddressWsdlClass::WSDL_EXCPTS
	 * @uses CdyneAddressWsdlClass::WSDL_FEATURES
	 * @uses CdyneAddressWsdlClass::WSDL_LOGIN
	 * @uses CdyneAddressWsdlClass::WSDL_PASSWD
	 * @uses CdyneAddressWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneAddressWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneAddressWsdlClass::WSDL_TRACE
	 * @uses CdyneAddressWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneAddressWsdlClass::WSDL_URL
	 * @uses CdyneAddressWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneAddressWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneAddressWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneAddressWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneAddressWsdlClass::offsetExists()
	 ...
	 * @uses CdyneAddressWsdlClass::getAttributeName()
	 * @uses CdyneAddressWsdlClass::__toString()
	 * @uses CdyneAddressWsdlClass::_set()
	 * @uses CdyneAddressWsdlClass::_get()
	 * @uses CdyneAddressWsdlClass::setInternArrayToIterate()
	 * @uses CdyneAddressWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneAddressWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::item()
	 * @uses CdyneAddressWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneAddressWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneAddressWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
