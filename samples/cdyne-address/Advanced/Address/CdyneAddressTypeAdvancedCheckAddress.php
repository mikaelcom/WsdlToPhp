<?php
/**
 * Class file for CdyneAddressTypeAdvancedCheckAddress
 * @date 02/07/2012
 */
/**
 * Class CdyneAddressTypeAdvancedCheckAddress
 * @date 02/07/2012
 */
class CdyneAddressTypeAdvancedCheckAddress extends CdyneAddressWsdlClass
{
	/**
	 * The AddressLine
	 * Meta informations :
	 ...
	 * @return CdyneAddressTypeAdvancedCheckAddress
	 */
