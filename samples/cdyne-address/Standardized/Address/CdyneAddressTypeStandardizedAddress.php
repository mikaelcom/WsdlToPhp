<?php
/**
 * Class file for CdyneAddressTypeStandardizedAddress
 * @date 02/07/2012
 */
/**
 * Class CdyneAddressTypeStandardizedAddress
 * @date 02/07/2012
 */
class CdyneAddressTypeStandardizedAddress extends CdyneAddressWsdlClass
{
	/**
	 * The addressToCheck
	 * Meta informations :
	 ...
	 * @return CdyneAddressTypeStandardizedAddress
	 */
