<?php
/**
 * File for RFHCPCSWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFHCPCSWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFHCPCSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFHCPCSWsdlClass::setLastError()
	 * @uses RFHCPCSWsdlClass::initSoapClient()
	 * @uses RFHCPCSWsdlClass::initInternArrayToIterate()
	 * @uses RFHCPCSWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFHCPCSWsdlClass::classMap()
	 * @uses RFHCPCSWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFHCPCSClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFHCPCSClassMap::classMap();
	 ...
	 * @uses RFHCPCSWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFHCPCSWsdlClass::WSDL_COMPRESSION
	 * @uses RFHCPCSWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFHCPCSWsdlClass::WSDL_ENCODING
	 * @uses RFHCPCSWsdlClass::WSDL_EXCPTS
	 * @uses RFHCPCSWsdlClass::WSDL_FEATURES
	 * @uses RFHCPCSWsdlClass::WSDL_LOGIN
	 * @uses RFHCPCSWsdlClass::WSDL_PASSWD
	 * @uses RFHCPCSWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFHCPCSWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFHCPCSWsdlClass::WSDL_TRACE
	 * @uses RFHCPCSWsdlClass::WSDL_TYPEMAP
	 * @uses RFHCPCSWsdlClass::WSDL_URL
	 * @uses RFHCPCSWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses RFHCPCSWsdlClass::internArrayToIterateIsArray()
	 * @uses RFHCPCSWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFHCPCSWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFHCPCSWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFHCPCSWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFHCPCSWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFHCPCSWsdlClass::offsetExists()
	 ...
	 * @uses RFHCPCSWsdlClass::getAttributeName()
	 * @uses RFHCPCSWsdlClass::__toString()
	 * @uses RFHCPCSWsdlClass::_set()
	 * @uses RFHCPCSWsdlClass::_get()
	 * @uses RFHCPCSWsdlClass::setInternArrayToIterate()
	 * @uses RFHCPCSWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFHCPCSWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFHCPCSWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFHCPCSWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
