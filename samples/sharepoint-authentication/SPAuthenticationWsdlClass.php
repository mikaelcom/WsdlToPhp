<?php
/**
 * File for SPAuthenticationWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPAuthenticationWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPAuthenticationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPAuthenticationWsdlClass::setLastError()
	 * @uses SPAuthenticationWsdlClass::initSoapClient()
	 * @uses SPAuthenticationWsdlClass::initInternArrayToIterate()
	 * @uses SPAuthenticationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPAuthenticationWsdlClass::classMap()
	 * @uses SPAuthenticationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPAuthenticationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPAuthenticationClassMap::classMap();
	 ...
	 * @uses SPAuthenticationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPAuthenticationWsdlClass::WSDL_COMPRESSION
	 * @uses SPAuthenticationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPAuthenticationWsdlClass::WSDL_ENCODING
	 * @uses SPAuthenticationWsdlClass::WSDL_EXCPTS
	 * @uses SPAuthenticationWsdlClass::WSDL_FEATURES
	 * @uses SPAuthenticationWsdlClass::WSDL_LOGIN
	 * @uses SPAuthenticationWsdlClass::WSDL_PASSWD
	 * @uses SPAuthenticationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPAuthenticationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPAuthenticationWsdlClass::WSDL_TRACE
	 * @uses SPAuthenticationWsdlClass::WSDL_TYPEMAP
	 * @uses SPAuthenticationWsdlClass::WSDL_URL
	 * @uses SPAuthenticationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPAuthenticationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::internArrayToIterateIsArray()
	 * @uses SPAuthenticationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPAuthenticationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPAuthenticationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPAuthenticationWsdlClass::offsetGet()
	 * @uses SPAuthenticationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::getAttributeName()
	 * @uses SPAuthenticationWsdlClass::__toString()
	 * @uses SPAuthenticationWsdlClass::_set()
	 * @uses SPAuthenticationWsdlClass::_get()
	 * @uses SPAuthenticationWsdlClass::setInternArrayToIterate()
	 * @uses SPAuthenticationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPAuthenticationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::item()
	 * @uses SPAuthenticationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPAuthenticationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPAuthenticationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
