<?php
/**
 * File for SOTelVerificationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOTelVerificationWsdlClass to communicate with SOAP service
 * Documentation : For more information on our web services, visit us at <a href='http://www.serviceobjects.com/products/product-overview' target='new'>our website</a><br/><br/><a href='http://www.serviceobjects.com' target='new'><img src='http://www.serviceobjects.com/images/so_logo_2_inside.gif' border='0'/></a>
 * @date 08/07/2012
 */
class SOTelVerificationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOTelVerificationWsdlClass::setLastError()
	 * @uses SOTelVerificationWsdlClass::initSoapClient()
	 * @uses SOTelVerificationWsdlClass::initInternArrayToIterate()
	 * @uses SOTelVerificationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOTelVerificationWsdlClass::classMap()
	 * @uses SOTelVerificationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOTelVerificationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOTelVerificationClassMap::classMap();
	 ...
	 * @uses SOTelVerificationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOTelVerificationWsdlClass::WSDL_COMPRESSION
	 * @uses SOTelVerificationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOTelVerificationWsdlClass::WSDL_ENCODING
	 * @uses SOTelVerificationWsdlClass::WSDL_EXCPTS
	 * @uses SOTelVerificationWsdlClass::WSDL_FEATURES
	 * @uses SOTelVerificationWsdlClass::WSDL_LOGIN
	 * @uses SOTelVerificationWsdlClass::WSDL_PASSWD
	 * @uses SOTelVerificationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOTelVerificationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOTelVerificationWsdlClass::WSDL_TRACE
	 * @uses SOTelVerificationWsdlClass::WSDL_TYPEMAP
	 * @uses SOTelVerificationWsdlClass::WSDL_URL
	 * @uses SOTelVerificationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOTelVerificationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::internArrayToIterateIsArray()
	 * @uses SOTelVerificationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOTelVerificationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOTelVerificationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOTelVerificationWsdlClass::offsetGet()
	 * @uses SOTelVerificationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::getAttributeName()
	 * @uses SOTelVerificationWsdlClass::__toString()
	 * @uses SOTelVerificationWsdlClass::_set()
	 * @uses SOTelVerificationWsdlClass::_get()
	 * @uses SOTelVerificationWsdlClass::setInternArrayToIterate()
	 * @uses SOTelVerificationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOTelVerificationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::item()
	 * @uses SOTelVerificationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOTelVerificationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOTelVerificationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
