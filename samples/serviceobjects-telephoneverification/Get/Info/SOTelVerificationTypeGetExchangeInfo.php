<?php
/**
 * Class file for SOTelVerificationTypeGetExchangeInfo
 * @date 08/07/2012
 */
/**
 * Class SOTelVerificationTypeGetExchangeInfo
 * @date 08/07/2012
 */
class SOTelVerificationTypeGetExchangeInfo extends SOTelVerificationWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOTelVerificationTypeGetExchangeInfo
	 */
