<?php
/**
 * Class file for SOTelVerificationTypeGetPhoneInfo
 * @date 08/07/2012
 */
/**
 * Class SOTelVerificationTypeGetPhoneInfo
 * @date 08/07/2012
 */
class SOTelVerificationTypeGetPhoneInfo extends SOTelVerificationWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOTelVerificationTypeGetPhoneInfo
	 */
