<?php
/**
 * File for RFAirportWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFAirportWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFAirportWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFAirportWsdlClass::setLastError()
	 * @uses RFAirportWsdlClass::initSoapClient()
	 * @uses RFAirportWsdlClass::initInternArrayToIterate()
	 * @uses RFAirportWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFAirportWsdlClass::classMap()
	 * @uses RFAirportWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFAirportClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFAirportClassMap::classMap();
	 ...
	 * @uses RFAirportWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFAirportWsdlClass::WSDL_COMPRESSION
	 * @uses RFAirportWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFAirportWsdlClass::WSDL_ENCODING
	 * @uses RFAirportWsdlClass::WSDL_EXCPTS
	 * @uses RFAirportWsdlClass::WSDL_FEATURES
	 * @uses RFAirportWsdlClass::WSDL_LOGIN
	 * @uses RFAirportWsdlClass::WSDL_PASSWD
	 * @uses RFAirportWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFAirportWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFAirportWsdlClass::WSDL_TRACE
	 * @uses RFAirportWsdlClass::WSDL_TYPEMAP
	 * @uses RFAirportWsdlClass::WSDL_URL
	 * @uses RFAirportWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses RFAirportWsdlClass::internArrayToIterateIsArray()
	 * @uses RFAirportWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFAirportWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFAirportWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFAirportWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFAirportWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFAirportWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see RFAirportWsdlClass::offsetGet()
	 * @uses RFAirportWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses RFAirportWsdlClass::getAttributeName()
	 * @uses RFAirportWsdlClass::__toString()
	 * @uses RFAirportWsdlClass::_set()
	 * @uses RFAirportWsdlClass::_get()
	 * @uses RFAirportWsdlClass::setInternArrayToIterate()
	 * @uses RFAirportWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFAirportWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFAirportWsdlClass::item()
	 * @uses RFAirportWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses RFAirportWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFAirportWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
