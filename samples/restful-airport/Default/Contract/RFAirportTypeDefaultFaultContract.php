<?php
/**
 * Class file for RFAirportTypeDefaultFaultContract
 * @date 15/08/2012
 */
/**
 * Class RFAirportTypeDefaultFaultContract
 * @date 15/08/2012
 */
class RFAirportTypeDefaultFaultContract extends RFAirportWsdlClass
{
	/**
	 * The ErrorId
	 * @var int
	 ...
	 * @param RFAirportTypeGuid CorrelationId
	 * @return RFAirportTypeDefaultFaultContract
	 */
