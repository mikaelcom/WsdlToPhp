<?php
/**
 * File for CdyneDeathIndexWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for CdyneDeathIndexWsdlClass to communicate with SOAP service
 ...
 * @date 03/07/2012
 */
class CdyneDeathIndexWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdyneDeathIndexWsdlClass::setLastError()
	 * @uses CdyneDeathIndexWsdlClass::initSoapClient()
	 * @uses CdyneDeathIndexWsdlClass::initInternArrayToIterate()
	 * @uses CdyneDeathIndexWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneDeathIndexWsdlClass::classMap()
	 * @uses CdyneDeathIndexWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneDeathIndexClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneDeathIndexClassMap::classMap();
	 ...
	 * @uses CdyneDeathIndexWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneDeathIndexWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneDeathIndexWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneDeathIndexWsdlClass::WSDL_ENCODING
	 * @uses CdyneDeathIndexWsdlClass::WSDL_EXCPTS
	 * @uses CdyneDeathIndexWsdlClass::WSDL_FEATURES
	 * @uses CdyneDeathIndexWsdlClass::WSDL_LOGIN
	 * @uses CdyneDeathIndexWsdlClass::WSDL_PASSWD
	 * @uses CdyneDeathIndexWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneDeathIndexWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneDeathIndexWsdlClass::WSDL_TRACE
	 * @uses CdyneDeathIndexWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneDeathIndexWsdlClass::WSDL_URL
	 * @uses CdyneDeathIndexWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneDeathIndexWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneDeathIndexWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneDeathIndexWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneDeathIndexWsdlClass::offsetExists()
	 ...
	 * @uses CdyneDeathIndexWsdlClass::getAttributeName()
	 * @uses CdyneDeathIndexWsdlClass::__toString()
	 * @uses CdyneDeathIndexWsdlClass::_set()
	 * @uses CdyneDeathIndexWsdlClass::_get()
	 * @uses CdyneDeathIndexWsdlClass::setInternArrayToIterate()
	 * @uses CdyneDeathIndexWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneDeathIndexWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::item()
	 * @uses CdyneDeathIndexWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDeathIndexWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneDeathIndexWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
