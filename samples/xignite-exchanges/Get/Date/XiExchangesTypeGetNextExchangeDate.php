<?php
/**
 * Class file for XiExchangesTypeGetNextExchangeDate
 * @date 08/07/2012
 */
/**
 * Class XiExchangesTypeGetNextExchangeDate
 * @date 08/07/2012
 */
class XiExchangesTypeGetNextExchangeDate extends XiExchangesWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @return XiExchangesTypeGetNextExchangeDate
	 */
