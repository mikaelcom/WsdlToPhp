<?php
/**
 * Class file for XiExchangesTypeGetPriorExchangeDate
 * @date 08/07/2012
 */
/**
 * Class XiExchangesTypeGetPriorExchangeDate
 * @date 08/07/2012
 */
class XiExchangesTypeGetPriorExchangeDate extends XiExchangesWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @return XiExchangesTypeGetPriorExchangeDate
	 */
