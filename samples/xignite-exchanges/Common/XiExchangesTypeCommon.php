<?php
/**
 * Class file for XiExchangesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiExchangesTypeCommon
 * @date 08/07/2012
 */
class XiExchangesTypeCommon extends XiExchangesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiExchangesTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiExchangesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiExchangesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiExchangesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiExchangesTypeOutcomeTypes
	 */
