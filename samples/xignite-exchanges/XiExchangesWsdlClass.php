<?php
/**
 * File for XiExchangesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiExchangesWsdlClass to communicate with SOAP service
 * Documentation : Provide information about securities exchanges around the world.
 * @date 08/07/2012
 */
class XiExchangesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiExchangesWsdlClass::setLastError()
	 * @uses XiExchangesWsdlClass::initSoapClient()
	 * @uses XiExchangesWsdlClass::initInternArrayToIterate()
	 * @uses XiExchangesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiExchangesWsdlClass::classMap()
	 * @uses XiExchangesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiExchangesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiExchangesClassMap::classMap();
	 ...
	 * @uses XiExchangesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiExchangesWsdlClass::WSDL_COMPRESSION
	 * @uses XiExchangesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiExchangesWsdlClass::WSDL_ENCODING
	 * @uses XiExchangesWsdlClass::WSDL_EXCPTS
	 * @uses XiExchangesWsdlClass::WSDL_FEATURES
	 * @uses XiExchangesWsdlClass::WSDL_LOGIN
	 * @uses XiExchangesWsdlClass::WSDL_PASSWD
	 * @uses XiExchangesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiExchangesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiExchangesWsdlClass::WSDL_TRACE
	 * @uses XiExchangesWsdlClass::WSDL_TYPEMAP
	 * @uses XiExchangesWsdlClass::WSDL_URL
	 * @uses XiExchangesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiExchangesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiExchangesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiExchangesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiExchangesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiExchangesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiExchangesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiExchangesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiExchangesWsdlClass::offsetExists()
	 ...
	 * @uses XiExchangesWsdlClass::getAttributeName()
	 * @uses XiExchangesWsdlClass::__toString()
	 * @uses XiExchangesWsdlClass::_set()
	 * @uses XiExchangesWsdlClass::_get()
	 * @uses XiExchangesWsdlClass::setInternArrayToIterate()
	 * @uses XiExchangesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiExchangesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiExchangesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiExchangesWsdlClass::item()
	 * @uses XiExchangesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiExchangesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiExchangesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
