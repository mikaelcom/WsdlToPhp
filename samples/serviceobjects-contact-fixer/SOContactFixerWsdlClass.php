<?php
/**
 * File for SOContactFixerWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOContactFixerWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOContactFixerWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOContactFixerWsdlClass::setLastError()
	 * @uses SOContactFixerWsdlClass::initSoapClient()
	 * @uses SOContactFixerWsdlClass::initInternArrayToIterate()
	 * @uses SOContactFixerWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOContactFixerWsdlClass::classMap()
	 * @uses SOContactFixerWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOContactFixerClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOContactFixerClassMap::classMap();
	 ...
	 * @uses SOContactFixerWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOContactFixerWsdlClass::WSDL_COMPRESSION
	 * @uses SOContactFixerWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOContactFixerWsdlClass::WSDL_ENCODING
	 * @uses SOContactFixerWsdlClass::WSDL_EXCPTS
	 * @uses SOContactFixerWsdlClass::WSDL_FEATURES
	 * @uses SOContactFixerWsdlClass::WSDL_LOGIN
	 * @uses SOContactFixerWsdlClass::WSDL_PASSWD
	 * @uses SOContactFixerWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOContactFixerWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOContactFixerWsdlClass::WSDL_TRACE
	 * @uses SOContactFixerWsdlClass::WSDL_TYPEMAP
	 * @uses SOContactFixerWsdlClass::WSDL_URL
	 * @uses SOContactFixerWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOContactFixerWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::internArrayToIterateIsArray()
	 * @uses SOContactFixerWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOContactFixerWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOContactFixerWsdlClass::offsetExists()
	 ...
	 * @uses SOContactFixerWsdlClass::getAttributeName()
	 * @uses SOContactFixerWsdlClass::__toString()
	 * @uses SOContactFixerWsdlClass::_set()
	 * @uses SOContactFixerWsdlClass::_get()
	 * @uses SOContactFixerWsdlClass::setInternArrayToIterate()
	 * @uses SOContactFixerWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOContactFixerWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::item()
	 * @uses SOContactFixerWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOContactFixerWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOContactFixerWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
