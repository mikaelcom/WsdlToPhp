<?php
/**
 * File for CdyneDemographicsQWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for CdyneDemographicsQWsdlClass to communicate with SOAP service
 * Documentation : CDYNE’s Demographics® is a neighborhood level segmentation system built using various data sources in one combined database. By classifying all U.S. neighborhoods according to consumers’ different stages of life and related income levels, it provides a current, accurate and consistent framework to view customers at a neighborhood level. It enables users to compare customers across their product mix, across time and across their enterprise. With high coverage, Demographix also enables users to see differences in how U.S. neighborhoods spend time and money. This turns raw data about customers into accurate, actionable information. Use a Licensekey of 0 for testing.
 * @date 03/07/2012
 */
class CdyneDemographicsQWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdyneDemographicsQWsdlClass::setLastError()
	 * @uses CdyneDemographicsQWsdlClass::initSoapClient()
	 * @uses CdyneDemographicsQWsdlClass::initInternArrayToIterate()
	 * @uses CdyneDemographicsQWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneDemographicsQWsdlClass::classMap()
	 * @uses CdyneDemographicsQWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneDemographicsQClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneDemographicsQClassMap::classMap();
	 ...
	 * @uses CdyneDemographicsQWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneDemographicsQWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneDemographicsQWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneDemographicsQWsdlClass::WSDL_ENCODING
	 * @uses CdyneDemographicsQWsdlClass::WSDL_EXCPTS
	 * @uses CdyneDemographicsQWsdlClass::WSDL_FEATURES
	 * @uses CdyneDemographicsQWsdlClass::WSDL_LOGIN
	 * @uses CdyneDemographicsQWsdlClass::WSDL_PASSWD
	 * @uses CdyneDemographicsQWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneDemographicsQWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneDemographicsQWsdlClass::WSDL_TRACE
	 * @uses CdyneDemographicsQWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneDemographicsQWsdlClass::WSDL_URL
	 * @uses CdyneDemographicsQWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneDemographicsQWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneDemographicsQWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneDemographicsQWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneDemographicsQWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see CdyneDemographicsQWsdlClass::offsetGet()
	 * @uses CdyneDemographicsQWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::getAttributeName()
	 * @uses CdyneDemographicsQWsdlClass::__toString()
	 * @uses CdyneDemographicsQWsdlClass::_set()
	 * @uses CdyneDemographicsQWsdlClass::_get()
	 * @uses CdyneDemographicsQWsdlClass::setInternArrayToIterate()
	 * @uses CdyneDemographicsQWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneDemographicsQWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::item()
	 * @uses CdyneDemographicsQWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneDemographicsQWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneDemographicsQWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
