<?php
/**
 * Class file for CdyneDemographicsQTypeGetIncomeHouseValueByAddress
 * @date 03/07/2012
 */
/**
 * Class CdyneDemographicsQTypeGetIncomeHouseValueByAddress
 * @date 03/07/2012
 */
class CdyneDemographicsQTypeGetIncomeHouseValueByAddress extends CdyneDemographicsQWsdlClass
{
	/**
	 * The AddressLine1
	 * Meta informations :
	 ...
	 * @return CdyneDemographicsQTypeGetIncomeHouseValueByAddress
	 */
