<?php
/**
 * Class file for CdyneDemographicsQTypeGetNeighborhoodAgeInDataSet
 * @date 03/07/2012
 */
/**
 * Class CdyneDemographicsQTypeGetNeighborhoodAgeInDataSet
 * @date 03/07/2012
 */
class CdyneDemographicsQTypeGetNeighborhoodAgeInDataSet extends CdyneDemographicsQWsdlClass
{
	/**
	 * The StateAbbrev
	 * Meta informations :
	 ...
	 * @return CdyneDemographicsQTypeGetNeighborhoodAgeInDataSet
	 */
