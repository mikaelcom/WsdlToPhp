<?php
/**
 * Class file for CdyneDemographicsQTypeGetNeighborhoodAgeGenderFemaleInDataSet
 * @date 03/07/2012
 */
/**
 * Class CdyneDemographicsQTypeGetNeighborhoodAgeGenderFemaleInDataSet
 * @date 03/07/2012
 */
class CdyneDemographicsQTypeGetNeighborhoodAgeGenderFemaleInDataSet extends CdyneDemographicsQWsdlClass
{
	/**
	 * The StateAbbrev
	 * Meta informations :
	 ...
	 * @return CdyneDemographicsQTypeGetNeighborhoodAgeGenderFemaleInDataSet
	 */
