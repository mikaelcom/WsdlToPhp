<?php
/**
 * Class file for CdyneDemographicsQTypeGetNeighborhoodRealtyValueInDataSet
 * @date 03/07/2012
 */
/**
 * Class CdyneDemographicsQTypeGetNeighborhoodRealtyValueInDataSet
 * @date 03/07/2012
 */
class CdyneDemographicsQTypeGetNeighborhoodRealtyValueInDataSet extends CdyneDemographicsQWsdlClass
{
	/**
	 * The StateAbbrev
	 * Meta informations :
	 ...
	 * @return CdyneDemographicsQTypeGetNeighborhoodRealtyValueInDataSet
	 */
