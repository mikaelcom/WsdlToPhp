<?php
/**
 * Class file for CdyneDemographicsQTypeGetSummaryInformationByPlaceID
 * @date 03/07/2012
 */
/**
 * Class CdyneDemographicsQTypeGetSummaryInformationByPlaceID
 * @date 03/07/2012
 */
class CdyneDemographicsQTypeGetSummaryInformationByPlaceID extends CdyneDemographicsQWsdlClass
{
	/**
	 * The StateAbbrev
	 * Meta informations :
	 ...
	 * @return CdyneDemographicsQTypeGetSummaryInformationByPlaceID
	 */
