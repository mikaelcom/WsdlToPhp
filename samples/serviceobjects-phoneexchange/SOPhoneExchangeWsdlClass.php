<?php
/**
 * File for SOPhoneExchangeWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOPhoneExchangeWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOPhoneExchangeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOPhoneExchangeWsdlClass::setLastError()
	 * @uses SOPhoneExchangeWsdlClass::initSoapClient()
	 * @uses SOPhoneExchangeWsdlClass::initInternArrayToIterate()
	 * @uses SOPhoneExchangeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOPhoneExchangeWsdlClass::classMap()
	 * @uses SOPhoneExchangeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOPhoneExchangeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOPhoneExchangeClassMap::classMap();
	 ...
	 * @uses SOPhoneExchangeWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOPhoneExchangeWsdlClass::WSDL_COMPRESSION
	 * @uses SOPhoneExchangeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOPhoneExchangeWsdlClass::WSDL_ENCODING
	 * @uses SOPhoneExchangeWsdlClass::WSDL_EXCPTS
	 * @uses SOPhoneExchangeWsdlClass::WSDL_FEATURES
	 * @uses SOPhoneExchangeWsdlClass::WSDL_LOGIN
	 * @uses SOPhoneExchangeWsdlClass::WSDL_PASSWD
	 * @uses SOPhoneExchangeWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOPhoneExchangeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOPhoneExchangeWsdlClass::WSDL_TRACE
	 * @uses SOPhoneExchangeWsdlClass::WSDL_TYPEMAP
	 * @uses SOPhoneExchangeWsdlClass::WSDL_URL
	 * @uses SOPhoneExchangeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOPhoneExchangeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::internArrayToIterateIsArray()
	 * @uses SOPhoneExchangeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPhoneExchangeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPhoneExchangeWsdlClass::offsetExists()
	 ...
	 * @uses SOPhoneExchangeWsdlClass::getAttributeName()
	 * @uses SOPhoneExchangeWsdlClass::__toString()
	 * @uses SOPhoneExchangeWsdlClass::_set()
	 * @uses SOPhoneExchangeWsdlClass::_get()
	 * @uses SOPhoneExchangeWsdlClass::setInternArrayToIterate()
	 * @uses SOPhoneExchangeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOPhoneExchangeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::item()
	 * @uses SOPhoneExchangeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneExchangeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOPhoneExchangeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
