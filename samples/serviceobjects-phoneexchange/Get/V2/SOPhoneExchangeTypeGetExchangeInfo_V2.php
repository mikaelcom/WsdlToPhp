<?php
/**
 * Class file for SOPhoneExchangeTypeGetExchangeInfo_V2
 * @date 08/07/2012
 */
/**
 * Class SOPhoneExchangeTypeGetExchangeInfo_V2
 * @date 08/07/2012
 */
class SOPhoneExchangeTypeGetExchangeInfo_V2 extends SOPhoneExchangeWsdlClass
{
	/**
	 * The PhoneNumbers
	 * Meta informations :
	 ...
	 * @return SOPhoneExchangeTypeGetExchangeInfo_V2
	 */
