<?php
/**
 * Class file for XiBATSRealTimeTypeStockChartStyles
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypeStockChartStyles
 * @date 08/07/2012
 */
class XiBATSRealTimeTypeStockChartStyles extends XiBATSRealTimeWsdlClass
{
	/**
