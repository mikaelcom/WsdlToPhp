<?php
/**
 * Class file for XiBATSRealTimeTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypeHeader
 * @date 08/07/2012
 */
class XiBATSRealTimeTypeHeader extends XiBATSRealTimeWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiBATSRealTimeTypeHeader
	 */
