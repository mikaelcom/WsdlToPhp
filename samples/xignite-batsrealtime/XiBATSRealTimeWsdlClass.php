<?php
/**
 * File for XiBATSRealTimeWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiBATSRealTimeWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class XiBATSRealTimeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiBATSRealTimeWsdlClass::setLastError()
	 * @uses XiBATSRealTimeWsdlClass::initSoapClient()
	 * @uses XiBATSRealTimeWsdlClass::initInternArrayToIterate()
	 * @uses XiBATSRealTimeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiBATSRealTimeWsdlClass::classMap()
	 * @uses XiBATSRealTimeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiBATSRealTimeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiBATSRealTimeClassMap::classMap();
	 ...
	 * @uses XiBATSRealTimeWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiBATSRealTimeWsdlClass::WSDL_COMPRESSION
	 * @uses XiBATSRealTimeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiBATSRealTimeWsdlClass::WSDL_ENCODING
	 * @uses XiBATSRealTimeWsdlClass::WSDL_EXCPTS
	 * @uses XiBATSRealTimeWsdlClass::WSDL_FEATURES
	 * @uses XiBATSRealTimeWsdlClass::WSDL_LOGIN
	 * @uses XiBATSRealTimeWsdlClass::WSDL_PASSWD
	 * @uses XiBATSRealTimeWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiBATSRealTimeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiBATSRealTimeWsdlClass::WSDL_TRACE
	 * @uses XiBATSRealTimeWsdlClass::WSDL_TYPEMAP
	 * @uses XiBATSRealTimeWsdlClass::WSDL_URL
	 * @uses XiBATSRealTimeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiBATSRealTimeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::internArrayToIterateIsArray()
	 * @uses XiBATSRealTimeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBATSRealTimeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBATSRealTimeWsdlClass::offsetExists()
	 ...
	 * @uses XiBATSRealTimeWsdlClass::getAttributeName()
	 * @uses XiBATSRealTimeWsdlClass::__toString()
	 * @uses XiBATSRealTimeWsdlClass::_set()
	 * @uses XiBATSRealTimeWsdlClass::_get()
	 * @uses XiBATSRealTimeWsdlClass::setInternArrayToIterate()
	 * @uses XiBATSRealTimeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiBATSRealTimeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::item()
	 * @uses XiBATSRealTimeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiBATSRealTimeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiBATSRealTimeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
