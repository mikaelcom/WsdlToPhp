<?php
/**
 * Class file for XiBATSRealTimeTypeGetChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypeGetChartCustom
 * @date 08/07/2012
 */
class XiBATSRealTimeTypeGetChartCustom extends XiBATSRealTimeWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiBATSRealTimeTypeGetChartCustom
	 */
