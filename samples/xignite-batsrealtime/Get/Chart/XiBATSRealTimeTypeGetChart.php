<?php
/**
 * Class file for XiBATSRealTimeTypeGetChart
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypeGetChart
 * @date 08/07/2012
 */
class XiBATSRealTimeTypeGetChart extends XiBATSRealTimeWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiBATSRealTimeTypeGetChart
	 */
