<?php
/**
 * Class file for XiBATSRealTimeTypePredefinedProjection
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypePredefinedProjection
 * @date 08/07/2012
 */
class XiBATSRealTimeTypePredefinedProjection extends XiBATSRealTimeWsdlClass
{
	/**
