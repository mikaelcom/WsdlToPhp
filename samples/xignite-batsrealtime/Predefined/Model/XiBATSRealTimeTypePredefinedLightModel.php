<?php
/**
 * Class file for XiBATSRealTimeTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiBATSRealTimeTypePredefinedLightModel extends XiBATSRealTimeWsdlClass
{
	/**
