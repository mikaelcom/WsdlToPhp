<?php
/**
 * Class file for XiBATSRealTimeTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypeSecurity
 * @date 08/07/2012
 */
class XiBATSRealTimeTypeSecurity extends XiBATSRealTimeTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiBATSRealTimeWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
