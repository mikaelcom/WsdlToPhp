<?php
/**
 * Class file for XiBATSRealTimeTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiBATSRealTimeTypeChartDesign
 * @date 08/07/2012
 */
class XiBATSRealTimeTypeChartDesign extends XiBATSRealTimeTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBATSRealTimeTypeLinePattern
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBATSRealTimeTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBATSRealTimeTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBATSRealTimeTypeTickPeriod
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBATSRealTimeTypeHorzAlign
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiBATSRealTimeTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiBATSRealTimeTypeLinePattern GridHorizontalStyle
	 * @param XiBATSRealTimeTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiBATSRealTimeTypeImageFrameType FrameType
	 * @param XiBATSRealTimeTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiBATSRealTimeTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiBATSRealTimeTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiBATSRealTimeTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiBATSRealTimeTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiBATSRealTimeTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiBATSRealTimeTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiBATSRealTimeTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	...
	{
		return ($this->Projection = XiBATSRealTimeTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiBATSRealTimeTypePredefinedProjection
	 */
	...
	{
		return ($this->TickPrecision = XiBATSRealTimeTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	 * @return XiBATSRealTimeTypeTickPeriod
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiBATSRealTimeTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	...
	{
		return ($this->LightScheme = XiBATSRealTimeTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiBATSRealTimeTypePredefinedLightModel
	 */
