<?php
/**
 * File for SODisconnectedWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SODisconnectedWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SODisconnectedWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SODisconnectedWsdlClass::setLastError()
	 * @uses SODisconnectedWsdlClass::initSoapClient()
	 * @uses SODisconnectedWsdlClass::initInternArrayToIterate()
	 * @uses SODisconnectedWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SODisconnectedWsdlClass::classMap()
	 * @uses SODisconnectedWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SODisconnectedClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SODisconnectedClassMap::classMap();
	 ...
	 * @uses SODisconnectedWsdlClass::WSDL_CACHE_WSDL
	 * @uses SODisconnectedWsdlClass::WSDL_COMPRESSION
	 * @uses SODisconnectedWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SODisconnectedWsdlClass::WSDL_ENCODING
	 * @uses SODisconnectedWsdlClass::WSDL_EXCPTS
	 * @uses SODisconnectedWsdlClass::WSDL_FEATURES
	 * @uses SODisconnectedWsdlClass::WSDL_LOGIN
	 * @uses SODisconnectedWsdlClass::WSDL_PASSWD
	 * @uses SODisconnectedWsdlClass::WSDL_SOAP_VERSION
	 * @uses SODisconnectedWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SODisconnectedWsdlClass::WSDL_TRACE
	 * @uses SODisconnectedWsdlClass::WSDL_TYPEMAP
	 * @uses SODisconnectedWsdlClass::WSDL_URL
	 * @uses SODisconnectedWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SODisconnectedWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::internArrayToIterateIsArray()
	 * @uses SODisconnectedWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::getInternArrayToIterateOffset()
	 * @uses SODisconnectedWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::getInternArrayToIterateOffset()
	 * @uses SODisconnectedWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SODisconnectedWsdlClass::offsetGet()
	 * @uses SODisconnectedWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::getAttributeName()
	 * @uses SODisconnectedWsdlClass::__toString()
	 * @uses SODisconnectedWsdlClass::_set()
	 * @uses SODisconnectedWsdlClass::_get()
	 * @uses SODisconnectedWsdlClass::setInternArrayToIterate()
	 * @uses SODisconnectedWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SODisconnectedWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::item()
	 * @uses SODisconnectedWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SODisconnectedWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SODisconnectedWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
