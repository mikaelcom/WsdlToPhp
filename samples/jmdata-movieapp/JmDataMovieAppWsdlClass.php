<?php
/**
 * File for JmDataMovieAppWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for JmDataMovieAppWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class JmDataMovieAppWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses JmDataMovieAppWsdlClass::setLastError()
	 * @uses JmDataMovieAppWsdlClass::initSoapClient()
	 * @uses JmDataMovieAppWsdlClass::initInternArrayToIterate()
	 * @uses JmDataMovieAppWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses JmDataMovieAppWsdlClass::classMap()
	 * @uses JmDataMovieAppWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('JmDataMovieAppClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = JmDataMovieAppClassMap::classMap();
	 ...
	 * @uses JmDataMovieAppWsdlClass::WSDL_CACHE_WSDL
	 * @uses JmDataMovieAppWsdlClass::WSDL_COMPRESSION
	 * @uses JmDataMovieAppWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses JmDataMovieAppWsdlClass::WSDL_ENCODING
	 * @uses JmDataMovieAppWsdlClass::WSDL_EXCPTS
	 * @uses JmDataMovieAppWsdlClass::WSDL_FEATURES
	 * @uses JmDataMovieAppWsdlClass::WSDL_LOGIN
	 * @uses JmDataMovieAppWsdlClass::WSDL_PASSWD
	 * @uses JmDataMovieAppWsdlClass::WSDL_SOAP_VERSION
	 * @uses JmDataMovieAppWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses JmDataMovieAppWsdlClass::WSDL_TRACE
	 * @uses JmDataMovieAppWsdlClass::WSDL_TYPEMAP
	 * @uses JmDataMovieAppWsdlClass::WSDL_URL
	 * @uses JmDataMovieAppWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses JmDataMovieAppWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::internArrayToIterateIsArray()
	 * @uses JmDataMovieAppWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::getInternArrayToIterateOffset()
	 * @uses JmDataMovieAppWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::getInternArrayToIterateOffset()
	 * @uses JmDataMovieAppWsdlClass::offsetExists()
	 ...
	 * @uses JmDataMovieAppWsdlClass::getAttributeName()
	 * @uses JmDataMovieAppWsdlClass::__toString()
	 * @uses JmDataMovieAppWsdlClass::_set()
	 * @uses JmDataMovieAppWsdlClass::_get()
	 * @uses JmDataMovieAppWsdlClass::setInternArrayToIterate()
	 * @uses JmDataMovieAppWsdlClass::setInternArrayToIterateIsArray()
	 * @uses JmDataMovieAppWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::item()
	 * @uses JmDataMovieAppWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses JmDataMovieAppWsdlClass::getInternArrayToIterateIsArray()
	 * @uses JmDataMovieAppWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
