<?php
/**
 * Class file for JmDataMovieAppTypeRemoveFavoriteStore
 * @date 10/07/2012
 */
/**
 * Class JmDataMovieAppTypeRemoveFavoriteStore
 * @date 10/07/2012
 */
class JmDataMovieAppTypeRemoveFavoriteStore extends JmDataMovieAppWsdlClass
{
	/**
	 * The APIKEY
	 * Meta informations :
	 ...
	 * @param int userID
	 * @param int storeID
	 * @return JmDataMovieAppTypeRemoveFavoriteStore
	 */
