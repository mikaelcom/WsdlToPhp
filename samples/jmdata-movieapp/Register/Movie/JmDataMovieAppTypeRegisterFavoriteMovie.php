<?php
/**
 * Class file for JmDataMovieAppTypeRegisterFavoriteMovie
 * @date 10/07/2012
 */
/**
 * Class JmDataMovieAppTypeRegisterFavoriteMovie
 * @date 10/07/2012
 */
class JmDataMovieAppTypeRegisterFavoriteMovie extends JmDataMovieAppWsdlClass
{
	/**
	 * The APIKEY
	 * Meta informations :
	 ...
	 * @param int userID
	 * @param int movieID
	 * @return JmDataMovieAppTypeRegisterFavoriteMovie
	 */
