<?php
/**
 * Class file for SOValidateCanadaTypeParseCanadianAddress
 * @date 05/07/2012
 */
/**
 * Class SOValidateCanadaTypeParseCanadianAddress
 * @date 05/07/2012
 */
class SOValidateCanadaTypeParseCanadianAddress extends SOValidateCanadaWsdlClass
{
	/**
	 * The Address
	 * Meta informations :
	 ...
	 * @return SOValidateCanadaTypeParseCanadianAddress
	 */
