<?php
/**
 * File for SOValidateCanadaWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for SOValidateCanadaWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class SOValidateCanadaWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOValidateCanadaWsdlClass::setLastError()
	 * @uses SOValidateCanadaWsdlClass::initSoapClient()
	 * @uses SOValidateCanadaWsdlClass::initInternArrayToIterate()
	 * @uses SOValidateCanadaWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOValidateCanadaWsdlClass::classMap()
	 * @uses SOValidateCanadaWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOValidateCanadaClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOValidateCanadaClassMap::classMap();
	 ...
	 * @uses SOValidateCanadaWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOValidateCanadaWsdlClass::WSDL_COMPRESSION
	 * @uses SOValidateCanadaWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOValidateCanadaWsdlClass::WSDL_ENCODING
	 * @uses SOValidateCanadaWsdlClass::WSDL_EXCPTS
	 * @uses SOValidateCanadaWsdlClass::WSDL_FEATURES
	 * @uses SOValidateCanadaWsdlClass::WSDL_LOGIN
	 * @uses SOValidateCanadaWsdlClass::WSDL_PASSWD
	 * @uses SOValidateCanadaWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOValidateCanadaWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOValidateCanadaWsdlClass::WSDL_TRACE
	 * @uses SOValidateCanadaWsdlClass::WSDL_TYPEMAP
	 * @uses SOValidateCanadaWsdlClass::WSDL_URL
	 * @uses SOValidateCanadaWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOValidateCanadaWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::internArrayToIterateIsArray()
	 * @uses SOValidateCanadaWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOValidateCanadaWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOValidateCanadaWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOValidateCanadaWsdlClass::offsetGet()
	 * @uses SOValidateCanadaWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::getAttributeName()
	 * @uses SOValidateCanadaWsdlClass::__toString()
	 * @uses SOValidateCanadaWsdlClass::_set()
	 * @uses SOValidateCanadaWsdlClass::_get()
	 * @uses SOValidateCanadaWsdlClass::setInternArrayToIterate()
	 * @uses SOValidateCanadaWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOValidateCanadaWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::item()
	 * @uses SOValidateCanadaWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOValidateCanadaWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOValidateCanadaWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
