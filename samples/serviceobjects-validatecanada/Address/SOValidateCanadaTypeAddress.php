<?php
/**
 * Class file for SOValidateCanadaTypeAddress
 * @date 05/07/2012
 */
/**
 * Class SOValidateCanadaTypeAddress
 * @date 05/07/2012
 */
class SOValidateCanadaTypeAddress extends SOValidateCanadaWsdlClass
{
	/**
	 * The Address
	 * Meta informations :
	 ...
	 */
	public function __construct($_Address = null,$_Municipality = null,$_Province = null,$_PostalCode = null,$_TimeZone = null,$_AddressNumberFragment = null,$_StreetNameFragment = null,$_StreetTypeFragment = null,$_DirectionalCodeFragment = null,$_UnitTypeFragment = null,$_UnitNumberFragment = null,$_IsPOBox = null,$_Error = null)
	{
		parent::__construct(array('Address'=>$_Address,'Municipality'=>$_Municipality,'Province'=>$_Province,'PostalCode'=>$_PostalCode,'TimeZone'=>$_TimeZone,'AddressNumberFragment'=>$_AddressNumberFragment,'StreetNameFragment'=>$_StreetNameFragment,'StreetTypeFragment'=>$_StreetTypeFragment,'DirectionalCodeFragment'=>$_DirectionalCodeFragment,'UnitTypeFragment'=>$_UnitTypeFragment,'UnitNumberFragment'=>$_UnitNumberFragment,'IsPOBox'=>$_IsPOBox,'Error'=>$_Error));
	}
	/**
	 * Set Address
	 * @param string Address
