<?php
/**
 * File for SOContactValidationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOContactValidationWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOContactValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOContactValidationWsdlClass::setLastError()
	 * @uses SOContactValidationWsdlClass::initSoapClient()
	 * @uses SOContactValidationWsdlClass::initInternArrayToIterate()
	 * @uses SOContactValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOContactValidationWsdlClass::classMap()
	 * @uses SOContactValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOContactValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOContactValidationClassMap::classMap();
	 ...
	 * @uses SOContactValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOContactValidationWsdlClass::WSDL_COMPRESSION
	 * @uses SOContactValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOContactValidationWsdlClass::WSDL_ENCODING
	 * @uses SOContactValidationWsdlClass::WSDL_EXCPTS
	 * @uses SOContactValidationWsdlClass::WSDL_FEATURES
	 * @uses SOContactValidationWsdlClass::WSDL_LOGIN
	 * @uses SOContactValidationWsdlClass::WSDL_PASSWD
	 * @uses SOContactValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOContactValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOContactValidationWsdlClass::WSDL_TRACE
	 * @uses SOContactValidationWsdlClass::WSDL_TYPEMAP
	 * @uses SOContactValidationWsdlClass::WSDL_URL
	 * @uses SOContactValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOContactValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses SOContactValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOContactValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOContactValidationWsdlClass::offsetExists()
	 ...
	 * @uses SOContactValidationWsdlClass::getAttributeName()
	 * @uses SOContactValidationWsdlClass::__toString()
	 * @uses SOContactValidationWsdlClass::_set()
	 * @uses SOContactValidationWsdlClass::_get()
	 * @uses SOContactValidationWsdlClass::setInternArrayToIterate()
	 * @uses SOContactValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOContactValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::item()
	 * @uses SOContactValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOContactValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOContactValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
