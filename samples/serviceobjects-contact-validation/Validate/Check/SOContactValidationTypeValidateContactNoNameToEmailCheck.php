<?php
/**
 * Class file for SOContactValidationTypeValidateContactNoNameToEmailCheck
 * @date 08/07/2012
 */
/**
 * Class SOContactValidationTypeValidateContactNoNameToEmailCheck
 * @date 08/07/2012
 */
class SOContactValidationTypeValidateContactNoNameToEmailCheck extends SOContactValidationWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return SOContactValidationTypeValidateContactNoNameToEmailCheck
	 */
