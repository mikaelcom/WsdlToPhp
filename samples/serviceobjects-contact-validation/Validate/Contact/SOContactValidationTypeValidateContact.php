<?php
/**
 * Class file for SOContactValidationTypeValidateContact
 * @date 08/07/2012
 */
/**
 * Class SOContactValidationTypeValidateContact
 * @date 08/07/2012
 */
class SOContactValidationTypeValidateContact extends SOContactValidationWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return SOContactValidationTypeValidateContact
	 */
