<?php
/**
 * File for EccVideoWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccVideoWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Video Web Services.
 * @date 03/07/2012
 */
class EccVideoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccVideoWsdlClass::setLastError()
	 * @uses EccVideoWsdlClass::initSoapClient()
	 * @uses EccVideoWsdlClass::initInternArrayToIterate()
	 * @uses EccVideoWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccVideoWsdlClass::classMap()
	 * @uses EccVideoWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccVideoClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccVideoClassMap::classMap();
	 ...
	 * @uses EccVideoWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccVideoWsdlClass::WSDL_COMPRESSION
	 * @uses EccVideoWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccVideoWsdlClass::WSDL_ENCODING
	 * @uses EccVideoWsdlClass::WSDL_EXCPTS
	 * @uses EccVideoWsdlClass::WSDL_FEATURES
	 * @uses EccVideoWsdlClass::WSDL_LOGIN
	 * @uses EccVideoWsdlClass::WSDL_PASSWD
	 * @uses EccVideoWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccVideoWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccVideoWsdlClass::WSDL_TRACE
	 * @uses EccVideoWsdlClass::WSDL_TYPEMAP
	 * @uses EccVideoWsdlClass::WSDL_URL
	 * @uses EccVideoWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses EccVideoWsdlClass::internArrayToIterateIsArray()
	 * @uses EccVideoWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccVideoWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccVideoWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccVideoWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccVideoWsdlClass::offsetExists()
	 ...
	 * @uses EccVideoWsdlClass::getAttributeName()
	 * @uses EccVideoWsdlClass::__toString()
	 * @uses EccVideoWsdlClass::_set()
	 * @uses EccVideoWsdlClass::_get()
	 * @uses EccVideoWsdlClass::setInternArrayToIterate()
	 * @uses EccVideoWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccVideoWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccVideoWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccVideoWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
