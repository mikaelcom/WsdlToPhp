<?php
/**
 * Class file for EccVideoTypeGetExtendedVideo
 * @date 03/07/2012
 */
/**
 * Class EccVideoTypeGetExtendedVideo
 * @date 03/07/2012
 */
class EccVideoTypeGetExtendedVideo extends EccVideoWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccVideoTypeGetExtendedVideo
	 */
