<?php
/**
 * File for BingWsdlClass to communicate with SOAP service
 * @date 02/07/2012
 */
/**
 * File for BingWsdlClass to communicate with SOAP service
 ...
 * @date 02/07/2012
 */
class BingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses BingWsdlClass::setLastError()
	 * @uses BingWsdlClass::initSoapClient()
	 * @uses BingWsdlClass::initInternArrayToIterate()
	 * @uses BingWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses BingWsdlClass::classMap()
	 * @uses BingWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('BingClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = BingClassMap::classMap();
	 ...
	 * @uses BingWsdlClass::WSDL_CACHE_WSDL
	 * @uses BingWsdlClass::WSDL_COMPRESSION
	 * @uses BingWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses BingWsdlClass::WSDL_ENCODING
	 * @uses BingWsdlClass::WSDL_EXCPTS
	 * @uses BingWsdlClass::WSDL_FEATURES
	 * @uses BingWsdlClass::WSDL_LOGIN
	 * @uses BingWsdlClass::WSDL_PASSWD
	 * @uses BingWsdlClass::WSDL_SOAP_VERSION
	 * @uses BingWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses BingWsdlClass::WSDL_TRACE
	 * @uses BingWsdlClass::WSDL_TYPEMAP
	 * @uses BingWsdlClass::WSDL_URL
	 * @uses BingWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses BingWsdlClass::internArrayToIterateIsArray()
	 * @uses BingWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses BingWsdlClass::getInternArrayToIterateOffset()
	 * @uses BingWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses BingWsdlClass::getInternArrayToIterateOffset()
	 * @uses BingWsdlClass::offsetExists()
	 ...
	 * @uses BingWsdlClass::getAttributeName()
	 * @uses BingWsdlClass::__toString()
	 * @uses BingWsdlClass::_set()
	 * @uses BingWsdlClass::_get()
	 * @uses BingWsdlClass::setInternArrayToIterate()
	 * @uses BingWsdlClass::setInternArrayToIterateIsArray()
	 * @uses BingWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses BingWsdlClass::getInternArrayToIterateIsArray()
	 * @uses BingWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
