<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeGetEquityOptionBySymbol
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeGetEquityOptionBySymbol
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeGetEquityOptionBySymbol extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeoptionsTypeGetEquityOptionBySymbol
	 */
