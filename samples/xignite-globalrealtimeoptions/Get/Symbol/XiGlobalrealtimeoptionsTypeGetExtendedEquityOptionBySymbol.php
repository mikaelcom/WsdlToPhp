<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbol
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbol
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbol extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbol
	 */
