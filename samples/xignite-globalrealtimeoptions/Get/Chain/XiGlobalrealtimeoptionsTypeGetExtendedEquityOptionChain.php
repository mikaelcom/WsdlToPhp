<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionChain
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionChain
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionChain extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionChain
	 */
