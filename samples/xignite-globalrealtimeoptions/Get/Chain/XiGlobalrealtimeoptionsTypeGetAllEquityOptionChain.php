<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeGetAllEquityOptionChain
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeGetAllEquityOptionChain
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeGetAllEquityOptionChain extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeoptionsTypeGetAllEquityOptionChain
	 */
