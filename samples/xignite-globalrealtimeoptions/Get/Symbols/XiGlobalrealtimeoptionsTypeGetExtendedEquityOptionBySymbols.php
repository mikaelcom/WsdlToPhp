<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbols
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbols
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbols extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
	 * The Symbols
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeoptionsTypeGetExtendedEquityOptionBySymbols
	 */
