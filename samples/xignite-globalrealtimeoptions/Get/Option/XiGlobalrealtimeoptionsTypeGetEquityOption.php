<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeGetEquityOption
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeGetEquityOption
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeGetEquityOption extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalrealtimeoptionsTypeGetEquityOption
	 */
