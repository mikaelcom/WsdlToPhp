<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeQuickQuote
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeQuickQuote
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeQuickQuote extends XiGlobalrealtimeoptionsTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	...
	{
		XiGlobalrealtimeoptionsWsdlClass::__construct(array('Symbol'=>$_Symbol,'Date'=>$_Date,'Time'=>$_Time,'UTCDate'=>$_UTCDate,'UTCTime'=>$_UTCTime,'Last'=>$_Last,'Volume'=>$_Volume,'Change'=>$_Change,'Currency'=>$_Currency,'Exchange'=>$_Exchange));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
