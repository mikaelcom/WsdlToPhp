<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeSecurity
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeSecurity extends XiGlobalrealtimeoptionsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiGlobalrealtimeoptionsWsdlClass::__construct(array('CIK'=>$_CIK,'CUSIP'=>$_CUSIP,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'MarketIdentificationCode'=>$_MarketIdentificationCode,'MostLiquidExchange'=>$_MostLiquidExchange,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
