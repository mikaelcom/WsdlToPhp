<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeIdentifierTypes extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
