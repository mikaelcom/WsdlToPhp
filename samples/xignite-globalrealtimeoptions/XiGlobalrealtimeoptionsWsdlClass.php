<?php
/**
 * File for XiGlobalrealtimeoptionsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalrealtimeoptionsWsdlClass to communicate with SOAP service
 * Documentation : Complete stock option management application.
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalrealtimeoptionsWsdlClass::setLastError()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::initSoapClient()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalrealtimeoptionsWsdlClass::classMap()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalrealtimeoptionsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalrealtimeoptionsClassMap::classMap();
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_TRACE
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_URL
	 * @uses XiGlobalrealtimeoptionsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalrealtimeoptionsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getAttributeName()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::__toString()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::_set()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::_get()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::item()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalrealtimeoptionsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
