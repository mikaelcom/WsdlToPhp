<?php
/**
 * Class file for XiGlobalrealtimeoptionsTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalrealtimeoptionsTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiGlobalrealtimeoptionsTypeOutcomeTypes extends XiGlobalrealtimeoptionsWsdlClass
{
	/**
