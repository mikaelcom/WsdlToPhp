<?php
/**
 * File for XWebOrderWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebOrderWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebOrderWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebOrderWsdlClass::setLastError()
	 * @uses XWebOrderWsdlClass::initSoapClient()
	 * @uses XWebOrderWsdlClass::initInternArrayToIterate()
	 * @uses XWebOrderWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebOrderWsdlClass::classMap()
	 * @uses XWebOrderWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebOrderClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebOrderClassMap::classMap();
	 ...
	 * @uses XWebOrderWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebOrderWsdlClass::WSDL_COMPRESSION
	 * @uses XWebOrderWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebOrderWsdlClass::WSDL_ENCODING
	 * @uses XWebOrderWsdlClass::WSDL_EXCPTS
	 * @uses XWebOrderWsdlClass::WSDL_FEATURES
	 * @uses XWebOrderWsdlClass::WSDL_LOGIN
	 * @uses XWebOrderWsdlClass::WSDL_PASSWD
	 * @uses XWebOrderWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebOrderWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebOrderWsdlClass::WSDL_TRACE
	 * @uses XWebOrderWsdlClass::WSDL_TYPEMAP
	 * @uses XWebOrderWsdlClass::WSDL_URL
	 * @uses XWebOrderWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XWebOrderWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebOrderWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebOrderWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebOrderWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebOrderWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebOrderWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebOrderWsdlClass::offsetGet()
	 * @uses XWebOrderWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderWsdlClass::getAttributeName()
	 * @uses XWebOrderWsdlClass::__toString()
	 * @uses XWebOrderWsdlClass::_set()
	 * @uses XWebOrderWsdlClass::_get()
	 * @uses XWebOrderWsdlClass::setInternArrayToIterate()
	 * @uses XWebOrderWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebOrderWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebOrderWsdlClass::item()
	 * @uses XWebOrderWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebOrderWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
