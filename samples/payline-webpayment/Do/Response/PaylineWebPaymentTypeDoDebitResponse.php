<?php
/**
 * Class file for PaylineWebPaymentTypeDoDebitResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoDebitResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoDebitResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeDoDebitResponse
	 */
