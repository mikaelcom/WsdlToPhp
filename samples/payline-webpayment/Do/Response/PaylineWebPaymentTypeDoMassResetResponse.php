<?php
/**
 * Class file for PaylineWebPaymentTypeDoMassResetResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoMassResetResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoMassResetResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
	 ...
	 * @param string date
	 * @return PaylineWebPaymentTypeDoMassResetResponse
	 */
