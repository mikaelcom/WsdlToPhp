<?php
/**
 * Class file for PaylineWebPaymentTypeDoMassRefundResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoMassRefundResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoMassRefundResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
	 ...
	 * @param string date
	 * @return PaylineWebPaymentTypeDoMassRefundResponse
	 */
