<?php
/**
 * Class file for PaylineWebPaymentTypeDoCreditResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoCreditResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoCreditResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeDoCreditResponse
	 */
