<?php
/**
 * Class file for PaylineWebPaymentTypeDoResetResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoResetResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoResetResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeDoResetResponse
	 */
