<?php
/**
 * Class file for PaylineWebPaymentTypeDoImmediateWalletPaymentResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoImmediateWalletPaymentResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoImmediateWalletPaymentResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeDoImmediateWalletPaymentResponse
	 */
