<?php
/**
 * Class file for PaylineWebPaymentTypeDoDebitRequest
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeDoDebitRequest
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeDoDebitRequest extends PaylineWebPaymentWsdlClass
{
	/**
	 * The payment
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeDoDebitRequest
	 */
	public function __construct($_payment = null,$_card = null,$_order = null,$_buyer = null,$_owner = null,$_privateDataList = null,$_authentication3DSecure = null,$_authorization = null)
	{
		parent::__construct(array('payment'=>$_payment,'card'=>$_card,'order'=>$_order,'buyer'=>$_buyer,'owner'=>$_owner,'privateDataList'=>$_privateDataList,'authentication3DSecure'=>$_authentication3DSecure,'authorization'=>$_authorization));
	}
	/**
	 * Set payment
