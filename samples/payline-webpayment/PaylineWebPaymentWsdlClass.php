<?php
/**
 * File for PaylineWebPaymentWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for PaylineWebPaymentWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class PaylineWebPaymentWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses PaylineWebPaymentWsdlClass::setLastError()
	 * @uses PaylineWebPaymentWsdlClass::initSoapClient()
	 * @uses PaylineWebPaymentWsdlClass::initInternArrayToIterate()
	 * @uses PaylineWebPaymentWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses PaylineWebPaymentWsdlClass::classMap()
	 * @uses PaylineWebPaymentWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('PaylineWebPaymentClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = PaylineWebPaymentClassMap::classMap();
	 ...
	 * @uses PaylineWebPaymentWsdlClass::WSDL_CACHE_WSDL
	 * @uses PaylineWebPaymentWsdlClass::WSDL_COMPRESSION
	 * @uses PaylineWebPaymentWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses PaylineWebPaymentWsdlClass::WSDL_ENCODING
	 * @uses PaylineWebPaymentWsdlClass::WSDL_EXCPTS
	 * @uses PaylineWebPaymentWsdlClass::WSDL_FEATURES
	 * @uses PaylineWebPaymentWsdlClass::WSDL_LOGIN
	 * @uses PaylineWebPaymentWsdlClass::WSDL_PASSWD
	 * @uses PaylineWebPaymentWsdlClass::WSDL_SOAP_VERSION
	 * @uses PaylineWebPaymentWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses PaylineWebPaymentWsdlClass::WSDL_TRACE
	 * @uses PaylineWebPaymentWsdlClass::WSDL_TYPEMAP
	 * @uses PaylineWebPaymentWsdlClass::WSDL_URL
	 * @uses PaylineWebPaymentWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses PaylineWebPaymentWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::internArrayToIterateIsArray()
	 * @uses PaylineWebPaymentWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::getInternArrayToIterateOffset()
	 * @uses PaylineWebPaymentWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::getInternArrayToIterateOffset()
	 * @uses PaylineWebPaymentWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see PaylineWebPaymentWsdlClass::offsetGet()
	 * @uses PaylineWebPaymentWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::getAttributeName()
	 * @uses PaylineWebPaymentWsdlClass::__toString()
	 * @uses PaylineWebPaymentWsdlClass::_set()
	 * @uses PaylineWebPaymentWsdlClass::_get()
	 * @uses PaylineWebPaymentWsdlClass::setInternArrayToIterate()
	 * @uses PaylineWebPaymentWsdlClass::setInternArrayToIterateIsArray()
	 * @uses PaylineWebPaymentWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::item()
	 * @uses PaylineWebPaymentWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses PaylineWebPaymentWsdlClass::getInternArrayToIterateIsArray()
	 * @uses PaylineWebPaymentWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
