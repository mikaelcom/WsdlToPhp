<?php
/**
 * Class file for PaylineWebPaymentTypeCreateWebWalletResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeCreateWebWalletResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeCreateWebWalletResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
