<?php
/**
 * Class file for PaylineWebPaymentTypeEnableWalletRequest
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeEnableWalletRequest
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeEnableWalletRequest extends PaylineWebPaymentWsdlClass
{
	/**
	 * The contractNumber
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeEnableWalletRequest
	 */
