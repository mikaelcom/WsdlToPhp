<?php
/**
 * Class file for PaylineWebPaymentTypeUpdateWalletRequest
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeUpdateWalletRequest
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeUpdateWalletRequest extends PaylineWebPaymentWsdlClass
{
	/**
	 * The contractNumber
	 * Meta informations :
	 ...
	 * @return PaylineWebPaymentTypeUpdateWalletRequest
	 */
