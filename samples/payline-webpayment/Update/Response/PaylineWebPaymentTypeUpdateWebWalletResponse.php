<?php
/**
 * Class file for PaylineWebPaymentTypeUpdateWebWalletResponse
 * @date 10/07/2012
 */
/**
 * Class PaylineWebPaymentTypeUpdateWebWalletResponse
 * @date 10/07/2012
 */
class PaylineWebPaymentTypeUpdateWebWalletResponse extends PaylineWebPaymentWsdlClass
{
	/**
	 * The result
	 * Meta informations :
