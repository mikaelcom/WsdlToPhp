<?php
/**
 * File for SOGeoPhoneWirelessWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOGeoPhoneWirelessWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOGeoPhoneWirelessWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOGeoPhoneWirelessWsdlClass::setLastError()
	 * @uses SOGeoPhoneWirelessWsdlClass::initSoapClient()
	 * @uses SOGeoPhoneWirelessWsdlClass::initInternArrayToIterate()
	 * @uses SOGeoPhoneWirelessWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOGeoPhoneWirelessWsdlClass::classMap()
	 * @uses SOGeoPhoneWirelessWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOGeoPhoneWirelessClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOGeoPhoneWirelessClassMap::classMap();
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_COMPRESSION
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_ENCODING
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_EXCPTS
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_FEATURES
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_LOGIN
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_PASSWD
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_TRACE
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_TYPEMAP
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_URL
	 * @uses SOGeoPhoneWirelessWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOGeoPhoneWirelessWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::internArrayToIterateIsArray()
	 * @uses SOGeoPhoneWirelessWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoPhoneWirelessWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoPhoneWirelessWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOGeoPhoneWirelessWsdlClass::offsetGet()
	 * @uses SOGeoPhoneWirelessWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::getAttributeName()
	 * @uses SOGeoPhoneWirelessWsdlClass::__toString()
	 * @uses SOGeoPhoneWirelessWsdlClass::_set()
	 * @uses SOGeoPhoneWirelessWsdlClass::_get()
	 * @uses SOGeoPhoneWirelessWsdlClass::setInternArrayToIterate()
	 * @uses SOGeoPhoneWirelessWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOGeoPhoneWirelessWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::item()
	 * @uses SOGeoPhoneWirelessWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWirelessWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOGeoPhoneWirelessWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
