<?php
/**
 * Class file for SOGeoPhoneWirelessTypeContact
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhoneWirelessTypeContact
 * @date 08/07/2012
 */
class SOGeoPhoneWirelessTypeContact extends SOGeoPhoneWirelessWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
