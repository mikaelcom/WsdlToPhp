<?php
/**
 * Class file for SOPackTrackTypePurolator_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypePurolator_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypePurolator_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypePurolator_GetTrackingInfo
	 */
