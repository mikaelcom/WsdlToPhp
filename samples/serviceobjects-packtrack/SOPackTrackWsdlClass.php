<?php
/**
 * File for SOPackTrackWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOPackTrackWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOPackTrackWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOPackTrackWsdlClass::setLastError()
	 * @uses SOPackTrackWsdlClass::initSoapClient()
	 * @uses SOPackTrackWsdlClass::initInternArrayToIterate()
	 * @uses SOPackTrackWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOPackTrackWsdlClass::classMap()
	 * @uses SOPackTrackWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOPackTrackClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOPackTrackClassMap::classMap();
	 ...
	 * @uses SOPackTrackWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOPackTrackWsdlClass::WSDL_COMPRESSION
	 * @uses SOPackTrackWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOPackTrackWsdlClass::WSDL_ENCODING
	 * @uses SOPackTrackWsdlClass::WSDL_EXCPTS
	 * @uses SOPackTrackWsdlClass::WSDL_FEATURES
	 * @uses SOPackTrackWsdlClass::WSDL_LOGIN
	 * @uses SOPackTrackWsdlClass::WSDL_PASSWD
	 * @uses SOPackTrackWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOPackTrackWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOPackTrackWsdlClass::WSDL_TRACE
	 * @uses SOPackTrackWsdlClass::WSDL_TYPEMAP
	 * @uses SOPackTrackWsdlClass::WSDL_URL
	 * @uses SOPackTrackWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOPackTrackWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::internArrayToIterateIsArray()
	 * @uses SOPackTrackWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPackTrackWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPackTrackWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOPackTrackWsdlClass::offsetGet()
	 * @uses SOPackTrackWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::getAttributeName()
	 * @uses SOPackTrackWsdlClass::__toString()
	 * @uses SOPackTrackWsdlClass::_set()
	 * @uses SOPackTrackWsdlClass::_get()
	 * @uses SOPackTrackWsdlClass::setInternArrayToIterate()
	 * @uses SOPackTrackWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOPackTrackWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::item()
	 * @uses SOPackTrackWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOPackTrackWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOPackTrackWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
