<?php
/**
 * Class file for SOPackTrackTypeAirborne_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeAirborne_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeAirborne_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeAirborne_GetTrackingInfo
	 */
