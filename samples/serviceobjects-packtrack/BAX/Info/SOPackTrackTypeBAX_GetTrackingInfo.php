<?php
/**
 * Class file for SOPackTrackTypeBAX_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeBAX_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeBAX_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeBAX_GetTrackingInfo
	 */
