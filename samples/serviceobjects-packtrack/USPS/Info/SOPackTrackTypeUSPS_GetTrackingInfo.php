<?php
/**
 * Class file for SOPackTrackTypeUSPS_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeUSPS_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeUSPS_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeUSPS_GetTrackingInfo
	 */
