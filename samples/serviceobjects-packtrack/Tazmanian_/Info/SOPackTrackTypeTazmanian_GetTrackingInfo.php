<?php
/**
 * Class file for SOPackTrackTypeTazmanian_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeTazmanian_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeTazmanian_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeTazmanian_GetTrackingInfo
	 */
