<?php
/**
 * Class file for SOPackTrackTypeEmery_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeEmery_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeEmery_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeEmery_GetTrackingInfo
	 */
