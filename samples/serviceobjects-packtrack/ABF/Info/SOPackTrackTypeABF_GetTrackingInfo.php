<?php
/**
 * Class file for SOPackTrackTypeABF_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeABF_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeABF_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeABF_GetTrackingInfo
	 */
