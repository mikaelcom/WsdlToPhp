<?php
/**
 * Class file for SOPackTrackTypeFedEx_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeFedEx_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeFedEx_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeFedEx_GetTrackingInfo
	 */
