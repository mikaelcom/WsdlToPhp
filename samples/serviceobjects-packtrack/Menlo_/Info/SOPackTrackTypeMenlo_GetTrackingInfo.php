<?php
/**
 * Class file for SOPackTrackTypeMenlo_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeMenlo_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeMenlo_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeMenlo_GetTrackingInfo
	 */
