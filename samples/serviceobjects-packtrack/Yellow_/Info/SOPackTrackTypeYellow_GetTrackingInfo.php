<?php
/**
 * Class file for SOPackTrackTypeYellow_GetTrackingInfo
 * @date 08/07/2012
 */
/**
 * Class SOPackTrackTypeYellow_GetTrackingInfo
 * @date 08/07/2012
 */
class SOPackTrackTypeYellow_GetTrackingInfo extends SOPackTrackWsdlClass
{
	/**
	 * The TrackingNumber
	 * Meta informations :
	 ...
	 * @return SOPackTrackTypeYellow_GetTrackingInfo
	 */
