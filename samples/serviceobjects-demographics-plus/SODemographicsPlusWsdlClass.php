<?php
/**
 * File for SODemographicsPlusWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SODemographicsPlusWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SODemographicsPlusWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SODemographicsPlusWsdlClass::setLastError()
	 * @uses SODemographicsPlusWsdlClass::initSoapClient()
	 * @uses SODemographicsPlusWsdlClass::initInternArrayToIterate()
	 * @uses SODemographicsPlusWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SODemographicsPlusWsdlClass::classMap()
	 * @uses SODemographicsPlusWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SODemographicsPlusClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SODemographicsPlusClassMap::classMap();
	 ...
	 * @uses SODemographicsPlusWsdlClass::WSDL_CACHE_WSDL
	 * @uses SODemographicsPlusWsdlClass::WSDL_COMPRESSION
	 * @uses SODemographicsPlusWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SODemographicsPlusWsdlClass::WSDL_ENCODING
	 * @uses SODemographicsPlusWsdlClass::WSDL_EXCPTS
	 * @uses SODemographicsPlusWsdlClass::WSDL_FEATURES
	 * @uses SODemographicsPlusWsdlClass::WSDL_LOGIN
	 * @uses SODemographicsPlusWsdlClass::WSDL_PASSWD
	 * @uses SODemographicsPlusWsdlClass::WSDL_SOAP_VERSION
	 * @uses SODemographicsPlusWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SODemographicsPlusWsdlClass::WSDL_TRACE
	 * @uses SODemographicsPlusWsdlClass::WSDL_TYPEMAP
	 * @uses SODemographicsPlusWsdlClass::WSDL_URL
	 * @uses SODemographicsPlusWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SODemographicsPlusWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::internArrayToIterateIsArray()
	 * @uses SODemographicsPlusWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SODemographicsPlusWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SODemographicsPlusWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SODemographicsPlusWsdlClass::offsetGet()
	 * @uses SODemographicsPlusWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::getAttributeName()
	 * @uses SODemographicsPlusWsdlClass::__toString()
	 * @uses SODemographicsPlusWsdlClass::_set()
	 * @uses SODemographicsPlusWsdlClass::_get()
	 * @uses SODemographicsPlusWsdlClass::setInternArrayToIterate()
	 * @uses SODemographicsPlusWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SODemographicsPlusWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::item()
	 * @uses SODemographicsPlusWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SODemographicsPlusWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SODemographicsPlusWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
