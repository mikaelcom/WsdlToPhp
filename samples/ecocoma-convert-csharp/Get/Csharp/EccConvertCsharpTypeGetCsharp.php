<?php
/**
 * Class file for EccConvertCsharpTypeGetCsharp
 * @date 03/07/2012
 */
/**
 * Class EccConvertCsharpTypeGetCsharp
 * @date 03/07/2012
 */
class EccConvertCsharpTypeGetCsharp extends EccConvertCsharpWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Code
	 * @return EccConvertCsharpTypeGetCsharp
	 */
