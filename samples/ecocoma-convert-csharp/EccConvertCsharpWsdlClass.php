<?php
/**
 * File for EccConvertCsharpWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccConvertCsharpWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Csharp Convert Web Services.
 * @date 03/07/2012
 */
class EccConvertCsharpWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccConvertCsharpWsdlClass::setLastError()
	 * @uses EccConvertCsharpWsdlClass::initSoapClient()
	 * @uses EccConvertCsharpWsdlClass::initInternArrayToIterate()
	 * @uses EccConvertCsharpWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccConvertCsharpWsdlClass::classMap()
	 * @uses EccConvertCsharpWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccConvertCsharpClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccConvertCsharpClassMap::classMap();
	 ...
	 * @uses EccConvertCsharpWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccConvertCsharpWsdlClass::WSDL_COMPRESSION
	 * @uses EccConvertCsharpWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccConvertCsharpWsdlClass::WSDL_ENCODING
	 * @uses EccConvertCsharpWsdlClass::WSDL_EXCPTS
	 * @uses EccConvertCsharpWsdlClass::WSDL_FEATURES
	 * @uses EccConvertCsharpWsdlClass::WSDL_LOGIN
	 * @uses EccConvertCsharpWsdlClass::WSDL_PASSWD
	 * @uses EccConvertCsharpWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccConvertCsharpWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccConvertCsharpWsdlClass::WSDL_TRACE
	 * @uses EccConvertCsharpWsdlClass::WSDL_TYPEMAP
	 * @uses EccConvertCsharpWsdlClass::WSDL_URL
	 * @uses EccConvertCsharpWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccConvertCsharpWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::internArrayToIterateIsArray()
	 * @uses EccConvertCsharpWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertCsharpWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertCsharpWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccConvertCsharpWsdlClass::offsetGet()
	 * @uses EccConvertCsharpWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::getAttributeName()
	 * @uses EccConvertCsharpWsdlClass::__toString()
	 * @uses EccConvertCsharpWsdlClass::_set()
	 * @uses EccConvertCsharpWsdlClass::_get()
	 * @uses EccConvertCsharpWsdlClass::setInternArrayToIterate()
	 * @uses EccConvertCsharpWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccConvertCsharpWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::item()
	 * @uses EccConvertCsharpWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertCsharpWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccConvertCsharpWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
