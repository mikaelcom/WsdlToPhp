<?php
/**
 * File for SOPhoneAppendWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOPhoneAppendWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOPhoneAppendWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOPhoneAppendWsdlClass::setLastError()
	 * @uses SOPhoneAppendWsdlClass::initSoapClient()
	 * @uses SOPhoneAppendWsdlClass::initInternArrayToIterate()
	 * @uses SOPhoneAppendWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOPhoneAppendWsdlClass::classMap()
	 * @uses SOPhoneAppendWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOPhoneAppendClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOPhoneAppendClassMap::classMap();
	 ...
	 * @uses SOPhoneAppendWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOPhoneAppendWsdlClass::WSDL_COMPRESSION
	 * @uses SOPhoneAppendWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOPhoneAppendWsdlClass::WSDL_ENCODING
	 * @uses SOPhoneAppendWsdlClass::WSDL_EXCPTS
	 * @uses SOPhoneAppendWsdlClass::WSDL_FEATURES
	 * @uses SOPhoneAppendWsdlClass::WSDL_LOGIN
	 * @uses SOPhoneAppendWsdlClass::WSDL_PASSWD
	 * @uses SOPhoneAppendWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOPhoneAppendWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOPhoneAppendWsdlClass::WSDL_TRACE
	 * @uses SOPhoneAppendWsdlClass::WSDL_TYPEMAP
	 * @uses SOPhoneAppendWsdlClass::WSDL_URL
	 * @uses SOPhoneAppendWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOPhoneAppendWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::internArrayToIterateIsArray()
	 * @uses SOPhoneAppendWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPhoneAppendWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPhoneAppendWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOPhoneAppendWsdlClass::offsetGet()
	 * @uses SOPhoneAppendWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::getAttributeName()
	 * @uses SOPhoneAppendWsdlClass::__toString()
	 * @uses SOPhoneAppendWsdlClass::_set()
	 * @uses SOPhoneAppendWsdlClass::_get()
	 * @uses SOPhoneAppendWsdlClass::setInternArrayToIterate()
	 * @uses SOPhoneAppendWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOPhoneAppendWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::item()
	 * @uses SOPhoneAppendWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhoneAppendWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOPhoneAppendWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
