<?php
/**
 * File for CdyneIntAddressWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for CdyneIntAddressWsdlClass to communicate with SOAP service
 ...
 * @date 03/07/2012
 */
class CdyneIntAddressWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdyneIntAddressWsdlClass::setLastError()
	 * @uses CdyneIntAddressWsdlClass::initSoapClient()
	 * @uses CdyneIntAddressWsdlClass::initInternArrayToIterate()
	 * @uses CdyneIntAddressWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneIntAddressWsdlClass::classMap()
	 * @uses CdyneIntAddressWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneIntAddressClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneIntAddressClassMap::classMap();
	 ...
	 * @uses CdyneIntAddressWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneIntAddressWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneIntAddressWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneIntAddressWsdlClass::WSDL_ENCODING
	 * @uses CdyneIntAddressWsdlClass::WSDL_EXCPTS
	 * @uses CdyneIntAddressWsdlClass::WSDL_FEATURES
	 * @uses CdyneIntAddressWsdlClass::WSDL_LOGIN
	 * @uses CdyneIntAddressWsdlClass::WSDL_PASSWD
	 * @uses CdyneIntAddressWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneIntAddressWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneIntAddressWsdlClass::WSDL_TRACE
	 * @uses CdyneIntAddressWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneIntAddressWsdlClass::WSDL_URL
	 * @uses CdyneIntAddressWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneIntAddressWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneIntAddressWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneIntAddressWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneIntAddressWsdlClass::offsetExists()
	 ...
	 * @uses CdyneIntAddressWsdlClass::getAttributeName()
	 * @uses CdyneIntAddressWsdlClass::__toString()
	 * @uses CdyneIntAddressWsdlClass::_set()
	 * @uses CdyneIntAddressWsdlClass::_get()
	 * @uses CdyneIntAddressWsdlClass::setInternArrayToIterate()
	 * @uses CdyneIntAddressWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneIntAddressWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::item()
	 * @uses CdyneIntAddressWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIntAddressWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneIntAddressWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
