<?php
/**
 * File for XiInsiderWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiInsiderWsdlClass to communicate with SOAP service
 * Documentation : This web services provides real-time access to corporate insider information.
 * @date 08/07/2012
 */
class XiInsiderWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiInsiderWsdlClass::setLastError()
	 * @uses XiInsiderWsdlClass::initSoapClient()
	 * @uses XiInsiderWsdlClass::initInternArrayToIterate()
	 * @uses XiInsiderWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiInsiderWsdlClass::classMap()
	 * @uses XiInsiderWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiInsiderClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiInsiderClassMap::classMap();
	 ...
	 * @uses XiInsiderWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiInsiderWsdlClass::WSDL_COMPRESSION
	 * @uses XiInsiderWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiInsiderWsdlClass::WSDL_ENCODING
	 * @uses XiInsiderWsdlClass::WSDL_EXCPTS
	 * @uses XiInsiderWsdlClass::WSDL_FEATURES
	 * @uses XiInsiderWsdlClass::WSDL_LOGIN
	 * @uses XiInsiderWsdlClass::WSDL_PASSWD
	 * @uses XiInsiderWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiInsiderWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiInsiderWsdlClass::WSDL_TRACE
	 * @uses XiInsiderWsdlClass::WSDL_TYPEMAP
	 * @uses XiInsiderWsdlClass::WSDL_URL
	 * @uses XiInsiderWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiInsiderWsdlClass::internArrayToIterateIsArray()
	 * @uses XiInsiderWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiInsiderWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiInsiderWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiInsiderWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiInsiderWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiInsiderWsdlClass::offsetExists()
	 ...
	 * @uses XiInsiderWsdlClass::getAttributeName()
	 * @uses XiInsiderWsdlClass::__toString()
	 * @uses XiInsiderWsdlClass::_set()
	 * @uses XiInsiderWsdlClass::_get()
	 * @uses XiInsiderWsdlClass::setInternArrayToIterate()
	 * @uses XiInsiderWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiInsiderWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiInsiderWsdlClass::item()
	 * @uses XiInsiderWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiInsiderWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiInsiderWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
