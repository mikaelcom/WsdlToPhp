<?php
/**
 * Class file for XiInsiderTypeSharesAsOf
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeSharesAsOf
 * @date 08/07/2012
 */
class XiInsiderTypeSharesAsOf extends XiInsiderTypeCommon
{
	/**
	 * The AsOfDate
	 * Meta informations :
	...
	{
		XiInsiderWsdlClass::__construct(array('AsOfDate'=>$_AsOfDate,'Quantity'=>$_Quantity,'Source'=>$_Source,'SourceDate'=>$_SourceDate,'SourceUrl'=>$_SourceUrl));
	}
	/**
	 * Set AsOfDate
	 * @param string AsOfDate
