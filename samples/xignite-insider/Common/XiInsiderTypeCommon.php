<?php
/**
 * Class file for XiInsiderTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeCommon
 * @date 08/07/2012
 */
class XiInsiderTypeCommon extends XiInsiderWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiInsiderTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiInsiderTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiInsiderTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiInsiderTypeOutcomeTypes
	 */
