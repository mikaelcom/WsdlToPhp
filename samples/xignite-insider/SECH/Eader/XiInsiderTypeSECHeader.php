<?php
/**
 * Class file for XiInsiderTypeSECHeader
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeSECHeader
 * @date 08/07/2012
 */
class XiInsiderTypeSECHeader extends XiInsiderTypeCommon
{
	/**
	 * The Number
	 * Meta informations :
	 ...
	 * @param string SROS
	 * @param XiInsiderTypeSECFiler Filer
