<?php
/**
 * Class file for XiInsiderTypeGetInsiderTransactions
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeGetInsiderTransactions
 * @date 08/07/2012
 */
class XiInsiderTypeGetInsiderTransactions extends XiInsiderWsdlClass
{
	/**
	 * The InsiderCIK
	 * Meta informations :
	 ...
	 * @return XiInsiderTypeGetInsiderTransactions
	 */
