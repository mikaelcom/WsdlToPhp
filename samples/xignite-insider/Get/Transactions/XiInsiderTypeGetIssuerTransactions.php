<?php
/**
 * Class file for XiInsiderTypeGetIssuerTransactions
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeGetIssuerTransactions
 * @date 08/07/2012
 */
class XiInsiderTypeGetIssuerTransactions extends XiInsiderWsdlClass
{
	/**
	 ...
	 * @return XiInsiderTypeGetIssuerTransactions
	 */
