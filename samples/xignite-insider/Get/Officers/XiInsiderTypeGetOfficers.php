<?php
/**
 * Class file for XiInsiderTypeGetOfficers
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeGetOfficers
 * @date 08/07/2012
 */
class XiInsiderTypeGetOfficers extends XiInsiderWsdlClass
{
	/**
	 ...
	 * @return XiInsiderTypeGetOfficers
	 */
