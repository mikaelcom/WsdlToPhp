<?php
/**
 * Class file for XiInsiderTypeGetIssuerOwnerships
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeGetIssuerOwnerships
 * @date 08/07/2012
 */
class XiInsiderTypeGetIssuerOwnerships extends XiInsiderWsdlClass
{
	/**
	 ...
	 * @return XiInsiderTypeGetIssuerOwnerships
	 */
