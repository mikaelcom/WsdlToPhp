<?php
/**
 * Class file for XiInsiderTypeGetInsiderOwnerships
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeGetInsiderOwnerships
 * @date 08/07/2012
 */
class XiInsiderTypeGetInsiderOwnerships extends XiInsiderWsdlClass
{
	/**
	 * The InsiderCIK
	 * Meta informations :
	 ...
	 * @return XiInsiderTypeGetInsiderOwnerships
	 */
