<?php
/**
 * Class file for XiInsiderTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeSecurity
 * @date 08/07/2012
 */
class XiInsiderTypeSecurity extends XiInsiderTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiInsiderWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
