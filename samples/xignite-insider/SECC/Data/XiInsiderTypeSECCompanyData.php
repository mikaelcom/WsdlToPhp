<?php
/**
 * Class file for XiInsiderTypeSECCompanyData
 * @date 08/07/2012
 */
/**
 * Class XiInsiderTypeSECCompanyData
 * @date 08/07/2012
 */
class XiInsiderTypeSECCompanyData extends XiInsiderWsdlClass
{
	/**
	 ...
	 * @param XiInsiderTypeSICCode SICCode
