<?php
/**
 * Class file for XiGlobalquotesTypeGetGlobalDelayedQuote
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeGetGlobalDelayedQuote
 * @date 08/07/2012
 */
class XiGlobalquotesTypeGetGlobalDelayedQuote extends XiGlobalquotesWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalquotesTypeGetGlobalDelayedQuote
	 */
