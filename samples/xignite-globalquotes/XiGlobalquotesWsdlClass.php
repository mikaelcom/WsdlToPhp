<?php
/**
 * File for XiGlobalquotesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalquotesWsdlClass to communicate with SOAP service
 * Documentation : This web service provides global delayed stock quotes and for U.S. and international equities.
 * @date 08/07/2012
 */
class XiGlobalquotesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalquotesWsdlClass::setLastError()
	 * @uses XiGlobalquotesWsdlClass::initSoapClient()
	 * @uses XiGlobalquotesWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalquotesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalquotesWsdlClass::classMap()
	 * @uses XiGlobalquotesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalquotesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalquotesClassMap::classMap();
	 ...
	 * @uses XiGlobalquotesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalquotesWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalquotesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalquotesWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalquotesWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalquotesWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalquotesWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalquotesWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalquotesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalquotesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalquotesWsdlClass::WSDL_TRACE
	 * @uses XiGlobalquotesWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalquotesWsdlClass::WSDL_URL
	 * @uses XiGlobalquotesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalquotesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalquotesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalquotesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalquotesWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalquotesWsdlClass::getAttributeName()
	 * @uses XiGlobalquotesWsdlClass::__toString()
	 * @uses XiGlobalquotesWsdlClass::_set()
	 * @uses XiGlobalquotesWsdlClass::_get()
	 * @uses XiGlobalquotesWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalquotesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalquotesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::item()
	 * @uses XiGlobalquotesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalquotesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalquotesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
