<?php
/**
 * Class file for XiGlobalquotesTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalquotesTypeIdentifierTypes extends XiGlobalquotesWsdlClass
{
	/**
