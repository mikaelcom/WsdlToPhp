<?php
/**
 * Class file for XiGlobalquotesTypeIntradayVWAPTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeIntradayVWAPTypes
 * @date 08/07/2012
 */
class XiGlobalquotesTypeIntradayVWAPTypes extends XiGlobalquotesWsdlClass
{
	/**
