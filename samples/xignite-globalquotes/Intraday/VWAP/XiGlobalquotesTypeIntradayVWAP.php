<?php
/**
 * Class file for XiGlobalquotesTypeIntradayVWAP
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeIntradayVWAP
 * @date 08/07/2012
 */
class XiGlobalquotesTypeIntradayVWAP extends XiGlobalquotesTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiGlobalquotesTypeIntradayVWAPTypes
	 */
	public $VWAPType;
	/**
	 * The VWAP
	 ...
	 * @param XiGlobalquotesTypeIntradayVWAPTypes VWAPType
	 * @param double VWAP
	 * @param double High
	 * @param double Low
	...
	{
		XiGlobalquotesWsdlClass::__construct(array('Security'=>$_Security,'Date'=>$_Date,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'UTCStartDate'=>$_UTCStartDate,'UTCStartTime'=>$_UTCStartTime,'UTCEndDate'=>$_UTCEndDate,'UTCEndTime'=>$_UTCEndTime,'VWAPType'=>$_VWAPType,'VWAP'=>$_VWAP,'High'=>$_High,'Low'=>$_Low,'Average'=>$_Average,'Amount'=>$_Amount,'Volume'=>$_Volume,'Trades'=>$_Trades));
	}
	/**
	 * Set Security
	...
	{
		return ($this->VWAPType = XiGlobalquotesTypeIntradayVWAPTypes::valueIsValid($_VWAPType)?$_VWAPType:null);
	}
	/**
	 * Get VWAPType
	 * @return XiGlobalquotesTypeIntradayVWAPTypes
	 */
