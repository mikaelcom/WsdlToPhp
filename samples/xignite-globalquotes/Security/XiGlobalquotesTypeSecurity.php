<?php
/**
 * Class file for XiGlobalquotesTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeSecurity
 * @date 08/07/2012
 */
class XiGlobalquotesTypeSecurity extends XiGlobalquotesTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiGlobalquotesWsdlClass::__construct(array('CIK'=>$_CIK,'CUSIP'=>$_CUSIP,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'MarketIdentificationCode'=>$_MarketIdentificationCode,'MostLiquidExchange'=>$_MostLiquidExchange,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
