<?php
/**
 * Class file for XiGlobalquotesTypeGlobalTickSet
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeGlobalTickSet
 * @date 08/07/2012
 */
class XiGlobalquotesTypeGlobalTickSet extends XiGlobalquotesTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiGlobalquotesTypeArrayOfTick
	 */
	public $Ticks;
	/**
	 * Constructor
	 ...
	 * @param XiGlobalquotesTypeArrayOfTick Ticks
	...
	{
		XiGlobalquotesWsdlClass::__construct(array('Symbol'=>$_Symbol,'Name'=>$_Name,'MarketIdentificationCode'=>$_MarketIdentificationCode,'Currency'=>$_Currency,'Ticks'=>new XiGlobalquotesTypeArrayOfTick($_Ticks)));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
