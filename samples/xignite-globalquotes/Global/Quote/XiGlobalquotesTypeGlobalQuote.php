<?php
/**
 * Class file for XiGlobalquotesTypeGlobalQuote
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeGlobalQuote
 * @date 08/07/2012
 */
class XiGlobalquotesTypeGlobalQuote extends XiGlobalquotesTypeQuoteWithSecurity
{
	/**
	 * The Date
	 * Meta informations :
