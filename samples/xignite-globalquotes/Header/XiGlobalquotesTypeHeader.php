<?php
/**
 * Class file for XiGlobalquotesTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobalquotesTypeHeader
 * @date 08/07/2012
 */
class XiGlobalquotesTypeHeader extends XiGlobalquotesWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobalquotesTypeHeader
	 */
