<?php
/**
 * File for BingGeoWsdlClass to communicate with SOAP service
 * @date 02/07/2012
 */
/**
 * File for BingGeoWsdlClass to communicate with SOAP service
 ...
 * @date 02/07/2012
 */
class BingGeoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses BingGeoWsdlClass::setLastError()
	 * @uses BingGeoWsdlClass::initSoapClient()
	 * @uses BingGeoWsdlClass::initInternArrayToIterate()
	 * @uses BingGeoWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses BingGeoWsdlClass::classMap()
	 * @uses BingGeoWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('BingGeoClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = BingGeoClassMap::classMap();
	 ...
	 * @uses BingGeoWsdlClass::WSDL_CACHE_WSDL
	 * @uses BingGeoWsdlClass::WSDL_COMPRESSION
	 * @uses BingGeoWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses BingGeoWsdlClass::WSDL_ENCODING
	 * @uses BingGeoWsdlClass::WSDL_EXCPTS
	 * @uses BingGeoWsdlClass::WSDL_FEATURES
	 * @uses BingGeoWsdlClass::WSDL_LOGIN
	 * @uses BingGeoWsdlClass::WSDL_PASSWD
	 * @uses BingGeoWsdlClass::WSDL_SOAP_VERSION
	 * @uses BingGeoWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses BingGeoWsdlClass::WSDL_TRACE
	 * @uses BingGeoWsdlClass::WSDL_TYPEMAP
	 * @uses BingGeoWsdlClass::WSDL_URL
	 * @uses BingGeoWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses BingGeoWsdlClass::internArrayToIterateIsArray()
	 * @uses BingGeoWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses BingGeoWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses BingGeoWsdlClass::getInternArrayToIterateOffset()
	 * @uses BingGeoWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses BingGeoWsdlClass::getInternArrayToIterateOffset()
	 * @uses BingGeoWsdlClass::offsetExists()
	 ...
	 * @uses BingGeoWsdlClass::getAttributeName()
	 * @uses BingGeoWsdlClass::__toString()
	 * @uses BingGeoWsdlClass::_set()
	 * @uses BingGeoWsdlClass::_get()
	 * @uses BingGeoWsdlClass::setInternArrayToIterate()
	 * @uses BingGeoWsdlClass::setInternArrayToIterateIsArray()
	 * @uses BingGeoWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses BingGeoWsdlClass::getInternArrayToIterateIsArray()
	 * @uses BingGeoWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
