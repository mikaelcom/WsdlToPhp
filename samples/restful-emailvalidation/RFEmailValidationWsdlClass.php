<?php
/**
 * File for RFEmailValidationWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFEmailValidationWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFEmailValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFEmailValidationWsdlClass::setLastError()
	 * @uses RFEmailValidationWsdlClass::initSoapClient()
	 * @uses RFEmailValidationWsdlClass::initInternArrayToIterate()
	 * @uses RFEmailValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFEmailValidationWsdlClass::classMap()
	 * @uses RFEmailValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFEmailValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFEmailValidationClassMap::classMap();
	 ...
	 * @uses RFEmailValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFEmailValidationWsdlClass::WSDL_COMPRESSION
	 * @uses RFEmailValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFEmailValidationWsdlClass::WSDL_ENCODING
	 * @uses RFEmailValidationWsdlClass::WSDL_EXCPTS
	 * @uses RFEmailValidationWsdlClass::WSDL_FEATURES
	 * @uses RFEmailValidationWsdlClass::WSDL_LOGIN
	 * @uses RFEmailValidationWsdlClass::WSDL_PASSWD
	 * @uses RFEmailValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFEmailValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFEmailValidationWsdlClass::WSDL_TRACE
	 * @uses RFEmailValidationWsdlClass::WSDL_TYPEMAP
	 * @uses RFEmailValidationWsdlClass::WSDL_URL
	 * @uses RFEmailValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses RFEmailValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses RFEmailValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFEmailValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFEmailValidationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see RFEmailValidationWsdlClass::offsetGet()
	 * @uses RFEmailValidationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::getAttributeName()
	 * @uses RFEmailValidationWsdlClass::__toString()
	 * @uses RFEmailValidationWsdlClass::_set()
	 * @uses RFEmailValidationWsdlClass::_get()
	 * @uses RFEmailValidationWsdlClass::setInternArrayToIterate()
	 * @uses RFEmailValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFEmailValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::item()
	 * @uses RFEmailValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses RFEmailValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFEmailValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
