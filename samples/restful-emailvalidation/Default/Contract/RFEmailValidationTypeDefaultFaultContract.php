<?php
/**
 * Class file for RFEmailValidationTypeDefaultFaultContract
 * @date 15/08/2012
 */
/**
 * Class RFEmailValidationTypeDefaultFaultContract
 * @date 15/08/2012
 */
class RFEmailValidationTypeDefaultFaultContract extends RFEmailValidationWsdlClass
{
	/**
	 * The ErrorId
	 * @var int
	 ...
	 * @param RFEmailValidationTypeGuid CorrelationId
	 * @return RFEmailValidationTypeDefaultFaultContract
	 */
	...
	/**
	 * Get CorrelationId
	 * @return RFEmailValidationTypeguid
	 */
