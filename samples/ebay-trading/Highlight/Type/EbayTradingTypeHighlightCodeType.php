<?php
/**
 * Class file for EbayTradingTypeHighlightCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeHighlightCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeHighlightCodeType extends EbayTradingWsdlClass
{
	/**
