<?php
/**
 * Class file for EbayTradingTypeGetSellingManagerTemplateAutomationRuleResponseType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeGetSellingManagerTemplateAutomationRuleResponseType
 * Documentation : Contains the set of automation rules associated with the specified template.
 * @date 04/07/2012
 */
class EbayTradingTypeGetSellingManagerTemplateAutomationRuleResponseType extends EbayTradingTypeAbstractResponseType
{
	/**
