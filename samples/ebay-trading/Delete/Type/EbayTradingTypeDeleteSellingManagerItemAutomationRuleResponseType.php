<?php
/**
 * Class file for EbayTradingTypeDeleteSellingManagerItemAutomationRuleResponseType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeDeleteSellingManagerItemAutomationRuleResponseType
 * Documentation : Contains the set of automation rules associated with the specified item.
 * @date 04/07/2012
 */
class EbayTradingTypeDeleteSellingManagerItemAutomationRuleResponseType extends EbayTradingTypeAbstractResponseType
{
	/**
	 * The AutomatedListingRule
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Contains the remaining automated listing rules associated with this item.
	 ...
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Contains the remaining automated relisting rules associated with this item.
	 ...
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Contains the remaining automated second chance offer rule associated with this item.
