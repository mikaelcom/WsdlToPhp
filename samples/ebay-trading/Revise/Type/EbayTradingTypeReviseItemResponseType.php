<?php
/**
 * Class file for EbayTradingTypeReviseItemResponseType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeReviseItemResponseType
 * Documentation : Returns the item ID and the estimated fees for the revised listing.
 * @date 04/07/2012
 */
class EbayTradingTypeReviseItemResponseType extends EbayTradingTypeAbstractResponseType
{
	/**
	 * The ItemID
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Item ID that uniquely identifies the item listing that was revised. Provided for confirmation purposes. The value returned should be the same as the item ID specified in the ItemID property of the Item object specified as input for the call. Also applicable to Half.com.
	 ...
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Starting date and time for the revised listing. Also returned for Half.com (for Half.com, the start time is always the time the item was originally listed).
	 * @var dateTime
	 */
	public $StartTime;
	/**
	 ...
	 */
	public function __construct($_ItemID = null,$_StartTime = null,$_EndTime = null,$_Fees = null,$_CategoryID = null,$_Category2ID = null,$_VerifyOnly = null,$_DiscountReason = null,$_ProductSuggestions = null)
	{
		EbayTradingWsdlClass::__construct(array('ItemID'=>$_ItemID,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'Fees'=>$_Fees,'CategoryID'=>$_CategoryID,'Category2ID'=>$_Category2ID,'VerifyOnly'=>$_VerifyOnly,'DiscountReason'=>$_DiscountReason,'ProductSuggestions'=>$_ProductSuggestions));
	}
	/**
	 * Set ItemID
