<?php
/**
 * Class file for EbayTradingTypeReviseQuantityAllowedDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeReviseQuantityAllowedDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeReviseQuantityAllowedDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
