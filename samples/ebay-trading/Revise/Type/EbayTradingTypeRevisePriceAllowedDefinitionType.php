<?php
/**
 * Class file for EbayTradingTypeRevisePriceAllowedDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeRevisePriceAllowedDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeRevisePriceAllowedDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
