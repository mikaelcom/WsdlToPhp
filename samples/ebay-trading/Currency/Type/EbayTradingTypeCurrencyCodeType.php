<?php
/**
 * Class file for EbayTradingTypeCurrencyCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeCurrencyCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeCurrencyCodeType extends EbayTradingWsdlClass
{
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Indian Rupee. For eBay, you can only specify this currency for listings you submit to the India site (site ID 203).
	 * @return string 'INR'
	 */
	const VALUE_INR = 'INR';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Canadian Dollar. For eBay, you can only specify this currency for listings you submit to the Canada site (site ID 2) (Items listed on the Canada site can also specify USD.)
	 * @return string 'CAD'
	 */
	const VALUE_CAD = 'CAD';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Hong Kong Dollar. For eBay, you can only specify this currency for listings you submit to the Hong Kong site (site ID 201).
	 * @return string 'HKD'
	 */
	const VALUE_HKD = 'HKD';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Australian Dollar. For eBay, you can only specify this currency for listings you submit to the Australia site (site ID 15).
	 * @return string 'AUD'
	 */
	const VALUE_AUD = 'AUD';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Malaysian Ringgit. For eBay, you can only specify this currency for listings you submit to the Malaysia site (site ID 207).
	 * @return string 'MYR'
	 */
	const VALUE_MYR = 'MYR';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Euro. For eBay, you can only specify this currency for listings you submit to these sites: Austria (site 16), Belgium_French (site 23), France (site 71), Germany (site 77), Italy (site 101), Belgium_Dutch (site 123), Netherlands (site 146), Spain (site 186), Ireland (site 205).
	 * @return string 'EUR'
	 */
	const VALUE_EUR = 'EUR';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Philippines Peso. For eBay, you can only specify this currency for listings you submit to the Philippines site (site ID 211).
	 * @return string 'PHP'
	 */
	const VALUE_PHP = 'PHP';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Poland, Zloty. For eBay, you can only specify this currency for listings you submit to the Poland site (site ID 212).
	 * @return string 'PLN'
	 */
	const VALUE_PLN = 'PLN';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : US Dollar. For eBay, you can only specify this currency for listings you submit to the US (site ID 0), eBayMotors (site 100), and Canada (site 2) sites.
	 * @return string 'USD'
	 */
	const VALUE_USD = 'USD';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Singapore Dollar. For eBay, you can only specify this currency for listings you submit to the Singapore site (site 216).
	 * @return string 'SGD'
	 */
	const VALUE_SGD = 'SGD';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Swedish Krona. For eBay, you can only specify this currency for listings you submit to the Sweden site (site 218).
	 * @return string 'SEK'
	 */
	const VALUE_SEK = 'SEK';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : New Taiwan Dollar. This value is not applicable since the API is not used with new eBay Taiwan site.
	 * @return string 'TWD'
	 */
	const VALUE_TWD = 'TWD';
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Pound Sterling. For eBay, you can only specify this currency for listings you submit to the UK site (site ID 3).
	 * @return string 'GBP'
	 */
	const VALUE_GBP = 'GBP';
	/**
