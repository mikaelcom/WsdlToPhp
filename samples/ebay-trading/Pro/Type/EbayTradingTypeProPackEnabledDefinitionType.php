<?php
/**
 * Class file for EbayTradingTypeProPackEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeProPackEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeProPackEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
