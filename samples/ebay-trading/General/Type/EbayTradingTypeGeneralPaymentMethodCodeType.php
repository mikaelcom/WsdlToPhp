<?php
/**
 * Class file for EbayTradingTypeGeneralPaymentMethodCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeGeneralPaymentMethodCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeGeneralPaymentMethodCodeType extends EbayTradingWsdlClass
{
	/**
	...
	/**
	 * Constructor
	 * @return EbayTradingTypeGeneralPaymentMethodCodeType
	 */
