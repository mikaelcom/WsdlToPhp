<?php
/**
 * Class file for EbayTradingTypeRegularSubscriptionDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeRegularSubscriptionDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeRegularSubscriptionDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
