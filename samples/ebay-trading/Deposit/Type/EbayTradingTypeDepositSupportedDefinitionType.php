<?php
/**
 * Class file for EbayTradingTypeDepositSupportedDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeDepositSupportedDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeDepositSupportedDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
