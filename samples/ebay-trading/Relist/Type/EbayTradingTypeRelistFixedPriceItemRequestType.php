<?php
/**
 * Class file for EbayTradingTypeRelistFixedPriceItemRequestType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeRelistFixedPriceItemRequestType
 * Documentation : Enables a seller to take a single fixed-price item (or a single multi-item listing) that has ended and re-list it on a specified eBay site.
 * @date 04/07/2012
 */
class EbayTradingTypeRelistFixedPriceItemRequestType extends EbayTradingTypeAbstractRequestType
{
	/**
	 * The Item
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Child elements hold the values for item properties that change for the relisted item. Item is a required input. At a minimum, the Item.ItemID property must be set to the ID of the original listing (a listing that ended in the past 90 days). By default, the new listing's Item object properties are the same as those of the original (ended) listing. By setting a new value in the Item object, the new listing uses the new value rather than the original value from the old listing.
	 ...
	 * @return EbayTradingTypeRelistFixedPriceItemRequestType
	 */
