<?php
/**
 * Class file for EbayTradingTypeBuyingGuideType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeBuyingGuideType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeBuyingGuideType extends EbayTradingWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Display name of the buying guide. <br> <br> GetProducts only returns 20 characters, followed by "..." if the name is longer than 20 characters. For the full title, see BuyingGuide.Title instead.
	 * @var string
	 */
	public $Name;
	/**
	 ...
	 * @return EbayTradingTypeBuyingGuideType
	 */
	public function __construct($_Name = null,$_URL = null,$_CategoryID = null,$_ProductFinderID = null,$_Title = null,$_Text = null,$_CreationTime = null,$_UserID = null,$_any = null)
	{
		parent::__construct(array('Name'=>$_Name,'URL'=>$_URL,'CategoryID'=>$_CategoryID,'ProductFinderID'=>$_ProductFinderID,'Title'=>$_Title,'Text'=>$_Text,'CreationTime'=>$_CreationTime,'UserID'=>$_UserID,'any'=>$_any));
	}
	/**
	 * Set Name
	 * @param string Name
