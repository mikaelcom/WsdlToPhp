<?php
/**
 * Class file for EbayTradingTypeBuyingGuideDetailsType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeBuyingGuideDetailsType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeBuyingGuideDetailsType extends EbayTradingWsdlClass
{
	/**
	 * The BuyingGuide
	 * Meta informations :
	 ...
	 * @var EbayTradingTypeBuyingGuideType
	 */
	public $BuyingGuide;
	/**
	 * The BuyingGuideHub
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : URL of the buying guide home page for the site being searched. Your application can present this URL as a link. Optionally, you can use a value like "See all buying guides" as the link's display name. GetProducts returns this URL even when no guides are available for the product.
	 * @var anyURI
	 */
	...
	/**
	 * Constructor
	 * @param EbayTradingTypeBuyingGuideType BuyingGuide
