<?php
/**
 * Class file for EbayTradingTypeClassifiedAdPayPerLeadEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeClassifiedAdPayPerLeadEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeClassifiedAdPayPerLeadEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
