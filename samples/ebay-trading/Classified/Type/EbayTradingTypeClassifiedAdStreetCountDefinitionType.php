<?php
/**
 * Class file for EbayTradingTypeClassifiedAdStreetCountDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeClassifiedAdStreetCountDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeClassifiedAdStreetCountDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
