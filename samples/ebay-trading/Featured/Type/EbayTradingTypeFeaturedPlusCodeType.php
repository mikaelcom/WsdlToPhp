<?php
/**
 * Class file for EbayTradingTypeFeaturedPlusCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeFeaturedPlusCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeFeaturedPlusCodeType extends EbayTradingWsdlClass
{
	/**
