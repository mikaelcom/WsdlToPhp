<?php
/**
 * Class file for EbayTradingTypeFeaturedFirstCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeFeaturedFirstCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeFeaturedFirstCodeType extends EbayTradingWsdlClass
{
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : Indicates that Featured First is disabled for the site. In this case, listings containing Featured First are listed, but Featured First is dropped and a warning is returned.
