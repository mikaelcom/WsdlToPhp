<?php
/**
 * Class file for EbayTradingTypeISBNIdentifierEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeISBNIdentifierEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeISBNIdentifierEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
