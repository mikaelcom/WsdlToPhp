<?php
/**
 * Class file for EbayTradingTypeVATDetailsType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeVATDetailsType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeVATDetailsType extends EbayTradingWsdlClass
{
	/**
	 * The BusinessSeller
	 * Meta informations :
	 ...
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : Displays the VatSite Id of the seller (in a business card format) as part of the data returned in the GetItem call if the seller's SellerBusinessCodeType is set to 'Commercial'.
	 * @var string
	 */
	public $VATSite;
	/**
