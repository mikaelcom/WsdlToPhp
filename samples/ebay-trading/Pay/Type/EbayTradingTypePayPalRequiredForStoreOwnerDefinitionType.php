<?php
/**
 * Class file for EbayTradingTypePayPalRequiredForStoreOwnerDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypePayPalRequiredForStoreOwnerDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypePayPalRequiredForStoreOwnerDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
