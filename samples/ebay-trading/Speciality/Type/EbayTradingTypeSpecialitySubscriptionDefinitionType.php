<?php
/**
 * Class file for EbayTradingTypeSpecialitySubscriptionDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeSpecialitySubscriptionDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeSpecialitySubscriptionDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
