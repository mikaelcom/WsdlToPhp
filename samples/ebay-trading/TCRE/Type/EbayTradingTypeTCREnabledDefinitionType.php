<?php
/**
 * Class file for EbayTradingTypeTCREnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeTCREnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeTCREnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
