<?php
/**
 * Class file for EbayTradingTypeMinItemCompatibilityDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeMinItemCompatibilityDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeMinItemCompatibilityDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
