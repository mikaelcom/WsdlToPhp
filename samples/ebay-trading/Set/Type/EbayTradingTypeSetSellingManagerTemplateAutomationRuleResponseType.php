<?php
/**
 * Class file for EbayTradingTypeSetSellingManagerTemplateAutomationRuleResponseType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeSetSellingManagerTemplateAutomationRuleResponseType
 * Documentation : Contains the set of automation rules associated with the specified template.
 * @date 04/07/2012
 */
class EbayTradingTypeSetSellingManagerTemplateAutomationRuleResponseType extends EbayTradingTypeAbstractResponseType
{
	/**
