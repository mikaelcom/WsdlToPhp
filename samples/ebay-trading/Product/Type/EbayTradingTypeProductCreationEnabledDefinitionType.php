<?php
/**
 * Class file for EbayTradingTypeProductCreationEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeProductCreationEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeProductCreationEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
