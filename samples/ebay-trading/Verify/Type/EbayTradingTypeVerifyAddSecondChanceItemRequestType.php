<?php
/**
 * Class file for EbayTradingTypeVerifyAddSecondChanceItemRequestType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeVerifyAddSecondChanceItemRequestType
 * Documentation : Simulates the creation of a new Second Chance Offer listing of an item without actually creating a listing.
 * @date 04/07/2012
 */
class EbayTradingTypeVerifyAddSecondChanceItemRequestType extends EbayTradingTypeAbstractRequestType
{
	/**
	 ...
	 * @return EbayTradingTypeVerifyAddSecondChanceItemRequestType
	 */
