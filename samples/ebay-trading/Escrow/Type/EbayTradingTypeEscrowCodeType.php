<?php
/**
 * Class file for EbayTradingTypeEscrowCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeEscrowCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeEscrowCodeType extends EbayTradingWsdlClass
{
	/**
	...
	/**
	 * Constructor
	 * @return EbayTradingTypeEscrowCodeType
	 */
