<?php
/**
 * Class file for EbayTradingTypeMaxItemCompatibilityDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeMaxItemCompatibilityDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeMaxItemCompatibilityDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
