<?php
/**
 * Class file for EbayTradingTypePreferredLocationCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypePreferredLocationCodeType
 * @date 04/07/2012
 */
class EbayTradingTypePreferredLocationCodeType extends EbayTradingWsdlClass
{
	/**
