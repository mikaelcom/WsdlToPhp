<?php
/**
 * Class file for EbayTradingTypeStoreOwnerExtendedListingDurationsDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeStoreOwnerExtendedListingDurationsDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeStoreOwnerExtendedListingDurationsDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
