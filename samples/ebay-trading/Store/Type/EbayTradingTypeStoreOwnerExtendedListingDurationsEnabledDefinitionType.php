<?php
/**
 * Class file for EbayTradingTypeStoreOwnerExtendedListingDurationsEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeStoreOwnerExtendedListingDurationsEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeStoreOwnerExtendedListingDurationsEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
