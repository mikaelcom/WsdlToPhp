<?php
/**
 * Class file for EbayTradingTypeErrorClassificationCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeErrorClassificationCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeErrorClassificationCodeType extends EbayTradingWsdlClass
{
	/**
