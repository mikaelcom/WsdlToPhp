<?php
/**
 * Class file for EbayTradingTypeLocalListingDistancesSpecialtyDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeLocalListingDistancesSpecialtyDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeLocalListingDistancesSpecialtyDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
