<?php
/**
 * Class file for EbayTradingTypeLocalMarketContactByPhoneEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeLocalMarketContactByPhoneEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeLocalMarketContactByPhoneEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
