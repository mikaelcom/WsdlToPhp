<?php
/**
 * Class file for EbayTradingTypeLocalMarketPaymentMethodCheckOutEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeLocalMarketPaymentMethodCheckOutEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeLocalMarketPaymentMethodCheckOutEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
