<?php
/**
 * Class file for EbayTradingTypeLocalMarketContactByEmailEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeLocalMarketContactByEmailEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeLocalMarketContactByEmailEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
