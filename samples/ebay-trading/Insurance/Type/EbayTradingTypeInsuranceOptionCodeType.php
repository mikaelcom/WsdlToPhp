<?php
/**
 * Class file for EbayTradingTypeInsuranceOptionCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeInsuranceOptionCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeInsuranceOptionCodeType extends EbayTradingWsdlClass
{
	/**
