<?php
/**
 * File for EbayTradingWsdlClass to communicate with SOAP service
 * @date 04/07/2012
 */
/**
 * File for EbayTradingWsdlClass to communicate with SOAP service
 ...
 * @date 04/07/2012
 */
class EbayTradingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EbayTradingWsdlClass::setLastError()
	 * @uses EbayTradingWsdlClass::initSoapClient()
	 * @uses EbayTradingWsdlClass::initInternArrayToIterate()
	 * @uses EbayTradingWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EbayTradingWsdlClass::classMap()
	 * @uses EbayTradingWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EbayTradingClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EbayTradingClassMap::classMap();
	 ...
	 * @uses EbayTradingWsdlClass::WSDL_CACHE_WSDL
	 * @uses EbayTradingWsdlClass::WSDL_COMPRESSION
	 * @uses EbayTradingWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EbayTradingWsdlClass::WSDL_ENCODING
	 * @uses EbayTradingWsdlClass::WSDL_EXCPTS
	 * @uses EbayTradingWsdlClass::WSDL_FEATURES
	 * @uses EbayTradingWsdlClass::WSDL_LOGIN
	 * @uses EbayTradingWsdlClass::WSDL_PASSWD
	 * @uses EbayTradingWsdlClass::WSDL_SOAP_VERSION
	 * @uses EbayTradingWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EbayTradingWsdlClass::WSDL_TRACE
	 * @uses EbayTradingWsdlClass::WSDL_TYPEMAP
	 * @uses EbayTradingWsdlClass::WSDL_URL
	 * @uses EbayTradingWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EbayTradingWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EbayTradingWsdlClass::internArrayToIterateIsArray()
	 * @uses EbayTradingWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EbayTradingWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EbayTradingWsdlClass::getInternArrayToIterateOffset()
	 * @uses EbayTradingWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EbayTradingWsdlClass::getInternArrayToIterateOffset()
	 * @uses EbayTradingWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EbayTradingWsdlClass::offsetGet()
	 * @uses EbayTradingWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EbayTradingWsdlClass::getAttributeName()
	 * @uses EbayTradingWsdlClass::__toString()
	 * @uses EbayTradingWsdlClass::_set()
	 * @uses EbayTradingWsdlClass::_get()
	 * @uses EbayTradingWsdlClass::setInternArrayToIterate()
	 * @uses EbayTradingWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EbayTradingWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EbayTradingWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EbayTradingWsdlClass::item()
	 * @uses EbayTradingWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EbayTradingWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EbayTradingWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
