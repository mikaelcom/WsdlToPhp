<?php
/**
 * Class file for EbayTradingTypeFlatShippingDiscountType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeFlatShippingDiscountType
 * Documentation : Details of an individual discount profile defined by the user for flat rate shipping.
 * @date 04/07/2012
 */
class EbayTradingTypeFlatShippingDiscountType extends EbayTradingWsdlClass
{
	/**
	 * The DiscountName
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- documentation : The type of discount or "rule" that is being used by the profile. The value corresponding to the selected rule is set in the same-named field of FlatShippingDiscount.DiscountProfile. All are "variable" rules, as defined in the documentation on shipping discount profiles.
