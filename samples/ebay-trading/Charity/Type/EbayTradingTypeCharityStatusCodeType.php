<?php
/**
 * Class file for EbayTradingTypeCharityStatusCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeCharityStatusCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeCharityStatusCodeType extends EbayTradingWsdlClass
{
	/**
