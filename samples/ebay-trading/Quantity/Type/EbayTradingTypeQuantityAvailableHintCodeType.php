<?php
/**
 * Class file for EbayTradingTypeQuantityAvailableHintCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeQuantityAvailableHintCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeQuantityAvailableHintCodeType extends EbayTradingWsdlClass
{
	/**
