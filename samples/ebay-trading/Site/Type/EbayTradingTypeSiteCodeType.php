<?php
/**
 * Class file for EbayTradingTypeSiteCodeType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeSiteCodeType
 * @date 04/07/2012
 */
class EbayTradingTypeSiteCodeType extends EbayTradingWsdlClass
{
	/**
	 ...
	 * Meta informations :
	 * 	- documentation : China, currency CNY. Note that there is no longer an eBay China site.
	 * @return string 'China'
	 */
