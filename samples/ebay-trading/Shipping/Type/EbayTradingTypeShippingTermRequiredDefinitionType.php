<?php
/**
 * Class file for EbayTradingTypeShippingTermRequiredDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeShippingTermRequiredDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeShippingTermRequiredDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
