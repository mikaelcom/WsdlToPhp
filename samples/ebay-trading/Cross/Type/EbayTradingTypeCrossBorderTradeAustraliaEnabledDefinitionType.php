<?php
/**
 * Class file for EbayTradingTypeCrossBorderTradeAustraliaEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeCrossBorderTradeAustraliaEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeCrossBorderTradeAustraliaEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
