<?php
/**
 * Class file for EbayTradingTypeCrossBorderTradeNorthAmericaEnabledDefinitionType
 * @date 04/07/2012
 */
/**
 * Class EbayTradingTypeCrossBorderTradeNorthAmericaEnabledDefinitionType
 ...
 * @date 04/07/2012
 */
class EbayTradingTypeCrossBorderTradeNorthAmericaEnabledDefinitionType extends EbayTradingWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
