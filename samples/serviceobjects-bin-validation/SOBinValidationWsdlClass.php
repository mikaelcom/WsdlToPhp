<?php
/**
 * File for SOBinValidationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOBinValidationWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOBinValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOBinValidationWsdlClass::setLastError()
	 * @uses SOBinValidationWsdlClass::initSoapClient()
	 * @uses SOBinValidationWsdlClass::initInternArrayToIterate()
	 * @uses SOBinValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOBinValidationWsdlClass::classMap()
	 * @uses SOBinValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOBinValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOBinValidationClassMap::classMap();
	 ...
	 * @uses SOBinValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOBinValidationWsdlClass::WSDL_COMPRESSION
	 * @uses SOBinValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOBinValidationWsdlClass::WSDL_ENCODING
	 * @uses SOBinValidationWsdlClass::WSDL_EXCPTS
	 * @uses SOBinValidationWsdlClass::WSDL_FEATURES
	 * @uses SOBinValidationWsdlClass::WSDL_LOGIN
	 * @uses SOBinValidationWsdlClass::WSDL_PASSWD
	 * @uses SOBinValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOBinValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOBinValidationWsdlClass::WSDL_TRACE
	 * @uses SOBinValidationWsdlClass::WSDL_TYPEMAP
	 * @uses SOBinValidationWsdlClass::WSDL_URL
	 * @uses SOBinValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOBinValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses SOBinValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOBinValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOBinValidationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOBinValidationWsdlClass::offsetGet()
	 * @uses SOBinValidationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::getAttributeName()
	 * @uses SOBinValidationWsdlClass::__toString()
	 * @uses SOBinValidationWsdlClass::_set()
	 * @uses SOBinValidationWsdlClass::_get()
	 * @uses SOBinValidationWsdlClass::setInternArrayToIterate()
	 * @uses SOBinValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOBinValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::item()
	 * @uses SOBinValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOBinValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOBinValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
