<?php
/**
 * File for XWebEmailValidationWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebEmailValidationWsdlClass to communicate with SOAP service
 * Documentation : XML/SOAP based Web Service which validates email addresses for client applications.
 * @date 09/07/2012
 */
class XWebEmailValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebEmailValidationWsdlClass::setLastError()
	 * @uses XWebEmailValidationWsdlClass::initSoapClient()
	 * @uses XWebEmailValidationWsdlClass::initInternArrayToIterate()
	 * @uses XWebEmailValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebEmailValidationWsdlClass::classMap()
	 * @uses XWebEmailValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebEmailValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebEmailValidationClassMap::classMap();
	 ...
	 * @uses XWebEmailValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebEmailValidationWsdlClass::WSDL_COMPRESSION
	 * @uses XWebEmailValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebEmailValidationWsdlClass::WSDL_ENCODING
	 * @uses XWebEmailValidationWsdlClass::WSDL_EXCPTS
	 * @uses XWebEmailValidationWsdlClass::WSDL_FEATURES
	 * @uses XWebEmailValidationWsdlClass::WSDL_LOGIN
	 * @uses XWebEmailValidationWsdlClass::WSDL_PASSWD
	 * @uses XWebEmailValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebEmailValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebEmailValidationWsdlClass::WSDL_TRACE
	 * @uses XWebEmailValidationWsdlClass::WSDL_TYPEMAP
	 * @uses XWebEmailValidationWsdlClass::WSDL_URL
	 * @uses XWebEmailValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebEmailValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebEmailValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebEmailValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebEmailValidationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebEmailValidationWsdlClass::offsetGet()
	 * @uses XWebEmailValidationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::getAttributeName()
	 * @uses XWebEmailValidationWsdlClass::__toString()
	 * @uses XWebEmailValidationWsdlClass::_set()
	 * @uses XWebEmailValidationWsdlClass::_get()
	 * @uses XWebEmailValidationWsdlClass::setInternArrayToIterate()
	 * @uses XWebEmailValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebEmailValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::item()
	 * @uses XWebEmailValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebEmailValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebEmailValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
