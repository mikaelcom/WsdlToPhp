<?php
/**
 * Class file for SPPermissionsTypeUpdatePermission
 * @date 06/07/2012
 */
/**
 * Class SPPermissionsTypeUpdatePermission
 * @date 06/07/2012
 */
class SPPermissionsTypeUpdatePermission extends SPPermissionsWsdlClass
{
	/**
	 * The objectName
	 * @var string
	 ...
	 * @return SPPermissionsTypeUpdatePermission
	 */
