<?php
/**
 * File for SPPermissionsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPPermissionsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPPermissionsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPPermissionsWsdlClass::setLastError()
	 * @uses SPPermissionsWsdlClass::initSoapClient()
	 * @uses SPPermissionsWsdlClass::initInternArrayToIterate()
	 * @uses SPPermissionsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPPermissionsWsdlClass::classMap()
	 * @uses SPPermissionsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPPermissionsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPPermissionsClassMap::classMap();
	 ...
	 * @uses SPPermissionsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPPermissionsWsdlClass::WSDL_COMPRESSION
	 * @uses SPPermissionsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPPermissionsWsdlClass::WSDL_ENCODING
	 * @uses SPPermissionsWsdlClass::WSDL_EXCPTS
	 * @uses SPPermissionsWsdlClass::WSDL_FEATURES
	 * @uses SPPermissionsWsdlClass::WSDL_LOGIN
	 * @uses SPPermissionsWsdlClass::WSDL_PASSWD
	 * @uses SPPermissionsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPPermissionsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPPermissionsWsdlClass::WSDL_TRACE
	 * @uses SPPermissionsWsdlClass::WSDL_TYPEMAP
	 * @uses SPPermissionsWsdlClass::WSDL_URL
	 * @uses SPPermissionsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPPermissionsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPPermissionsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPPermissionsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPPermissionsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPPermissionsWsdlClass::offsetGet()
	 * @uses SPPermissionsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::getAttributeName()
	 * @uses SPPermissionsWsdlClass::__toString()
	 * @uses SPPermissionsWsdlClass::_set()
	 * @uses SPPermissionsWsdlClass::_get()
	 * @uses SPPermissionsWsdlClass::setInternArrayToIterate()
	 * @uses SPPermissionsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPPermissionsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::item()
	 * @uses SPPermissionsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPPermissionsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPPermissionsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
