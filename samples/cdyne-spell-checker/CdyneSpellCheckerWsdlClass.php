<?php
/**
 * File for CdyneSpellCheckerWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for CdyneSpellCheckerWsdlClass to communicate with SOAP service
 * Documentation : This engine makes spelling suggestions for text.<br><br><b>See it working at</b>: <a href="http://www.cdyne.com/SpellChecker" target="_blank">http://www.cdyne.com/SpellChecker</a>
 * @date 03/07/2012
 */
class CdyneSpellCheckerWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdyneSpellCheckerWsdlClass::setLastError()
	 * @uses CdyneSpellCheckerWsdlClass::initSoapClient()
	 * @uses CdyneSpellCheckerWsdlClass::initInternArrayToIterate()
	 * @uses CdyneSpellCheckerWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneSpellCheckerWsdlClass::classMap()
	 * @uses CdyneSpellCheckerWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneSpellCheckerClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneSpellCheckerClassMap::classMap();
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_ENCODING
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_EXCPTS
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_FEATURES
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_LOGIN
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_PASSWD
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_TRACE
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_URL
	 * @uses CdyneSpellCheckerWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneSpellCheckerWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneSpellCheckerWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneSpellCheckerWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneSpellCheckerWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see CdyneSpellCheckerWsdlClass::offsetGet()
	 * @uses CdyneSpellCheckerWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::getAttributeName()
	 * @uses CdyneSpellCheckerWsdlClass::__toString()
	 * @uses CdyneSpellCheckerWsdlClass::_set()
	 * @uses CdyneSpellCheckerWsdlClass::_get()
	 * @uses CdyneSpellCheckerWsdlClass::setInternArrayToIterate()
	 * @uses CdyneSpellCheckerWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneSpellCheckerWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::item()
	 * @uses CdyneSpellCheckerWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneSpellCheckerWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneSpellCheckerWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
