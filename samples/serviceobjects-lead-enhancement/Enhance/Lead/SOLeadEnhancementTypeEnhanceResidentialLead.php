<?php
/**
 * Class file for SOLeadEnhancementTypeEnhanceResidentialLead
 * @date 06/07/2012
 */
/**
 * Class SOLeadEnhancementTypeEnhanceResidentialLead
 * @date 06/07/2012
 */
class SOLeadEnhancementTypeEnhanceResidentialLead extends SOLeadEnhancementWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return SOLeadEnhancementTypeEnhanceResidentialLead
	 */
