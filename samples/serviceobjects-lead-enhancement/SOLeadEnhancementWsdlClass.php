<?php
/**
 * File for SOLeadEnhancementWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SOLeadEnhancementWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SOLeadEnhancementWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOLeadEnhancementWsdlClass::setLastError()
	 * @uses SOLeadEnhancementWsdlClass::initSoapClient()
	 * @uses SOLeadEnhancementWsdlClass::initInternArrayToIterate()
	 * @uses SOLeadEnhancementWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOLeadEnhancementWsdlClass::classMap()
	 * @uses SOLeadEnhancementWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOLeadEnhancementClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOLeadEnhancementClassMap::classMap();
	 ...
	 * @uses SOLeadEnhancementWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOLeadEnhancementWsdlClass::WSDL_COMPRESSION
	 * @uses SOLeadEnhancementWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOLeadEnhancementWsdlClass::WSDL_ENCODING
	 * @uses SOLeadEnhancementWsdlClass::WSDL_EXCPTS
	 * @uses SOLeadEnhancementWsdlClass::WSDL_FEATURES
	 * @uses SOLeadEnhancementWsdlClass::WSDL_LOGIN
	 * @uses SOLeadEnhancementWsdlClass::WSDL_PASSWD
	 * @uses SOLeadEnhancementWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOLeadEnhancementWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOLeadEnhancementWsdlClass::WSDL_TRACE
	 * @uses SOLeadEnhancementWsdlClass::WSDL_TYPEMAP
	 * @uses SOLeadEnhancementWsdlClass::WSDL_URL
	 * @uses SOLeadEnhancementWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOLeadEnhancementWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::internArrayToIterateIsArray()
	 * @uses SOLeadEnhancementWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOLeadEnhancementWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOLeadEnhancementWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOLeadEnhancementWsdlClass::offsetGet()
	 * @uses SOLeadEnhancementWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::getAttributeName()
	 * @uses SOLeadEnhancementWsdlClass::__toString()
	 * @uses SOLeadEnhancementWsdlClass::_set()
	 * @uses SOLeadEnhancementWsdlClass::_get()
	 * @uses SOLeadEnhancementWsdlClass::setInternArrayToIterate()
	 * @uses SOLeadEnhancementWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOLeadEnhancementWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::item()
	 * @uses SOLeadEnhancementWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOLeadEnhancementWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
