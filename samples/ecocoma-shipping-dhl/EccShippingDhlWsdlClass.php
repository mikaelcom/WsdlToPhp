<?php
/**
 * File for EccShippingDhlWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccShippingDhlWsdlClass to communicate with SOAP service
 * Documentation : Cocoma DHL Shipping Web Services.
 * @date 03/07/2012
 */
class EccShippingDhlWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccShippingDhlWsdlClass::setLastError()
	 * @uses EccShippingDhlWsdlClass::initSoapClient()
	 * @uses EccShippingDhlWsdlClass::initInternArrayToIterate()
	 * @uses EccShippingDhlWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccShippingDhlWsdlClass::classMap()
	 * @uses EccShippingDhlWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccShippingDhlClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccShippingDhlClassMap::classMap();
	 ...
	 * @uses EccShippingDhlWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccShippingDhlWsdlClass::WSDL_COMPRESSION
	 * @uses EccShippingDhlWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccShippingDhlWsdlClass::WSDL_ENCODING
	 * @uses EccShippingDhlWsdlClass::WSDL_EXCPTS
	 * @uses EccShippingDhlWsdlClass::WSDL_FEATURES
	 * @uses EccShippingDhlWsdlClass::WSDL_LOGIN
	 * @uses EccShippingDhlWsdlClass::WSDL_PASSWD
	 * @uses EccShippingDhlWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccShippingDhlWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccShippingDhlWsdlClass::WSDL_TRACE
	 * @uses EccShippingDhlWsdlClass::WSDL_TYPEMAP
	 * @uses EccShippingDhlWsdlClass::WSDL_URL
	 * @uses EccShippingDhlWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccShippingDhlWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::internArrayToIterateIsArray()
	 * @uses EccShippingDhlWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingDhlWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingDhlWsdlClass::offsetExists()
	 ...
	 * @uses EccShippingDhlWsdlClass::getAttributeName()
	 * @uses EccShippingDhlWsdlClass::__toString()
	 * @uses EccShippingDhlWsdlClass::_set()
	 * @uses EccShippingDhlWsdlClass::_get()
	 * @uses EccShippingDhlWsdlClass::setInternArrayToIterate()
	 * @uses EccShippingDhlWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccShippingDhlWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::item()
	 * @uses EccShippingDhlWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingDhlWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccShippingDhlWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
