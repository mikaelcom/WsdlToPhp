<?php
/**
 * Class file for XiAnalystsTypeGetMultiResearchField
 * @date 08/07/2012
 */
/**
 * Class XiAnalystsTypeGetMultiResearchField
 * @date 08/07/2012
 */
class XiAnalystsTypeGetMultiResearchField extends XiAnalystsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiAnalystsTypeGetMultiResearchField
	 */
