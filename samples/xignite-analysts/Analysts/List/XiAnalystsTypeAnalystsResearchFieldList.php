<?php
/**
 * Class file for XiAnalystsTypeAnalystsResearchFieldList
 * @date 08/07/2012
 */
/**
 * Class XiAnalystsTypeAnalystsResearchFieldList
 * @date 08/07/2012
 */
class XiAnalystsTypeAnalystsResearchFieldList extends XiAnalystsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
