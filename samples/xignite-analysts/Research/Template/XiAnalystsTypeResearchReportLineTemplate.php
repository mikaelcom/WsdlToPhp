<?php
/**
 * Class file for XiAnalystsTypeResearchReportLineTemplate
 * @date 08/07/2012
 */
/**
 * Class XiAnalystsTypeResearchReportLineTemplate
 * @date 08/07/2012
 */
class XiAnalystsTypeResearchReportLineTemplate extends XiAnalystsWsdlClass
{
	/**
	...
	{
		parent::__construct(array('ResearchReportLineType'=>$_ResearchReportLineType,'Name'=>$_Name,'Description'=>$_Description,'Values'=>new XiAnalystsTypeArrayOfString($_Values)));
	}
	/**
