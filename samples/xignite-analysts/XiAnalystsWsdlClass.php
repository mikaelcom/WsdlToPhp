<?php
/**
 * File for XiAnalystsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiAnalystsWsdlClass to communicate with SOAP service
 * Documentation : Zacks Analysts Ratings
 * @date 08/07/2012
 */
class XiAnalystsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiAnalystsWsdlClass::setLastError()
	 * @uses XiAnalystsWsdlClass::initSoapClient()
	 * @uses XiAnalystsWsdlClass::initInternArrayToIterate()
	 * @uses XiAnalystsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiAnalystsWsdlClass::classMap()
	 * @uses XiAnalystsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiAnalystsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiAnalystsClassMap::classMap();
	 ...
	 * @uses XiAnalystsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiAnalystsWsdlClass::WSDL_COMPRESSION
	 * @uses XiAnalystsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiAnalystsWsdlClass::WSDL_ENCODING
	 * @uses XiAnalystsWsdlClass::WSDL_EXCPTS
	 * @uses XiAnalystsWsdlClass::WSDL_FEATURES
	 * @uses XiAnalystsWsdlClass::WSDL_LOGIN
	 * @uses XiAnalystsWsdlClass::WSDL_PASSWD
	 * @uses XiAnalystsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiAnalystsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiAnalystsWsdlClass::WSDL_TRACE
	 * @uses XiAnalystsWsdlClass::WSDL_TYPEMAP
	 * @uses XiAnalystsWsdlClass::WSDL_URL
	 * @uses XiAnalystsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiAnalystsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiAnalystsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiAnalystsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiAnalystsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiAnalystsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiAnalystsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiAnalystsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiAnalystsWsdlClass::offsetExists()
	 ...
	 * @uses XiAnalystsWsdlClass::getAttributeName()
	 * @uses XiAnalystsWsdlClass::__toString()
	 * @uses XiAnalystsWsdlClass::_set()
	 * @uses XiAnalystsWsdlClass::_get()
	 * @uses XiAnalystsWsdlClass::setInternArrayToIterate()
	 * @uses XiAnalystsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiAnalystsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiAnalystsWsdlClass::item()
	 * @uses XiAnalystsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiAnalystsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiAnalystsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
