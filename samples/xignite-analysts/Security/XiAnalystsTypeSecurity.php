<?php
/**
 * Class file for XiAnalystsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiAnalystsTypeSecurity
 * @date 08/07/2012
 */
class XiAnalystsTypeSecurity extends XiAnalystsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiAnalystsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
