<?php
/**
 * Class file for PayPalTypeBMCreateButtonRequestType
 * @date 14/07/2012
 */
/**
 * Class PayPalTypeBMCreateButtonRequestType
 * @date 14/07/2012
 */
class PayPalTypeBMCreateButtonRequestType extends PayPalTypeAbstractRequestType
{
	/**
	 * The ButtonType
	 * Meta informations :
