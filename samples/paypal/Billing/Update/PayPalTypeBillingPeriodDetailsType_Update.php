<?php
/**
 * Class file for PayPalTypeBillingPeriodDetailsType_Update
 * @date 14/07/2012
 */
/**
 * Class PayPalTypeBillingPeriodDetailsType_Update
 * @date 14/07/2012
 */
class PayPalTypeBillingPeriodDetailsType_Update extends PayPalWsdlClass
{
	/**
	 * The BillingPeriod
	 * Meta informations :
