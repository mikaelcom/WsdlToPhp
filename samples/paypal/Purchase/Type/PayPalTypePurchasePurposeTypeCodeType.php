<?php
/**
 * Class file for PayPalTypePurchasePurposeTypeCodeType
 * @date 14/07/2012
 */
/**
 * Class PayPalTypePurchasePurposeTypeCodeType
 * @date 14/07/2012
 */
class PayPalTypePurchasePurposeTypeCodeType extends PayPalWsdlClass
{
	/**
	...
	/**
	 * Constructor
	 * @return PayPalTypePurchasePurposeTypeCodeType
	 */
