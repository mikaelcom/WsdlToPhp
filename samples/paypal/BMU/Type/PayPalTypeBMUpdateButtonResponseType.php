<?php
/**
 * Class file for PayPalTypeBMUpdateButtonResponseType
 * @date 14/07/2012
 */
/**
 * Class PayPalTypeBMUpdateButtonResponseType
 * @date 14/07/2012
 */
class PayPalTypeBMUpdateButtonResponseType extends PayPalTypeAbstractResponseType
{
	/**
	 * The Website
	 * Meta informations :
