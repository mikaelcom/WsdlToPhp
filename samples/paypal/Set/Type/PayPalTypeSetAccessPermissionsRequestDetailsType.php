<?php
/**
 * Class file for PayPalTypeSetAccessPermissionsRequestDetailsType
 * @date 14/07/2012
 */
/**
 * Class PayPalTypeSetAccessPermissionsRequestDetailsType
 * @date 14/07/2012
 */
class PayPalTypeSetAccessPermissionsRequestDetailsType extends PayPalWsdlClass
{
	/**
	 * The ReturnURL
	 * Meta informations :
