<?php
/**
 * Class file for PayPalTypeSetAccessPermissionsResponseType
 * @date 14/07/2012
 */
/**
 * Class PayPalTypeSetAccessPermissionsResponseType
 * @date 14/07/2012
 */
class PayPalTypeSetAccessPermissionsResponseType extends PayPalTypeAbstractResponseType
{
	/**
	 * The Token
	 * Meta informations :
