<?php
/**
 * File for UsgsUsngWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for UsgsUsngWsdlClass to communicate with SOAP service
 * Documentation : The USNG Web Service returns the United States National Grid Coordinate for a specific latitutde/longitude point or the Latitude/longitude for a USNG position. View the detailed <a href="http://gisdata.usgs.net/xmlwebservices/USNG_methods.asp">USNG Methods</a> description for more information on the methods and parameters used in this service. Visit <a href="http://gisdata.usgs.net/">http://gisdata.usgs.net/</a> to view other USGS Web Services.
 * @date 08/07/2012
 */
class UsgsUsngWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses UsgsUsngWsdlClass::setLastError()
	 * @uses UsgsUsngWsdlClass::initSoapClient()
	 * @uses UsgsUsngWsdlClass::initInternArrayToIterate()
	 * @uses UsgsUsngWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses UsgsUsngWsdlClass::classMap()
	 * @uses UsgsUsngWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('UsgsUsngClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = UsgsUsngClassMap::classMap();
	 ...
	 * @uses UsgsUsngWsdlClass::WSDL_CACHE_WSDL
	 * @uses UsgsUsngWsdlClass::WSDL_COMPRESSION
	 * @uses UsgsUsngWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses UsgsUsngWsdlClass::WSDL_ENCODING
	 * @uses UsgsUsngWsdlClass::WSDL_EXCPTS
	 * @uses UsgsUsngWsdlClass::WSDL_FEATURES
	 * @uses UsgsUsngWsdlClass::WSDL_LOGIN
	 * @uses UsgsUsngWsdlClass::WSDL_PASSWD
	 * @uses UsgsUsngWsdlClass::WSDL_SOAP_VERSION
	 * @uses UsgsUsngWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses UsgsUsngWsdlClass::WSDL_TRACE
	 * @uses UsgsUsngWsdlClass::WSDL_TYPEMAP
	 * @uses UsgsUsngWsdlClass::WSDL_URL
	 * @uses UsgsUsngWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses UsgsUsngWsdlClass::internArrayToIterateIsArray()
	 * @uses UsgsUsngWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses UsgsUsngWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsUsngWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsUsngWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses UsgsUsngWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsUsngWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see UsgsUsngWsdlClass::offsetGet()
	 * @uses UsgsUsngWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses UsgsUsngWsdlClass::getAttributeName()
	 * @uses UsgsUsngWsdlClass::__toString()
	 * @uses UsgsUsngWsdlClass::_set()
	 * @uses UsgsUsngWsdlClass::_get()
	 * @uses UsgsUsngWsdlClass::setInternArrayToIterate()
	 * @uses UsgsUsngWsdlClass::setInternArrayToIterateIsArray()
	 * @uses UsgsUsngWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses UsgsUsngWsdlClass::getInternArrayToIterateIsArray()
	 * @uses UsgsUsngWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
