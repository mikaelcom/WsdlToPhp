<?php
/**
 * File for XWebPriceAvailabilityWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebPriceAvailabilityWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebPriceAvailabilityWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebPriceAvailabilityWsdlClass::setLastError()
	 * @uses XWebPriceAvailabilityWsdlClass::initSoapClient()
	 * @uses XWebPriceAvailabilityWsdlClass::initInternArrayToIterate()
	 * @uses XWebPriceAvailabilityWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebPriceAvailabilityWsdlClass::classMap()
	 * @uses XWebPriceAvailabilityWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebPriceAvailabilityClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebPriceAvailabilityClassMap::classMap();
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_COMPRESSION
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_ENCODING
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_EXCPTS
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_FEATURES
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_LOGIN
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_PASSWD
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_TRACE
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_TYPEMAP
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_URL
	 * @uses XWebPriceAvailabilityWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebPriceAvailabilityWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebPriceAvailabilityWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebPriceAvailabilityWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebPriceAvailabilityWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebPriceAvailabilityWsdlClass::offsetGet()
	 * @uses XWebPriceAvailabilityWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::getAttributeName()
	 * @uses XWebPriceAvailabilityWsdlClass::__toString()
	 * @uses XWebPriceAvailabilityWsdlClass::_set()
	 * @uses XWebPriceAvailabilityWsdlClass::_get()
	 * @uses XWebPriceAvailabilityWsdlClass::setInternArrayToIterate()
	 * @uses XWebPriceAvailabilityWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebPriceAvailabilityWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::item()
	 * @uses XWebPriceAvailabilityWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceAvailabilityWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebPriceAvailabilityWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
