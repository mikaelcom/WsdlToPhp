<?php
/**
 * Class file for XWebPriceAvailabilityTypeRefIDQualType
 * @date 09/07/2012
 */
/**
 * Class XWebPriceAvailabilityTypeRefIDQualType
 * @date 09/07/2012
 */
class XWebPriceAvailabilityTypeRefIDQualType extends XWebPriceAvailabilityWsdlClass
{
	/**
