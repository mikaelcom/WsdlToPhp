<?php
/**
 * Class file for XWebPriceAvailabilityTypeResponseSummaryType
 * @date 09/07/2012
 */
/**
 * Class XWebPriceAvailabilityTypeResponseSummaryType
 * @date 09/07/2012
 */
class XWebPriceAvailabilityTypeResponseSummaryType extends XWebPriceAvailabilityWsdlClass
{
	/**
	 * The NbrOfSegments
	 * @var NbrOfSegments
