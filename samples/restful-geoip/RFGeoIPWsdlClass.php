<?php
/**
 * File for RFGeoIPWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFGeoIPWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFGeoIPWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFGeoIPWsdlClass::setLastError()
	 * @uses RFGeoIPWsdlClass::initSoapClient()
	 * @uses RFGeoIPWsdlClass::initInternArrayToIterate()
	 * @uses RFGeoIPWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFGeoIPWsdlClass::classMap()
	 * @uses RFGeoIPWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFGeoIPClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFGeoIPClassMap::classMap();
	 ...
	 * @uses RFGeoIPWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFGeoIPWsdlClass::WSDL_COMPRESSION
	 * @uses RFGeoIPWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFGeoIPWsdlClass::WSDL_ENCODING
	 * @uses RFGeoIPWsdlClass::WSDL_EXCPTS
	 * @uses RFGeoIPWsdlClass::WSDL_FEATURES
	 * @uses RFGeoIPWsdlClass::WSDL_LOGIN
	 * @uses RFGeoIPWsdlClass::WSDL_PASSWD
	 * @uses RFGeoIPWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFGeoIPWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFGeoIPWsdlClass::WSDL_TRACE
	 * @uses RFGeoIPWsdlClass::WSDL_TYPEMAP
	 * @uses RFGeoIPWsdlClass::WSDL_URL
	 * @uses RFGeoIPWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses RFGeoIPWsdlClass::internArrayToIterateIsArray()
	 * @uses RFGeoIPWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFGeoIPWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFGeoIPWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFGeoIPWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFGeoIPWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFGeoIPWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see RFGeoIPWsdlClass::offsetGet()
	 * @uses RFGeoIPWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses RFGeoIPWsdlClass::getAttributeName()
	 * @uses RFGeoIPWsdlClass::__toString()
	 * @uses RFGeoIPWsdlClass::_set()
	 * @uses RFGeoIPWsdlClass::_get()
	 * @uses RFGeoIPWsdlClass::setInternArrayToIterate()
	 * @uses RFGeoIPWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFGeoIPWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFGeoIPWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFGeoIPWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
