<?php
/**
 * Class file for AmazonWebServicesTypeClearShoppingCartRequest
 * @date 10/07/2012
 */
/**
 * Class AmazonWebServicesTypeClearShoppingCartRequest
 * @date 10/07/2012
 */
class AmazonWebServicesTypeClearShoppingCartRequest extends AmazonWebServicesWsdlClass
{
	/**
	 * The tag
	 * @var string
	 ...
	 * @param string HMAC
	 * @param string locale
	 * @return AmazonWebServicesTypeClearShoppingCartRequest
	 */
