<?php
/**
 * Class file for AmazonWebServicesTypeModifyShoppingCartItemsRequest
 * @date 10/07/2012
 */
/**
 * Class AmazonWebServicesTypeModifyShoppingCartItemsRequest
 * @date 10/07/2012
 */
class AmazonWebServicesTypeModifyShoppingCartItemsRequest extends AmazonWebServicesWsdlClass
{
	/**
	 * The tag
	 * @var string
	 ...
	 * @param string CartId
	 * @param string HMAC
	 * @param ItemQuantityArray Items
	 * @param string locale
	 * @return AmazonWebServicesTypeModifyShoppingCartItemsRequest
	 */
