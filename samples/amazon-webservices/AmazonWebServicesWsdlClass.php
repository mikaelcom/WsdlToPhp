<?php
/**
 * File for AmazonWebServicesWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonWebServicesWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class AmazonWebServicesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonWebServicesWsdlClass::setLastError()
	 * @uses AmazonWebServicesWsdlClass::initSoapClient()
	 * @uses AmazonWebServicesWsdlClass::initInternArrayToIterate()
	 * @uses AmazonWebServicesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonWebServicesWsdlClass::classMap()
	 * @uses AmazonWebServicesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonWebServicesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonWebServicesClassMap::classMap();
	 ...
	 * @uses AmazonWebServicesWsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonWebServicesWsdlClass::WSDL_COMPRESSION
	 * @uses AmazonWebServicesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonWebServicesWsdlClass::WSDL_ENCODING
	 * @uses AmazonWebServicesWsdlClass::WSDL_EXCPTS
	 * @uses AmazonWebServicesWsdlClass::WSDL_FEATURES
	 * @uses AmazonWebServicesWsdlClass::WSDL_LOGIN
	 * @uses AmazonWebServicesWsdlClass::WSDL_PASSWD
	 * @uses AmazonWebServicesWsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonWebServicesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonWebServicesWsdlClass::WSDL_TRACE
	 * @uses AmazonWebServicesWsdlClass::WSDL_TYPEMAP
	 * @uses AmazonWebServicesWsdlClass::WSDL_URL
	 * @uses AmazonWebServicesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses AmazonWebServicesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonWebServicesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonWebServicesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonWebServicesWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonWebServicesWsdlClass::offsetGet()
	 * @uses AmazonWebServicesWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::getAttributeName()
	 * @uses AmazonWebServicesWsdlClass::__toString()
	 * @uses AmazonWebServicesWsdlClass::_set()
	 * @uses AmazonWebServicesWsdlClass::_get()
	 * @uses AmazonWebServicesWsdlClass::setInternArrayToIterate()
	 * @uses AmazonWebServicesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonWebServicesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::item()
	 * @uses AmazonWebServicesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonWebServicesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonWebServicesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
