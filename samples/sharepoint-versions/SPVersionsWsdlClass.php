<?php
/**
 * File for SPVersionsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPVersionsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPVersionsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPVersionsWsdlClass::setLastError()
	 * @uses SPVersionsWsdlClass::initSoapClient()
	 * @uses SPVersionsWsdlClass::initInternArrayToIterate()
	 * @uses SPVersionsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPVersionsWsdlClass::classMap()
	 * @uses SPVersionsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPVersionsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPVersionsClassMap::classMap();
	 ...
	 * @uses SPVersionsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPVersionsWsdlClass::WSDL_COMPRESSION
	 * @uses SPVersionsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPVersionsWsdlClass::WSDL_ENCODING
	 * @uses SPVersionsWsdlClass::WSDL_EXCPTS
	 * @uses SPVersionsWsdlClass::WSDL_FEATURES
	 * @uses SPVersionsWsdlClass::WSDL_LOGIN
	 * @uses SPVersionsWsdlClass::WSDL_PASSWD
	 * @uses SPVersionsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPVersionsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPVersionsWsdlClass::WSDL_TRACE
	 * @uses SPVersionsWsdlClass::WSDL_TYPEMAP
	 * @uses SPVersionsWsdlClass::WSDL_URL
	 * @uses SPVersionsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPVersionsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPVersionsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPVersionsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPVersionsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPVersionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPVersionsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPVersionsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPVersionsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPVersionsWsdlClass::offsetGet()
	 * @uses SPVersionsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPVersionsWsdlClass::getAttributeName()
	 * @uses SPVersionsWsdlClass::__toString()
	 * @uses SPVersionsWsdlClass::_set()
	 * @uses SPVersionsWsdlClass::_get()
	 * @uses SPVersionsWsdlClass::setInternArrayToIterate()
	 * @uses SPVersionsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPVersionsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPVersionsWsdlClass::item()
	 * @uses SPVersionsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPVersionsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPVersionsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
