<?php
/**
 * File for SOEmailAppendWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOEmailAppendWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOEmailAppendWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOEmailAppendWsdlClass::setLastError()
	 * @uses SOEmailAppendWsdlClass::initSoapClient()
	 * @uses SOEmailAppendWsdlClass::initInternArrayToIterate()
	 * @uses SOEmailAppendWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOEmailAppendWsdlClass::classMap()
	 * @uses SOEmailAppendWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOEmailAppendClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOEmailAppendClassMap::classMap();
	 ...
	 * @uses SOEmailAppendWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOEmailAppendWsdlClass::WSDL_COMPRESSION
	 * @uses SOEmailAppendWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOEmailAppendWsdlClass::WSDL_ENCODING
	 * @uses SOEmailAppendWsdlClass::WSDL_EXCPTS
	 * @uses SOEmailAppendWsdlClass::WSDL_FEATURES
	 * @uses SOEmailAppendWsdlClass::WSDL_LOGIN
	 * @uses SOEmailAppendWsdlClass::WSDL_PASSWD
	 * @uses SOEmailAppendWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOEmailAppendWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOEmailAppendWsdlClass::WSDL_TRACE
	 * @uses SOEmailAppendWsdlClass::WSDL_TYPEMAP
	 * @uses SOEmailAppendWsdlClass::WSDL_URL
	 * @uses SOEmailAppendWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOEmailAppendWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::internArrayToIterateIsArray()
	 * @uses SOEmailAppendWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOEmailAppendWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOEmailAppendWsdlClass::offsetExists()
	 ...
	 * @uses SOEmailAppendWsdlClass::getAttributeName()
	 * @uses SOEmailAppendWsdlClass::__toString()
	 * @uses SOEmailAppendWsdlClass::_set()
	 * @uses SOEmailAppendWsdlClass::_get()
	 * @uses SOEmailAppendWsdlClass::setInternArrayToIterate()
	 * @uses SOEmailAppendWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOEmailAppendWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::item()
	 * @uses SOEmailAppendWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailAppendWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOEmailAppendWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
