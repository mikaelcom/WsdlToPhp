<?php
/**
 * File for EccShippingUpsWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccShippingUpsWsdlClass to communicate with SOAP service
 * Documentation : Cocoma UPS Shipping Web Services.
 * @date 03/07/2012
 */
class EccShippingUpsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccShippingUpsWsdlClass::setLastError()
	 * @uses EccShippingUpsWsdlClass::initSoapClient()
	 * @uses EccShippingUpsWsdlClass::initInternArrayToIterate()
	 * @uses EccShippingUpsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccShippingUpsWsdlClass::classMap()
	 * @uses EccShippingUpsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccShippingUpsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccShippingUpsClassMap::classMap();
	 ...
	 * @uses EccShippingUpsWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccShippingUpsWsdlClass::WSDL_COMPRESSION
	 * @uses EccShippingUpsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccShippingUpsWsdlClass::WSDL_ENCODING
	 * @uses EccShippingUpsWsdlClass::WSDL_EXCPTS
	 * @uses EccShippingUpsWsdlClass::WSDL_FEATURES
	 * @uses EccShippingUpsWsdlClass::WSDL_LOGIN
	 * @uses EccShippingUpsWsdlClass::WSDL_PASSWD
	 * @uses EccShippingUpsWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccShippingUpsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccShippingUpsWsdlClass::WSDL_TRACE
	 * @uses EccShippingUpsWsdlClass::WSDL_TYPEMAP
	 * @uses EccShippingUpsWsdlClass::WSDL_URL
	 * @uses EccShippingUpsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccShippingUpsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::internArrayToIterateIsArray()
	 * @uses EccShippingUpsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingUpsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingUpsWsdlClass::offsetExists()
	 ...
	 * @uses EccShippingUpsWsdlClass::getAttributeName()
	 * @uses EccShippingUpsWsdlClass::__toString()
	 * @uses EccShippingUpsWsdlClass::_set()
	 * @uses EccShippingUpsWsdlClass::_get()
	 * @uses EccShippingUpsWsdlClass::setInternArrayToIterate()
	 * @uses EccShippingUpsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccShippingUpsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::item()
	 * @uses EccShippingUpsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingUpsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccShippingUpsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
