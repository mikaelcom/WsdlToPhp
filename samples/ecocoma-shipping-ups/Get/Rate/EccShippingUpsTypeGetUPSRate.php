<?php
/**
 * Class file for EccShippingUpsTypeGetUPSRate
 * @date 03/07/2012
 */
/**
 * Class EccShippingUpsTypeGetUPSRate
 * @date 03/07/2012
 */
class EccShippingUpsTypeGetUPSRate extends EccShippingUpsWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Weight
	 * @param string Value
	 * @return EccShippingUpsTypeGetUPSRate
	 */
	public function __construct($_KeyID = null,$_DomainID = null,$_origPostal = null,$_origCountry = null,$_destPostal = null,$_destCountry = null,$_Weight = null,$_Value = null)
	{
		parent::__construct(array('KeyID'=>$_KeyID,'DomainID'=>$_DomainID,'origPostal'=>$_origPostal,'origCountry'=>$_origCountry,'destPostal'=>$_destPostal,'destCountry'=>$_destCountry,'Weight'=>$_Weight,'Value'=>$_Value));
	}
	/**
	 * Set KeyID
	 * @param string KeyID
