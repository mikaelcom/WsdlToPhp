<?php
/**
 * File for YMailWsdlClass to communicate with SOAP service
 * @date 02/07/2012
 */
/**
 * File for YMailWsdlClass to communicate with SOAP service
 ...
 * @date 02/07/2012
 */
class YMailWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses YMailWsdlClass::setLastError()
	 * @uses YMailWsdlClass::initSoapClient()
	 * @uses YMailWsdlClass::initInternArrayToIterate()
	 * @uses YMailWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses YMailWsdlClass::classMap()
	 * @uses YMailWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('YMailClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = YMailClassMap::classMap();
	 ...
	 * @uses YMailWsdlClass::WSDL_CACHE_WSDL
	 * @uses YMailWsdlClass::WSDL_COMPRESSION
	 * @uses YMailWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses YMailWsdlClass::WSDL_ENCODING
	 * @uses YMailWsdlClass::WSDL_EXCPTS
	 * @uses YMailWsdlClass::WSDL_FEATURES
	 * @uses YMailWsdlClass::WSDL_LOGIN
	 * @uses YMailWsdlClass::WSDL_PASSWD
	 * @uses YMailWsdlClass::WSDL_SOAP_VERSION
	 * @uses YMailWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses YMailWsdlClass::WSDL_TRACE
	 * @uses YMailWsdlClass::WSDL_TYPEMAP
	 * @uses YMailWsdlClass::WSDL_URL
	 * @uses YMailWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses YMailWsdlClass::internArrayToIterateIsArray()
	 * @uses YMailWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses YMailWsdlClass::getInternArrayToIterateOffset()
	 * @uses YMailWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses YMailWsdlClass::getInternArrayToIterateOffset()
	 * @uses YMailWsdlClass::offsetExists()
	 ...
	 * @uses YMailWsdlClass::getAttributeName()
	 * @uses YMailWsdlClass::__toString()
	 * @uses YMailWsdlClass::_set()
	 * @uses YMailWsdlClass::_get()
	 * @uses YMailWsdlClass::setInternArrayToIterate()
	 * @uses YMailWsdlClass::setInternArrayToIterateIsArray()
	 * @uses YMailWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses YMailWsdlClass::getInternArrayToIterateIsArray()
	 * @uses YMailWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
