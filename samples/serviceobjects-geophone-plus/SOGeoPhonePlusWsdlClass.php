<?php
/**
 * File for SOGeoPhonePlusWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOGeoPhonePlusWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOGeoPhonePlusWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOGeoPhonePlusWsdlClass::setLastError()
	 * @uses SOGeoPhonePlusWsdlClass::initSoapClient()
	 * @uses SOGeoPhonePlusWsdlClass::initInternArrayToIterate()
	 * @uses SOGeoPhonePlusWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOGeoPhonePlusWsdlClass::classMap()
	 * @uses SOGeoPhonePlusWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOGeoPhonePlusClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOGeoPhonePlusClassMap::classMap();
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_COMPRESSION
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_ENCODING
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_EXCPTS
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_FEATURES
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_LOGIN
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_PASSWD
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_TRACE
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_TYPEMAP
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_URL
	 * @uses SOGeoPhonePlusWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOGeoPhonePlusWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::internArrayToIterateIsArray()
	 * @uses SOGeoPhonePlusWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoPhonePlusWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoPhonePlusWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOGeoPhonePlusWsdlClass::offsetGet()
	 * @uses SOGeoPhonePlusWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::getAttributeName()
	 * @uses SOGeoPhonePlusWsdlClass::__toString()
	 * @uses SOGeoPhonePlusWsdlClass::_set()
	 * @uses SOGeoPhonePlusWsdlClass::_get()
	 * @uses SOGeoPhonePlusWsdlClass::setInternArrayToIterate()
	 * @uses SOGeoPhonePlusWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOGeoPhonePlusWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::item()
	 * @uses SOGeoPhonePlusWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhonePlusWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOGeoPhonePlusWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
