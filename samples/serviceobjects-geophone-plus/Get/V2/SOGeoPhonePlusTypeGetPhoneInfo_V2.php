<?php
/**
 * Class file for SOGeoPhonePlusTypeGetPhoneInfo_V2
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhonePlusTypeGetPhoneInfo_V2
 * @date 08/07/2012
 */
class SOGeoPhonePlusTypeGetPhoneInfo_V2 extends SOGeoPhonePlusWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOGeoPhonePlusTypeGetPhoneInfo_V2
	 */
