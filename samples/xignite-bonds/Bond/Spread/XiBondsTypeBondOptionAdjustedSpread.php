<?php
/**
 * Class file for XiBondsTypeBondOptionAdjustedSpread
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeBondOptionAdjustedSpread
 * @date 08/07/2012
 */
class XiBondsTypeBondOptionAdjustedSpread extends XiBondsWsdlClass
{
	/**
	 * The ShortName
	 * Meta informations :
