<?php
/**
 * Class file for XiBondsTypeGetBondCalculation
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetBondCalculation
 * @date 08/07/2012
 */
class XiBondsTypeGetBondCalculation extends XiBondsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetBondCalculation
	 */
