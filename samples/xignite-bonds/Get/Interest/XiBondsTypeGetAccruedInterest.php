<?php
/**
 * Class file for XiBondsTypeGetAccruedInterest
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetAccruedInterest
 * @date 08/07/2012
 */
class XiBondsTypeGetAccruedInterest extends XiBondsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetAccruedInterest
	 */
