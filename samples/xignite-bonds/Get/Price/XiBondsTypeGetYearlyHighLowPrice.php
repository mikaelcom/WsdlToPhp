<?php
/**
 * Class file for XiBondsTypeGetYearlyHighLowPrice
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetYearlyHighLowPrice
 * @date 08/07/2012
 */
class XiBondsTypeGetYearlyHighLowPrice extends XiBondsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetYearlyHighLowPrice
	 */
