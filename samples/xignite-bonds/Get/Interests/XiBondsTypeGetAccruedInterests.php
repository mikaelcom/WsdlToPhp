<?php
/**
 * Class file for XiBondsTypeGetAccruedInterests
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetAccruedInterests
 * @date 08/07/2012
 */
class XiBondsTypeGetAccruedInterests extends XiBondsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetAccruedInterests
	 */
