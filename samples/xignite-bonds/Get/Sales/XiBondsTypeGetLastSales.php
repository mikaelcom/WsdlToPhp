<?php
/**
 * Class file for XiBondsTypeGetLastSales
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetLastSales
 * @date 08/07/2012
 */
class XiBondsTypeGetLastSales extends XiBondsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetLastSales
	 */
