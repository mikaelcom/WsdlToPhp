<?php
/**
 * Class file for XiBondsTypeGetPriceComposite
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetPriceComposite
 * @date 08/07/2012
 */
class XiBondsTypeGetPriceComposite extends XiBondsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetPriceComposite
	 */
