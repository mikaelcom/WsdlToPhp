<?php
/**
 * Class file for XiBondsTypeGetDailyOpenHighLowClosePrices
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetDailyOpenHighLowClosePrices
 * @date 08/07/2012
 */
class XiBondsTypeGetDailyOpenHighLowClosePrices extends XiBondsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetDailyOpenHighLowClosePrices
	 */
