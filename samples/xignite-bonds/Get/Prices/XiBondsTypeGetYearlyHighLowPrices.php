<?php
/**
 * Class file for XiBondsTypeGetYearlyHighLowPrices
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetYearlyHighLowPrices
 * @date 08/07/2012
 */
class XiBondsTypeGetYearlyHighLowPrices extends XiBondsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetYearlyHighLowPrices
	 */
