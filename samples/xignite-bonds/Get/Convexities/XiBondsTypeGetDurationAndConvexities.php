<?php
/**
 * Class file for XiBondsTypeGetDurationAndConvexities
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeGetDurationAndConvexities
 * @date 08/07/2012
 */
class XiBondsTypeGetDurationAndConvexities extends XiBondsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsTypeGetDurationAndConvexities
	 */
