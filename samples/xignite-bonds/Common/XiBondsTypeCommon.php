<?php
/**
 * Class file for XiBondsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeCommon
 * @date 08/07/2012
 */
class XiBondsTypeCommon extends XiBondsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiBondsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiBondsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiBondsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiBondsTypeOutcomeTypes
	 */
