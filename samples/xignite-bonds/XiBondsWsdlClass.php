<?php
/**
 * File for XiBondsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiBondsWsdlClass to communicate with SOAP service
 * Documentation : XigniteBonds service provides four-hour delayed price data for US Corporate and Agency Debt bonds including debt securities issued by Government-sponsored enterprises (GSE). Price data includes last sale, yield, daily and yearly open, high, low, close trade price data.
 * @date 08/07/2012
 */
class XiBondsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiBondsWsdlClass::setLastError()
	 * @uses XiBondsWsdlClass::initSoapClient()
	 * @uses XiBondsWsdlClass::initInternArrayToIterate()
	 * @uses XiBondsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiBondsWsdlClass::classMap()
	 * @uses XiBondsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiBondsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiBondsClassMap::classMap();
	 ...
	 * @uses XiBondsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiBondsWsdlClass::WSDL_COMPRESSION
	 * @uses XiBondsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiBondsWsdlClass::WSDL_ENCODING
	 * @uses XiBondsWsdlClass::WSDL_EXCPTS
	 * @uses XiBondsWsdlClass::WSDL_FEATURES
	 * @uses XiBondsWsdlClass::WSDL_LOGIN
	 * @uses XiBondsWsdlClass::WSDL_PASSWD
	 * @uses XiBondsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiBondsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiBondsWsdlClass::WSDL_TRACE
	 * @uses XiBondsWsdlClass::WSDL_TYPEMAP
	 * @uses XiBondsWsdlClass::WSDL_URL
	 * @uses XiBondsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiBondsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiBondsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiBondsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBondsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiBondsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBondsWsdlClass::offsetExists()
	 ...
	 * @uses XiBondsWsdlClass::getAttributeName()
	 * @uses XiBondsWsdlClass::__toString()
	 * @uses XiBondsWsdlClass::_set()
	 * @uses XiBondsWsdlClass::_get()
	 * @uses XiBondsWsdlClass::setInternArrayToIterate()
	 * @uses XiBondsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiBondsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiBondsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiBondsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
