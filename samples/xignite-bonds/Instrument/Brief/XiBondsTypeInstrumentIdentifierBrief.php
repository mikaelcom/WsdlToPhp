<?php
/**
 * Class file for XiBondsTypeInstrumentIdentifierBrief
 * @date 08/07/2012
 */
/**
 * Class XiBondsTypeInstrumentIdentifierBrief
 * @date 08/07/2012
 */
class XiBondsTypeInstrumentIdentifierBrief extends XiBondsWsdlClass
{
	/**
	 * The Valoren
	 * Meta informations :
