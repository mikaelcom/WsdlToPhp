<?php
/**
 * Class file for XiWatchListsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiWatchListsTypeHeader
 * @date 08/07/2012
 */
class XiWatchListsTypeHeader extends XiWatchListsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
