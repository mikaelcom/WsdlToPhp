<?php
/**
 * Class file for XiWatchListsTypeAddWatchListMetal
 * @date 08/07/2012
 */
/**
 * Class XiWatchListsTypeAddWatchListMetal
 * @date 08/07/2012
 */
class XiWatchListsTypeAddWatchListMetal extends XiWatchListsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @return XiWatchListsTypeAddWatchListMetal
	 */
