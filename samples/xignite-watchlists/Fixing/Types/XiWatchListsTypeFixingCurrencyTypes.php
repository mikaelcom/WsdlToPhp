<?php
/**
 * Class file for XiWatchListsTypeFixingCurrencyTypes
 * @date 08/07/2012
 */
/**
 * Class XiWatchListsTypeFixingCurrencyTypes
 * @date 08/07/2012
 */
class XiWatchListsTypeFixingCurrencyTypes extends XiWatchListsWsdlClass
{
	/**
