<?php
/**
 * Class file for XiWatchListsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiWatchListsTypeCommon
 * @date 08/07/2012
 */
class XiWatchListsTypeCommon extends XiWatchListsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiWatchListsTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiWatchListsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiWatchListsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiWatchListsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiWatchListsTypeOutcomeTypes
	 */
