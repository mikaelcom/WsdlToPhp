<?php
/**
 * File for XiWatchListsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiWatchListsWsdlClass to communicate with SOAP service
 * Documentation : This Web Service provides for the management of symbol-based watchlists.
 * @date 08/07/2012
 */
class XiWatchListsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiWatchListsWsdlClass::setLastError()
	 * @uses XiWatchListsWsdlClass::initSoapClient()
	 * @uses XiWatchListsWsdlClass::initInternArrayToIterate()
	 * @uses XiWatchListsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiWatchListsWsdlClass::classMap()
	 * @uses XiWatchListsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiWatchListsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiWatchListsClassMap::classMap();
	 ...
	 * @uses XiWatchListsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiWatchListsWsdlClass::WSDL_COMPRESSION
	 * @uses XiWatchListsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiWatchListsWsdlClass::WSDL_ENCODING
	 * @uses XiWatchListsWsdlClass::WSDL_EXCPTS
	 * @uses XiWatchListsWsdlClass::WSDL_FEATURES
	 * @uses XiWatchListsWsdlClass::WSDL_LOGIN
	 * @uses XiWatchListsWsdlClass::WSDL_PASSWD
	 * @uses XiWatchListsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiWatchListsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiWatchListsWsdlClass::WSDL_TRACE
	 * @uses XiWatchListsWsdlClass::WSDL_TYPEMAP
	 * @uses XiWatchListsWsdlClass::WSDL_URL
	 * @uses XiWatchListsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiWatchListsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiWatchListsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiWatchListsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiWatchListsWsdlClass::offsetExists()
	 ...
	 * @uses XiWatchListsWsdlClass::getAttributeName()
	 * @uses XiWatchListsWsdlClass::__toString()
	 * @uses XiWatchListsWsdlClass::_set()
	 * @uses XiWatchListsWsdlClass::_get()
	 * @uses XiWatchListsWsdlClass::setInternArrayToIterate()
	 * @uses XiWatchListsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiWatchListsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::item()
	 * @uses XiWatchListsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiWatchListsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiWatchListsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
