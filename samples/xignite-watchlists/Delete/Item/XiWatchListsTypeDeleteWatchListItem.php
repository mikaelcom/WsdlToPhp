<?php
/**
 * Class file for XiWatchListsTypeDeleteWatchListItem
 * @date 08/07/2012
 */
/**
 * Class XiWatchListsTypeDeleteWatchListItem
 * @date 08/07/2012
 */
class XiWatchListsTypeDeleteWatchListItem extends XiWatchListsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Symbol
	 * @return XiWatchListsTypeDeleteWatchListItem
	 */
