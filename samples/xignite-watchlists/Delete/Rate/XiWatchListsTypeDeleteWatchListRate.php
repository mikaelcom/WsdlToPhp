<?php
/**
 * Class file for XiWatchListsTypeDeleteWatchListRate
 * @date 08/07/2012
 */
/**
 * Class XiWatchListsTypeDeleteWatchListRate
 * @date 08/07/2012
 */
class XiWatchListsTypeDeleteWatchListRate extends XiWatchListsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @return XiWatchListsTypeDeleteWatchListRate
	 */
