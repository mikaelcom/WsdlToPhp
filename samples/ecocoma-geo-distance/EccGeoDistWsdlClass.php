<?php
/**
 * File for EccGeoDistWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccGeoDistWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Distance Web Services.
 * @date 03/07/2012
 */
class EccGeoDistWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccGeoDistWsdlClass::setLastError()
	 * @uses EccGeoDistWsdlClass::initSoapClient()
	 * @uses EccGeoDistWsdlClass::initInternArrayToIterate()
	 * @uses EccGeoDistWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccGeoDistWsdlClass::classMap()
	 * @uses EccGeoDistWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccGeoDistClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccGeoDistClassMap::classMap();
	 ...
	 * @uses EccGeoDistWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccGeoDistWsdlClass::WSDL_COMPRESSION
	 * @uses EccGeoDistWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccGeoDistWsdlClass::WSDL_ENCODING
	 * @uses EccGeoDistWsdlClass::WSDL_EXCPTS
	 * @uses EccGeoDistWsdlClass::WSDL_FEATURES
	 * @uses EccGeoDistWsdlClass::WSDL_LOGIN
	 * @uses EccGeoDistWsdlClass::WSDL_PASSWD
	 * @uses EccGeoDistWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccGeoDistWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccGeoDistWsdlClass::WSDL_TRACE
	 * @uses EccGeoDistWsdlClass::WSDL_TYPEMAP
	 * @uses EccGeoDistWsdlClass::WSDL_URL
	 * @uses EccGeoDistWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccGeoDistWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::internArrayToIterateIsArray()
	 * @uses EccGeoDistWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoDistWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoDistWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccGeoDistWsdlClass::offsetGet()
	 * @uses EccGeoDistWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::getAttributeName()
	 * @uses EccGeoDistWsdlClass::__toString()
	 * @uses EccGeoDistWsdlClass::_set()
	 * @uses EccGeoDistWsdlClass::_get()
	 * @uses EccGeoDistWsdlClass::setInternArrayToIterate()
	 * @uses EccGeoDistWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccGeoDistWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::item()
	 * @uses EccGeoDistWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoDistWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccGeoDistWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
