<?php
/**
 * Class file for XWebOrderStatusTypeResponseRefInfoType
 * @date 09/07/2012
 */
/**
 * Class XWebOrderStatusTypeResponseRefInfoType
 * @date 09/07/2012
 */
class XWebOrderStatusTypeResponseRefInfoType extends XWebOrderStatusWsdlClass
{
	/**
	 * The RefIDQual
	 * @var RefIDQual
