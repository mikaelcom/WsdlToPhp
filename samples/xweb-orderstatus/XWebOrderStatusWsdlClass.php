<?php
/**
 * File for XWebOrderStatusWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebOrderStatusWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebOrderStatusWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebOrderStatusWsdlClass::setLastError()
	 * @uses XWebOrderStatusWsdlClass::initSoapClient()
	 * @uses XWebOrderStatusWsdlClass::initInternArrayToIterate()
	 * @uses XWebOrderStatusWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebOrderStatusWsdlClass::classMap()
	 * @uses XWebOrderStatusWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebOrderStatusClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebOrderStatusClassMap::classMap();
	 ...
	 * @uses XWebOrderStatusWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebOrderStatusWsdlClass::WSDL_COMPRESSION
	 * @uses XWebOrderStatusWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebOrderStatusWsdlClass::WSDL_ENCODING
	 * @uses XWebOrderStatusWsdlClass::WSDL_EXCPTS
	 * @uses XWebOrderStatusWsdlClass::WSDL_FEATURES
	 * @uses XWebOrderStatusWsdlClass::WSDL_LOGIN
	 * @uses XWebOrderStatusWsdlClass::WSDL_PASSWD
	 * @uses XWebOrderStatusWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebOrderStatusWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebOrderStatusWsdlClass::WSDL_TRACE
	 * @uses XWebOrderStatusWsdlClass::WSDL_TYPEMAP
	 * @uses XWebOrderStatusWsdlClass::WSDL_URL
	 * @uses XWebOrderStatusWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebOrderStatusWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebOrderStatusWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebOrderStatusWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebOrderStatusWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebOrderStatusWsdlClass::offsetGet()
	 * @uses XWebOrderStatusWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::getAttributeName()
	 * @uses XWebOrderStatusWsdlClass::__toString()
	 * @uses XWebOrderStatusWsdlClass::_set()
	 * @uses XWebOrderStatusWsdlClass::_get()
	 * @uses XWebOrderStatusWsdlClass::setInternArrayToIterate()
	 * @uses XWebOrderStatusWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebOrderStatusWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::item()
	 * @uses XWebOrderStatusWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebOrderStatusWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebOrderStatusWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
