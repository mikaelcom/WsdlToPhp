<?php
/**
 * Class file for XiIndicesTypeMarketIndex
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeMarketIndex
 * @date 08/07/2012
 */
class XiIndicesTypeMarketIndex extends XiIndicesTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	...
	{
		XiIndicesWsdlClass::__construct(array('Symbol'=>$_Symbol,'Category'=>$_Category,'Name'=>$_Name,'Last'=>$_Last,'Time'=>$_Time,'Change'=>$_Change,'PercentChange'=>$_PercentChange));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
