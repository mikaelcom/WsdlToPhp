<?php
/**
 * Class file for XiIndicesTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeSecurity
 * @date 08/07/2012
 */
class XiIndicesTypeSecurity extends XiIndicesTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiIndicesWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
