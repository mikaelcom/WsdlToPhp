<?php
/**
 * Class file for XiIndicesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeCommon
 * @date 08/07/2012
 */
class XiIndicesTypeCommon extends XiIndicesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiIndicesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiIndicesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiIndicesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiIndicesTypeOutcomeTypes
	 */
