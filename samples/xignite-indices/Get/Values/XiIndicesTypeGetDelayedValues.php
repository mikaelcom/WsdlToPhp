<?php
/**
 * Class file for XiIndicesTypeGetDelayedValues
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeGetDelayedValues
 * @date 08/07/2012
 */
class XiIndicesTypeGetDelayedValues extends XiIndicesWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiIndicesTypeGetDelayedValues
	 */
