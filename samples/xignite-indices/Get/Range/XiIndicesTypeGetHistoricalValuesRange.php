<?php
/**
 * Class file for XiIndicesTypeGetHistoricalValuesRange
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeGetHistoricalValuesRange
 * @date 08/07/2012
 */
class XiIndicesTypeGetHistoricalValuesRange extends XiIndicesWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiIndicesTypeGetHistoricalValuesRange
	 */
