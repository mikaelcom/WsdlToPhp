<?php
/**
 * Class file for XiIndicesTypeGetLastClosingValue
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeGetLastClosingValue
 * @date 08/07/2012
 */
class XiIndicesTypeGetLastClosingValue extends XiIndicesWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiIndicesTypeGetLastClosingValue
	 */
