<?php
/**
 * Class file for XiIndicesTypeGetDelayedValue
 * @date 08/07/2012
 */
/**
 * Class XiIndicesTypeGetDelayedValue
 * @date 08/07/2012
 */
class XiIndicesTypeGetDelayedValue extends XiIndicesWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiIndicesTypeGetDelayedValue
	 */
