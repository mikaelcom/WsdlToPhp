<?php
/**
 * File for XiIndicesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiIndicesWsdlClass to communicate with SOAP service
 * Documentation : This web service provides market index information.
 * @date 08/07/2012
 */
class XiIndicesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiIndicesWsdlClass::setLastError()
	 * @uses XiIndicesWsdlClass::initSoapClient()
	 * @uses XiIndicesWsdlClass::initInternArrayToIterate()
	 * @uses XiIndicesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiIndicesWsdlClass::classMap()
	 * @uses XiIndicesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiIndicesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiIndicesClassMap::classMap();
	 ...
	 * @uses XiIndicesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiIndicesWsdlClass::WSDL_COMPRESSION
	 * @uses XiIndicesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiIndicesWsdlClass::WSDL_ENCODING
	 * @uses XiIndicesWsdlClass::WSDL_EXCPTS
	 * @uses XiIndicesWsdlClass::WSDL_FEATURES
	 * @uses XiIndicesWsdlClass::WSDL_LOGIN
	 * @uses XiIndicesWsdlClass::WSDL_PASSWD
	 * @uses XiIndicesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiIndicesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiIndicesWsdlClass::WSDL_TRACE
	 * @uses XiIndicesWsdlClass::WSDL_TYPEMAP
	 * @uses XiIndicesWsdlClass::WSDL_URL
	 * @uses XiIndicesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiIndicesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiIndicesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiIndicesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiIndicesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiIndicesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiIndicesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiIndicesWsdlClass::offsetExists()
	 ...
	 * @uses XiIndicesWsdlClass::getAttributeName()
	 * @uses XiIndicesWsdlClass::__toString()
	 * @uses XiIndicesWsdlClass::_set()
	 * @uses XiIndicesWsdlClass::_get()
	 * @uses XiIndicesWsdlClass::setInternArrayToIterate()
	 * @uses XiIndicesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiIndicesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiIndicesWsdlClass::item()
	 * @uses XiIndicesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiIndicesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiIndicesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
