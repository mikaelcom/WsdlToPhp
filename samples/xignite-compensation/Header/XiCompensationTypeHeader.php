<?php
/**
 * Class file for XiCompensationTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeHeader
 * @date 08/07/2012
 */
class XiCompensationTypeHeader extends XiCompensationWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiCompensationTypeHeader
	 */
