<?php
/**
 * Class file for XiCompensationTypeGetOfficerOptionsExercised
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetOfficerOptionsExercised
 * @date 08/07/2012
 */
class XiCompensationTypeGetOfficerOptionsExercised extends XiCompensationWsdlClass
{
	/**
	 * The OfficerID
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetOfficerOptionsExercised
	 */
