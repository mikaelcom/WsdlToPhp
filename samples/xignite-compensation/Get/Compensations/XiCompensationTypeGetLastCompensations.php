<?php
/**
 * Class file for XiCompensationTypeGetLastCompensations
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetLastCompensations
 * @date 08/07/2012
 */
class XiCompensationTypeGetLastCompensations extends XiCompensationWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetLastCompensations
	 */
