<?php
/**
 * Class file for XiCompensationTypeGetOfficerOptionsGranted
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetOfficerOptionsGranted
 * @date 08/07/2012
 */
class XiCompensationTypeGetOfficerOptionsGranted extends XiCompensationWsdlClass
{
	/**
	 * The OfficerID
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetOfficerOptionsGranted
	 */
