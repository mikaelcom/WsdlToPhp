<?php
/**
 * Class file for XiCompensationTypeGetOfficerOptions
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetOfficerOptions
 * @date 08/07/2012
 */
class XiCompensationTypeGetOfficerOptions extends XiCompensationWsdlClass
{
	/**
	 * The OfficerID
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetOfficerOptions
	 */
