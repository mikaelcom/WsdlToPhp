<?php
/**
 * Class file for XiCompensationTypeGetLastCompensation
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetLastCompensation
 * @date 08/07/2012
 */
class XiCompensationTypeGetLastCompensation extends XiCompensationWsdlClass
{
	/**
	 * The OfficerID
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetLastCompensation
	 */
