<?php
/**
 * Class file for XiCompensationTypeGetCurrentOfficers
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetCurrentOfficers
 * @date 08/07/2012
 */
class XiCompensationTypeGetCurrentOfficers extends XiCompensationWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetCurrentOfficers
	 */
