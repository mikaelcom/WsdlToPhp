<?php
/**
 * Class file for XiCompensationTypeGetOfficers
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetOfficers
 * @date 08/07/2012
 */
class XiCompensationTypeGetOfficers extends XiCompensationWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetOfficers
	 */
