<?php
/**
 * Class file for XiCompensationTypeGetOfficer
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeGetOfficer
 * @date 08/07/2012
 */
class XiCompensationTypeGetOfficer extends XiCompensationWsdlClass
{
	/**
	 * The OfficerID
	 * Meta informations :
	 ...
	 * @return XiCompensationTypeGetOfficer
	 */
