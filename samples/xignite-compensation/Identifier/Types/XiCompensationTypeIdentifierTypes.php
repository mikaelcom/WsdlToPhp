<?php
/**
 * Class file for XiCompensationTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiCompensationTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiCompensationTypeIdentifierTypes extends XiCompensationWsdlClass
{
	/**
