<?php
/**
 * File for XiCompensationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiCompensationWsdlClass to communicate with SOAP service
 * Documentation : Delivers statistics about executive compensation.
 * @date 08/07/2012
 */
class XiCompensationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiCompensationWsdlClass::setLastError()
	 * @uses XiCompensationWsdlClass::initSoapClient()
	 * @uses XiCompensationWsdlClass::initInternArrayToIterate()
	 * @uses XiCompensationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiCompensationWsdlClass::classMap()
	 * @uses XiCompensationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiCompensationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiCompensationClassMap::classMap();
	 ...
	 * @uses XiCompensationWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiCompensationWsdlClass::WSDL_COMPRESSION
	 * @uses XiCompensationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiCompensationWsdlClass::WSDL_ENCODING
	 * @uses XiCompensationWsdlClass::WSDL_EXCPTS
	 * @uses XiCompensationWsdlClass::WSDL_FEATURES
	 * @uses XiCompensationWsdlClass::WSDL_LOGIN
	 * @uses XiCompensationWsdlClass::WSDL_PASSWD
	 * @uses XiCompensationWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiCompensationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiCompensationWsdlClass::WSDL_TRACE
	 * @uses XiCompensationWsdlClass::WSDL_TYPEMAP
	 * @uses XiCompensationWsdlClass::WSDL_URL
	 * @uses XiCompensationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiCompensationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiCompensationWsdlClass::internArrayToIterateIsArray()
	 * @uses XiCompensationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiCompensationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiCompensationWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiCompensationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiCompensationWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiCompensationWsdlClass::offsetExists()
	 ...
	 * @uses XiCompensationWsdlClass::getAttributeName()
	 * @uses XiCompensationWsdlClass::__toString()
	 * @uses XiCompensationWsdlClass::_set()
	 * @uses XiCompensationWsdlClass::_get()
	 * @uses XiCompensationWsdlClass::setInternArrayToIterate()
	 * @uses XiCompensationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiCompensationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiCompensationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiCompensationWsdlClass::item()
	 * @uses XiCompensationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiCompensationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiCompensationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
