<?php
/**
 * File for SOGeoCashWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOGeoCashWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOGeoCashWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOGeoCashWsdlClass::setLastError()
	 * @uses SOGeoCashWsdlClass::initSoapClient()
	 * @uses SOGeoCashWsdlClass::initInternArrayToIterate()
	 * @uses SOGeoCashWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOGeoCashWsdlClass::classMap()
	 * @uses SOGeoCashWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOGeoCashClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOGeoCashClassMap::classMap();
	 ...
	 * @uses SOGeoCashWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOGeoCashWsdlClass::WSDL_COMPRESSION
	 * @uses SOGeoCashWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOGeoCashWsdlClass::WSDL_ENCODING
	 * @uses SOGeoCashWsdlClass::WSDL_EXCPTS
	 * @uses SOGeoCashWsdlClass::WSDL_FEATURES
	 * @uses SOGeoCashWsdlClass::WSDL_LOGIN
	 * @uses SOGeoCashWsdlClass::WSDL_PASSWD
	 * @uses SOGeoCashWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOGeoCashWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOGeoCashWsdlClass::WSDL_TRACE
	 * @uses SOGeoCashWsdlClass::WSDL_TYPEMAP
	 * @uses SOGeoCashWsdlClass::WSDL_URL
	 * @uses SOGeoCashWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::internArrayToIterateIsArray()
	 * @uses SOGeoCashWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoCashWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoCashWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOGeoCashWsdlClass::offsetGet()
	 * @uses SOGeoCashWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::getAttributeName()
	 * @uses SOGeoCashWsdlClass::__toString()
	 * @uses SOGeoCashWsdlClass::_set()
	 * @uses SOGeoCashWsdlClass::_get()
	 * @uses SOGeoCashWsdlClass::setInternArrayToIterate()
	 * @uses SOGeoCashWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOGeoCashWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::item()
	 * @uses SOGeoCashWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCashWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOGeoCashWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
