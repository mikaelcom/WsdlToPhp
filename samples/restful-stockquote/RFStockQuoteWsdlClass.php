<?php
/**
 * File for RFStockQuoteWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFStockQuoteWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFStockQuoteWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFStockQuoteWsdlClass::setLastError()
	 * @uses RFStockQuoteWsdlClass::initSoapClient()
	 * @uses RFStockQuoteWsdlClass::initInternArrayToIterate()
	 * @uses RFStockQuoteWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFStockQuoteWsdlClass::classMap()
	 * @uses RFStockQuoteWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFStockQuoteClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFStockQuoteClassMap::classMap();
	 ...
	 * @uses RFStockQuoteWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFStockQuoteWsdlClass::WSDL_COMPRESSION
	 * @uses RFStockQuoteWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFStockQuoteWsdlClass::WSDL_ENCODING
	 * @uses RFStockQuoteWsdlClass::WSDL_EXCPTS
	 * @uses RFStockQuoteWsdlClass::WSDL_FEATURES
	 * @uses RFStockQuoteWsdlClass::WSDL_LOGIN
	 * @uses RFStockQuoteWsdlClass::WSDL_PASSWD
	 * @uses RFStockQuoteWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFStockQuoteWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFStockQuoteWsdlClass::WSDL_TRACE
	 * @uses RFStockQuoteWsdlClass::WSDL_TYPEMAP
	 * @uses RFStockQuoteWsdlClass::WSDL_URL
	 * @uses RFStockQuoteWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses RFStockQuoteWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::internArrayToIterateIsArray()
	 * @uses RFStockQuoteWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFStockQuoteWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFStockQuoteWsdlClass::offsetExists()
	 ...
	 * @uses RFStockQuoteWsdlClass::getAttributeName()
	 * @uses RFStockQuoteWsdlClass::__toString()
	 * @uses RFStockQuoteWsdlClass::_set()
	 * @uses RFStockQuoteWsdlClass::_get()
	 * @uses RFStockQuoteWsdlClass::setInternArrayToIterate()
	 * @uses RFStockQuoteWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFStockQuoteWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::item()
	 * @uses RFStockQuoteWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses RFStockQuoteWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFStockQuoteWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
