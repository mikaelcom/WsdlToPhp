<?php
/**
 * File for SONameValidationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SONameValidationWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SONameValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SONameValidationWsdlClass::setLastError()
	 * @uses SONameValidationWsdlClass::initSoapClient()
	 * @uses SONameValidationWsdlClass::initInternArrayToIterate()
	 * @uses SONameValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SONameValidationWsdlClass::classMap()
	 * @uses SONameValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SONameValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SONameValidationClassMap::classMap();
	 ...
	 * @uses SONameValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SONameValidationWsdlClass::WSDL_COMPRESSION
	 * @uses SONameValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SONameValidationWsdlClass::WSDL_ENCODING
	 * @uses SONameValidationWsdlClass::WSDL_EXCPTS
	 * @uses SONameValidationWsdlClass::WSDL_FEATURES
	 * @uses SONameValidationWsdlClass::WSDL_LOGIN
	 * @uses SONameValidationWsdlClass::WSDL_PASSWD
	 * @uses SONameValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SONameValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SONameValidationWsdlClass::WSDL_TRACE
	 * @uses SONameValidationWsdlClass::WSDL_TYPEMAP
	 * @uses SONameValidationWsdlClass::WSDL_URL
	 * @uses SONameValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SONameValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SONameValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses SONameValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SONameValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SONameValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SONameValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SONameValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SONameValidationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SONameValidationWsdlClass::offsetGet()
	 * @uses SONameValidationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SONameValidationWsdlClass::getAttributeName()
	 * @uses SONameValidationWsdlClass::__toString()
	 * @uses SONameValidationWsdlClass::_set()
	 * @uses SONameValidationWsdlClass::_get()
	 * @uses SONameValidationWsdlClass::setInternArrayToIterate()
	 * @uses SONameValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SONameValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SONameValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SONameValidationWsdlClass::item()
	 * @uses SONameValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SONameValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SONameValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
