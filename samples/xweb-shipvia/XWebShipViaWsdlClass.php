<?php
/**
 * File for XWebShipViaWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebShipViaWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebShipViaWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebShipViaWsdlClass::setLastError()
	 * @uses XWebShipViaWsdlClass::initSoapClient()
	 * @uses XWebShipViaWsdlClass::initInternArrayToIterate()
	 * @uses XWebShipViaWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebShipViaWsdlClass::classMap()
	 * @uses XWebShipViaWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebShipViaClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebShipViaClassMap::classMap();
	 ...
	 * @uses XWebShipViaWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebShipViaWsdlClass::WSDL_COMPRESSION
	 * @uses XWebShipViaWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebShipViaWsdlClass::WSDL_ENCODING
	 * @uses XWebShipViaWsdlClass::WSDL_EXCPTS
	 * @uses XWebShipViaWsdlClass::WSDL_FEATURES
	 * @uses XWebShipViaWsdlClass::WSDL_LOGIN
	 * @uses XWebShipViaWsdlClass::WSDL_PASSWD
	 * @uses XWebShipViaWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebShipViaWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebShipViaWsdlClass::WSDL_TRACE
	 * @uses XWebShipViaWsdlClass::WSDL_TYPEMAP
	 * @uses XWebShipViaWsdlClass::WSDL_URL
	 * @uses XWebShipViaWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebShipViaWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebShipViaWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebShipViaWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebShipViaWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebShipViaWsdlClass::offsetGet()
	 * @uses XWebShipViaWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::getAttributeName()
	 * @uses XWebShipViaWsdlClass::__toString()
	 * @uses XWebShipViaWsdlClass::_set()
	 * @uses XWebShipViaWsdlClass::_get()
	 * @uses XWebShipViaWsdlClass::setInternArrayToIterate()
	 * @uses XWebShipViaWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebShipViaWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::item()
	 * @uses XWebShipViaWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebShipViaWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebShipViaWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
