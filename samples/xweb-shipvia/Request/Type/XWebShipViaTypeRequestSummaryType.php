<?php
/**
 * Class file for XWebShipViaTypeRequestSummaryType
 * @date 09/07/2012
 */
/**
 * Class XWebShipViaTypeRequestSummaryType
 * @date 09/07/2012
 */
class XWebShipViaTypeRequestSummaryType extends XWebShipViaWsdlClass
{
	/**
	 * The NbrOfSegments
	 * @var NbrOfSegments
