<?php
/**
 * Class file for AmazonAlexaTypeUrlInfoResult
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeUrlInfoResult
 * @date 10/07/2012
 */
class AmazonAlexaTypeUrlInfoResult extends AmazonAlexaWsdlClass
{
	/**
	 * The Request
	 ...
	 * @return AmazonAlexaTypeUrlInfoResult
	 */
