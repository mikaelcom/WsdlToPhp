<?php
/**
 * Class file for AmazonAlexaTypeCategoryListingsResult
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeCategoryListingsResult
 * @date 10/07/2012
 */
class AmazonAlexaTypeCategoryListingsResult extends AmazonAlexaWsdlClass
{
	/**
	 * The Request
	 ...
	 * @return AmazonAlexaTypeCategoryListingsResult
	 */
