<?php
/**
 * Class file for AmazonAlexaTypeCategoryBrowseResult
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeCategoryBrowseResult
 * @date 10/07/2012
 */
class AmazonAlexaTypeCategoryBrowseResult extends AmazonAlexaWsdlClass
{
	/**
	 * The Request
