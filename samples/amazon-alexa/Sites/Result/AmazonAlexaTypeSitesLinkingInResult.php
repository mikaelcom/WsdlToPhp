<?php
/**
 * Class file for AmazonAlexaTypeSitesLinkingInResult
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeSitesLinkingInResult
 * @date 10/07/2012
 */
class AmazonAlexaTypeSitesLinkingInResult extends AmazonAlexaWsdlClass
{
	/**
	 * The Request
	 ...
	 * @return AmazonAlexaTypeSitesLinkingInResult
	 */
