<?php
/**
 * Class file for AmazonAlexaTypeSitesLinkingInRequest
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeSitesLinkingInRequest
 * @date 10/07/2012
 */
class AmazonAlexaTypeSitesLinkingInRequest extends AmazonAlexaWsdlClass
{
	/**
	 * The Security
