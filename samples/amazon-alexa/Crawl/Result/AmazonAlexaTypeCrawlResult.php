<?php
/**
 * Class file for AmazonAlexaTypeCrawlResult
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeCrawlResult
 * @date 10/07/2012
 */
class AmazonAlexaTypeCrawlResult extends AmazonAlexaWsdlClass
{
	/**
	 * The Request
	 ...
	 * @return AmazonAlexaTypeCrawlResult
	 */
