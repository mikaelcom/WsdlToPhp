<?php
/**
 * Class file for AmazonAlexaTypeTrafficHistoryResult
 * @date 10/07/2012
 */
/**
 * Class AmazonAlexaTypeTrafficHistoryResult
 * @date 10/07/2012
 */
class AmazonAlexaTypeTrafficHistoryResult extends AmazonAlexaWsdlClass
{
	/**
	 * The Request
	 ...
	 * @return AmazonAlexaTypeTrafficHistoryResult
	 */
