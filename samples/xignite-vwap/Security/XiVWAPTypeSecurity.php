<?php
/**
 * Class file for XiVWAPTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeSecurity
 * @date 08/07/2012
 */
class XiVWAPTypeSecurity extends XiVWAPTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiVWAPWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
