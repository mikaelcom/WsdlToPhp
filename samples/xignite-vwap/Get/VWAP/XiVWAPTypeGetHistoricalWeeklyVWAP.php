<?php
/**
 * Class file for XiVWAPTypeGetHistoricalWeeklyVWAP
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeGetHistoricalWeeklyVWAP
 * @date 08/07/2012
 */
class XiVWAPTypeGetHistoricalWeeklyVWAP extends XiVWAPWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiVWAPTypeGetHistoricalWeeklyVWAP
	 */
