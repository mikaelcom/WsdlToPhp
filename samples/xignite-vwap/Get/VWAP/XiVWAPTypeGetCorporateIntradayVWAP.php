<?php
/**
 * Class file for XiVWAPTypeGetCorporateIntradayVWAP
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeGetCorporateIntradayVWAP
 * @date 08/07/2012
 */
class XiVWAPTypeGetCorporateIntradayVWAP extends XiVWAPWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiVWAPTypeGetCorporateIntradayVWAP
	 */
