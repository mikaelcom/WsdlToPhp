<?php
/**
 * Class file for XiVWAPTypeGetHistoricalDailyVWAP
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeGetHistoricalDailyVWAP
 * @date 08/07/2012
 */
class XiVWAPTypeGetHistoricalDailyVWAP extends XiVWAPWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiVWAPTypeGetHistoricalDailyVWAP
	 */
