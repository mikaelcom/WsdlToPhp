<?php
/**
 * Class file for XiVWAPTypeGetCorporateHistoricalVWAP
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeGetCorporateHistoricalVWAP
 * @date 08/07/2012
 */
class XiVWAPTypeGetCorporateHistoricalVWAP extends XiVWAPWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiVWAPTypeGetCorporateHistoricalVWAP
	 */
