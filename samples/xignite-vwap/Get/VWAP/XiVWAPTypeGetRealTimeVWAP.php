<?php
/**
 * Class file for XiVWAPTypeGetRealTimeVWAP
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeGetRealTimeVWAP
 * @date 08/07/2012
 */
class XiVWAPTypeGetRealTimeVWAP extends XiVWAPWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiVWAPTypeGetRealTimeVWAP
	 */
