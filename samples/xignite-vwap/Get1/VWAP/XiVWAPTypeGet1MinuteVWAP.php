<?php
/**
 * Class file for XiVWAPTypeGet1MinuteVWAP
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeGet1MinuteVWAP
 * @date 08/07/2012
 */
class XiVWAPTypeGet1MinuteVWAP extends XiVWAPWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiVWAPTypeGet1MinuteVWAP
	 */
