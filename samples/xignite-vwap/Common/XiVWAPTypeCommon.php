<?php
/**
 * Class file for XiVWAPTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiVWAPTypeCommon
 * @date 08/07/2012
 */
class XiVWAPTypeCommon extends XiVWAPWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiVWAPTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiVWAPTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiVWAPTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
