<?php
/**
 * File for XiVWAPWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiVWAPWsdlClass to communicate with SOAP service
 * Documentation : Provides delayed and historical Volume-Weighted-Average Price (VWAP) information.
 * @date 08/07/2012
 */
class XiVWAPWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiVWAPWsdlClass::setLastError()
	 * @uses XiVWAPWsdlClass::initSoapClient()
	 * @uses XiVWAPWsdlClass::initInternArrayToIterate()
	 * @uses XiVWAPWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiVWAPWsdlClass::classMap()
	 * @uses XiVWAPWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiVWAPClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiVWAPClassMap::classMap();
	 ...
	 * @uses XiVWAPWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiVWAPWsdlClass::WSDL_COMPRESSION
	 * @uses XiVWAPWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiVWAPWsdlClass::WSDL_ENCODING
	 * @uses XiVWAPWsdlClass::WSDL_EXCPTS
	 * @uses XiVWAPWsdlClass::WSDL_FEATURES
	 * @uses XiVWAPWsdlClass::WSDL_LOGIN
	 * @uses XiVWAPWsdlClass::WSDL_PASSWD
	 * @uses XiVWAPWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiVWAPWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiVWAPWsdlClass::WSDL_TRACE
	 * @uses XiVWAPWsdlClass::WSDL_TYPEMAP
	 * @uses XiVWAPWsdlClass::WSDL_URL
	 * @uses XiVWAPWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiVWAPWsdlClass::internArrayToIterateIsArray()
	 * @uses XiVWAPWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiVWAPWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiVWAPWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiVWAPWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiVWAPWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiVWAPWsdlClass::offsetExists()
	 ...
	 * @uses XiVWAPWsdlClass::getAttributeName()
	 * @uses XiVWAPWsdlClass::__toString()
	 * @uses XiVWAPWsdlClass::_set()
	 * @uses XiVWAPWsdlClass::_get()
	 * @uses XiVWAPWsdlClass::setInternArrayToIterate()
	 * @uses XiVWAPWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiVWAPWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiVWAPWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiVWAPWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
