<?php
/**
 * File for SPSitedataWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPSitedataWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPSitedataWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPSitedataWsdlClass::setLastError()
	 * @uses SPSitedataWsdlClass::initSoapClient()
	 * @uses SPSitedataWsdlClass::initInternArrayToIterate()
	 * @uses SPSitedataWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPSitedataWsdlClass::classMap()
	 * @uses SPSitedataWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPSitedataClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPSitedataClassMap::classMap();
	 ...
	 * @uses SPSitedataWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPSitedataWsdlClass::WSDL_COMPRESSION
	 * @uses SPSitedataWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPSitedataWsdlClass::WSDL_ENCODING
	 * @uses SPSitedataWsdlClass::WSDL_EXCPTS
	 * @uses SPSitedataWsdlClass::WSDL_FEATURES
	 * @uses SPSitedataWsdlClass::WSDL_LOGIN
	 * @uses SPSitedataWsdlClass::WSDL_PASSWD
	 * @uses SPSitedataWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPSitedataWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPSitedataWsdlClass::WSDL_TRACE
	 * @uses SPSitedataWsdlClass::WSDL_TYPEMAP
	 * @uses SPSitedataWsdlClass::WSDL_URL
	 * @uses SPSitedataWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPSitedataWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPSitedataWsdlClass::internArrayToIterateIsArray()
	 * @uses SPSitedataWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPSitedataWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPSitedataWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPSitedataWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPSitedataWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPSitedataWsdlClass::offsetExists()
	 ...
	 * @uses SPSitedataWsdlClass::getAttributeName()
	 * @uses SPSitedataWsdlClass::__toString()
	 * @uses SPSitedataWsdlClass::_set()
	 * @uses SPSitedataWsdlClass::_get()
	 * @uses SPSitedataWsdlClass::setInternArrayToIterate()
	 * @uses SPSitedataWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPSitedataWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPSitedataWsdlClass::item()
	 * @uses SPSitedataWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPSitedataWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPSitedataWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
