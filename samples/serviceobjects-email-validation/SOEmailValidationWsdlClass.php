<?php
/**
 * File for SOEmailValidationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOEmailValidationWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOEmailValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOEmailValidationWsdlClass::setLastError()
	 * @uses SOEmailValidationWsdlClass::initSoapClient()
	 * @uses SOEmailValidationWsdlClass::initInternArrayToIterate()
	 * @uses SOEmailValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOEmailValidationWsdlClass::classMap()
	 * @uses SOEmailValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOEmailValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOEmailValidationClassMap::classMap();
	 ...
	 * @uses SOEmailValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOEmailValidationWsdlClass::WSDL_COMPRESSION
	 * @uses SOEmailValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOEmailValidationWsdlClass::WSDL_ENCODING
	 * @uses SOEmailValidationWsdlClass::WSDL_EXCPTS
	 * @uses SOEmailValidationWsdlClass::WSDL_FEATURES
	 * @uses SOEmailValidationWsdlClass::WSDL_LOGIN
	 * @uses SOEmailValidationWsdlClass::WSDL_PASSWD
	 * @uses SOEmailValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOEmailValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOEmailValidationWsdlClass::WSDL_TRACE
	 * @uses SOEmailValidationWsdlClass::WSDL_TYPEMAP
	 * @uses SOEmailValidationWsdlClass::WSDL_URL
	 * @uses SOEmailValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOEmailValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses SOEmailValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOEmailValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOEmailValidationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOEmailValidationWsdlClass::offsetGet()
	 * @uses SOEmailValidationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::getAttributeName()
	 * @uses SOEmailValidationWsdlClass::__toString()
	 * @uses SOEmailValidationWsdlClass::_set()
	 * @uses SOEmailValidationWsdlClass::_get()
	 * @uses SOEmailValidationWsdlClass::setInternArrayToIterate()
	 * @uses SOEmailValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOEmailValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::item()
	 * @uses SOEmailValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOEmailValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOEmailValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
