<?php
/**
 * Class file for SOEmailValidationTypeEmailValidateInfo_v2
 * @date 08/07/2012
 */
/**
 * Class SOEmailValidationTypeEmailValidateInfo_v2
 * @date 08/07/2012
 */
class SOEmailValidationTypeEmailValidateInfo_v2 extends SOEmailValidationWsdlClass
{
	/**
	 * The EmailAddressIn
	 * Meta informations :
	...
	/**
	 * The IsBusinessAddress
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var string
	 */
	public $IsBusinessAddress;
	/**
	 * Constructor
	 ...
	 * @param boolean IsSMSDomain
	 * @param boolean IsRole
	 * @param int IsGood
	 * @param string IsDeliverable
	 * @param string IsBusinessAddress
	 * @return SOEmailValidationTypeEmailValidateInfo_v2
	 */
	public function __construct($_EmailAddressIn = null,$_Box = null,$_Domain = null,$_IsRecognizedTLD,$_TopLevelDomain = null,$_TopLevelDomainDescription = null,$_IsCCTLD,$_IsSyntaxGood,$_IsDomainSpecificSyntaxGood,$_IsDNSGood,$_IsSMTPServerGood = null,$_IsCatchAllDomain = null,$_IsSMTPMailBoxGood = null,$_IsFree = null,$_IsEstablished,$_IsAlias,$_IsBogus,$_IsVulgar,$_PossibleFirstName = null,$_PossibleLastName = null,$_IsSMSDomain,$_IsRole,$_IsGood,$_IsDeliverable = null,$_IsBusinessAddress = null)
	{
		parent::__construct(array('EmailAddressIn'=>$_EmailAddressIn,'Box'=>$_Box,'Domain'=>$_Domain,'IsRecognizedTLD'=>$_IsRecognizedTLD,'TopLevelDomain'=>$_TopLevelDomain,'TopLevelDomainDescription'=>$_TopLevelDomainDescription,'IsCCTLD'=>$_IsCCTLD,'IsSyntaxGood'=>$_IsSyntaxGood,'IsDomainSpecificSyntaxGood'=>$_IsDomainSpecificSyntaxGood,'IsDNSGood'=>$_IsDNSGood,'IsSMTPServerGood'=>$_IsSMTPServerGood,'IsCatchAllDomain'=>$_IsCatchAllDomain,'IsSMTPMailBoxGood'=>$_IsSMTPMailBoxGood,'IsFree'=>$_IsFree,'IsEstablished'=>$_IsEstablished,'IsAlias'=>$_IsAlias,'IsBogus'=>$_IsBogus,'IsVulgar'=>$_IsVulgar,'PossibleFirstName'=>$_PossibleFirstName,'PossibleLastName'=>$_PossibleLastName,'IsSMSDomain'=>$_IsSMSDomain,'IsRole'=>$_IsRole,'IsGood'=>$_IsGood,'IsDeliverable'=>$_IsDeliverable,'IsBusinessAddress'=>$_IsBusinessAddress));
	}
	/**
	 * Set EmailAddressIn
	 * @param string EmailAddressIn
	 ...
	 * @return boolean
	 */
	public function setIsSMSDomain($_IsSMSDomain)
	{
		return ($this->IsSMSDomain = $_IsSMSDomain);
	}
	/**
	 * Get IsSMSDomain
	 * @return boolean
	 */
	public function getIsSMSDomain()
	{
		return $this->IsSMSDomain;
	}
	/**
	 * Set IsRole
	 * @param boolean IsRole
	 * @return boolean
	 */
	public function setIsRole($_IsRole)
	{
		return ($this->IsRole = $_IsRole);
	}
	/**
	 * Get IsRole
	 * @return boolean
	 ...
	 * @return int
	 */
	public function setIsGood($_IsGood)
	{
		return ($this->IsGood = $_IsGood);
	}
	/**
	 * Get IsGood
	 * @return int
	 ...
	 * @return string
	 */
	public function setIsDeliverable($_IsDeliverable)
	{
		return ($this->IsDeliverable = $_IsDeliverable);
	}
	/**
	 * Get IsDeliverable
	 * @return string
	...
	/**
	 * Set IsBusinessAddress
	 * @param string IsBusinessAddress
	 * @return string
	 */
	public function setIsBusinessAddress($_IsBusinessAddress)
	{
		return ($this->IsBusinessAddress = $_IsBusinessAddress);
	}
	/**
	 * Get IsBusinessAddress
	 * @return string
	 */
