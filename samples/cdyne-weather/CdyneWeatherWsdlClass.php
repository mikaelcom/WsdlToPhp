<?php
/**
 * File for CdyneWeatherWsdlClass to communicate with SOAP service
 * @date 02/07/2012
 */
/**
 * File for CdyneWeatherWsdlClass to communicate with SOAP service
 ...
 * @date 02/07/2012
 */
class CdyneWeatherWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdyneWeatherWsdlClass::setLastError()
	 * @uses CdyneWeatherWsdlClass::initSoapClient()
	 * @uses CdyneWeatherWsdlClass::initInternArrayToIterate()
	 * @uses CdyneWeatherWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneWeatherWsdlClass::classMap()
	 * @uses CdyneWeatherWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneWeatherClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneWeatherClassMap::classMap();
	 ...
	 * @uses CdyneWeatherWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneWeatherWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneWeatherWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneWeatherWsdlClass::WSDL_ENCODING
	 * @uses CdyneWeatherWsdlClass::WSDL_EXCPTS
	 * @uses CdyneWeatherWsdlClass::WSDL_FEATURES
	 * @uses CdyneWeatherWsdlClass::WSDL_LOGIN
	 * @uses CdyneWeatherWsdlClass::WSDL_PASSWD
	 * @uses CdyneWeatherWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneWeatherWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneWeatherWsdlClass::WSDL_TRACE
	 * @uses CdyneWeatherWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneWeatherWsdlClass::WSDL_URL
	 * @uses CdyneWeatherWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneWeatherWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneWeatherWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneWeatherWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneWeatherWsdlClass::offsetExists()
	 ...
	 * @uses CdyneWeatherWsdlClass::getAttributeName()
	 * @uses CdyneWeatherWsdlClass::__toString()
	 * @uses CdyneWeatherWsdlClass::_set()
	 * @uses CdyneWeatherWsdlClass::_get()
	 * @uses CdyneWeatherWsdlClass::setInternArrayToIterate()
	 * @uses CdyneWeatherWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneWeatherWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::item()
	 * @uses CdyneWeatherWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneWeatherWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneWeatherWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
