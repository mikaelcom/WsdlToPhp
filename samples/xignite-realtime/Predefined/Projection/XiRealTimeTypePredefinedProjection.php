<?php
/**
 * Class file for XiRealTimeTypePredefinedProjection
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypePredefinedProjection
 * @date 08/07/2012
 */
class XiRealTimeTypePredefinedProjection extends XiRealTimeWsdlClass
{
	/**
