<?php
/**
 * Class file for XiRealTimeTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiRealTimeTypePredefinedLightModel extends XiRealTimeWsdlClass
{
	/**
