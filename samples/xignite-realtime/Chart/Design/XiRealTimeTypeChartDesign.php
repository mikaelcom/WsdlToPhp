<?php
/**
 * Class file for XiRealTimeTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeChartDesign
 * @date 08/07/2012
 */
class XiRealTimeTypeChartDesign extends XiRealTimeTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRealTimeTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRealTimeTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRealTimeTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiRealTimeTypeLinePattern GridHorizontalStyle
	 * @param XiRealTimeTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiRealTimeTypeImageFrameType FrameType
	 * @param XiRealTimeTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiRealTimeTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiRealTimeTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiRealTimeTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiRealTimeTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiRealTimeTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiRealTimeTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiRealTimeTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiRealTimeTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiRealTimeTypePredefinedProjection
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiRealTimeTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiRealTimeTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiRealTimeTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiRealTimeTypePredefinedLightModel
	 */
