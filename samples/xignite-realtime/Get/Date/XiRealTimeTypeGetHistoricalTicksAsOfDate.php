<?php
/**
 * Class file for XiRealTimeTypeGetHistoricalTicksAsOfDate
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetHistoricalTicksAsOfDate
 * @date 08/07/2012
 */
class XiRealTimeTypeGetHistoricalTicksAsOfDate extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @return XiRealTimeTypeGetHistoricalTicksAsOfDate
	 */
	public function __construct($_Exchange,$_Symbol = null,$_AsOfDate = null,$_StartTime = null,$_EndTime = null,$_TickPrecision,$_TickPeriods)
	{
		parent::__construct(array('Exchange'=>$_Exchange,'Symbol'=>$_Symbol,'AsOfDate'=>$_AsOfDate,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'TickPrecision'=>$_TickPrecision,'TickPeriods'=>$_TickPeriods));
	}
	/**
	 * Set Exchange
