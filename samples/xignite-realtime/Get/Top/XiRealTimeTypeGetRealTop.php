<?php
/**
 * Class file for XiRealTimeTypeGetRealTop
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetRealTop
 * @date 08/07/2012
 */
class XiRealTimeTypeGetRealTop extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiRealTimeTypeGetRealTop
	 */
