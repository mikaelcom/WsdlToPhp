<?php
/**
 * Class file for XiRealTimeTypeGetRealTopMovers
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetRealTopMovers
 * @date 08/07/2012
 */
class XiRealTimeTypeGetRealTopMovers extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiRealTimeTypeGetRealTopMovers
	 */
