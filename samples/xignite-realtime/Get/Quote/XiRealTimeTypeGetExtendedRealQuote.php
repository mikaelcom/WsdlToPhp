<?php
/**
 * Class file for XiRealTimeTypeGetExtendedRealQuote
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetExtendedRealQuote
 * @date 08/07/2012
 */
class XiRealTimeTypeGetExtendedRealQuote extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @param string Symbol
	 * @return XiRealTimeTypeGetExtendedRealQuote
	 */
