<?php
/**
 * Class file for XiRealTimeTypeGetRealTopGainers
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetRealTopGainers
 * @date 08/07/2012
 */
class XiRealTimeTypeGetRealTopGainers extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiRealTimeTypeGetRealTopGainers
	 */
