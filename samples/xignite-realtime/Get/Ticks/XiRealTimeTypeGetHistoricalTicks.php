<?php
/**
 * Class file for XiRealTimeTypeGetHistoricalTicks
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetHistoricalTicks
 * @date 08/07/2012
 */
class XiRealTimeTypeGetHistoricalTicks extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRealTimeTypeHistoricalPeriods
	 */
	 ...
	 * @param string Symbol
	 * @param XiRealTimeTypeHistoricalPeriods HistoricalPeriod
	 * @param string StartTime
	 * @param string EndTime
	 * @param XiRealTimeTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @return XiRealTimeTypeGetHistoricalTicks
	 */
	public function __construct($_Exchange,$_Symbol = null,$_HistoricalPeriod,$_StartTime = null,$_EndTime = null,$_TickPrecision,$_TickPeriods)
	{
		parent::__construct(array('Exchange'=>$_Exchange,'Symbol'=>$_Symbol,'HistoricalPeriod'=>$_HistoricalPeriod,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'TickPrecision'=>$_TickPrecision,'TickPeriods'=>$_TickPeriods));
	}
	/**
	 * Set Exchange
	...
	{
		return ($this->HistoricalPeriod = XiRealTimeTypeHistoricalPeriods::valueIsValid($_HistoricalPeriod)?$_HistoricalPeriod:null);
	}
	/**
