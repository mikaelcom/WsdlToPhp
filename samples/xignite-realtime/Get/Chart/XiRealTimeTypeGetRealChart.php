<?php
/**
 * Class file for XiRealTimeTypeGetRealChart
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeGetRealChart
 * @date 08/07/2012
 */
class XiRealTimeTypeGetRealChart extends XiRealTimeWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiRealTimeTypeGetRealChart
	 */
	public function __construct($_Exchange,$_Symbol = null,$_AdditionalSymbols = null,$_StartTime = null,$_EndTime = null,$_Style,$_Width,$_Height)
	{
		parent::__construct(array('Exchange'=>$_Exchange,'Symbol'=>$_Symbol,'AdditionalSymbols'=>$_AdditionalSymbols,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height));
	}
	/**
	 * Set Exchange
