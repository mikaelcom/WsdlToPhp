<?php
/**
 * Class file for XiRealTimeTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeSecurity
 * @date 08/07/2012
 */
class XiRealTimeTypeSecurity extends XiRealTimeTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiRealTimeWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
