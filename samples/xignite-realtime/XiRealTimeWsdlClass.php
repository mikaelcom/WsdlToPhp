<?php
/**
 * File for XiRealTimeWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiRealTimeWsdlClass to communicate with SOAP service
 * Documentation : This web service provides real-time access to quote and order data on the Island ECN.
 * @date 08/07/2012
 */
class XiRealTimeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiRealTimeWsdlClass::setLastError()
	 * @uses XiRealTimeWsdlClass::initSoapClient()
	 * @uses XiRealTimeWsdlClass::initInternArrayToIterate()
	 * @uses XiRealTimeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiRealTimeWsdlClass::classMap()
	 * @uses XiRealTimeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiRealTimeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiRealTimeClassMap::classMap();
	 ...
	 * @uses XiRealTimeWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiRealTimeWsdlClass::WSDL_COMPRESSION
	 * @uses XiRealTimeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiRealTimeWsdlClass::WSDL_ENCODING
	 * @uses XiRealTimeWsdlClass::WSDL_EXCPTS
	 * @uses XiRealTimeWsdlClass::WSDL_FEATURES
	 * @uses XiRealTimeWsdlClass::WSDL_LOGIN
	 * @uses XiRealTimeWsdlClass::WSDL_PASSWD
	 * @uses XiRealTimeWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiRealTimeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiRealTimeWsdlClass::WSDL_TRACE
	 * @uses XiRealTimeWsdlClass::WSDL_TYPEMAP
	 * @uses XiRealTimeWsdlClass::WSDL_URL
	 * @uses XiRealTimeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiRealTimeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiRealTimeWsdlClass::internArrayToIterateIsArray()
	 * @uses XiRealTimeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiRealTimeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiRealTimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiRealTimeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiRealTimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiRealTimeWsdlClass::offsetExists()
	 ...
	 * @uses XiRealTimeWsdlClass::getAttributeName()
	 * @uses XiRealTimeWsdlClass::__toString()
	 * @uses XiRealTimeWsdlClass::_set()
	 * @uses XiRealTimeWsdlClass::_get()
	 * @uses XiRealTimeWsdlClass::setInternArrayToIterate()
	 * @uses XiRealTimeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiRealTimeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiRealTimeWsdlClass::item()
	 * @uses XiRealTimeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiRealTimeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiRealTimeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
