<?php
/**
 * Class file for XiRealTimeTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiRealTimeTypeCommon
 * @date 08/07/2012
 */
class XiRealTimeTypeCommon extends XiRealTimeWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRealTimeTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiRealTimeTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiRealTimeTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiRealTimeTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiRealTimeTypeOutcomeTypes
	 */
