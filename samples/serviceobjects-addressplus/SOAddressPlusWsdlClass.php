<?php
/**
 * File for SOAddressPlusWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for SOAddressPlusWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class SOAddressPlusWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOAddressPlusWsdlClass::setLastError()
	 * @uses SOAddressPlusWsdlClass::initSoapClient()
	 * @uses SOAddressPlusWsdlClass::initInternArrayToIterate()
	 * @uses SOAddressPlusWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOAddressPlusWsdlClass::classMap()
	 * @uses SOAddressPlusWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOAddressPlusClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOAddressPlusClassMap::classMap();
	 ...
	 * @uses SOAddressPlusWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOAddressPlusWsdlClass::WSDL_COMPRESSION
	 * @uses SOAddressPlusWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOAddressPlusWsdlClass::WSDL_ENCODING
	 * @uses SOAddressPlusWsdlClass::WSDL_EXCPTS
	 * @uses SOAddressPlusWsdlClass::WSDL_FEATURES
	 * @uses SOAddressPlusWsdlClass::WSDL_LOGIN
	 * @uses SOAddressPlusWsdlClass::WSDL_PASSWD
	 * @uses SOAddressPlusWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOAddressPlusWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOAddressPlusWsdlClass::WSDL_TRACE
	 * @uses SOAddressPlusWsdlClass::WSDL_TYPEMAP
	 * @uses SOAddressPlusWsdlClass::WSDL_URL
	 * @uses SOAddressPlusWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOAddressPlusWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::internArrayToIterateIsArray()
	 * @uses SOAddressPlusWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOAddressPlusWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOAddressPlusWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOAddressPlusWsdlClass::offsetGet()
	 * @uses SOAddressPlusWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::getAttributeName()
	 * @uses SOAddressPlusWsdlClass::__toString()
	 * @uses SOAddressPlusWsdlClass::_set()
	 * @uses SOAddressPlusWsdlClass::_get()
	 * @uses SOAddressPlusWsdlClass::setInternArrayToIterate()
	 * @uses SOAddressPlusWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOAddressPlusWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::item()
	 * @uses SOAddressPlusWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOAddressPlusWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOAddressPlusWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
