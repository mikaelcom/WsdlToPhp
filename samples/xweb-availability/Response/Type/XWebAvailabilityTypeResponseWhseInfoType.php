<?php
/**
 * Class file for XWebAvailabilityTypeResponseWhseInfoType
 * @date 09/07/2012
 */
/**
 * Class XWebAvailabilityTypeResponseWhseInfoType
 * @date 09/07/2012
 */
class XWebAvailabilityTypeResponseWhseInfoType extends XWebAvailabilityWsdlClass
{
	/**
	 * The IDCode
	 * @var IDCode
