<?php
/**
 * Class file for XWebAvailabilityTypeResponseSummaryType
 * @date 09/07/2012
 */
/**
 * Class XWebAvailabilityTypeResponseSummaryType
 * @date 09/07/2012
 */
class XWebAvailabilityTypeResponseSummaryType extends XWebAvailabilityWsdlClass
{
	/**
	 * The NbrOfSegments
	 * @var NbrOfSegments
