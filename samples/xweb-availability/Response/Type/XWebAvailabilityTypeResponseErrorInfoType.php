<?php
/**
 * Class file for XWebAvailabilityTypeResponseErrorInfoType
 * @date 09/07/2012
 */
/**
 * Class XWebAvailabilityTypeResponseErrorInfoType
 * @date 09/07/2012
 */
class XWebAvailabilityTypeResponseErrorInfoType extends XWebAvailabilityWsdlClass
{
	/**
	 * The RefIDQual3
	 * @var RefIDQual3
