<?php
/**
 * Class file for XWebAvailabilityTypeRefIDQualType
 * @date 09/07/2012
 */
/**
 * Class XWebAvailabilityTypeRefIDQualType
 * @date 09/07/2012
 */
class XWebAvailabilityTypeRefIDQualType extends XWebAvailabilityWsdlClass
{
	/**
