<?php
/**
 * File for XWebAvailabilityWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebAvailabilityWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebAvailabilityWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebAvailabilityWsdlClass::setLastError()
	 * @uses XWebAvailabilityWsdlClass::initSoapClient()
	 * @uses XWebAvailabilityWsdlClass::initInternArrayToIterate()
	 * @uses XWebAvailabilityWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebAvailabilityWsdlClass::classMap()
	 * @uses XWebAvailabilityWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebAvailabilityClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebAvailabilityClassMap::classMap();
	 ...
	 * @uses XWebAvailabilityWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebAvailabilityWsdlClass::WSDL_COMPRESSION
	 * @uses XWebAvailabilityWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebAvailabilityWsdlClass::WSDL_ENCODING
	 * @uses XWebAvailabilityWsdlClass::WSDL_EXCPTS
	 * @uses XWebAvailabilityWsdlClass::WSDL_FEATURES
	 * @uses XWebAvailabilityWsdlClass::WSDL_LOGIN
	 * @uses XWebAvailabilityWsdlClass::WSDL_PASSWD
	 * @uses XWebAvailabilityWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebAvailabilityWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebAvailabilityWsdlClass::WSDL_TRACE
	 * @uses XWebAvailabilityWsdlClass::WSDL_TYPEMAP
	 * @uses XWebAvailabilityWsdlClass::WSDL_URL
	 * @uses XWebAvailabilityWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebAvailabilityWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebAvailabilityWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebAvailabilityWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebAvailabilityWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebAvailabilityWsdlClass::offsetGet()
	 * @uses XWebAvailabilityWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::getAttributeName()
	 * @uses XWebAvailabilityWsdlClass::__toString()
	 * @uses XWebAvailabilityWsdlClass::_set()
	 * @uses XWebAvailabilityWsdlClass::_get()
	 * @uses XWebAvailabilityWsdlClass::setInternArrayToIterate()
	 * @uses XWebAvailabilityWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebAvailabilityWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::item()
	 * @uses XWebAvailabilityWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebAvailabilityWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebAvailabilityWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
