<?php
/**
 * Class file for XWebAvailabilityTypeRequestSummaryType
 * @date 09/07/2012
 */
/**
 * Class XWebAvailabilityTypeRequestSummaryType
 * @date 09/07/2012
 */
class XWebAvailabilityTypeRequestSummaryType extends XWebAvailabilityWsdlClass
{
	/**
	 * The NbrOfSegments
	 * @var NbrOfSegments
