<?php
/**
 * File for SOGeoCensusWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SOGeoCensusWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SOGeoCensusWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOGeoCensusWsdlClass::setLastError()
	 * @uses SOGeoCensusWsdlClass::initSoapClient()
	 * @uses SOGeoCensusWsdlClass::initInternArrayToIterate()
	 * @uses SOGeoCensusWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOGeoCensusWsdlClass::classMap()
	 * @uses SOGeoCensusWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOGeoCensusClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOGeoCensusClassMap::classMap();
	 ...
	 * @uses SOGeoCensusWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOGeoCensusWsdlClass::WSDL_COMPRESSION
	 * @uses SOGeoCensusWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOGeoCensusWsdlClass::WSDL_ENCODING
	 * @uses SOGeoCensusWsdlClass::WSDL_EXCPTS
	 * @uses SOGeoCensusWsdlClass::WSDL_FEATURES
	 * @uses SOGeoCensusWsdlClass::WSDL_LOGIN
	 * @uses SOGeoCensusWsdlClass::WSDL_PASSWD
	 * @uses SOGeoCensusWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOGeoCensusWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOGeoCensusWsdlClass::WSDL_TRACE
	 * @uses SOGeoCensusWsdlClass::WSDL_TYPEMAP
	 * @uses SOGeoCensusWsdlClass::WSDL_URL
	 * @uses SOGeoCensusWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOGeoCensusWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::internArrayToIterateIsArray()
	 * @uses SOGeoCensusWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoCensusWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoCensusWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOGeoCensusWsdlClass::offsetGet()
	 * @uses SOGeoCensusWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::getAttributeName()
	 * @uses SOGeoCensusWsdlClass::__toString()
	 * @uses SOGeoCensusWsdlClass::_set()
	 * @uses SOGeoCensusWsdlClass::_get()
	 * @uses SOGeoCensusWsdlClass::setInternArrayToIterate()
	 * @uses SOGeoCensusWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOGeoCensusWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::item()
	 * @uses SOGeoCensusWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCensusWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOGeoCensusWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
