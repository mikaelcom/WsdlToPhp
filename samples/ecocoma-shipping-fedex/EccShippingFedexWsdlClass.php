<?php
/**
 * File for EccShippingFedexWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccShippingFedexWsdlClass to communicate with SOAP service
 * Documentation : Cocoma FedEx Shipping Web Services.
 * @date 03/07/2012
 */
class EccShippingFedexWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccShippingFedexWsdlClass::setLastError()
	 * @uses EccShippingFedexWsdlClass::initSoapClient()
	 * @uses EccShippingFedexWsdlClass::initInternArrayToIterate()
	 * @uses EccShippingFedexWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccShippingFedexWsdlClass::classMap()
	 * @uses EccShippingFedexWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccShippingFedexClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccShippingFedexClassMap::classMap();
	 ...
	 * @uses EccShippingFedexWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccShippingFedexWsdlClass::WSDL_COMPRESSION
	 * @uses EccShippingFedexWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccShippingFedexWsdlClass::WSDL_ENCODING
	 * @uses EccShippingFedexWsdlClass::WSDL_EXCPTS
	 * @uses EccShippingFedexWsdlClass::WSDL_FEATURES
	 * @uses EccShippingFedexWsdlClass::WSDL_LOGIN
	 * @uses EccShippingFedexWsdlClass::WSDL_PASSWD
	 * @uses EccShippingFedexWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccShippingFedexWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccShippingFedexWsdlClass::WSDL_TRACE
	 * @uses EccShippingFedexWsdlClass::WSDL_TYPEMAP
	 * @uses EccShippingFedexWsdlClass::WSDL_URL
	 * @uses EccShippingFedexWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccShippingFedexWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::internArrayToIterateIsArray()
	 * @uses EccShippingFedexWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingFedexWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingFedexWsdlClass::offsetExists()
	 ...
	 * @uses EccShippingFedexWsdlClass::getAttributeName()
	 * @uses EccShippingFedexWsdlClass::__toString()
	 * @uses EccShippingFedexWsdlClass::_set()
	 * @uses EccShippingFedexWsdlClass::_get()
	 * @uses EccShippingFedexWsdlClass::setInternArrayToIterate()
	 * @uses EccShippingFedexWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccShippingFedexWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::item()
	 * @uses EccShippingFedexWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingFedexWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccShippingFedexWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
