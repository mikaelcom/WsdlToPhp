<?php
/**
 * Class file for LifePicsTypeGetStoresMerchantGroup
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresMerchantGroup
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresMerchantGroup extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresMerchantGroup
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_Longitude = null,$_Latitude = null,$_Distance = null,$_MerchantID = null,$_PickupOnly,$_MerchantGroupKey = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'Longitude'=>$_Longitude,'Latitude'=>$_Latitude,'Distance'=>$_Distance,'MerchantID'=>$_MerchantID,'PickupOnly'=>$_PickupOnly,'MerchantGroupKey'=>$_MerchantGroupKey));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
