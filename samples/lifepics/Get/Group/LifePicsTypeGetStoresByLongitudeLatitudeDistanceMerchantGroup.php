<?php
/**
 * Class file for LifePicsTypeGetStoresByLongitudeLatitudeDistanceMerchantGroup
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresByLongitudeLatitudeDistanceMerchantGroup
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresByLongitudeLatitudeDistanceMerchantGroup extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresByLongitudeLatitudeDistanceMerchantGroup
	 */
	public function __construct($_SessionID = null,$_Longitude = null,$_Latitude = null,$_Distance = null,$_PickupOnly,$_MerchantGroupKey = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'Longitude'=>$_Longitude,'Latitude'=>$_Latitude,'Distance'=>$_Distance,'PickupOnly'=>$_PickupOnly,'MerchantGroupKey'=>$_MerchantGroupKey));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
