<?php
/**
 * Class file for LifePicsTypeGetStores
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStores
 * @date 02/08/2012
 */
class LifePicsTypeGetStores extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStores
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_Longitude = null,$_Latitude = null,$_Distance = null,$_MerchantID = null,$_PickupOnly)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'Longitude'=>$_Longitude,'Latitude'=>$_Latitude,'Distance'=>$_Distance,'MerchantID'=>$_MerchantID,'PickupOnly'=>$_PickupOnly));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
