<?php
/**
 * Class file for LifePicsTypeGetStoresPaging
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresPaging
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresPaging extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresPaging
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_Longitude = null,$_Latitude = null,$_Distance = null,$_MerchantID = null,$_PickupOnly,$_StartIndex,$_DisplayCount)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'Longitude'=>$_Longitude,'Latitude'=>$_Latitude,'Distance'=>$_Distance,'MerchantID'=>$_MerchantID,'PickupOnly'=>$_PickupOnly,'StartIndex'=>$_StartIndex,'DisplayCount'=>$_DisplayCount));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
