<?php
/**
 * Class file for LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPaging
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPaging
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPaging extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPaging
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_Distance = null,$_PickupOnly,$_StartIndex,$_DisplayCount,$_MerchantGroupKey = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'Distance'=>$_Distance,'PickupOnly'=>$_PickupOnly,'StartIndex'=>$_StartIndex,'DisplayCount'=>$_DisplayCount,'MerchantGroupKey'=>$_MerchantGroupKey));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
