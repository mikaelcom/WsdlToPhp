<?php
/**
 * Class file for LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPagingMetric
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPagingMetric
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPagingMetric extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresByPostalCodeDistanceMerchantGroupPagingMetric
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_Distance = null,$_PickupOnly,$_StartIndex,$_DisplayCount,$_MerchantGroupKey = null,$_IsMetric)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'Distance'=>$_Distance,'PickupOnly'=>$_PickupOnly,'StartIndex'=>$_StartIndex,'DisplayCount'=>$_DisplayCount,'MerchantGroupKey'=>$_MerchantGroupKey,'IsMetric'=>$_IsMetric));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
