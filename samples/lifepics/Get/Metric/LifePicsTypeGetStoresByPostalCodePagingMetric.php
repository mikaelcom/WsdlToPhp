<?php
/**
 * Class file for LifePicsTypeGetStoresByPostalCodePagingMetric
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresByPostalCodePagingMetric
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresByPostalCodePagingMetric extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresByPostalCodePagingMetric
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_PickupOnly,$_StartIndex,$_DisplayCount,$_IsMetric)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'PickupOnly'=>$_PickupOnly,'StartIndex'=>$_StartIndex,'DisplayCount'=>$_DisplayCount,'IsMetric'=>$_IsMetric));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
