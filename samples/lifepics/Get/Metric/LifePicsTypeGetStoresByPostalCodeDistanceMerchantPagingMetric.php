<?php
/**
 * Class file for LifePicsTypeGetStoresByPostalCodeDistanceMerchantPagingMetric
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeGetStoresByPostalCodeDistanceMerchantPagingMetric
 * @date 02/08/2012
 */
class LifePicsTypeGetStoresByPostalCodeDistanceMerchantPagingMetric extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeGetStoresByPostalCodeDistanceMerchantPagingMetric
	 */
	public function __construct($_SessionID = null,$_PostalCode = null,$_Distance = null,$_MerchantID = null,$_PickupOnly,$_StartIndex,$_DisplayCount,$_IsMetric)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PostalCode'=>$_PostalCode,'Distance'=>$_Distance,'MerchantID'=>$_MerchantID,'PickupOnly'=>$_PickupOnly,'StartIndex'=>$_StartIndex,'DisplayCount'=>$_DisplayCount,'IsMetric'=>$_IsMetric));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
