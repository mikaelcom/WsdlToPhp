<?php
/**
 * Class file for LifePicsTypeUploadFileRotateAlbum
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeUploadFileRotateAlbum
 * @date 02/08/2012
 */
class LifePicsTypeUploadFileRotateAlbum extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeUploadFileRotateAlbum
	 */
	public function __construct($_SessionID = null,$_PartnerSourceID = null,$_UserID = null,$_FileBinaryArray = null,$_FileStreamSize = null,$_Filename = null,$_Rotate,$_AlbumID = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PartnerSourceID'=>$_PartnerSourceID,'UserID'=>$_UserID,'FileBinaryArray'=>$_FileBinaryArray,'FileStreamSize'=>$_FileStreamSize,'Filename'=>$_Filename,'Rotate'=>$_Rotate,'AlbumID'=>$_AlbumID));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
