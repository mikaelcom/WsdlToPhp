<?php
/**
 * Class file for LifePicsTypeUploadFileWatermark
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeUploadFileWatermark
 * @date 02/08/2012
 */
class LifePicsTypeUploadFileWatermark extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeUploadFileWatermark
	 */
	public function __construct($_SessionID = null,$_PartnerSourceID = null,$_UserID = null,$_FileBinaryArray = null,$_FileStreamSize = null,$_Filename = null,$_Watermark)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PartnerSourceID'=>$_PartnerSourceID,'UserID'=>$_UserID,'FileBinaryArray'=>$_FileBinaryArray,'FileStreamSize'=>$_FileStreamSize,'Filename'=>$_Filename,'Watermark'=>$_Watermark));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
