<?php
/**
 * Class file for LifePicsTypeUploadFileExclusiveTagsSource
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeUploadFileExclusiveTagsSource
 * @date 02/08/2012
 */
class LifePicsTypeUploadFileExclusiveTagsSource extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeUploadFileExclusiveTagsSource
	 */
	public function __construct($_SessionID = null,$_PartnerSourceID = null,$_UserID = null,$_FileBinaryArray = null,$_FileStreamSize = null,$_Filename = null,$_ExclusiveToDealer,$_MerchantID = null,$_TagsXML = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PartnerSourceID'=>$_PartnerSourceID,'UserID'=>$_UserID,'FileBinaryArray'=>$_FileBinaryArray,'FileStreamSize'=>$_FileStreamSize,'Filename'=>$_Filename,'ExclusiveToDealer'=>$_ExclusiveToDealer,'MerchantID'=>$_MerchantID,'TagsXML'=>$_TagsXML));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
