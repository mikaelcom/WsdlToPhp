<?php
/**
 * Class file for LifePicsTypeUploadFileTagsSource
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeUploadFileTagsSource
 * @date 02/08/2012
 */
class LifePicsTypeUploadFileTagsSource extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeUploadFileTagsSource
	 */
	public function __construct($_SessionID = null,$_PartnerSourceID = null,$_UserID = null,$_FileBinaryArray = null,$_FileStreamSize = null,$_Filename = null,$_TagsXML = null,$_MerchantID = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PartnerSourceID'=>$_PartnerSourceID,'UserID'=>$_UserID,'FileBinaryArray'=>$_FileBinaryArray,'FileStreamSize'=>$_FileStreamSize,'Filename'=>$_Filename,'TagsXML'=>$_TagsXML,'MerchantID'=>$_MerchantID));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
