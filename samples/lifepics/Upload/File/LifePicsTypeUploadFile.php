<?php
/**
 * Class file for LifePicsTypeUploadFile
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeUploadFile
 * @date 02/08/2012
 */
class LifePicsTypeUploadFile extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeUploadFile
	 */
	public function __construct($_SessionID = null,$_PartnerSourceID = null,$_UserID = null,$_FileBinaryArray = null,$_FileStreamSize = null,$_Filename = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'PartnerSourceID'=>$_PartnerSourceID,'UserID'=>$_UserID,'FileBinaryArray'=>$_FileBinaryArray,'FileStreamSize'=>$_FileStreamSize,'Filename'=>$_Filename));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
