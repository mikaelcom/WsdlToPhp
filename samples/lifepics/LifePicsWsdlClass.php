<?php
/**
 * File for LifePicsWsdlClass to communicate with SOAP service
 * @date 02/08/2012
 */
/**
 * File for LifePicsWsdlClass to communicate with SOAP service
 ...
 * @date 02/08/2012
 */
class LifePicsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses LifePicsWsdlClass::setLastError()
	 * @uses LifePicsWsdlClass::initSoapClient()
	 * @uses LifePicsWsdlClass::initInternArrayToIterate()
	 * @uses LifePicsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses LifePicsWsdlClass::classMap()
	 * @uses LifePicsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('LifePicsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = LifePicsClassMap::classMap();
	 ...
	 * @uses LifePicsWsdlClass::WSDL_CACHE_WSDL
	 * @uses LifePicsWsdlClass::WSDL_COMPRESSION
	 * @uses LifePicsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses LifePicsWsdlClass::WSDL_ENCODING
	 * @uses LifePicsWsdlClass::WSDL_EXCPTS
	 * @uses LifePicsWsdlClass::WSDL_FEATURES
	 * @uses LifePicsWsdlClass::WSDL_LOGIN
	 * @uses LifePicsWsdlClass::WSDL_PASSWD
	 * @uses LifePicsWsdlClass::WSDL_SOAP_VERSION
	 * @uses LifePicsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses LifePicsWsdlClass::WSDL_TRACE
	 * @uses LifePicsWsdlClass::WSDL_TYPEMAP
	 * @uses LifePicsWsdlClass::WSDL_URL
	 * @uses LifePicsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses LifePicsWsdlClass::internArrayToIterateIsArray()
	 * @uses LifePicsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses LifePicsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses LifePicsWsdlClass::getInternArrayToIterateOffset()
	 * @uses LifePicsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses LifePicsWsdlClass::getInternArrayToIterateOffset()
	 * @uses LifePicsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see LifePicsWsdlClass::offsetGet()
	 * @uses LifePicsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses LifePicsWsdlClass::getAttributeName()
	 * @uses LifePicsWsdlClass::__toString()
	 * @uses LifePicsWsdlClass::_set()
	 * @uses LifePicsWsdlClass::_get()
	 * @uses LifePicsWsdlClass::setInternArrayToIterate()
	 * @uses LifePicsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses LifePicsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses LifePicsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses LifePicsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
