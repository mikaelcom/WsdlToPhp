<?php
/**
 * Class file for LifePicsTypeAddItemToCartWeb
 * @date 02/08/2012
 */
/**
 * Class LifePicsTypeAddItemToCartWeb
 * @date 02/08/2012
 */
class LifePicsTypeAddItemToCartWeb extends LifePicsWsdlClass
{
	/**
	 * The SessionID
	 * Meta informations :
	 ...
	 * @return LifePicsTypeAddItemToCartWeb
	 */
	public function __construct($_SessionID = null,$_MerchantID = null,$_PartnerSourceID = null,$_UserID = null,$_PickupLocationID = null,$_ProductID = null,$_Quantity = null,$_ImagesXML = null,$_AttributesXML = null)
	{
		parent::__construct(array('SessionID'=>$_SessionID,'MerchantID'=>$_MerchantID,'PartnerSourceID'=>$_PartnerSourceID,'UserID'=>$_UserID,'PickupLocationID'=>$_PickupLocationID,'ProductID'=>$_ProductID,'Quantity'=>$_Quantity,'ImagesXML'=>$_ImagesXML,'AttributesXML'=>$_AttributesXML));
	}
	/**
	 * Set SessionID
	 * @param string SessionID
