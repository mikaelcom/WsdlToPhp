<?php
/**
 * File for EccVideoAolWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccVideoAolWsdlClass to communicate with SOAP service
 * Documentation : Cocoma AOL Video Web Services.
 * @date 03/07/2012
 */
class EccVideoAolWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccVideoAolWsdlClass::setLastError()
	 * @uses EccVideoAolWsdlClass::initSoapClient()
	 * @uses EccVideoAolWsdlClass::initInternArrayToIterate()
	 * @uses EccVideoAolWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccVideoAolWsdlClass::classMap()
	 * @uses EccVideoAolWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccVideoAolClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccVideoAolClassMap::classMap();
	 ...
	 * @uses EccVideoAolWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccVideoAolWsdlClass::WSDL_COMPRESSION
	 * @uses EccVideoAolWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccVideoAolWsdlClass::WSDL_ENCODING
	 * @uses EccVideoAolWsdlClass::WSDL_EXCPTS
	 * @uses EccVideoAolWsdlClass::WSDL_FEATURES
	 * @uses EccVideoAolWsdlClass::WSDL_LOGIN
	 * @uses EccVideoAolWsdlClass::WSDL_PASSWD
	 * @uses EccVideoAolWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccVideoAolWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccVideoAolWsdlClass::WSDL_TRACE
	 * @uses EccVideoAolWsdlClass::WSDL_TYPEMAP
	 * @uses EccVideoAolWsdlClass::WSDL_URL
	 * @uses EccVideoAolWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccVideoAolWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::internArrayToIterateIsArray()
	 * @uses EccVideoAolWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccVideoAolWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccVideoAolWsdlClass::offsetExists()
	 ...
	 * @uses EccVideoAolWsdlClass::getAttributeName()
	 * @uses EccVideoAolWsdlClass::__toString()
	 * @uses EccVideoAolWsdlClass::_set()
	 * @uses EccVideoAolWsdlClass::_get()
	 * @uses EccVideoAolWsdlClass::setInternArrayToIterate()
	 * @uses EccVideoAolWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccVideoAolWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::item()
	 * @uses EccVideoAolWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoAolWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccVideoAolWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
