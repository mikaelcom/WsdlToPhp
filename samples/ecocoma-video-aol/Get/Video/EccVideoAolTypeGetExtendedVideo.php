<?php
/**
 * Class file for EccVideoAolTypeGetExtendedVideo
 * @date 03/07/2012
 */
/**
 * Class EccVideoAolTypeGetExtendedVideo
 * @date 03/07/2012
 */
class EccVideoAolTypeGetExtendedVideo extends EccVideoAolWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccVideoAolTypeGetExtendedVideo
	 */
