<?php
/**
 * Class file for XiStatisticsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeHeader
 * @date 08/07/2012
 */
class XiStatisticsTypeHeader extends XiStatisticsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
