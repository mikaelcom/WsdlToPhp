<?php
/**
 * Class file for XiStatisticsTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiStatisticsTypePredefinedLightModel extends XiStatisticsWsdlClass
{
	/**
