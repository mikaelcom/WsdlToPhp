<?php
/**
 * File for XiStatisticsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiStatisticsWsdlClass to communicate with SOAP service
 * Documentation : Delivers and charts more than 1400 economical time-series fom the Federal Reserve Bank.
 * @date 08/07/2012
 */
class XiStatisticsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiStatisticsWsdlClass::setLastError()
	 * @uses XiStatisticsWsdlClass::initSoapClient()
	 * @uses XiStatisticsWsdlClass::initInternArrayToIterate()
	 * @uses XiStatisticsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiStatisticsWsdlClass::classMap()
	 * @uses XiStatisticsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiStatisticsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiStatisticsClassMap::classMap();
	 ...
	 * @uses XiStatisticsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiStatisticsWsdlClass::WSDL_COMPRESSION
	 * @uses XiStatisticsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiStatisticsWsdlClass::WSDL_ENCODING
	 * @uses XiStatisticsWsdlClass::WSDL_EXCPTS
	 * @uses XiStatisticsWsdlClass::WSDL_FEATURES
	 * @uses XiStatisticsWsdlClass::WSDL_LOGIN
	 * @uses XiStatisticsWsdlClass::WSDL_PASSWD
	 * @uses XiStatisticsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiStatisticsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiStatisticsWsdlClass::WSDL_TRACE
	 * @uses XiStatisticsWsdlClass::WSDL_TYPEMAP
	 * @uses XiStatisticsWsdlClass::WSDL_URL
	 * @uses XiStatisticsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiStatisticsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiStatisticsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiStatisticsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiStatisticsWsdlClass::offsetExists()
	 ...
	 * @uses XiStatisticsWsdlClass::getAttributeName()
	 * @uses XiStatisticsWsdlClass::__toString()
	 * @uses XiStatisticsWsdlClass::_set()
	 * @uses XiStatisticsWsdlClass::_get()
	 * @uses XiStatisticsWsdlClass::setInternArrayToIterate()
	 * @uses XiStatisticsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiStatisticsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::item()
	 * @uses XiStatisticsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiStatisticsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiStatisticsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
