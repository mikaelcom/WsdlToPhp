<?php
/**
 * Class file for XiStatisticsTypeGetChartUrl
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetChartUrl
 * @date 08/07/2012
 */
class XiStatisticsTypeGetChartUrl extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetChartUrl
	 */
