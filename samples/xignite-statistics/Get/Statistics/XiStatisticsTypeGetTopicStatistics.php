<?php
/**
 * Class file for XiStatisticsTypeGetTopicStatistics
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetTopicStatistics
 * @date 08/07/2012
 */
class XiStatisticsTypeGetTopicStatistics extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetTopicStatistics
	 */
