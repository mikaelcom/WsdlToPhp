<?php
/**
 * Class file for XiStatisticsTypeGetAnnualizedTopicData
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetAnnualizedTopicData
 * @date 08/07/2012
 */
class XiStatisticsTypeGetAnnualizedTopicData extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetAnnualizedTopicData
	 */
