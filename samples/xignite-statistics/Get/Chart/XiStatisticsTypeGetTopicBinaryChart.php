<?php
/**
 * Class file for XiStatisticsTypeGetTopicBinaryChart
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetTopicBinaryChart
 * @date 08/07/2012
 */
class XiStatisticsTypeGetTopicBinaryChart extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @param string Preset
	 * @return XiStatisticsTypeGetTopicBinaryChart
	 */
