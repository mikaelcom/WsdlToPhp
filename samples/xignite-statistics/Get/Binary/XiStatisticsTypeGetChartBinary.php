<?php
/**
 * Class file for XiStatisticsTypeGetChartBinary
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetChartBinary
 * @date 08/07/2012
 */
class XiStatisticsTypeGetChartBinary extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetChartBinary
	 */
