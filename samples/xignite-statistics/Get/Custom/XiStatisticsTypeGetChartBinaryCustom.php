<?php
/**
 * Class file for XiStatisticsTypeGetChartBinaryCustom
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetChartBinaryCustom
 * @date 08/07/2012
 */
class XiStatisticsTypeGetChartBinaryCustom extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetChartBinaryCustom
	 */
