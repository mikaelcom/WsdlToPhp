<?php
/**
 * Class file for XiStatisticsTypeGetChartUrlCustom
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetChartUrlCustom
 * @date 08/07/2012
 */
class XiStatisticsTypeGetChartUrlCustom extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetChartUrlCustom
	 */
