<?php
/**
 * Class file for XiStatisticsTypeGetTopicBinaryChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetTopicBinaryChartCustom
 * @date 08/07/2012
 */
class XiStatisticsTypeGetTopicBinaryChartCustom extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @return XiStatisticsTypeGetTopicBinaryChartCustom
	 */
