<?php
/**
 * Class file for XiStatisticsTypeGetChartUrlPreset
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetChartUrlPreset
 * @date 08/07/2012
 */
class XiStatisticsTypeGetChartUrlPreset extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @param string Preset
	 * @return XiStatisticsTypeGetChartUrlPreset
	 */
