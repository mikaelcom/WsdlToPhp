<?php
/**
 * Class file for XiStatisticsTypeGetChartBinaryPreset
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeGetChartBinaryPreset
 * @date 08/07/2012
 */
class XiStatisticsTypeGetChartBinaryPreset extends XiStatisticsWsdlClass
{
	/**
	 * The TopicCode
	 * Meta informations :
	 ...
	 * @param string Preset
	 * @return XiStatisticsTypeGetChartBinaryPreset
	 */
