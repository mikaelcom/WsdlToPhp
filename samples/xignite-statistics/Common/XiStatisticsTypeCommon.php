<?php
/**
 * Class file for XiStatisticsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeCommon
 * @date 08/07/2012
 */
class XiStatisticsTypeCommon extends XiStatisticsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiStatisticsTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiStatisticsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiStatisticsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiStatisticsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiStatisticsTypeOutcomeTypes
	 */
