<?php
/**
 * Class file for XiStatisticsTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiStatisticsTypeChartDesign
 * @date 08/07/2012
 */
class XiStatisticsTypeChartDesign extends XiStatisticsTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiStatisticsTypeLinePattern
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiStatisticsTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiStatisticsTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiStatisticsTypeTickPeriod
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiStatisticsTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiStatisticsTypeLinePattern GridHorizontalStyle
	 * @param XiStatisticsTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiStatisticsTypeImageFrameType FrameType
	 * @param XiStatisticsTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiStatisticsTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiStatisticsTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiStatisticsTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiStatisticsTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiStatisticsTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiStatisticsTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiStatisticsTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiStatisticsTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiStatisticsTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	...
	{
		return ($this->TickPrecision = XiStatisticsTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	 * @return XiStatisticsTypeTickPeriod
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiStatisticsTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiStatisticsTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiStatisticsTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiStatisticsTypePredefinedLightModel
	 */
