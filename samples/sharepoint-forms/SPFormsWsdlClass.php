<?php
/**
 * File for SPFormsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPFormsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPFormsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPFormsWsdlClass::setLastError()
	 * @uses SPFormsWsdlClass::initSoapClient()
	 * @uses SPFormsWsdlClass::initInternArrayToIterate()
	 * @uses SPFormsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPFormsWsdlClass::classMap()
	 * @uses SPFormsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPFormsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPFormsClassMap::classMap();
	 ...
	 * @uses SPFormsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPFormsWsdlClass::WSDL_COMPRESSION
	 * @uses SPFormsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPFormsWsdlClass::WSDL_ENCODING
	 * @uses SPFormsWsdlClass::WSDL_EXCPTS
	 * @uses SPFormsWsdlClass::WSDL_FEATURES
	 * @uses SPFormsWsdlClass::WSDL_LOGIN
	 * @uses SPFormsWsdlClass::WSDL_PASSWD
	 * @uses SPFormsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPFormsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPFormsWsdlClass::WSDL_TRACE
	 * @uses SPFormsWsdlClass::WSDL_TYPEMAP
	 * @uses SPFormsWsdlClass::WSDL_URL
	 * @uses SPFormsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPFormsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPFormsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPFormsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPFormsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPFormsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPFormsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPFormsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPFormsWsdlClass::offsetGet()
	 * @uses SPFormsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPFormsWsdlClass::getAttributeName()
	 * @uses SPFormsWsdlClass::__toString()
	 * @uses SPFormsWsdlClass::_set()
	 * @uses SPFormsWsdlClass::_get()
	 * @uses SPFormsWsdlClass::setInternArrayToIterate()
	 * @uses SPFormsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPFormsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPFormsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPFormsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
