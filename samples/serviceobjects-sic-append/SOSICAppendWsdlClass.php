<?php
/**
 * File for SOSICAppendWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOSICAppendWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOSICAppendWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOSICAppendWsdlClass::setLastError()
	 * @uses SOSICAppendWsdlClass::initSoapClient()
	 * @uses SOSICAppendWsdlClass::initInternArrayToIterate()
	 * @uses SOSICAppendWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOSICAppendWsdlClass::classMap()
	 * @uses SOSICAppendWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOSICAppendClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOSICAppendClassMap::classMap();
	 ...
	 * @uses SOSICAppendWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOSICAppendWsdlClass::WSDL_COMPRESSION
	 * @uses SOSICAppendWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOSICAppendWsdlClass::WSDL_ENCODING
	 * @uses SOSICAppendWsdlClass::WSDL_EXCPTS
	 * @uses SOSICAppendWsdlClass::WSDL_FEATURES
	 * @uses SOSICAppendWsdlClass::WSDL_LOGIN
	 * @uses SOSICAppendWsdlClass::WSDL_PASSWD
	 * @uses SOSICAppendWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOSICAppendWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOSICAppendWsdlClass::WSDL_TRACE
	 * @uses SOSICAppendWsdlClass::WSDL_TYPEMAP
	 * @uses SOSICAppendWsdlClass::WSDL_URL
	 * @uses SOSICAppendWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOSICAppendWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::internArrayToIterateIsArray()
	 * @uses SOSICAppendWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOSICAppendWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOSICAppendWsdlClass::offsetExists()
	 ...
	 * @uses SOSICAppendWsdlClass::getAttributeName()
	 * @uses SOSICAppendWsdlClass::__toString()
	 * @uses SOSICAppendWsdlClass::_set()
	 * @uses SOSICAppendWsdlClass::_get()
	 * @uses SOSICAppendWsdlClass::setInternArrayToIterate()
	 * @uses SOSICAppendWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOSICAppendWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::item()
	 * @uses SOSICAppendWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOSICAppendWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOSICAppendWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
