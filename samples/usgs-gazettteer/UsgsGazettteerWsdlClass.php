<?php
/**
 * File for UsgsGazettteerWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for UsgsGazettteerWsdlClass to communicate with SOAP service
 * Documentation : The TNM Gazetteer Query Web Service returns the <a href="http://geonames.usgs.gov">Geographic Names Information System (GNIS)</a> point from the USGS_GNIS datasets hosted at the <a href="http://edc.usgs.gov/">EROS Data Center</a>. View the detailed <a href="http://gisdata.usgs.net/XMLWebServices/TNM_Gazetteer_Service_Methods.asp">Gazetteer Service Methods</a> description for more information on the methods and parameters used in this service. Visit <a href="http://gisdata.usgs.net/">http://gisdata.usgs.net/</a> to view other TNM Web Services.
 * @date 08/07/2012
 */
class UsgsGazettteerWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses UsgsGazettteerWsdlClass::setLastError()
	 * @uses UsgsGazettteerWsdlClass::initSoapClient()
	 * @uses UsgsGazettteerWsdlClass::initInternArrayToIterate()
	 * @uses UsgsGazettteerWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses UsgsGazettteerWsdlClass::classMap()
	 * @uses UsgsGazettteerWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('UsgsGazettteerClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = UsgsGazettteerClassMap::classMap();
	 ...
	 * @uses UsgsGazettteerWsdlClass::WSDL_CACHE_WSDL
	 * @uses UsgsGazettteerWsdlClass::WSDL_COMPRESSION
	 * @uses UsgsGazettteerWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses UsgsGazettteerWsdlClass::WSDL_ENCODING
	 * @uses UsgsGazettteerWsdlClass::WSDL_EXCPTS
	 * @uses UsgsGazettteerWsdlClass::WSDL_FEATURES
	 * @uses UsgsGazettteerWsdlClass::WSDL_LOGIN
	 * @uses UsgsGazettteerWsdlClass::WSDL_PASSWD
	 * @uses UsgsGazettteerWsdlClass::WSDL_SOAP_VERSION
	 * @uses UsgsGazettteerWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses UsgsGazettteerWsdlClass::WSDL_TRACE
	 * @uses UsgsGazettteerWsdlClass::WSDL_TYPEMAP
	 * @uses UsgsGazettteerWsdlClass::WSDL_URL
	 * @uses UsgsGazettteerWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses UsgsGazettteerWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::internArrayToIterateIsArray()
	 * @uses UsgsGazettteerWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsGazettteerWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsGazettteerWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see UsgsGazettteerWsdlClass::offsetGet()
	 * @uses UsgsGazettteerWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::getAttributeName()
	 * @uses UsgsGazettteerWsdlClass::__toString()
	 * @uses UsgsGazettteerWsdlClass::_set()
	 * @uses UsgsGazettteerWsdlClass::_get()
	 * @uses UsgsGazettteerWsdlClass::setInternArrayToIterate()
	 * @uses UsgsGazettteerWsdlClass::setInternArrayToIterateIsArray()
	 * @uses UsgsGazettteerWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::item()
	 * @uses UsgsGazettteerWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsGazettteerWsdlClass::getInternArrayToIterateIsArray()
	 * @uses UsgsGazettteerWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
