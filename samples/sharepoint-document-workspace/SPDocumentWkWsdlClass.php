<?php
/**
 * File for SPDocumentWkWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPDocumentWkWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPDocumentWkWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPDocumentWkWsdlClass::setLastError()
	 * @uses SPDocumentWkWsdlClass::initSoapClient()
	 * @uses SPDocumentWkWsdlClass::initInternArrayToIterate()
	 * @uses SPDocumentWkWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPDocumentWkWsdlClass::classMap()
	 * @uses SPDocumentWkWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPDocumentWkClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPDocumentWkClassMap::classMap();
	 ...
	 * @uses SPDocumentWkWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPDocumentWkWsdlClass::WSDL_COMPRESSION
	 * @uses SPDocumentWkWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPDocumentWkWsdlClass::WSDL_ENCODING
	 * @uses SPDocumentWkWsdlClass::WSDL_EXCPTS
	 * @uses SPDocumentWkWsdlClass::WSDL_FEATURES
	 * @uses SPDocumentWkWsdlClass::WSDL_LOGIN
	 * @uses SPDocumentWkWsdlClass::WSDL_PASSWD
	 * @uses SPDocumentWkWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPDocumentWkWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPDocumentWkWsdlClass::WSDL_TRACE
	 * @uses SPDocumentWkWsdlClass::WSDL_TYPEMAP
	 * @uses SPDocumentWkWsdlClass::WSDL_URL
	 * @uses SPDocumentWkWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPDocumentWkWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::internArrayToIterateIsArray()
	 * @uses SPDocumentWkWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPDocumentWkWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPDocumentWkWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPDocumentWkWsdlClass::offsetGet()
	 * @uses SPDocumentWkWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::getAttributeName()
	 * @uses SPDocumentWkWsdlClass::__toString()
	 * @uses SPDocumentWkWsdlClass::_set()
	 * @uses SPDocumentWkWsdlClass::_get()
	 * @uses SPDocumentWkWsdlClass::setInternArrayToIterate()
	 * @uses SPDocumentWkWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPDocumentWkWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::item()
	 * @uses SPDocumentWkWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPDocumentWkWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPDocumentWkWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
