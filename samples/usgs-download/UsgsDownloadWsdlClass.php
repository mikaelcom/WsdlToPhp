<?php
/**
 * File for UsgsDownloadWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for UsgsDownloadWsdlClass to communicate with SOAP service
 * Documentation : DownloadService
 * @date 08/07/2012
 */
class UsgsDownloadWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses UsgsDownloadWsdlClass::setLastError()
	 * @uses UsgsDownloadWsdlClass::initSoapClient()
	 * @uses UsgsDownloadWsdlClass::initInternArrayToIterate()
	 * @uses UsgsDownloadWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses UsgsDownloadWsdlClass::classMap()
	 * @uses UsgsDownloadWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('UsgsDownloadClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = UsgsDownloadClassMap::classMap();
	 ...
	 * @uses UsgsDownloadWsdlClass::WSDL_CACHE_WSDL
	 * @uses UsgsDownloadWsdlClass::WSDL_COMPRESSION
	 * @uses UsgsDownloadWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses UsgsDownloadWsdlClass::WSDL_ENCODING
	 * @uses UsgsDownloadWsdlClass::WSDL_EXCPTS
	 * @uses UsgsDownloadWsdlClass::WSDL_FEATURES
	 * @uses UsgsDownloadWsdlClass::WSDL_LOGIN
	 * @uses UsgsDownloadWsdlClass::WSDL_PASSWD
	 * @uses UsgsDownloadWsdlClass::WSDL_SOAP_VERSION
	 * @uses UsgsDownloadWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses UsgsDownloadWsdlClass::WSDL_TRACE
	 * @uses UsgsDownloadWsdlClass::WSDL_TYPEMAP
	 * @uses UsgsDownloadWsdlClass::WSDL_URL
	 * @uses UsgsDownloadWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses UsgsDownloadWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::internArrayToIterateIsArray()
	 * @uses UsgsDownloadWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsDownloadWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::getInternArrayToIterateOffset()
	 * @uses UsgsDownloadWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see UsgsDownloadWsdlClass::offsetGet()
	 * @uses UsgsDownloadWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::getAttributeName()
	 * @uses UsgsDownloadWsdlClass::__toString()
	 * @uses UsgsDownloadWsdlClass::_set()
	 * @uses UsgsDownloadWsdlClass::_get()
	 * @uses UsgsDownloadWsdlClass::setInternArrayToIterate()
	 * @uses UsgsDownloadWsdlClass::setInternArrayToIterateIsArray()
	 * @uses UsgsDownloadWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::item()
	 * @uses UsgsDownloadWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses UsgsDownloadWsdlClass::getInternArrayToIterateIsArray()
	 * @uses UsgsDownloadWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
