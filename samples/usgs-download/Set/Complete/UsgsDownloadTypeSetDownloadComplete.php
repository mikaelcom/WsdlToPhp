<?php
/**
 * Class file for UsgsDownloadTypeSetDownloadComplete
 * @date 08/07/2012
 */
/**
 * Class UsgsDownloadTypeSetDownloadComplete
 * @date 08/07/2012
 */
class UsgsDownloadTypeSetDownloadComplete extends UsgsDownloadWsdlClass
{
	/**
	 * The downloadID
	 * Meta informations :
	 ...
	 * @param string DB
	 * @return UsgsDownloadTypeSetDownloadComplete
	 */
