<?php
/**
 * File for XiGlobalBondMasterWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalBondMasterWsdlClass to communicate with SOAP service
 * Documentation : XigniteGlobalBondMaster service provides basic security master data European and Asian investment grade corporate bonds.
 * @date 08/07/2012
 */
class XiGlobalBondMasterWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalBondMasterWsdlClass::setLastError()
	 * @uses XiGlobalBondMasterWsdlClass::initSoapClient()
	 * @uses XiGlobalBondMasterWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalBondMasterWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalBondMasterWsdlClass::classMap()
	 * @uses XiGlobalBondMasterWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalBondMasterClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalBondMasterClassMap::classMap();
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_TRACE
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_URL
	 * @uses XiGlobalBondMasterWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalBondMasterWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalBondMasterWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalBondMasterWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalBondMasterWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::getAttributeName()
	 * @uses XiGlobalBondMasterWsdlClass::__toString()
	 * @uses XiGlobalBondMasterWsdlClass::_set()
	 * @uses XiGlobalBondMasterWsdlClass::_get()
	 * @uses XiGlobalBondMasterWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalBondMasterWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalBondMasterWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::item()
	 * @uses XiGlobalBondMasterWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalBondMasterWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalBondMasterWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
