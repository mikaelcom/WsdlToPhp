<?php
/**
 * Class file for XiGlobalBondMasterTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeHeader
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeHeader extends XiGlobalBondMasterWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobalBondMasterTypeHeader
	 */
