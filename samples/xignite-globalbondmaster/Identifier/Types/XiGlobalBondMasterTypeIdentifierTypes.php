<?php
/**
 * Class file for XiGlobalBondMasterTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeIdentifierTypes extends XiGlobalBondMasterWsdlClass
{
	/**
