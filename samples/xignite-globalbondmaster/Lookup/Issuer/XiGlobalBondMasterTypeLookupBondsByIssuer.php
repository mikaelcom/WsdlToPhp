<?php
/**
 * Class file for XiGlobalBondMasterTypeLookupBondsByIssuer
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeLookupBondsByIssuer
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeLookupBondsByIssuer extends XiGlobalBondMasterWsdlClass
{
	/**
	 * The IssuerName
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiGlobalBondMasterTypeCurrencies
	 */
	public $Currency;
	/**
	 ...
	 * @param XiGlobalBondMasterTypeCurrencies Currency
	 ...
	 * @return XiGlobalBondMasterTypeLookupBondsByIssuer
	 */
	public function __construct($_IssuerName = null,$_Domicile,$_Currency,$_StartMaturityDate = null,$_EndMaturityDate = null,$_StartCouponRate = null,$_EndCouponRate = null,$_IncludeNonactive)
	{
		parent::__construct(array('IssuerName'=>$_IssuerName,'Domicile'=>$_Domicile,'Currency'=>$_Currency,'StartMaturityDate'=>$_StartMaturityDate,'EndMaturityDate'=>$_EndMaturityDate,'StartCouponRate'=>$_StartCouponRate,'EndCouponRate'=>$_EndCouponRate,'IncludeNonactive'=>$_IncludeNonactive));
	}
	/**
	 * Set IssuerName
	 * @param string IssuerName
	...
	{
		return ($this->Currency = XiGlobalBondMasterTypeCurrencies::valueIsValid($_Currency)?$_Currency:null);
	}
	/**
	 * Get Currency
