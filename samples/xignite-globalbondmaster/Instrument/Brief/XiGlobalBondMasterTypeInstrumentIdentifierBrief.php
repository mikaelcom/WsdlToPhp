<?php
/**
 * Class file for XiGlobalBondMasterTypeInstrumentIdentifierBrief
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeInstrumentIdentifierBrief
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeInstrumentIdentifierBrief extends XiGlobalBondMasterWsdlClass
{
	/**
	 * The Valoren
	 * Meta informations :
