<?php
/**
 * Class file for XiGlobalBondMasterTypeInstrumentIdentifier
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeInstrumentIdentifier
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeInstrumentIdentifier extends XiGlobalBondMasterTypeInstrumentIdentifierBrief
{
	/**
	...
	{
		XiGlobalBondMasterWsdlClass::__construct(array('CompanyIdentifier'=>$_CompanyIdentifier,'ShortName'=>$_ShortName,'IssuerName'=>$_IssuerName,'IssuerDomicile'=>$_IssuerDomicile,'CFICode'=>$_CFICode,'OriginalIssuerName'=>$_OriginalIssuerName,'OriginalCompanyIdentifier'=>$_OriginalCompanyIdentifier));
	}
	/**
