<?php
/**
 * Class file for XiGlobalBondMasterTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeOutcomeTypes extends XiGlobalBondMasterWsdlClass
{
	/**
