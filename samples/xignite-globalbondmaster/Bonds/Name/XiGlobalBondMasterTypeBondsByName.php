<?php
/**
 * Class file for XiGlobalBondMasterTypeBondsByName
 * @date 08/07/2012
 */
/**
 * Class XiGlobalBondMasterTypeBondsByName
 * @date 08/07/2012
 */
class XiGlobalBondMasterTypeBondsByName extends XiGlobalBondMasterTypeCommon
{
	/**
	 * The Issuer
	 * Meta informations :
