<?php
/**
 * File for EccGeoCityZipWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccGeoCityZipWsdlClass to communicate with SOAP service
 * Documentation : Cocoma ZipCode Lookup Web Services.
 * @date 03/07/2012
 */
class EccGeoCityZipWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccGeoCityZipWsdlClass::setLastError()
	 * @uses EccGeoCityZipWsdlClass::initSoapClient()
	 * @uses EccGeoCityZipWsdlClass::initInternArrayToIterate()
	 * @uses EccGeoCityZipWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccGeoCityZipWsdlClass::classMap()
	 * @uses EccGeoCityZipWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccGeoCityZipClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccGeoCityZipClassMap::classMap();
	 ...
	 * @uses EccGeoCityZipWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccGeoCityZipWsdlClass::WSDL_COMPRESSION
	 * @uses EccGeoCityZipWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccGeoCityZipWsdlClass::WSDL_ENCODING
	 * @uses EccGeoCityZipWsdlClass::WSDL_EXCPTS
	 * @uses EccGeoCityZipWsdlClass::WSDL_FEATURES
	 * @uses EccGeoCityZipWsdlClass::WSDL_LOGIN
	 * @uses EccGeoCityZipWsdlClass::WSDL_PASSWD
	 * @uses EccGeoCityZipWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccGeoCityZipWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccGeoCityZipWsdlClass::WSDL_TRACE
	 * @uses EccGeoCityZipWsdlClass::WSDL_TYPEMAP
	 * @uses EccGeoCityZipWsdlClass::WSDL_URL
	 * @uses EccGeoCityZipWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccGeoCityZipWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::internArrayToIterateIsArray()
	 * @uses EccGeoCityZipWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoCityZipWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoCityZipWsdlClass::offsetExists()
	 ...
	 * @uses EccGeoCityZipWsdlClass::getAttributeName()
	 * @uses EccGeoCityZipWsdlClass::__toString()
	 * @uses EccGeoCityZipWsdlClass::_set()
	 * @uses EccGeoCityZipWsdlClass::_get()
	 * @uses EccGeoCityZipWsdlClass::setInternArrayToIterate()
	 * @uses EccGeoCityZipWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccGeoCityZipWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::item()
	 * @uses EccGeoCityZipWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoCityZipWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccGeoCityZipWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
