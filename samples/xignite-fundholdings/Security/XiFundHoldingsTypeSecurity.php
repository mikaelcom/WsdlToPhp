<?php
/**
 * Class file for XiFundHoldingsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeSecurity
 * @date 08/07/2012
 */
class XiFundHoldingsTypeSecurity extends XiFundHoldingsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiFundHoldingsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
