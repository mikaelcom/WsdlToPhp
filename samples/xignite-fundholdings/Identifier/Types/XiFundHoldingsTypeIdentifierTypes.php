<?php
/**
 * Class file for XiFundHoldingsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiFundHoldingsTypeIdentifierTypes extends XiFundHoldingsWsdlClass
{
	/**
