<?php
/**
 * File for XiFundHoldingsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiFundHoldingsWsdlClass to communicate with SOAP service
 * Documentation : this web service provides information about mutual funds holdings.
 * @date 08/07/2012
 */
class XiFundHoldingsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiFundHoldingsWsdlClass::setLastError()
	 * @uses XiFundHoldingsWsdlClass::initSoapClient()
	 * @uses XiFundHoldingsWsdlClass::initInternArrayToIterate()
	 * @uses XiFundHoldingsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiFundHoldingsWsdlClass::classMap()
	 * @uses XiFundHoldingsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiFundHoldingsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiFundHoldingsClassMap::classMap();
	 ...
	 * @uses XiFundHoldingsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiFundHoldingsWsdlClass::WSDL_COMPRESSION
	 * @uses XiFundHoldingsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiFundHoldingsWsdlClass::WSDL_ENCODING
	 * @uses XiFundHoldingsWsdlClass::WSDL_EXCPTS
	 * @uses XiFundHoldingsWsdlClass::WSDL_FEATURES
	 * @uses XiFundHoldingsWsdlClass::WSDL_LOGIN
	 * @uses XiFundHoldingsWsdlClass::WSDL_PASSWD
	 * @uses XiFundHoldingsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiFundHoldingsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiFundHoldingsWsdlClass::WSDL_TRACE
	 * @uses XiFundHoldingsWsdlClass::WSDL_TYPEMAP
	 * @uses XiFundHoldingsWsdlClass::WSDL_URL
	 * @uses XiFundHoldingsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiFundHoldingsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiFundHoldingsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundHoldingsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundHoldingsWsdlClass::offsetExists()
	 ...
	 * @uses XiFundHoldingsWsdlClass::getAttributeName()
	 * @uses XiFundHoldingsWsdlClass::__toString()
	 * @uses XiFundHoldingsWsdlClass::_set()
	 * @uses XiFundHoldingsWsdlClass::_get()
	 * @uses XiFundHoldingsWsdlClass::setInternArrayToIterate()
	 * @uses XiFundHoldingsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiFundHoldingsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::item()
	 * @uses XiFundHoldingsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundHoldingsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiFundHoldingsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
