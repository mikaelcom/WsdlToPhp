<?php
/**
 * Class file for XiFundHoldingsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeHeader
 * @date 08/07/2012
 */
class XiFundHoldingsTypeHeader extends XiFundHoldingsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiFundHoldingsTypeHeader
	 */
