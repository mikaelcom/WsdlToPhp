<?php
/**
 * Class file for XiFundHoldingsTypeGetTopHolders
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeGetTopHolders
 * @date 08/07/2012
 */
class XiFundHoldingsTypeGetTopHolders extends XiFundHoldingsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundHoldingsTypeGetTopHolders
	 */
