<?php
/**
 * Class file for XiFundHoldingsTypeGetLatestHolders
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeGetLatestHolders
 * @date 08/07/2012
 */
class XiFundHoldingsTypeGetLatestHolders extends XiFundHoldingsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiFundHoldingsTypeGetLatestHolders
	 */
