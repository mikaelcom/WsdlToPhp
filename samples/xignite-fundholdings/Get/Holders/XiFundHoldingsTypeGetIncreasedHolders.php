<?php
/**
 * Class file for XiFundHoldingsTypeGetIncreasedHolders
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeGetIncreasedHolders
 * @date 08/07/2012
 */
class XiFundHoldingsTypeGetIncreasedHolders extends XiFundHoldingsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiFundHoldingsTypeGetIncreasedHolders
	 */
