<?php
/**
 * Class file for XiFundHoldingsTypeGetIncreasedHoldings
 * @date 08/07/2012
 */
/**
 * Class XiFundHoldingsTypeGetIncreasedHoldings
 * @date 08/07/2012
 */
class XiFundHoldingsTypeGetIncreasedHoldings extends XiFundHoldingsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Count
	 * @return XiFundHoldingsTypeGetIncreasedHoldings
	 */
