<?php
/**
 * Class file for EccMktLiveTypeGetKeywordRankding
 * @date 03/07/2012
 */
/**
 * Class EccMktLiveTypeGetKeywordRankding
 * @date 03/07/2012
 */
class EccMktLiveTypeGetKeywordRankding extends EccMktLiveWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Url
	 * @return EccMktLiveTypeGetKeywordRankding
	 */
