<?php
/**
 * Class file for EccMktLiveTypeGetKeywordSuggest
 * @date 03/07/2012
 */
/**
 * Class EccMktLiveTypeGetKeywordSuggest
 * @date 03/07/2012
 */
class EccMktLiveTypeGetKeywordSuggest extends EccMktLiveWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccMktLiveTypeGetKeywordSuggest
	 */
