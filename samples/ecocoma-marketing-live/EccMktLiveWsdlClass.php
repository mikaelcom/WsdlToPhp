<?php
/**
 * File for EccMktLiveWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccMktLiveWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Live Web Services.
 * @date 03/07/2012
 */
class EccMktLiveWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccMktLiveWsdlClass::setLastError()
	 * @uses EccMktLiveWsdlClass::initSoapClient()
	 * @uses EccMktLiveWsdlClass::initInternArrayToIterate()
	 * @uses EccMktLiveWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccMktLiveWsdlClass::classMap()
	 * @uses EccMktLiveWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccMktLiveClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccMktLiveClassMap::classMap();
	 ...
	 * @uses EccMktLiveWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccMktLiveWsdlClass::WSDL_COMPRESSION
	 * @uses EccMktLiveWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccMktLiveWsdlClass::WSDL_ENCODING
	 * @uses EccMktLiveWsdlClass::WSDL_EXCPTS
	 * @uses EccMktLiveWsdlClass::WSDL_FEATURES
	 * @uses EccMktLiveWsdlClass::WSDL_LOGIN
	 * @uses EccMktLiveWsdlClass::WSDL_PASSWD
	 * @uses EccMktLiveWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccMktLiveWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccMktLiveWsdlClass::WSDL_TRACE
	 * @uses EccMktLiveWsdlClass::WSDL_TYPEMAP
	 * @uses EccMktLiveWsdlClass::WSDL_URL
	 * @uses EccMktLiveWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccMktLiveWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::internArrayToIterateIsArray()
	 * @uses EccMktLiveWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccMktLiveWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccMktLiveWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccMktLiveWsdlClass::offsetGet()
	 * @uses EccMktLiveWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::getAttributeName()
	 * @uses EccMktLiveWsdlClass::__toString()
	 * @uses EccMktLiveWsdlClass::_set()
	 * @uses EccMktLiveWsdlClass::_get()
	 * @uses EccMktLiveWsdlClass::setInternArrayToIterate()
	 * @uses EccMktLiveWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccMktLiveWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::item()
	 * @uses EccMktLiveWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktLiveWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccMktLiveWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
