<?php
/**
 * File for SOGeoPhoneWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOGeoPhoneWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOGeoPhoneWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOGeoPhoneWsdlClass::setLastError()
	 * @uses SOGeoPhoneWsdlClass::initSoapClient()
	 * @uses SOGeoPhoneWsdlClass::initInternArrayToIterate()
	 * @uses SOGeoPhoneWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOGeoPhoneWsdlClass::classMap()
	 * @uses SOGeoPhoneWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOGeoPhoneClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOGeoPhoneClassMap::classMap();
	 ...
	 * @uses SOGeoPhoneWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOGeoPhoneWsdlClass::WSDL_COMPRESSION
	 * @uses SOGeoPhoneWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOGeoPhoneWsdlClass::WSDL_ENCODING
	 * @uses SOGeoPhoneWsdlClass::WSDL_EXCPTS
	 * @uses SOGeoPhoneWsdlClass::WSDL_FEATURES
	 * @uses SOGeoPhoneWsdlClass::WSDL_LOGIN
	 * @uses SOGeoPhoneWsdlClass::WSDL_PASSWD
	 * @uses SOGeoPhoneWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOGeoPhoneWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOGeoPhoneWsdlClass::WSDL_TRACE
	 * @uses SOGeoPhoneWsdlClass::WSDL_TYPEMAP
	 * @uses SOGeoPhoneWsdlClass::WSDL_URL
	 * @uses SOGeoPhoneWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOGeoPhoneWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::internArrayToIterateIsArray()
	 * @uses SOGeoPhoneWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoPhoneWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoPhoneWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOGeoPhoneWsdlClass::offsetGet()
	 * @uses SOGeoPhoneWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::getAttributeName()
	 * @uses SOGeoPhoneWsdlClass::__toString()
	 * @uses SOGeoPhoneWsdlClass::_set()
	 * @uses SOGeoPhoneWsdlClass::_get()
	 * @uses SOGeoPhoneWsdlClass::setInternArrayToIterate()
	 * @uses SOGeoPhoneWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOGeoPhoneWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::item()
	 * @uses SOGeoPhoneWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoPhoneWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOGeoPhoneWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
