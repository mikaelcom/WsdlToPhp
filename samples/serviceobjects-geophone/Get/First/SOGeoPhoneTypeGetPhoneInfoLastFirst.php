<?php
/**
 * Class file for SOGeoPhoneTypeGetPhoneInfoLastFirst
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhoneTypeGetPhoneInfoLastFirst
 * @date 08/07/2012
 */
class SOGeoPhoneTypeGetPhoneInfoLastFirst extends SOGeoPhoneWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOGeoPhoneTypeGetPhoneInfoLastFirst
	 */
