<?php
/**
 * Class file for SOGeoPhoneTypeGetContactInfo
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhoneTypeGetContactInfo
 * @date 08/07/2012
 */
class SOGeoPhoneTypeGetContactInfo extends SOGeoPhoneWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOGeoPhoneTypeGetContactInfo
	 */
