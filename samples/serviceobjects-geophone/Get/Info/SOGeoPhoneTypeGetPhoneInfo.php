<?php
/**
 * Class file for SOGeoPhoneTypeGetPhoneInfo
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhoneTypeGetPhoneInfo
 * @date 08/07/2012
 */
class SOGeoPhoneTypeGetPhoneInfo extends SOGeoPhoneWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOGeoPhoneTypeGetPhoneInfo
	 */
