<?php
/**
 * Class file for SOGeoPhoneTypeGetExchangeInfo
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhoneTypeGetExchangeInfo
 * @date 08/07/2012
 */
class SOGeoPhoneTypeGetExchangeInfo extends SOGeoPhoneWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOGeoPhoneTypeGetExchangeInfo
	 */
