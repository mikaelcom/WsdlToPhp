<?php
/**
 * Class file for SOGeoPhoneTypeGetPhoneInfo_V2
 * @date 08/07/2012
 */
/**
 * Class SOGeoPhoneTypeGetPhoneInfo_V2
 * @date 08/07/2012
 */
class SOGeoPhoneTypeGetPhoneInfo_V2 extends SOGeoPhoneWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOGeoPhoneTypeGetPhoneInfo_V2
	 */
