<?php
/**
 * File for EccEmailValidateWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccEmailValidateWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Email Validate Web Services.
 * @date 03/07/2012
 */
class EccEmailValidateWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccEmailValidateWsdlClass::setLastError()
	 * @uses EccEmailValidateWsdlClass::initSoapClient()
	 * @uses EccEmailValidateWsdlClass::initInternArrayToIterate()
	 * @uses EccEmailValidateWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccEmailValidateWsdlClass::classMap()
	 * @uses EccEmailValidateWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccEmailValidateClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccEmailValidateClassMap::classMap();
	 ...
	 * @uses EccEmailValidateWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccEmailValidateWsdlClass::WSDL_COMPRESSION
	 * @uses EccEmailValidateWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccEmailValidateWsdlClass::WSDL_ENCODING
	 * @uses EccEmailValidateWsdlClass::WSDL_EXCPTS
	 * @uses EccEmailValidateWsdlClass::WSDL_FEATURES
	 * @uses EccEmailValidateWsdlClass::WSDL_LOGIN
	 * @uses EccEmailValidateWsdlClass::WSDL_PASSWD
	 * @uses EccEmailValidateWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccEmailValidateWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccEmailValidateWsdlClass::WSDL_TRACE
	 * @uses EccEmailValidateWsdlClass::WSDL_TYPEMAP
	 * @uses EccEmailValidateWsdlClass::WSDL_URL
	 * @uses EccEmailValidateWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccEmailValidateWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::internArrayToIterateIsArray()
	 * @uses EccEmailValidateWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccEmailValidateWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccEmailValidateWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccEmailValidateWsdlClass::offsetGet()
	 * @uses EccEmailValidateWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::getAttributeName()
	 * @uses EccEmailValidateWsdlClass::__toString()
	 * @uses EccEmailValidateWsdlClass::_set()
	 * @uses EccEmailValidateWsdlClass::_get()
	 * @uses EccEmailValidateWsdlClass::setInternArrayToIterate()
	 * @uses EccEmailValidateWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccEmailValidateWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::item()
	 * @uses EccEmailValidateWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccEmailValidateWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccEmailValidateWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
