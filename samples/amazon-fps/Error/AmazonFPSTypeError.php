<?php
/**
 * Class file for AmazonFPSTypeError
 * @date 10/07/2012
 */
/**
 * Class AmazonFPSTypeError
 * @date 10/07/2012
 */
class AmazonFPSTypeError extends AmazonFPSWsdlClass
{
	/**
	 * The Type
	 * @var Type
	 ...
	 * @param AmazonFPSTypeDetail Detail
