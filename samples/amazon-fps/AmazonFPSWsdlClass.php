<?php
/**
 * File for AmazonFPSWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonFPSWsdlClass to communicate with SOAP service
 * Documentation : Amazon Flexible Payments Service
 * @date 10/07/2012
 */
class AmazonFPSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonFPSWsdlClass::setLastError()
	 * @uses AmazonFPSWsdlClass::initSoapClient()
	 * @uses AmazonFPSWsdlClass::initInternArrayToIterate()
	 * @uses AmazonFPSWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonFPSWsdlClass::classMap()
	 * @uses AmazonFPSWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonFPSClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonFPSClassMap::classMap();
	 ...
	 * @uses AmazonFPSWsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonFPSWsdlClass::WSDL_COMPRESSION
	 * @uses AmazonFPSWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonFPSWsdlClass::WSDL_ENCODING
	 * @uses AmazonFPSWsdlClass::WSDL_EXCPTS
	 * @uses AmazonFPSWsdlClass::WSDL_FEATURES
	 * @uses AmazonFPSWsdlClass::WSDL_LOGIN
	 * @uses AmazonFPSWsdlClass::WSDL_PASSWD
	 * @uses AmazonFPSWsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonFPSWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonFPSWsdlClass::WSDL_TRACE
	 * @uses AmazonFPSWsdlClass::WSDL_TYPEMAP
	 * @uses AmazonFPSWsdlClass::WSDL_URL
	 * @uses AmazonFPSWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonFPSWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonFPSWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonFPSWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonFPSWsdlClass::offsetGet()
	 * @uses AmazonFPSWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::getAttributeName()
	 * @uses AmazonFPSWsdlClass::__toString()
	 * @uses AmazonFPSWsdlClass::_set()
	 * @uses AmazonFPSWsdlClass::_get()
	 * @uses AmazonFPSWsdlClass::setInternArrayToIterate()
	 * @uses AmazonFPSWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonFPSWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::item()
	 * @uses AmazonFPSWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonFPSWsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonFPSWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
