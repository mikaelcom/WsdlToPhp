<?php
/**
 * File for XiCalendarWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiCalendarWsdlClass to communicate with SOAP service
 * Documentation : On-demand global economic calendar.
 * @date 08/07/2012
 */
class XiCalendarWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiCalendarWsdlClass::setLastError()
	 * @uses XiCalendarWsdlClass::initSoapClient()
	 * @uses XiCalendarWsdlClass::initInternArrayToIterate()
	 * @uses XiCalendarWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiCalendarWsdlClass::classMap()
	 * @uses XiCalendarWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiCalendarClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiCalendarClassMap::classMap();
	 ...
	 * @uses XiCalendarWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiCalendarWsdlClass::WSDL_COMPRESSION
	 * @uses XiCalendarWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiCalendarWsdlClass::WSDL_ENCODING
	 * @uses XiCalendarWsdlClass::WSDL_EXCPTS
	 * @uses XiCalendarWsdlClass::WSDL_FEATURES
	 * @uses XiCalendarWsdlClass::WSDL_LOGIN
	 * @uses XiCalendarWsdlClass::WSDL_PASSWD
	 * @uses XiCalendarWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiCalendarWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiCalendarWsdlClass::WSDL_TRACE
	 * @uses XiCalendarWsdlClass::WSDL_TYPEMAP
	 * @uses XiCalendarWsdlClass::WSDL_URL
	 * @uses XiCalendarWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiCalendarWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiCalendarWsdlClass::internArrayToIterateIsArray()
	 * @uses XiCalendarWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiCalendarWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiCalendarWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiCalendarWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiCalendarWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiCalendarWsdlClass::offsetExists()
	 ...
	 * @uses XiCalendarWsdlClass::getAttributeName()
	 * @uses XiCalendarWsdlClass::__toString()
	 * @uses XiCalendarWsdlClass::_set()
	 * @uses XiCalendarWsdlClass::_get()
	 * @uses XiCalendarWsdlClass::setInternArrayToIterate()
	 * @uses XiCalendarWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiCalendarWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiCalendarWsdlClass::item()
	 * @uses XiCalendarWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiCalendarWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiCalendarWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
