<?php
/**
 * Class file for XiCalendarTypeGetEventsForDate
 * @date 08/07/2012
 */
/**
 * Class XiCalendarTypeGetEventsForDate
 * @date 08/07/2012
 */
class XiCalendarTypeGetEventsForDate extends XiCalendarWsdlClass
{
	/**
	 * The ForDate
	 * Meta informations :
	 ...
	 * @return XiCalendarTypeGetEventsForDate
	 */
