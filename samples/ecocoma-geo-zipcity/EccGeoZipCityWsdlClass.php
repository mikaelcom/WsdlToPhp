<?php
/**
 * File for EccGeoZipCityWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccGeoZipCityWsdlClass to communicate with SOAP service
 * Documentation : Cocoma City Lookup Web Services.
 * @date 03/07/2012
 */
class EccGeoZipCityWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccGeoZipCityWsdlClass::setLastError()
	 * @uses EccGeoZipCityWsdlClass::initSoapClient()
	 * @uses EccGeoZipCityWsdlClass::initInternArrayToIterate()
	 * @uses EccGeoZipCityWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccGeoZipCityWsdlClass::classMap()
	 * @uses EccGeoZipCityWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccGeoZipCityClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccGeoZipCityClassMap::classMap();
	 ...
	 * @uses EccGeoZipCityWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccGeoZipCityWsdlClass::WSDL_COMPRESSION
	 * @uses EccGeoZipCityWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccGeoZipCityWsdlClass::WSDL_ENCODING
	 * @uses EccGeoZipCityWsdlClass::WSDL_EXCPTS
	 * @uses EccGeoZipCityWsdlClass::WSDL_FEATURES
	 * @uses EccGeoZipCityWsdlClass::WSDL_LOGIN
	 * @uses EccGeoZipCityWsdlClass::WSDL_PASSWD
	 * @uses EccGeoZipCityWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccGeoZipCityWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccGeoZipCityWsdlClass::WSDL_TRACE
	 * @uses EccGeoZipCityWsdlClass::WSDL_TYPEMAP
	 * @uses EccGeoZipCityWsdlClass::WSDL_URL
	 * @uses EccGeoZipCityWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccGeoZipCityWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::internArrayToIterateIsArray()
	 * @uses EccGeoZipCityWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoZipCityWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoZipCityWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccGeoZipCityWsdlClass::offsetGet()
	 * @uses EccGeoZipCityWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::getAttributeName()
	 * @uses EccGeoZipCityWsdlClass::__toString()
	 * @uses EccGeoZipCityWsdlClass::_set()
	 * @uses EccGeoZipCityWsdlClass::_get()
	 * @uses EccGeoZipCityWsdlClass::setInternArrayToIterate()
	 * @uses EccGeoZipCityWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccGeoZipCityWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::item()
	 * @uses EccGeoZipCityWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoZipCityWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccGeoZipCityWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
