<?php
/**
 * File for SONcoaLiveWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SONcoaLiveWsdlClass to communicate with SOAP service
 * Documentation : Interface for USPS's NCOALink product
 * @date 06/07/2012
 */
class SONcoaLiveWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SONcoaLiveWsdlClass::setLastError()
	 * @uses SONcoaLiveWsdlClass::initSoapClient()
	 * @uses SONcoaLiveWsdlClass::initInternArrayToIterate()
	 * @uses SONcoaLiveWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SONcoaLiveWsdlClass::classMap()
	 * @uses SONcoaLiveWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SONcoaLiveClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SONcoaLiveClassMap::classMap();
	 ...
	 * @uses SONcoaLiveWsdlClass::WSDL_CACHE_WSDL
	 * @uses SONcoaLiveWsdlClass::WSDL_COMPRESSION
	 * @uses SONcoaLiveWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SONcoaLiveWsdlClass::WSDL_ENCODING
	 * @uses SONcoaLiveWsdlClass::WSDL_EXCPTS
	 * @uses SONcoaLiveWsdlClass::WSDL_FEATURES
	 * @uses SONcoaLiveWsdlClass::WSDL_LOGIN
	 * @uses SONcoaLiveWsdlClass::WSDL_PASSWD
	 * @uses SONcoaLiveWsdlClass::WSDL_SOAP_VERSION
	 * @uses SONcoaLiveWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SONcoaLiveWsdlClass::WSDL_TRACE
	 * @uses SONcoaLiveWsdlClass::WSDL_TYPEMAP
	 * @uses SONcoaLiveWsdlClass::WSDL_URL
	 * @uses SONcoaLiveWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SONcoaLiveWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SONcoaLiveWsdlClass::internArrayToIterateIsArray()
	 * @uses SONcoaLiveWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SONcoaLiveWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SONcoaLiveWsdlClass::getInternArrayToIterateOffset()
	 * @uses SONcoaLiveWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SONcoaLiveWsdlClass::getInternArrayToIterateOffset()
	 * @uses SONcoaLiveWsdlClass::offsetExists()
	 ...
	 * @uses SONcoaLiveWsdlClass::getAttributeName()
	 * @uses SONcoaLiveWsdlClass::__toString()
	 * @uses SONcoaLiveWsdlClass::_set()
	 * @uses SONcoaLiveWsdlClass::_get()
	 * @uses SONcoaLiveWsdlClass::setInternArrayToIterate()
	 * @uses SONcoaLiveWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SONcoaLiveWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SONcoaLiveWsdlClass::item()
	 * @uses SONcoaLiveWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SONcoaLiveWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SONcoaLiveWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
