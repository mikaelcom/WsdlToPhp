<?php
/**
 * Class file for XiNewsTypeStockNews
 * @date 08/07/2012
 */
/**
 * Class XiNewsTypeStockNews
 * @date 08/07/2012
 */
class XiNewsTypeStockNews extends XiNewsTypeCommon
{
	/**
	 * The Headline
	 * Meta informations :
	...
	{
		XiNewsWsdlClass::__construct(array('Headline'=>$_Headline,'Ticker'=>$_Ticker,'Date'=>$_Date,'Time'=>$_Time,'Source'=>$_Source,'Url'=>$_Url));
	}
	/**
	 * Set Headline
	 * @param string Headline
