<?php
/**
 * Class file for XiNewsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiNewsTypeCommon
 * @date 08/07/2012
 */
class XiNewsTypeCommon extends XiNewsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiNewsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiNewsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiNewsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiNewsTypeOutcomeTypes
	 */
