<?php
/**
 * File for XiNewsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiNewsWsdlClass to communicate with SOAP service
 * Documentation : Provide stock and market news operations.
 * @date 08/07/2012
 */
class XiNewsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiNewsWsdlClass::setLastError()
	 * @uses XiNewsWsdlClass::initSoapClient()
	 * @uses XiNewsWsdlClass::initInternArrayToIterate()
	 * @uses XiNewsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiNewsWsdlClass::classMap()
	 * @uses XiNewsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiNewsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiNewsClassMap::classMap();
	 ...
	 * @uses XiNewsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiNewsWsdlClass::WSDL_COMPRESSION
	 * @uses XiNewsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiNewsWsdlClass::WSDL_ENCODING
	 * @uses XiNewsWsdlClass::WSDL_EXCPTS
	 * @uses XiNewsWsdlClass::WSDL_FEATURES
	 * @uses XiNewsWsdlClass::WSDL_LOGIN
	 * @uses XiNewsWsdlClass::WSDL_PASSWD
	 * @uses XiNewsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiNewsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiNewsWsdlClass::WSDL_TRACE
	 * @uses XiNewsWsdlClass::WSDL_TYPEMAP
	 * @uses XiNewsWsdlClass::WSDL_URL
	 * @uses XiNewsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiNewsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiNewsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiNewsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiNewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiNewsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiNewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiNewsWsdlClass::offsetExists()
	 ...
	 * @uses XiNewsWsdlClass::getAttributeName()
	 * @uses XiNewsWsdlClass::__toString()
	 * @uses XiNewsWsdlClass::_set()
	 * @uses XiNewsWsdlClass::_get()
	 * @uses XiNewsWsdlClass::setInternArrayToIterate()
	 * @uses XiNewsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiNewsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiNewsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiNewsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
