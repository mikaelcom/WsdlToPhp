<?php
/**
 * Class file for XiHousingTypeGetHousingPrices
 * @date 08/07/2012
 */
/**
 * Class XiHousingTypeGetHousingPrices
 * @date 08/07/2012
 */
class XiHousingTypeGetHousingPrices extends XiHousingWsdlClass
{
	/**
	 * The Category
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiHousingTypePriceDataCategories
	 */
	public $Category;
	/**
	 * The Area
	...
	/**
	 * Constructor
	 * @param XiHousingTypePriceDataCategories Category
	 * @param XiHousingTypeRegions Area
	 * @param string StartDate
	 * @param string EndDate
	 * @param XiHousingTypePeriods Period
	 * @return XiHousingTypeGetHousingPrices
	 */
	...
	/**
	 * Set Category
	 * @param PriceDataCategories Category
	 * @return PriceDataCategories
	 */
	public function setCategory($_Category)
	{
		return ($this->Category = XiHousingTypePriceDataCategories::valueIsValid($_Category)?$_Category:null);
	}
	/**
	 * Get Category
