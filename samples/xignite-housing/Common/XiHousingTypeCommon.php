<?php
/**
 * Class file for XiHousingTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiHousingTypeCommon
 * @date 08/07/2012
 */
class XiHousingTypeCommon extends XiHousingWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiHousingTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiHousingTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiHousingTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiHousingTypeOutcomeTypes
	 */
