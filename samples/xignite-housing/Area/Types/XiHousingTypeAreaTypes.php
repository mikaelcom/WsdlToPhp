<?php
/**
 * Class file for XiHousingTypeAreaTypes
 * @date 08/07/2012
 */
/**
 * Class XiHousingTypeAreaTypes
 * @date 08/07/2012
 */
class XiHousingTypeAreaTypes extends XiHousingWsdlClass
{
	/**
