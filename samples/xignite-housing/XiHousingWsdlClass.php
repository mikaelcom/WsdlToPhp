<?php
/**
 * File for XiHousingWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiHousingWsdlClass to communicate with SOAP service
 * Documentation : Statistics on US Housing.
 * @date 08/07/2012
 */
class XiHousingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiHousingWsdlClass::setLastError()
	 * @uses XiHousingWsdlClass::initSoapClient()
	 * @uses XiHousingWsdlClass::initInternArrayToIterate()
	 * @uses XiHousingWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiHousingWsdlClass::classMap()
	 * @uses XiHousingWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiHousingClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiHousingClassMap::classMap();
	 ...
	 * @uses XiHousingWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiHousingWsdlClass::WSDL_COMPRESSION
	 * @uses XiHousingWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiHousingWsdlClass::WSDL_ENCODING
	 * @uses XiHousingWsdlClass::WSDL_EXCPTS
	 * @uses XiHousingWsdlClass::WSDL_FEATURES
	 * @uses XiHousingWsdlClass::WSDL_LOGIN
	 * @uses XiHousingWsdlClass::WSDL_PASSWD
	 * @uses XiHousingWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiHousingWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiHousingWsdlClass::WSDL_TRACE
	 * @uses XiHousingWsdlClass::WSDL_TYPEMAP
	 * @uses XiHousingWsdlClass::WSDL_URL
	 * @uses XiHousingWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiHousingWsdlClass::internArrayToIterateIsArray()
	 * @uses XiHousingWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiHousingWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiHousingWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiHousingWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiHousingWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiHousingWsdlClass::offsetExists()
	 ...
	 * @uses XiHousingWsdlClass::getAttributeName()
	 * @uses XiHousingWsdlClass::__toString()
	 * @uses XiHousingWsdlClass::_set()
	 * @uses XiHousingWsdlClass::_get()
	 * @uses XiHousingWsdlClass::setInternArrayToIterate()
	 * @uses XiHousingWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiHousingWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiHousingWsdlClass::item()
	 * @uses XiHousingWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiHousingWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiHousingWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
