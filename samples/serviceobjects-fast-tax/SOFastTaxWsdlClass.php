<?php
/**
 * File for SOFastTaxWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOFastTaxWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOFastTaxWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOFastTaxWsdlClass::setLastError()
	 * @uses SOFastTaxWsdlClass::initSoapClient()
	 * @uses SOFastTaxWsdlClass::initInternArrayToIterate()
	 * @uses SOFastTaxWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOFastTaxWsdlClass::classMap()
	 * @uses SOFastTaxWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOFastTaxClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOFastTaxClassMap::classMap();
	 ...
	 * @uses SOFastTaxWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOFastTaxWsdlClass::WSDL_COMPRESSION
	 * @uses SOFastTaxWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOFastTaxWsdlClass::WSDL_ENCODING
	 * @uses SOFastTaxWsdlClass::WSDL_EXCPTS
	 * @uses SOFastTaxWsdlClass::WSDL_FEATURES
	 * @uses SOFastTaxWsdlClass::WSDL_LOGIN
	 * @uses SOFastTaxWsdlClass::WSDL_PASSWD
	 * @uses SOFastTaxWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOFastTaxWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOFastTaxWsdlClass::WSDL_TRACE
	 * @uses SOFastTaxWsdlClass::WSDL_TYPEMAP
	 * @uses SOFastTaxWsdlClass::WSDL_URL
	 * @uses SOFastTaxWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SOFastTaxWsdlClass::internArrayToIterateIsArray()
	 * @uses SOFastTaxWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOFastTaxWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastTaxWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFastTaxWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOFastTaxWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFastTaxWsdlClass::offsetExists()
	 ...
	 * @uses SOFastTaxWsdlClass::getAttributeName()
	 * @uses SOFastTaxWsdlClass::__toString()
	 * @uses SOFastTaxWsdlClass::_set()
	 * @uses SOFastTaxWsdlClass::_get()
	 * @uses SOFastTaxWsdlClass::setInternArrayToIterate()
	 * @uses SOFastTaxWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOFastTaxWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOFastTaxWsdlClass::item()
	 * @uses SOFastTaxWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastTaxWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOFastTaxWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
