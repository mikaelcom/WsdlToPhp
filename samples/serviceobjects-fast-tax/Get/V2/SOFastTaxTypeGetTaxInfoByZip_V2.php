<?php
/**
 * Class file for SOFastTaxTypeGetTaxInfoByZip_V2
 * @date 08/07/2012
 */
/**
 * Class SOFastTaxTypeGetTaxInfoByZip_V2
 * @date 08/07/2012
 */
class SOFastTaxTypeGetTaxInfoByZip_V2 extends SOFastTaxWsdlClass
{
	/**
	 * The PostalCode
	 * Meta informations :
	 ...
	 * @return SOFastTaxTypeGetTaxInfoByZip_V2
	 */
