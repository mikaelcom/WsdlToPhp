<?php
/**
 * File for CdyneIp2geoWsdlClass to communicate with SOAP service
 * @date 02/07/2012
 */
/**
 * File for CdyneIp2geoWsdlClass to communicate with SOAP service
 * Documentation : Our system uses a multiple sources for resolution. Including a host database, trace route information, and other systems. Resolves IP addresses to Organization, Country, City, and State/Province, Latitude, Longitude. In most US cities it will also provide some extra information such as Area Code, and more.
 * @date 02/07/2012
 */
class CdyneIp2geoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdyneIp2geoWsdlClass::setLastError()
	 * @uses CdyneIp2geoWsdlClass::initSoapClient()
	 * @uses CdyneIp2geoWsdlClass::initInternArrayToIterate()
	 * @uses CdyneIp2geoWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdyneIp2geoWsdlClass::classMap()
	 * @uses CdyneIp2geoWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdyneIp2geoClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdyneIp2geoClassMap::classMap();
	 ...
	 * @uses CdyneIp2geoWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdyneIp2geoWsdlClass::WSDL_COMPRESSION
	 * @uses CdyneIp2geoWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdyneIp2geoWsdlClass::WSDL_ENCODING
	 * @uses CdyneIp2geoWsdlClass::WSDL_EXCPTS
	 * @uses CdyneIp2geoWsdlClass::WSDL_FEATURES
	 * @uses CdyneIp2geoWsdlClass::WSDL_LOGIN
	 * @uses CdyneIp2geoWsdlClass::WSDL_PASSWD
	 * @uses CdyneIp2geoWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdyneIp2geoWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdyneIp2geoWsdlClass::WSDL_TRACE
	 * @uses CdyneIp2geoWsdlClass::WSDL_TYPEMAP
	 * @uses CdyneIp2geoWsdlClass::WSDL_URL
	 * @uses CdyneIp2geoWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdyneIp2geoWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::internArrayToIterateIsArray()
	 * @uses CdyneIp2geoWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneIp2geoWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdyneIp2geoWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see CdyneIp2geoWsdlClass::offsetGet()
	 * @uses CdyneIp2geoWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::getAttributeName()
	 * @uses CdyneIp2geoWsdlClass::__toString()
	 * @uses CdyneIp2geoWsdlClass::_set()
	 * @uses CdyneIp2geoWsdlClass::_get()
	 * @uses CdyneIp2geoWsdlClass::setInternArrayToIterate()
	 * @uses CdyneIp2geoWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdyneIp2geoWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::item()
	 * @uses CdyneIp2geoWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdyneIp2geoWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdyneIp2geoWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
