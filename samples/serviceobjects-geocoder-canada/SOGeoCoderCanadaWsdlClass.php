<?php
/**
 * File for SOGeoCoderCanadaWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SOGeoCoderCanadaWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SOGeoCoderCanadaWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOGeoCoderCanadaWsdlClass::setLastError()
	 * @uses SOGeoCoderCanadaWsdlClass::initSoapClient()
	 * @uses SOGeoCoderCanadaWsdlClass::initInternArrayToIterate()
	 * @uses SOGeoCoderCanadaWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOGeoCoderCanadaWsdlClass::classMap()
	 * @uses SOGeoCoderCanadaWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOGeoCoderCanadaClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOGeoCoderCanadaClassMap::classMap();
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_COMPRESSION
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_ENCODING
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_EXCPTS
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_FEATURES
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_LOGIN
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_PASSWD
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_TRACE
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_TYPEMAP
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_URL
	 * @uses SOGeoCoderCanadaWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOGeoCoderCanadaWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::internArrayToIterateIsArray()
	 * @uses SOGeoCoderCanadaWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoCoderCanadaWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOGeoCoderCanadaWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOGeoCoderCanadaWsdlClass::offsetGet()
	 * @uses SOGeoCoderCanadaWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::getAttributeName()
	 * @uses SOGeoCoderCanadaWsdlClass::__toString()
	 * @uses SOGeoCoderCanadaWsdlClass::_set()
	 * @uses SOGeoCoderCanadaWsdlClass::_get()
	 * @uses SOGeoCoderCanadaWsdlClass::setInternArrayToIterate()
	 * @uses SOGeoCoderCanadaWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOGeoCoderCanadaWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::item()
	 * @uses SOGeoCoderCanadaWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOGeoCoderCanadaWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOGeoCoderCanadaWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
