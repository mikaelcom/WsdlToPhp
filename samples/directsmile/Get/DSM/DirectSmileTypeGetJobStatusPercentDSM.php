<?php
/**
 * Class file for DirectSmileTypeGetJobStatusPercentDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetJobStatusPercentDSM
 * @date 02/08/2012
 */
class DirectSmileTypeGetJobStatusPercentDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @param string JobID
	 * @return DirectSmileTypeGetJobStatusPercentDSM
	 */
