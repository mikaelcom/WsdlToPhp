<?php
/**
 * Class file for DirectSmileTypeGetImageUrlDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetImageUrlDSM
 * @date 02/08/2012
 */
class DirectSmileTypeGetImageUrlDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @return DirectSmileTypeGetImageUrlDSM
	 */
