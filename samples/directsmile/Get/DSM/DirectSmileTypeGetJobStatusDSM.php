<?php
/**
 * Class file for DirectSmileTypeGetJobStatusDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetJobStatusDSM
 * @date 02/08/2012
 */
class DirectSmileTypeGetJobStatusDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @param string JobID
	 * @return DirectSmileTypeGetJobStatusDSM
	 */
