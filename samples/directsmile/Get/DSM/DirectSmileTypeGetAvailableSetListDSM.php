<?php
/**
 * Class file for DirectSmileTypeGetAvailableSetListDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetAvailableSetListDSM
 * @date 02/08/2012
 */
class DirectSmileTypeGetAvailableSetListDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @return DirectSmileTypeGetAvailableSetListDSM
	 */
