<?php
/**
 * Class file for DirectSmileTypeGetAvailableSetListXMLDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetAvailableSetListXMLDSM
 * @date 02/08/2012
 */
class DirectSmileTypeGetAvailableSetListXMLDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @return DirectSmileTypeGetAvailableSetListXMLDSM
	 */
