<?php
/**
 * Class file for DirectSmileTypeGetAvailableSetListXMLAuth
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetAvailableSetListXMLAuth
 * @date 02/08/2012
 */
class DirectSmileTypeGetAvailableSetListXMLAuth extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @return DirectSmileTypeGetAvailableSetListXMLAuth
	 */
