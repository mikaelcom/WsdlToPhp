<?php
/**
 * Class file for DirectSmileTypeGetAvailableDocListAuth
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeGetAvailableDocListAuth
 * @date 02/08/2012
 */
class DirectSmileTypeGetAvailableDocListAuth extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @return DirectSmileTypeGetAvailableDocListAuth
	 */
