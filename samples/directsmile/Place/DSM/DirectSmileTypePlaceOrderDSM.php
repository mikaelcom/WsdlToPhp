<?php
/**
 * Class file for DirectSmileTypePlaceOrderDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypePlaceOrderDSM
 * @date 02/08/2012
 */
class DirectSmileTypePlaceOrderDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @return DirectSmileTypePlaceOrderDSM
	 */
