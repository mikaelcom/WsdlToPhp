<?php
/**
 * Class file for DirectSmileTypeDeleteDocOrderByDocIDDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeDeleteDocOrderByDocIDDSM
 * @date 02/08/2012
 */
class DirectSmileTypeDeleteDocOrderByDocIDDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @param string Key
	 * @return DirectSmileTypeDeleteDocOrderByDocIDDSM
	 */
