<?php
/**
 * Class file for DirectSmileTypeCancelJobOrderDSM
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeCancelJobOrderDSM
 * @date 02/08/2012
 */
class DirectSmileTypeCancelJobOrderDSM extends DirectSmileWsdlClass
{
	/**
	 ...
	 * @param string JobID
	 * @return DirectSmileTypeCancelJobOrderDSM
	 */
