<?php
/**
 * File for DirectSmileWsdlClass to communicate with SOAP service
 * @date 02/08/2012
 */
/**
 * File for DirectSmileWsdlClass to communicate with SOAP service
 ...
 * @date 02/08/2012
 */
class DirectSmileWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses DirectSmileWsdlClass::setLastError()
	 * @uses DirectSmileWsdlClass::initSoapClient()
	 * @uses DirectSmileWsdlClass::initInternArrayToIterate()
	 * @uses DirectSmileWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses DirectSmileWsdlClass::classMap()
	 * @uses DirectSmileWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('DirectSmileClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = DirectSmileClassMap::classMap();
	 ...
	 * @uses DirectSmileWsdlClass::WSDL_CACHE_WSDL
	 * @uses DirectSmileWsdlClass::WSDL_COMPRESSION
	 * @uses DirectSmileWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses DirectSmileWsdlClass::WSDL_ENCODING
	 * @uses DirectSmileWsdlClass::WSDL_EXCPTS
	 * @uses DirectSmileWsdlClass::WSDL_FEATURES
	 * @uses DirectSmileWsdlClass::WSDL_LOGIN
	 * @uses DirectSmileWsdlClass::WSDL_PASSWD
	 * @uses DirectSmileWsdlClass::WSDL_SOAP_VERSION
	 * @uses DirectSmileWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses DirectSmileWsdlClass::WSDL_TRACE
	 * @uses DirectSmileWsdlClass::WSDL_TYPEMAP
	 * @uses DirectSmileWsdlClass::WSDL_URL
	 * @uses DirectSmileWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses DirectSmileWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses DirectSmileWsdlClass::internArrayToIterateIsArray()
	 * @uses DirectSmileWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses DirectSmileWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses DirectSmileWsdlClass::getInternArrayToIterateOffset()
	 * @uses DirectSmileWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses DirectSmileWsdlClass::getInternArrayToIterateOffset()
	 * @uses DirectSmileWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see DirectSmileWsdlClass::offsetGet()
	 * @uses DirectSmileWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses DirectSmileWsdlClass::getAttributeName()
	 * @uses DirectSmileWsdlClass::__toString()
	 * @uses DirectSmileWsdlClass::_set()
	 * @uses DirectSmileWsdlClass::_get()
	 * @uses DirectSmileWsdlClass::setInternArrayToIterate()
	 * @uses DirectSmileWsdlClass::setInternArrayToIterateIsArray()
	 * @uses DirectSmileWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses DirectSmileWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses DirectSmileWsdlClass::item()
	 * @uses DirectSmileWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses DirectSmileWsdlClass::getInternArrayToIterateIsArray()
	 * @uses DirectSmileWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
