<?php
/**
 * Class file for DirectSmileTypeStartDoc
 * @date 02/08/2012
 */
/**
 * Class DirectSmileTypeStartDoc
 * @date 02/08/2012
 */
class DirectSmileTypeStartDoc extends DirectSmileWsdlClass
{
	/**
	 * The Sid
	 * Meta informations :
	 ...
	 * @return DirectSmileTypeStartDoc
	 */
