<?php
/**
 * Class file for EccGeoIPCtryTypeGetCountry
 * @date 03/07/2012
 */
/**
 * Class EccGeoIPCtryTypeGetCountry
 * @date 03/07/2012
 */
class EccGeoIPCtryTypeGetCountry extends EccGeoIPCtryWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccGeoIPCtryTypeGetCountry
	 */
