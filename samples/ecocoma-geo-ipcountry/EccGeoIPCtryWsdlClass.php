<?php
/**
 * File for EccGeoIPCtryWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccGeoIPCtryWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Country Lookup Web Services.
 * @date 03/07/2012
 */
class EccGeoIPCtryWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccGeoIPCtryWsdlClass::setLastError()
	 * @uses EccGeoIPCtryWsdlClass::initSoapClient()
	 * @uses EccGeoIPCtryWsdlClass::initInternArrayToIterate()
	 * @uses EccGeoIPCtryWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccGeoIPCtryWsdlClass::classMap()
	 * @uses EccGeoIPCtryWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccGeoIPCtryClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccGeoIPCtryClassMap::classMap();
	 ...
	 * @uses EccGeoIPCtryWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccGeoIPCtryWsdlClass::WSDL_COMPRESSION
	 * @uses EccGeoIPCtryWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccGeoIPCtryWsdlClass::WSDL_ENCODING
	 * @uses EccGeoIPCtryWsdlClass::WSDL_EXCPTS
	 * @uses EccGeoIPCtryWsdlClass::WSDL_FEATURES
	 * @uses EccGeoIPCtryWsdlClass::WSDL_LOGIN
	 * @uses EccGeoIPCtryWsdlClass::WSDL_PASSWD
	 * @uses EccGeoIPCtryWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccGeoIPCtryWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccGeoIPCtryWsdlClass::WSDL_TRACE
	 * @uses EccGeoIPCtryWsdlClass::WSDL_TYPEMAP
	 * @uses EccGeoIPCtryWsdlClass::WSDL_URL
	 * @uses EccGeoIPCtryWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccGeoIPCtryWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::internArrayToIterateIsArray()
	 * @uses EccGeoIPCtryWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoIPCtryWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccGeoIPCtryWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccGeoIPCtryWsdlClass::offsetGet()
	 * @uses EccGeoIPCtryWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::getAttributeName()
	 * @uses EccGeoIPCtryWsdlClass::__toString()
	 * @uses EccGeoIPCtryWsdlClass::_set()
	 * @uses EccGeoIPCtryWsdlClass::_get()
	 * @uses EccGeoIPCtryWsdlClass::setInternArrayToIterate()
	 * @uses EccGeoIPCtryWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccGeoIPCtryWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::item()
	 * @uses EccGeoIPCtryWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccGeoIPCtryWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccGeoIPCtryWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
