<?php
/**
 * Class file for XiOFACTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiOFACTypeCommon
 * @date 08/07/2012
 */
class XiOFACTypeCommon extends XiOFACWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiOFACTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiOFACTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiOFACTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiOFACTypeOutcomeTypes
	 */
