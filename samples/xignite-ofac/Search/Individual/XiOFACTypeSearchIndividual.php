<?php
/**
 * Class file for XiOFACTypeSearchIndividual
 * @date 08/07/2012
 */
/**
 * Class XiOFACTypeSearchIndividual
 * @date 08/07/2012
 */
class XiOFACTypeSearchIndividual extends XiOFACWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return XiOFACTypeSearchIndividual
	 */
