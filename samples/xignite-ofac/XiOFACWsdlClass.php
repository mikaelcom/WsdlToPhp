<?php
/**
 * File for XiOFACWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiOFACWsdlClass to communicate with SOAP service
 * Documentation : This web service provides compliance with OFAC requirements.
 * @date 08/07/2012
 */
class XiOFACWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiOFACWsdlClass::setLastError()
	 * @uses XiOFACWsdlClass::initSoapClient()
	 * @uses XiOFACWsdlClass::initInternArrayToIterate()
	 * @uses XiOFACWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiOFACWsdlClass::classMap()
	 * @uses XiOFACWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiOFACClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiOFACClassMap::classMap();
	 ...
	 * @uses XiOFACWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiOFACWsdlClass::WSDL_COMPRESSION
	 * @uses XiOFACWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiOFACWsdlClass::WSDL_ENCODING
	 * @uses XiOFACWsdlClass::WSDL_EXCPTS
	 * @uses XiOFACWsdlClass::WSDL_FEATURES
	 * @uses XiOFACWsdlClass::WSDL_LOGIN
	 * @uses XiOFACWsdlClass::WSDL_PASSWD
	 * @uses XiOFACWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiOFACWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiOFACWsdlClass::WSDL_TRACE
	 * @uses XiOFACWsdlClass::WSDL_TYPEMAP
	 * @uses XiOFACWsdlClass::WSDL_URL
	 * @uses XiOFACWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiOFACWsdlClass::internArrayToIterateIsArray()
	 * @uses XiOFACWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiOFACWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiOFACWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiOFACWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiOFACWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiOFACWsdlClass::offsetExists()
	 ...
	 * @uses XiOFACWsdlClass::getAttributeName()
	 * @uses XiOFACWsdlClass::__toString()
	 * @uses XiOFACWsdlClass::_set()
	 * @uses XiOFACWsdlClass::_get()
	 * @uses XiOFACWsdlClass::setInternArrayToIterate()
	 * @uses XiOFACWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiOFACWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiOFACWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiOFACWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
