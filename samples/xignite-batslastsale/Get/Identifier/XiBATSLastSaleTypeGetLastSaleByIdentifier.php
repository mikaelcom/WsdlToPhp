<?php
/**
 * Class file for XiBATSLastSaleTypeGetLastSaleByIdentifier
 * @date 08/07/2012
 */
/**
 * Class XiBATSLastSaleTypeGetLastSaleByIdentifier
 * @date 08/07/2012
 */
class XiBATSLastSaleTypeGetLastSaleByIdentifier extends XiBATSLastSaleWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBATSLastSaleTypeGetLastSaleByIdentifier
	 */
