<?php
/**
 * Class file for XiBATSLastSaleTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiBATSLastSaleTypeHeader
 * @date 08/07/2012
 */
class XiBATSLastSaleTypeHeader extends XiBATSLastSaleWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiBATSLastSaleTypeHeader
	 */
