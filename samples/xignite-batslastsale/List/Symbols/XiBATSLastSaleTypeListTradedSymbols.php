<?php
/**
 * Class file for XiBATSLastSaleTypeListTradedSymbols
 * @date 08/07/2012
 */
/**
 * Class XiBATSLastSaleTypeListTradedSymbols
 * @date 08/07/2012
 */
class XiBATSLastSaleTypeListTradedSymbols extends XiBATSLastSaleWsdlClass
{
	/**
	 * The NumOfDays
	 * Meta informations :
	 ...
	 * @return XiBATSLastSaleTypeListTradedSymbols
	 */
