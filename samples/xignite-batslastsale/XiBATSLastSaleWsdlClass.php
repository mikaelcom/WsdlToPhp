<?php
/**
 * File for XiBATSLastSaleWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiBATSLastSaleWsdlClass to communicate with SOAP service
 * Documentation : Provides real-time access to BATS market data.
 * @date 08/07/2012
 */
class XiBATSLastSaleWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiBATSLastSaleWsdlClass::setLastError()
	 * @uses XiBATSLastSaleWsdlClass::initSoapClient()
	 * @uses XiBATSLastSaleWsdlClass::initInternArrayToIterate()
	 * @uses XiBATSLastSaleWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiBATSLastSaleWsdlClass::classMap()
	 * @uses XiBATSLastSaleWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiBATSLastSaleClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiBATSLastSaleClassMap::classMap();
	 ...
	 * @uses XiBATSLastSaleWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiBATSLastSaleWsdlClass::WSDL_COMPRESSION
	 * @uses XiBATSLastSaleWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiBATSLastSaleWsdlClass::WSDL_ENCODING
	 * @uses XiBATSLastSaleWsdlClass::WSDL_EXCPTS
	 * @uses XiBATSLastSaleWsdlClass::WSDL_FEATURES
	 * @uses XiBATSLastSaleWsdlClass::WSDL_LOGIN
	 * @uses XiBATSLastSaleWsdlClass::WSDL_PASSWD
	 * @uses XiBATSLastSaleWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiBATSLastSaleWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiBATSLastSaleWsdlClass::WSDL_TRACE
	 * @uses XiBATSLastSaleWsdlClass::WSDL_TYPEMAP
	 * @uses XiBATSLastSaleWsdlClass::WSDL_URL
	 * @uses XiBATSLastSaleWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiBATSLastSaleWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::internArrayToIterateIsArray()
	 * @uses XiBATSLastSaleWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBATSLastSaleWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBATSLastSaleWsdlClass::offsetExists()
	 ...
	 * @uses XiBATSLastSaleWsdlClass::getAttributeName()
	 * @uses XiBATSLastSaleWsdlClass::__toString()
	 * @uses XiBATSLastSaleWsdlClass::_set()
	 * @uses XiBATSLastSaleWsdlClass::_get()
	 * @uses XiBATSLastSaleWsdlClass::setInternArrayToIterate()
	 * @uses XiBATSLastSaleWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiBATSLastSaleWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::item()
	 * @uses XiBATSLastSaleWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiBATSLastSaleWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiBATSLastSaleWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
