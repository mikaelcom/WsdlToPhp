<?php
/**
 * Class file for XiBATSLastSaleTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiBATSLastSaleTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiBATSLastSaleTypeIdentifierTypes extends XiBATSLastSaleWsdlClass
{
	/**
