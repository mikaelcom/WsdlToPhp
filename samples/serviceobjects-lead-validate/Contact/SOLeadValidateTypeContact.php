<?php
/**
 * Class file for SOLeadValidateTypeContact
 * @date 06/07/2012
 */
/**
 * Class SOLeadValidateTypeContact
 * @date 06/07/2012
 */
class SOLeadValidateTypeContact extends SOLeadValidateTypeResultContainer
{
	/**
	 * The NameIn
	 * Meta informations :
	 ...
	 */
	public function __construct($_NameIn = null,$_Address1In = null,$_Address2In = null,$_CityIn = null,$_StateIn = null,$_ZipIn = null,$_CountryIn = null,$_Phone1In = null,$_Phone2In = null,$_EmailAddressIn = null,$_IPAddressIn = null,$_FirstNameOut = null,$_LastNameOut = null,$_GenderOut = null,$_Address1Out = null,$_Address2Out = null,$_CityOut = null,$_StateOut = null,$_ZipOut = null,$_Phone1LineOut = null,$_Phone1TypeOut = null,$_Phone2LineOut = null,$_Phone2TypeOut = null,$_EmailOut = null,$_AlternativePhone = null,$_AlternativeName = null,$_AlternativeAddress = null,$_TestType = null,$_OverallCertainty = null,$_OverallQuality = null,$_NameQuality = null,$_EmailQuality = null,$_IPQuality = null,$_PhoneQuality = null,$_AddressQuality = null,$_PhoneContacts = null,$_WarningDesc1 = null,$_WarningCode1 = null,$_WarningDesc2 = null,$_WarningCode2 = null,$_WarningDesc3 = null,$_WarningCode3 = null,$_DEBUG = null)
	{
		SOLeadValidateWsdlClass::__construct(array('NameIn'=>$_NameIn,'Address1In'=>$_Address1In,'Address2In'=>$_Address2In,'CityIn'=>$_CityIn,'StateIn'=>$_StateIn,'ZipIn'=>$_ZipIn,'CountryIn'=>$_CountryIn,'Phone1In'=>$_Phone1In,'Phone2In'=>$_Phone2In,'EmailAddressIn'=>$_EmailAddressIn,'IPAddressIn'=>$_IPAddressIn,'FirstNameOut'=>$_FirstNameOut,'LastNameOut'=>$_LastNameOut,'GenderOut'=>$_GenderOut,'Address1Out'=>$_Address1Out,'Address2Out'=>$_Address2Out,'CityOut'=>$_CityOut,'StateOut'=>$_StateOut,'ZipOut'=>$_ZipOut,'Phone1LineOut'=>$_Phone1LineOut,'Phone1TypeOut'=>$_Phone1TypeOut,'Phone2LineOut'=>$_Phone2LineOut,'Phone2TypeOut'=>$_Phone2TypeOut,'EmailOut'=>$_EmailOut,'AlternativePhone'=>$_AlternativePhone,'AlternativeName'=>$_AlternativeName,'AlternativeAddress'=>$_AlternativeAddress,'TestType'=>$_TestType,'OverallCertainty'=>$_OverallCertainty,'OverallQuality'=>$_OverallQuality,'NameQuality'=>$_NameQuality,'EmailQuality'=>$_EmailQuality,'IPQuality'=>$_IPQuality,'PhoneQuality'=>$_PhoneQuality,'AddressQuality'=>$_AddressQuality,'PhoneContacts'=>$_PhoneContacts,'WarningDesc1'=>$_WarningDesc1,'WarningCode1'=>$_WarningCode1,'WarningDesc2'=>$_WarningDesc2,'WarningCode2'=>$_WarningCode2,'WarningDesc3'=>$_WarningDesc3,'WarningCode3'=>$_WarningCode3,'DEBUG'=>$_DEBUG));
	}
	/**
	 * Set NameIn
	 * @param string NameIn
