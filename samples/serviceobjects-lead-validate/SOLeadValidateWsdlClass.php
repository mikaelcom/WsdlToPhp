<?php
/**
 * File for SOLeadValidateWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SOLeadValidateWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SOLeadValidateWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOLeadValidateWsdlClass::setLastError()
	 * @uses SOLeadValidateWsdlClass::initSoapClient()
	 * @uses SOLeadValidateWsdlClass::initInternArrayToIterate()
	 * @uses SOLeadValidateWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOLeadValidateWsdlClass::classMap()
	 * @uses SOLeadValidateWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOLeadValidateClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOLeadValidateClassMap::classMap();
	 ...
	 * @uses SOLeadValidateWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOLeadValidateWsdlClass::WSDL_COMPRESSION
	 * @uses SOLeadValidateWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOLeadValidateWsdlClass::WSDL_ENCODING
	 * @uses SOLeadValidateWsdlClass::WSDL_EXCPTS
	 * @uses SOLeadValidateWsdlClass::WSDL_FEATURES
	 * @uses SOLeadValidateWsdlClass::WSDL_LOGIN
	 * @uses SOLeadValidateWsdlClass::WSDL_PASSWD
	 * @uses SOLeadValidateWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOLeadValidateWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOLeadValidateWsdlClass::WSDL_TRACE
	 * @uses SOLeadValidateWsdlClass::WSDL_TYPEMAP
	 * @uses SOLeadValidateWsdlClass::WSDL_URL
	 * @uses SOLeadValidateWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOLeadValidateWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::internArrayToIterateIsArray()
	 * @uses SOLeadValidateWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOLeadValidateWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOLeadValidateWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOLeadValidateWsdlClass::offsetGet()
	 * @uses SOLeadValidateWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::getAttributeName()
	 * @uses SOLeadValidateWsdlClass::__toString()
	 * @uses SOLeadValidateWsdlClass::_set()
	 * @uses SOLeadValidateWsdlClass::_get()
	 * @uses SOLeadValidateWsdlClass::setInternArrayToIterate()
	 * @uses SOLeadValidateWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOLeadValidateWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::item()
	 * @uses SOLeadValidateWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadValidateWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOLeadValidateWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
