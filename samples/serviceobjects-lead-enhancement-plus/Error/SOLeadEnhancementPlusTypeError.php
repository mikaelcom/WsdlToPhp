<?php
/**
 * Class file for SOLeadEnhancementPlusTypeError
 * @date 06/07/2012
 */
/**
 * Class SOLeadEnhancementPlusTypeError
 * @date 06/07/2012
 */
class SOLeadEnhancementPlusTypeError extends SOLeadEnhancementPlusWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
