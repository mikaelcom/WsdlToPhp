<?php
/**
 * File for SOLeadEnhancementPlusWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SOLeadEnhancementPlusWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SOLeadEnhancementPlusWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOLeadEnhancementPlusWsdlClass::setLastError()
	 * @uses SOLeadEnhancementPlusWsdlClass::initSoapClient()
	 * @uses SOLeadEnhancementPlusWsdlClass::initInternArrayToIterate()
	 * @uses SOLeadEnhancementPlusWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOLeadEnhancementPlusWsdlClass::classMap()
	 * @uses SOLeadEnhancementPlusWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOLeadEnhancementPlusClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOLeadEnhancementPlusClassMap::classMap();
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_COMPRESSION
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_ENCODING
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_EXCPTS
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_FEATURES
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_LOGIN
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_PASSWD
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_TRACE
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_TYPEMAP
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_URL
	 * @uses SOLeadEnhancementPlusWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOLeadEnhancementPlusWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::internArrayToIterateIsArray()
	 * @uses SOLeadEnhancementPlusWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOLeadEnhancementPlusWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOLeadEnhancementPlusWsdlClass::offsetExists()
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::getAttributeName()
	 * @uses SOLeadEnhancementPlusWsdlClass::__toString()
	 * @uses SOLeadEnhancementPlusWsdlClass::_set()
	 * @uses SOLeadEnhancementPlusWsdlClass::_get()
	 * @uses SOLeadEnhancementPlusWsdlClass::setInternArrayToIterate()
	 * @uses SOLeadEnhancementPlusWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOLeadEnhancementPlusWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::item()
	 * @uses SOLeadEnhancementPlusWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOLeadEnhancementPlusWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOLeadEnhancementPlusWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
