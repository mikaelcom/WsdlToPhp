<?php
/**
 * Class file for ATReportingTypeQueryInstantStreamUTF8
 * @date 03/07/2012
 */
/**
 * Class ATReportingTypeQueryInstantStreamUTF8
 * @date 03/07/2012
 */
class ATReportingTypeQueryInstantStreamUTF8 extends ATReportingWsdlClass
{
	/**
	 * The startDate
	 * Meta informations :
	 ...
	 * @param string query
	 * @param string param
	 * @return ATReportingTypeQueryInstantStreamUTF8
	 */
