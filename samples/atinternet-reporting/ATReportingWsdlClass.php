<?php
/**
 * File for ATReportingWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for ATReportingWsdlClass to communicate with SOAP service
 ...
 * @date 03/07/2012
 */
class ATReportingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses ATReportingWsdlClass::setLastError()
	 * @uses ATReportingWsdlClass::initSoapClient()
	 * @uses ATReportingWsdlClass::initInternArrayToIterate()
	 * @uses ATReportingWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses ATReportingWsdlClass::classMap()
	 * @uses ATReportingWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('ATReportingClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = ATReportingClassMap::classMap();
	 ...
	 * @uses ATReportingWsdlClass::WSDL_CACHE_WSDL
	 * @uses ATReportingWsdlClass::WSDL_COMPRESSION
	 * @uses ATReportingWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses ATReportingWsdlClass::WSDL_ENCODING
	 * @uses ATReportingWsdlClass::WSDL_EXCPTS
	 * @uses ATReportingWsdlClass::WSDL_FEATURES
	 * @uses ATReportingWsdlClass::WSDL_LOGIN
	 * @uses ATReportingWsdlClass::WSDL_PASSWD
	 * @uses ATReportingWsdlClass::WSDL_SOAP_VERSION
	 * @uses ATReportingWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses ATReportingWsdlClass::WSDL_TRACE
	 * @uses ATReportingWsdlClass::WSDL_TYPEMAP
	 * @uses ATReportingWsdlClass::WSDL_URL
	 * @uses ATReportingWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses ATReportingWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses ATReportingWsdlClass::internArrayToIterateIsArray()
	 * @uses ATReportingWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses ATReportingWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses ATReportingWsdlClass::getInternArrayToIterateOffset()
	 * @uses ATReportingWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses ATReportingWsdlClass::getInternArrayToIterateOffset()
	 * @uses ATReportingWsdlClass::offsetExists()
	 ...
	 * @uses ATReportingWsdlClass::getAttributeName()
	 * @uses ATReportingWsdlClass::__toString()
	 * @uses ATReportingWsdlClass::_set()
	 * @uses ATReportingWsdlClass::_get()
	 * @uses ATReportingWsdlClass::setInternArrayToIterate()
	 * @uses ATReportingWsdlClass::setInternArrayToIterateIsArray()
	 * @uses ATReportingWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses ATReportingWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses ATReportingWsdlClass::item()
	 * @uses ATReportingWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses ATReportingWsdlClass::getInternArrayToIterateIsArray()
	 * @uses ATReportingWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
