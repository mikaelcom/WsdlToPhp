<?php
/**
 * File for CdynePhoneVerifyWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for CdynePhoneVerifyWsdlClass to communicate with SOAP service
 ...
 * @date 03/07/2012
 */
class CdynePhoneVerifyWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses CdynePhoneVerifyWsdlClass::setLastError()
	 * @uses CdynePhoneVerifyWsdlClass::initSoapClient()
	 * @uses CdynePhoneVerifyWsdlClass::initInternArrayToIterate()
	 * @uses CdynePhoneVerifyWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses CdynePhoneVerifyWsdlClass::classMap()
	 * @uses CdynePhoneVerifyWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('CdynePhoneVerifyClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = CdynePhoneVerifyClassMap::classMap();
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_CACHE_WSDL
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_COMPRESSION
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_ENCODING
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_EXCPTS
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_FEATURES
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_LOGIN
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_PASSWD
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_SOAP_VERSION
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_TRACE
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_TYPEMAP
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_URL
	 * @uses CdynePhoneVerifyWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses CdynePhoneVerifyWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::internArrayToIterateIsArray()
	 * @uses CdynePhoneVerifyWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdynePhoneVerifyWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::getInternArrayToIterateOffset()
	 * @uses CdynePhoneVerifyWsdlClass::offsetExists()
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::getAttributeName()
	 * @uses CdynePhoneVerifyWsdlClass::__toString()
	 * @uses CdynePhoneVerifyWsdlClass::_set()
	 * @uses CdynePhoneVerifyWsdlClass::_get()
	 * @uses CdynePhoneVerifyWsdlClass::setInternArrayToIterate()
	 * @uses CdynePhoneVerifyWsdlClass::setInternArrayToIterateIsArray()
	 * @uses CdynePhoneVerifyWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::item()
	 * @uses CdynePhoneVerifyWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses CdynePhoneVerifyWsdlClass::getInternArrayToIterateIsArray()
	 * @uses CdynePhoneVerifyWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
