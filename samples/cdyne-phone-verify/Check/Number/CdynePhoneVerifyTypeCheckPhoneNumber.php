<?php
/**
 * Class file for CdynePhoneVerifyTypeCheckPhoneNumber
 * @date 03/07/2012
 */
/**
 * Class CdynePhoneVerifyTypeCheckPhoneNumber
 * @date 03/07/2012
 */
class CdynePhoneVerifyTypeCheckPhoneNumber extends CdynePhoneVerifyWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return CdynePhoneVerifyTypeCheckPhoneNumber
	 */
