<?php
/**
 * Class file for CdynePhoneVerifyTypeArrayOfString
 * @date 03/07/2012
 */
/**
 * Class CdynePhoneVerifyTypeArrayOfString
 * @date 03/07/2012
 */
class CdynePhoneVerifyTypeArrayOfString extends CdynePhoneVerifyWsdlClass
{
	/**
	 * The string
	 * Meta informations :
