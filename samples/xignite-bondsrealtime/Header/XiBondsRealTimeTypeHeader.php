<?php
/**
 * Class file for XiBondsRealTimeTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeHeader
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeHeader extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiBondsRealTimeTypeHeader
	 */
