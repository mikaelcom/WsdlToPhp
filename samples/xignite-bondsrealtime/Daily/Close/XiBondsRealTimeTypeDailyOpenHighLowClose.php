<?php
/**
 * Class file for XiBondsRealTimeTypeDailyOpenHighLowClose
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeDailyOpenHighLowClose
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeDailyOpenHighLowClose extends XiBondsRealTimeWsdlClass
{
	/**
	 * The ShortName
	 * Meta informations :
