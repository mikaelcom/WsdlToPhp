<?php
/**
 * Class file for XiBondsRealTimeTypeGetLastSale
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetLastSale
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetLastSale extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetLastSale
	 */
