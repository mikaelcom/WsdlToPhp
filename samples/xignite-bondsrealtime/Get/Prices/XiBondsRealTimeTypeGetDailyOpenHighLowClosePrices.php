<?php
/**
 * Class file for XiBondsRealTimeTypeGetDailyOpenHighLowClosePrices
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetDailyOpenHighLowClosePrices
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetDailyOpenHighLowClosePrices extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetDailyOpenHighLowClosePrices
	 */
