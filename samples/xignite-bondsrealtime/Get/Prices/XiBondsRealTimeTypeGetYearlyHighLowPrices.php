<?php
/**
 * Class file for XiBondsRealTimeTypeGetYearlyHighLowPrices
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetYearlyHighLowPrices
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetYearlyHighLowPrices extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetYearlyHighLowPrices
	 */
