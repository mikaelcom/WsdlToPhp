<?php
/**
 * Class file for XiBondsRealTimeTypeGetDurationAndConvexities
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetDurationAndConvexities
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetDurationAndConvexities extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetDurationAndConvexities
	 */
