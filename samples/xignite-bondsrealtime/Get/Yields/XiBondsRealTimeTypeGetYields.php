<?php
/**
 * Class file for XiBondsRealTimeTypeGetYields
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetYields
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetYields extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetYields
	 */
