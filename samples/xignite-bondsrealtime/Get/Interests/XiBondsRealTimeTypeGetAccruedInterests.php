<?php
/**
 * Class file for XiBondsRealTimeTypeGetAccruedInterests
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetAccruedInterests
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetAccruedInterests extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetAccruedInterests
	 */
