<?php
/**
 * Class file for XiBondsRealTimeTypeGetDurationAndConvexity
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetDurationAndConvexity
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetDurationAndConvexity extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetDurationAndConvexity
	 */
