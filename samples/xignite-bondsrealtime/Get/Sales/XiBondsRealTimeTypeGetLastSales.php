<?php
/**
 * Class file for XiBondsRealTimeTypeGetLastSales
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetLastSales
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetLastSales extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetLastSales
	 */
