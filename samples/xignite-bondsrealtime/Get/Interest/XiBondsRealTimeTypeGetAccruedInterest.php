<?php
/**
 * Class file for XiBondsRealTimeTypeGetAccruedInterest
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetAccruedInterest
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetAccruedInterest extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetAccruedInterest
	 */
