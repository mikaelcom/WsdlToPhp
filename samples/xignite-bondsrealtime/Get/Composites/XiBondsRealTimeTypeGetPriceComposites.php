<?php
/**
 * Class file for XiBondsRealTimeTypeGetPriceComposites
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetPriceComposites
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetPriceComposites extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetPriceComposites
	 */
