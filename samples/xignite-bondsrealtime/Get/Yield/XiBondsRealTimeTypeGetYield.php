<?php
/**
 * Class file for XiBondsRealTimeTypeGetYield
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetYield
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetYield extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetYield
	 */
