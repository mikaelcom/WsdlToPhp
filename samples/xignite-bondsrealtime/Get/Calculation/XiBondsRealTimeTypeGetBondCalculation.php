<?php
/**
 * Class file for XiBondsRealTimeTypeGetBondCalculation
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetBondCalculation
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetBondCalculation extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetBondCalculation
	 */
