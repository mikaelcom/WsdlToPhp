<?php
/**
 * Class file for XiBondsRealTimeTypeGetPriceComposite
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetPriceComposite
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetPriceComposite extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetPriceComposite
	 */
