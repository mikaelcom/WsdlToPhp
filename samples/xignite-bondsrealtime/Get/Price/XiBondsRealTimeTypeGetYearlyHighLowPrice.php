<?php
/**
 * Class file for XiBondsRealTimeTypeGetYearlyHighLowPrice
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeGetYearlyHighLowPrice
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeGetYearlyHighLowPrice extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiBondsRealTimeTypeGetYearlyHighLowPrice
	 */
