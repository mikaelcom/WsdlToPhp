<?php
/**
 * Class file for XiBondsRealTimeTypeInstrumentIdentifierBrief
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeInstrumentIdentifierBrief
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeInstrumentIdentifierBrief extends XiBondsRealTimeWsdlClass
{
	/**
	 * The Valoren
	 * Meta informations :
