<?php
/**
 * Class file for XiBondsRealTimeTypeYearlyHighLow
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeYearlyHighLow
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeYearlyHighLow extends XiBondsRealTimeWsdlClass
{
	/**
	 * The ShortName
	 * Meta informations :
