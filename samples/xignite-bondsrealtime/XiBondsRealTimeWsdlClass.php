<?php
/**
 * File for XiBondsRealTimeWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiBondsRealTimeWsdlClass to communicate with SOAP service
 * Documentation : XigniteBondsRealTime service provides real-time price data for US Corporate and Agency Debt bonds including debt securities issued by Government-sponsored enterprises (GSE). Price data includes last sale, yield, daily and yearly open, high, low, close trade price data.
 * @date 08/07/2012
 */
class XiBondsRealTimeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiBondsRealTimeWsdlClass::setLastError()
	 * @uses XiBondsRealTimeWsdlClass::initSoapClient()
	 * @uses XiBondsRealTimeWsdlClass::initInternArrayToIterate()
	 * @uses XiBondsRealTimeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiBondsRealTimeWsdlClass::classMap()
	 * @uses XiBondsRealTimeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiBondsRealTimeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiBondsRealTimeClassMap::classMap();
	 ...
	 * @uses XiBondsRealTimeWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiBondsRealTimeWsdlClass::WSDL_COMPRESSION
	 * @uses XiBondsRealTimeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiBondsRealTimeWsdlClass::WSDL_ENCODING
	 * @uses XiBondsRealTimeWsdlClass::WSDL_EXCPTS
	 * @uses XiBondsRealTimeWsdlClass::WSDL_FEATURES
	 * @uses XiBondsRealTimeWsdlClass::WSDL_LOGIN
	 * @uses XiBondsRealTimeWsdlClass::WSDL_PASSWD
	 * @uses XiBondsRealTimeWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiBondsRealTimeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiBondsRealTimeWsdlClass::WSDL_TRACE
	 * @uses XiBondsRealTimeWsdlClass::WSDL_TYPEMAP
	 * @uses XiBondsRealTimeWsdlClass::WSDL_URL
	 * @uses XiBondsRealTimeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiBondsRealTimeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::internArrayToIterateIsArray()
	 * @uses XiBondsRealTimeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBondsRealTimeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiBondsRealTimeWsdlClass::offsetExists()
	 ...
	 * @uses XiBondsRealTimeWsdlClass::getAttributeName()
	 * @uses XiBondsRealTimeWsdlClass::__toString()
	 * @uses XiBondsRealTimeWsdlClass::_set()
	 * @uses XiBondsRealTimeWsdlClass::_get()
	 * @uses XiBondsRealTimeWsdlClass::setInternArrayToIterate()
	 * @uses XiBondsRealTimeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiBondsRealTimeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::item()
	 * @uses XiBondsRealTimeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiBondsRealTimeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiBondsRealTimeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
