<?php
/**
 * Class file for XiBondsRealTimeTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeOutcomeTypes extends XiBondsRealTimeWsdlClass
{
	/**
