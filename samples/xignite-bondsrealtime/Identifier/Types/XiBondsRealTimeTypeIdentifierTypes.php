<?php
/**
 * Class file for XiBondsRealTimeTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiBondsRealTimeTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiBondsRealTimeTypeIdentifierTypes extends XiBondsRealTimeWsdlClass
{
	/**
