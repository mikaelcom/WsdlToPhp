<?php
/**
 * Class file for ScienceGovSearchTypeSearchRetrieveResponse
 * @date 13/10/2012
 */
/**
 * Class ScienceGovSearchTypeSearchRetrieveResponse
 * @date 13/10/2012
 */
class ScienceGovSearchTypeSearchRetrieveResponse extends ScienceGovSearchWsdlClass
{
	/**
	 * The searchId
	 * @var string
