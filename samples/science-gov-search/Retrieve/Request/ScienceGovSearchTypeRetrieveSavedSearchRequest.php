<?php
/**
 * Class file for ScienceGovSearchTypeRetrieveSavedSearchRequest
 * @date 13/10/2012
 */
/**
 * Class ScienceGovSearchTypeRetrieveSavedSearchRequest
 * @date 13/10/2012
 */
class ScienceGovSearchTypeRetrieveSavedSearchRequest extends ScienceGovSearchWsdlClass
{
	/**
	 * The searchId
	 * @var string
	 ...
	 * @return ScienceGovSearchTypeRetrieveSavedSearchRequest
	 */
	public function __construct($_searchId = null,$_startPosition = null,$_maxResults = null,$_collectionCodes = null,$_filters = null,$_maxResultsPerCollection = null,$_order = null,$_advancedOrder = null,$_snapshotId = null)
	{
		parent::__construct(array('searchId'=>$_searchId,'startPosition'=>$_startPosition,'maxResults'=>$_maxResults,'collectionCodes'=>$_collectionCodes,'filters'=>$_filters,'maxResultsPerCollection'=>$_maxResultsPerCollection,'order'=>$_order,'advancedOrder'=>$_advancedOrder,'snapshotId'=>$_snapshotId));
	}
	/**
	 * Set searchId
	 * @param string searchId
