<?php
/**
 * Class file for ScienceGovSearchTypeRetrieveRequest
 * @date 13/10/2012
 */
/**
 * Class ScienceGovSearchTypeRetrieveRequest
 * @date 13/10/2012
 */
class ScienceGovSearchTypeRetrieveRequest extends ScienceGovSearchWsdlClass
{
	/**
	 * The searchId
	 * @var string
	 ...
	 * @return ScienceGovSearchTypeRetrieveRequest
	 */
