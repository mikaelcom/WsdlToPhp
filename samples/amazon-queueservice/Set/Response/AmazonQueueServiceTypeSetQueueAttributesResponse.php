<?php
/**
 * Class file for AmazonQueueServiceTypeSetQueueAttributesResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonQueueServiceTypeSetQueueAttributesResponse
 * @date 10/07/2012
 */
class AmazonQueueServiceTypeSetQueueAttributesResponse extends AmazonQueueServiceWsdlClass
{
	/**
