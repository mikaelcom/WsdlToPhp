<?php
/**
 * File for AmazonQueueServiceWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonQueueServiceWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class AmazonQueueServiceWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonQueueServiceWsdlClass::setLastError()
	 * @uses AmazonQueueServiceWsdlClass::initSoapClient()
	 * @uses AmazonQueueServiceWsdlClass::initInternArrayToIterate()
	 * @uses AmazonQueueServiceWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonQueueServiceWsdlClass::classMap()
	 * @uses AmazonQueueServiceWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonQueueServiceClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonQueueServiceClassMap::classMap();
	 ...
	 * @uses AmazonQueueServiceWsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonQueueServiceWsdlClass::WSDL_COMPRESSION
	 * @uses AmazonQueueServiceWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonQueueServiceWsdlClass::WSDL_ENCODING
	 * @uses AmazonQueueServiceWsdlClass::WSDL_EXCPTS
	 * @uses AmazonQueueServiceWsdlClass::WSDL_FEATURES
	 * @uses AmazonQueueServiceWsdlClass::WSDL_LOGIN
	 * @uses AmazonQueueServiceWsdlClass::WSDL_PASSWD
	 * @uses AmazonQueueServiceWsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonQueueServiceWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonQueueServiceWsdlClass::WSDL_TRACE
	 * @uses AmazonQueueServiceWsdlClass::WSDL_TYPEMAP
	 * @uses AmazonQueueServiceWsdlClass::WSDL_URL
	 * @uses AmazonQueueServiceWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses AmazonQueueServiceWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonQueueServiceWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonQueueServiceWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonQueueServiceWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonQueueServiceWsdlClass::offsetGet()
	 * @uses AmazonQueueServiceWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::getAttributeName()
	 * @uses AmazonQueueServiceWsdlClass::__toString()
	 * @uses AmazonQueueServiceWsdlClass::_set()
	 * @uses AmazonQueueServiceWsdlClass::_get()
	 * @uses AmazonQueueServiceWsdlClass::setInternArrayToIterate()
	 * @uses AmazonQueueServiceWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonQueueServiceWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::item()
	 * @uses AmazonQueueServiceWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonQueueServiceWsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonQueueServiceWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
