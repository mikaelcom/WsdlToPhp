<?php
/**
 * Class file for AmazonQueueServiceTypeChangeMessageVisibilityResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonQueueServiceTypeChangeMessageVisibilityResponse
 * @date 10/07/2012
 */
class AmazonQueueServiceTypeChangeMessageVisibilityResponse extends AmazonQueueServiceWsdlClass
{
	/**
