<?php
/**
 * Class file for AmazonQueueServiceTypeDeleteQueue
 * @date 10/07/2012
 */
/**
 * Class AmazonQueueServiceTypeDeleteQueue
 * @date 10/07/2012
 */
class AmazonQueueServiceTypeDeleteQueue extends AmazonQueueServiceWsdlClass
{
	/**
	 * The Attribute
	 ...
	 * @return AmazonQueueServiceTypeDeleteQueue
	 */
