<?php
/**
 * Class file for AmazonQueueServiceTypeAddPermissionResponse
 * @date 10/07/2012
 */
/**
 * Class AmazonQueueServiceTypeAddPermissionResponse
 * @date 10/07/2012
 */
class AmazonQueueServiceTypeAddPermissionResponse extends AmazonQueueServiceWsdlClass
{
	/**
