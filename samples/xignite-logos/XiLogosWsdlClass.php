<?php
/**
 * File for XiLogosWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiLogosWsdlClass to communicate with SOAP service
 * Documentation : This web service provides company logo images.
 * @date 08/07/2012
 */
class XiLogosWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiLogosWsdlClass::setLastError()
	 * @uses XiLogosWsdlClass::initSoapClient()
	 * @uses XiLogosWsdlClass::initInternArrayToIterate()
	 * @uses XiLogosWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiLogosWsdlClass::classMap()
	 * @uses XiLogosWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiLogosClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiLogosClassMap::classMap();
	 ...
	 * @uses XiLogosWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiLogosWsdlClass::WSDL_COMPRESSION
	 * @uses XiLogosWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiLogosWsdlClass::WSDL_ENCODING
	 * @uses XiLogosWsdlClass::WSDL_EXCPTS
	 * @uses XiLogosWsdlClass::WSDL_FEATURES
	 * @uses XiLogosWsdlClass::WSDL_LOGIN
	 * @uses XiLogosWsdlClass::WSDL_PASSWD
	 * @uses XiLogosWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiLogosWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiLogosWsdlClass::WSDL_TRACE
	 * @uses XiLogosWsdlClass::WSDL_TYPEMAP
	 * @uses XiLogosWsdlClass::WSDL_URL
	 * @uses XiLogosWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiLogosWsdlClass::internArrayToIterateIsArray()
	 * @uses XiLogosWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiLogosWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiLogosWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiLogosWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiLogosWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiLogosWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XiLogosWsdlClass::offsetGet()
	 * @uses XiLogosWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XiLogosWsdlClass::getAttributeName()
	 * @uses XiLogosWsdlClass::__toString()
	 * @uses XiLogosWsdlClass::_set()
	 * @uses XiLogosWsdlClass::_get()
	 * @uses XiLogosWsdlClass::setInternArrayToIterate()
	 * @uses XiLogosWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiLogosWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiLogosWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiLogosWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
