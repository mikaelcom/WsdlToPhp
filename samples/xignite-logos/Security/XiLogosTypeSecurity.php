<?php
/**
 * Class file for XiLogosTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiLogosTypeSecurity
 * @date 08/07/2012
 */
class XiLogosTypeSecurity extends XiLogosTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiLogosWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
