<?php
/**
 * Class file for XiLogosTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiLogosTypeCommon
 * @date 08/07/2012
 */
class XiLogosTypeCommon extends XiLogosWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiLogosTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiLogosTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiLogosTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiLogosTypeOutcomeTypes
	 */
