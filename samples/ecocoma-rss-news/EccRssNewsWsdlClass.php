<?php
/**
 * File for EccRssNewsWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccRssNewsWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Rss News Web Services.
 * @date 03/07/2012
 */
class EccRssNewsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccRssNewsWsdlClass::setLastError()
	 * @uses EccRssNewsWsdlClass::initSoapClient()
	 * @uses EccRssNewsWsdlClass::initInternArrayToIterate()
	 * @uses EccRssNewsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccRssNewsWsdlClass::classMap()
	 * @uses EccRssNewsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccRssNewsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccRssNewsClassMap::classMap();
	 ...
	 * @uses EccRssNewsWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccRssNewsWsdlClass::WSDL_COMPRESSION
	 * @uses EccRssNewsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccRssNewsWsdlClass::WSDL_ENCODING
	 * @uses EccRssNewsWsdlClass::WSDL_EXCPTS
	 * @uses EccRssNewsWsdlClass::WSDL_FEATURES
	 * @uses EccRssNewsWsdlClass::WSDL_LOGIN
	 * @uses EccRssNewsWsdlClass::WSDL_PASSWD
	 * @uses EccRssNewsWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccRssNewsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccRssNewsWsdlClass::WSDL_TRACE
	 * @uses EccRssNewsWsdlClass::WSDL_TYPEMAP
	 * @uses EccRssNewsWsdlClass::WSDL_URL
	 * @uses EccRssNewsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccRssNewsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccRssNewsWsdlClass::internArrayToIterateIsArray()
	 * @uses EccRssNewsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccRssNewsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccRssNewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccRssNewsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccRssNewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccRssNewsWsdlClass::offsetExists()
	 ...
	 * @uses EccRssNewsWsdlClass::getAttributeName()
	 * @uses EccRssNewsWsdlClass::__toString()
	 * @uses EccRssNewsWsdlClass::_set()
	 * @uses EccRssNewsWsdlClass::_get()
	 * @uses EccRssNewsWsdlClass::setInternArrayToIterate()
	 * @uses EccRssNewsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccRssNewsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccRssNewsWsdlClass::item()
	 * @uses EccRssNewsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccRssNewsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccRssNewsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
