<?php
/**
 * File for MicrosoftResearchWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for MicrosoftResearchWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class MicrosoftResearchWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses MicrosoftResearchWsdlClass::setLastError()
	 * @uses MicrosoftResearchWsdlClass::initSoapClient()
	 * @uses MicrosoftResearchWsdlClass::initInternArrayToIterate()
	 * @uses MicrosoftResearchWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses MicrosoftResearchWsdlClass::classMap()
	 * @uses MicrosoftResearchWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('MicrosoftResearchClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = MicrosoftResearchClassMap::classMap();
	 ...
	 * @uses MicrosoftResearchWsdlClass::WSDL_CACHE_WSDL
	 * @uses MicrosoftResearchWsdlClass::WSDL_COMPRESSION
	 * @uses MicrosoftResearchWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses MicrosoftResearchWsdlClass::WSDL_ENCODING
	 * @uses MicrosoftResearchWsdlClass::WSDL_EXCPTS
	 * @uses MicrosoftResearchWsdlClass::WSDL_FEATURES
	 * @uses MicrosoftResearchWsdlClass::WSDL_LOGIN
	 * @uses MicrosoftResearchWsdlClass::WSDL_PASSWD
	 * @uses MicrosoftResearchWsdlClass::WSDL_SOAP_VERSION
	 * @uses MicrosoftResearchWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses MicrosoftResearchWsdlClass::WSDL_TRACE
	 * @uses MicrosoftResearchWsdlClass::WSDL_TYPEMAP
	 * @uses MicrosoftResearchWsdlClass::WSDL_URL
	 * @uses MicrosoftResearchWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses MicrosoftResearchWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::internArrayToIterateIsArray()
	 * @uses MicrosoftResearchWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::getInternArrayToIterateOffset()
	 * @uses MicrosoftResearchWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::getInternArrayToIterateOffset()
	 * @uses MicrosoftResearchWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see MicrosoftResearchWsdlClass::offsetGet()
	 * @uses MicrosoftResearchWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::getAttributeName()
	 * @uses MicrosoftResearchWsdlClass::__toString()
	 * @uses MicrosoftResearchWsdlClass::_set()
	 * @uses MicrosoftResearchWsdlClass::_get()
	 * @uses MicrosoftResearchWsdlClass::setInternArrayToIterate()
	 * @uses MicrosoftResearchWsdlClass::setInternArrayToIterateIsArray()
	 * @uses MicrosoftResearchWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::item()
	 * @uses MicrosoftResearchWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftResearchWsdlClass::getInternArrayToIterateIsArray()
	 * @uses MicrosoftResearchWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
