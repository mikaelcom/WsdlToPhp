<?php
/**
 * File for SPViewsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPViewsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPViewsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPViewsWsdlClass::setLastError()
	 * @uses SPViewsWsdlClass::initSoapClient()
	 * @uses SPViewsWsdlClass::initInternArrayToIterate()
	 * @uses SPViewsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPViewsWsdlClass::classMap()
	 * @uses SPViewsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPViewsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPViewsClassMap::classMap();
	 ...
	 * @uses SPViewsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPViewsWsdlClass::WSDL_COMPRESSION
	 * @uses SPViewsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPViewsWsdlClass::WSDL_ENCODING
	 * @uses SPViewsWsdlClass::WSDL_EXCPTS
	 * @uses SPViewsWsdlClass::WSDL_FEATURES
	 * @uses SPViewsWsdlClass::WSDL_LOGIN
	 * @uses SPViewsWsdlClass::WSDL_PASSWD
	 * @uses SPViewsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPViewsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPViewsWsdlClass::WSDL_TRACE
	 * @uses SPViewsWsdlClass::WSDL_TYPEMAP
	 * @uses SPViewsWsdlClass::WSDL_URL
	 * @uses SPViewsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPViewsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPViewsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPViewsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPViewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPViewsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPViewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPViewsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPViewsWsdlClass::offsetGet()
	 * @uses SPViewsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPViewsWsdlClass::getAttributeName()
	 * @uses SPViewsWsdlClass::__toString()
	 * @uses SPViewsWsdlClass::_set()
	 * @uses SPViewsWsdlClass::_get()
	 * @uses SPViewsWsdlClass::setInternArrayToIterate()
	 * @uses SPViewsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPViewsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPViewsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPViewsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
