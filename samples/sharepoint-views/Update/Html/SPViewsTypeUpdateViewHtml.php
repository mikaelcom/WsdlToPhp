<?php
/**
 * Class file for SPViewsTypeUpdateViewHtml
 * @date 06/07/2012
 */
/**
 * Class SPViewsTypeUpdateViewHtml
 * @date 06/07/2012
 */
class SPViewsTypeUpdateViewHtml extends SPViewsWsdlClass
{
	/**
	 * The listName
	 * @var string
	 ...
	 * @return SPViewsTypeUpdateViewHtml
	 */
	public function __construct($_listName = null,$_viewName = null,$_viewProperties = null,$_toolbar = null,$_viewHeader = null,$_viewBody = null,$_viewFooter = null,$_viewEmpty = null,$_rowLimitExceeded = null,$_query = null,$_viewFields = null,$_aggregations = null,$_formats = null,$_rowLimit = null)
	{
		parent::__construct(array('listName'=>$_listName,'viewName'=>$_viewName,'viewProperties'=>$_viewProperties,'toolbar'=>$_toolbar,'viewHeader'=>$_viewHeader,'viewBody'=>$_viewBody,'viewFooter'=>$_viewFooter,'viewEmpty'=>$_viewEmpty,'rowLimitExceeded'=>$_rowLimitExceeded,'query'=>$_query,'viewFields'=>$_viewFields,'aggregations'=>$_aggregations,'formats'=>$_formats,'rowLimit'=>$_rowLimit));
	}
	/**
	 * Set listName
	 * @param string listName
