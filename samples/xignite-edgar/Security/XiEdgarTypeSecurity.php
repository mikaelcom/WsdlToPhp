<?php
/**
 * Class file for XiEdgarTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeSecurity
 * @date 08/07/2012
 */
class XiEdgarTypeSecurity extends XiEdgarTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiEdgarWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
