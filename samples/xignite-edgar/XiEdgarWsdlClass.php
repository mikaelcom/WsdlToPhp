<?php
/**
 * File for XiEdgarWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiEdgarWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class XiEdgarWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiEdgarWsdlClass::setLastError()
	 * @uses XiEdgarWsdlClass::initSoapClient()
	 * @uses XiEdgarWsdlClass::initInternArrayToIterate()
	 * @uses XiEdgarWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiEdgarWsdlClass::classMap()
	 * @uses XiEdgarWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiEdgarClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiEdgarClassMap::classMap();
	 ...
	 * @uses XiEdgarWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiEdgarWsdlClass::WSDL_COMPRESSION
	 * @uses XiEdgarWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiEdgarWsdlClass::WSDL_ENCODING
	 * @uses XiEdgarWsdlClass::WSDL_EXCPTS
	 * @uses XiEdgarWsdlClass::WSDL_FEATURES
	 * @uses XiEdgarWsdlClass::WSDL_LOGIN
	 * @uses XiEdgarWsdlClass::WSDL_PASSWD
	 * @uses XiEdgarWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiEdgarWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiEdgarWsdlClass::WSDL_TRACE
	 * @uses XiEdgarWsdlClass::WSDL_TYPEMAP
	 * @uses XiEdgarWsdlClass::WSDL_URL
	 * @uses XiEdgarWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiEdgarWsdlClass::internArrayToIterateIsArray()
	 * @uses XiEdgarWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiEdgarWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiEdgarWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEdgarWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiEdgarWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEdgarWsdlClass::offsetExists()
	 ...
	 * @uses XiEdgarWsdlClass::getAttributeName()
	 * @uses XiEdgarWsdlClass::__toString()
	 * @uses XiEdgarWsdlClass::_set()
	 * @uses XiEdgarWsdlClass::_get()
	 * @uses XiEdgarWsdlClass::setInternArrayToIterate()
	 * @uses XiEdgarWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiEdgarWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiEdgarWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiEdgarWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
