<?php
/**
 * Class file for XiEdgarTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeCommon
 * @date 08/07/2012
 */
class XiEdgarTypeCommon extends XiEdgarWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiEdgarTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiEdgarTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiEdgarTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
