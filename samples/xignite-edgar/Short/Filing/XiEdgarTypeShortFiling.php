<?php
/**
 * Class file for XiEdgarTypeShortFiling
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeShortFiling
 * @date 08/07/2012
 */
class XiEdgarTypeShortFiling extends XiEdgarTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiEdgarWsdlClass::__construct(array('CIK'=>$_CIK,'Date'=>$_Date,'Type'=>$_Type,'Amendment'=>$_Amendment,'TextFileUrl'=>$_TextFileUrl,'HtmlFileUrl'=>$_HtmlFileUrl,'AlternateHtmlFileUrl'=>$_AlternateHtmlFileUrl,'FilingId'=>$_FilingId));
	}
	/**
	 * Set CIK
	 * @param string CIK
