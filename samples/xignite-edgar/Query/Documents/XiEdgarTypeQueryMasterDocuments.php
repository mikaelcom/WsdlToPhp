<?php
/**
 * Class file for XiEdgarTypeQueryMasterDocuments
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeQueryMasterDocuments
 * @date 08/07/2012
 */
class XiEdgarTypeQueryMasterDocuments extends XiEdgarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param string ToDate
	 * @return XiEdgarTypeQueryMasterDocuments
	 */
