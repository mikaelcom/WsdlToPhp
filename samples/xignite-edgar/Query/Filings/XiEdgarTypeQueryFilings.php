<?php
/**
 * Class file for XiEdgarTypeQueryFilings
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeQueryFilings
 * @date 08/07/2012
 */
class XiEdgarTypeQueryFilings extends XiEdgarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param string ToDate
	 * @return XiEdgarTypeQueryFilings
	 */
