<?php
/**
 * Class file for XiEdgarTypeGetTotalAssets
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeGetTotalAssets
 * @date 08/07/2012
 */
class XiEdgarTypeGetTotalAssets extends XiEdgarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEdgarTypeGetTotalAssets
	 */
