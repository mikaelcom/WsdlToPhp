<?php
/**
 * Class file for XiEdgarTypeGetFilingAsText
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeGetFilingAsText
 * @date 08/07/2012
 */
class XiEdgarTypeGetFilingAsText extends XiEdgarWsdlClass
{
	/**
	 * The TextFileUrl
	 * Meta informations :
	 ...
	 * @return XiEdgarTypeGetFilingAsText
	 */
