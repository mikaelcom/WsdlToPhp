<?php
/**
 * Class file for XiEdgarTypeGetFilingDetails
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeGetFilingDetails
 * @date 08/07/2012
 */
class XiEdgarTypeGetFilingDetails extends XiEdgarWsdlClass
{
	/**
	 * The HtmlFileUrl
	 * Meta informations :
	 ...
	 * @return XiEdgarTypeGetFilingDetails
	 */
