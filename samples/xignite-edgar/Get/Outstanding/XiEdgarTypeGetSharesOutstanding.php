<?php
/**
 * Class file for XiEdgarTypeGetSharesOutstanding
 * @date 08/07/2012
 */
/**
 * Class XiEdgarTypeGetSharesOutstanding
 * @date 08/07/2012
 */
class XiEdgarTypeGetSharesOutstanding extends XiEdgarWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEdgarTypeGetSharesOutstanding
	 */
