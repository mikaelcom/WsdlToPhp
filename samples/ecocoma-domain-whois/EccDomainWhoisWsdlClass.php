<?php
/**
 * File for EccDomainWhoisWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccDomainWhoisWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Whois Web Services.
 * @date 03/07/2012
 */
class EccDomainWhoisWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccDomainWhoisWsdlClass::setLastError()
	 * @uses EccDomainWhoisWsdlClass::initSoapClient()
	 * @uses EccDomainWhoisWsdlClass::initInternArrayToIterate()
	 * @uses EccDomainWhoisWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccDomainWhoisWsdlClass::classMap()
	 * @uses EccDomainWhoisWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccDomainWhoisClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccDomainWhoisClassMap::classMap();
	 ...
	 * @uses EccDomainWhoisWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccDomainWhoisWsdlClass::WSDL_COMPRESSION
	 * @uses EccDomainWhoisWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccDomainWhoisWsdlClass::WSDL_ENCODING
	 * @uses EccDomainWhoisWsdlClass::WSDL_EXCPTS
	 * @uses EccDomainWhoisWsdlClass::WSDL_FEATURES
	 * @uses EccDomainWhoisWsdlClass::WSDL_LOGIN
	 * @uses EccDomainWhoisWsdlClass::WSDL_PASSWD
	 * @uses EccDomainWhoisWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccDomainWhoisWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccDomainWhoisWsdlClass::WSDL_TRACE
	 * @uses EccDomainWhoisWsdlClass::WSDL_TYPEMAP
	 * @uses EccDomainWhoisWsdlClass::WSDL_URL
	 * @uses EccDomainWhoisWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccDomainWhoisWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::internArrayToIterateIsArray()
	 * @uses EccDomainWhoisWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccDomainWhoisWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccDomainWhoisWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccDomainWhoisWsdlClass::offsetGet()
	 * @uses EccDomainWhoisWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::getAttributeName()
	 * @uses EccDomainWhoisWsdlClass::__toString()
	 * @uses EccDomainWhoisWsdlClass::_set()
	 * @uses EccDomainWhoisWsdlClass::_get()
	 * @uses EccDomainWhoisWsdlClass::setInternArrayToIterate()
	 * @uses EccDomainWhoisWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccDomainWhoisWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::item()
	 * @uses EccDomainWhoisWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainWhoisWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccDomainWhoisWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
