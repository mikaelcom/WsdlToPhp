<?php
/**
 * File for XWebPriceListWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebPriceListWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebPriceListWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebPriceListWsdlClass::setLastError()
	 * @uses XWebPriceListWsdlClass::initSoapClient()
	 * @uses XWebPriceListWsdlClass::initInternArrayToIterate()
	 * @uses XWebPriceListWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebPriceListWsdlClass::classMap()
	 * @uses XWebPriceListWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebPriceListClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebPriceListClassMap::classMap();
	 ...
	 * @uses XWebPriceListWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebPriceListWsdlClass::WSDL_COMPRESSION
	 * @uses XWebPriceListWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebPriceListWsdlClass::WSDL_ENCODING
	 * @uses XWebPriceListWsdlClass::WSDL_EXCPTS
	 * @uses XWebPriceListWsdlClass::WSDL_FEATURES
	 * @uses XWebPriceListWsdlClass::WSDL_LOGIN
	 * @uses XWebPriceListWsdlClass::WSDL_PASSWD
	 * @uses XWebPriceListWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebPriceListWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebPriceListWsdlClass::WSDL_TRACE
	 * @uses XWebPriceListWsdlClass::WSDL_TYPEMAP
	 * @uses XWebPriceListWsdlClass::WSDL_URL
	 * @uses XWebPriceListWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebPriceListWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebPriceListWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebPriceListWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebPriceListWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebPriceListWsdlClass::offsetGet()
	 * @uses XWebPriceListWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::getAttributeName()
	 * @uses XWebPriceListWsdlClass::__toString()
	 * @uses XWebPriceListWsdlClass::_set()
	 * @uses XWebPriceListWsdlClass::_get()
	 * @uses XWebPriceListWsdlClass::setInternArrayToIterate()
	 * @uses XWebPriceListWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebPriceListWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::item()
	 * @uses XWebPriceListWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebPriceListWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebPriceListWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
