<?php
/**
 * Class file for XiReleasesTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiReleasesTypeSecurity
 * @date 08/07/2012
 */
class XiReleasesTypeSecurity extends XiReleasesTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiReleasesWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
