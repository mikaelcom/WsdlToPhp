<?php
/**
 * Class file for XiReleasesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiReleasesTypeCommon
 * @date 08/07/2012
 */
class XiReleasesTypeCommon extends XiReleasesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiReleasesTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiReleasesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiReleasesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiReleasesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiReleasesTypeOutcomeTypes
	 */
