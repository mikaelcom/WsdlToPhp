<?php
/**
 * File for XiReleasesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiReleasesWsdlClass to communicate with SOAP service
 * Documentation : This web service provides corporate press release information.
 * @date 08/07/2012
 */
class XiReleasesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiReleasesWsdlClass::setLastError()
	 * @uses XiReleasesWsdlClass::initSoapClient()
	 * @uses XiReleasesWsdlClass::initInternArrayToIterate()
	 * @uses XiReleasesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiReleasesWsdlClass::classMap()
	 * @uses XiReleasesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiReleasesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiReleasesClassMap::classMap();
	 ...
	 * @uses XiReleasesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiReleasesWsdlClass::WSDL_COMPRESSION
	 * @uses XiReleasesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiReleasesWsdlClass::WSDL_ENCODING
	 * @uses XiReleasesWsdlClass::WSDL_EXCPTS
	 * @uses XiReleasesWsdlClass::WSDL_FEATURES
	 * @uses XiReleasesWsdlClass::WSDL_LOGIN
	 * @uses XiReleasesWsdlClass::WSDL_PASSWD
	 * @uses XiReleasesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiReleasesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiReleasesWsdlClass::WSDL_TRACE
	 * @uses XiReleasesWsdlClass::WSDL_TYPEMAP
	 * @uses XiReleasesWsdlClass::WSDL_URL
	 * @uses XiReleasesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiReleasesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiReleasesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiReleasesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiReleasesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiReleasesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiReleasesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiReleasesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiReleasesWsdlClass::offsetExists()
	 ...
	 * @uses XiReleasesWsdlClass::getAttributeName()
	 * @uses XiReleasesWsdlClass::__toString()
	 * @uses XiReleasesWsdlClass::_set()
	 * @uses XiReleasesWsdlClass::_get()
	 * @uses XiReleasesWsdlClass::setInternArrayToIterate()
	 * @uses XiReleasesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiReleasesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiReleasesWsdlClass::item()
	 * @uses XiReleasesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiReleasesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiReleasesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
