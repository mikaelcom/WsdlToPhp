<?php
/**
 * Class file for XiReleasesTypeReleaseSourceTypes
 * @date 08/07/2012
 */
/**
 * Class XiReleasesTypeReleaseSourceTypes
 * @date 08/07/2012
 */
class XiReleasesTypeReleaseSourceTypes extends XiReleasesWsdlClass
{
	/**
