<?php
/**
 * Class file for MicrosoftSmDhTypeRemoveSensor
 * @date 05/07/2012
 */
/**
 * Class MicrosoftSmDhTypeRemoveSensor
 * @date 05/07/2012
 */
class MicrosoftSmDhTypeRemoveSensor extends MicrosoftSmDhWsdlClass
{
	/**
	 * The publisherName
	 * Meta informations :
	 ...
	 * @return MicrosoftSmDhTypeRemoveSensor
	 */
