<?php
/**
 * Class file for MicrosoftSmDhTypeGetLatestScalarSensorData
 * @date 05/07/2012
 */
/**
 * Class MicrosoftSmDhTypeGetLatestScalarSensorData
 * @date 05/07/2012
 */
class MicrosoftSmDhTypeGetLatestScalarSensorData extends MicrosoftSmDhWsdlClass
{
	/**
	 * The sensorName
	 * Meta informations :
	 ...
	 * @return MicrosoftSmDhTypeGetLatestScalarSensorData
	 */
