<?php
/**
 * Class file for MicrosoftSmDhTypeGetLatestSensingTime
 * @date 05/07/2012
 */
/**
 * Class MicrosoftSmDhTypeGetLatestSensingTime
 * @date 05/07/2012
 */
class MicrosoftSmDhTypeGetLatestSensingTime extends MicrosoftSmDhWsdlClass
{
	/**
	 * The sensorName
	 * Meta informations :
	 ...
	 * @return MicrosoftSmDhTypeGetLatestSensingTime
	 */
