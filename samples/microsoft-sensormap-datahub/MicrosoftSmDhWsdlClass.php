<?php
/**
 * File for MicrosoftSmDhWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for MicrosoftSmDhWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class MicrosoftSmDhWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses MicrosoftSmDhWsdlClass::setLastError()
	 * @uses MicrosoftSmDhWsdlClass::initSoapClient()
	 * @uses MicrosoftSmDhWsdlClass::initInternArrayToIterate()
	 * @uses MicrosoftSmDhWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses MicrosoftSmDhWsdlClass::classMap()
	 * @uses MicrosoftSmDhWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('MicrosoftSmDhClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = MicrosoftSmDhClassMap::classMap();
	 ...
	 * @uses MicrosoftSmDhWsdlClass::WSDL_CACHE_WSDL
	 * @uses MicrosoftSmDhWsdlClass::WSDL_COMPRESSION
	 * @uses MicrosoftSmDhWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses MicrosoftSmDhWsdlClass::WSDL_ENCODING
	 * @uses MicrosoftSmDhWsdlClass::WSDL_EXCPTS
	 * @uses MicrosoftSmDhWsdlClass::WSDL_FEATURES
	 * @uses MicrosoftSmDhWsdlClass::WSDL_LOGIN
	 * @uses MicrosoftSmDhWsdlClass::WSDL_PASSWD
	 * @uses MicrosoftSmDhWsdlClass::WSDL_SOAP_VERSION
	 * @uses MicrosoftSmDhWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses MicrosoftSmDhWsdlClass::WSDL_TRACE
	 * @uses MicrosoftSmDhWsdlClass::WSDL_TYPEMAP
	 * @uses MicrosoftSmDhWsdlClass::WSDL_URL
	 * @uses MicrosoftSmDhWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses MicrosoftSmDhWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::internArrayToIterateIsArray()
	 * @uses MicrosoftSmDhWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::getInternArrayToIterateOffset()
	 * @uses MicrosoftSmDhWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::getInternArrayToIterateOffset()
	 * @uses MicrosoftSmDhWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see MicrosoftSmDhWsdlClass::offsetGet()
	 * @uses MicrosoftSmDhWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::getAttributeName()
	 * @uses MicrosoftSmDhWsdlClass::__toString()
	 * @uses MicrosoftSmDhWsdlClass::_set()
	 * @uses MicrosoftSmDhWsdlClass::_get()
	 * @uses MicrosoftSmDhWsdlClass::setInternArrayToIterate()
	 * @uses MicrosoftSmDhWsdlClass::setInternArrayToIterateIsArray()
	 * @uses MicrosoftSmDhWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::item()
	 * @uses MicrosoftSmDhWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftSmDhWsdlClass::getInternArrayToIterateIsArray()
	 * @uses MicrosoftSmDhWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
