<?php
/**
 * File for SPEmailWsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPEmailWsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPEmailWsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPEmailWsWsdlClass::setLastError()
	 * @uses SPEmailWsWsdlClass::initSoapClient()
	 * @uses SPEmailWsWsdlClass::initInternArrayToIterate()
	 * @uses SPEmailWsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPEmailWsWsdlClass::classMap()
	 * @uses SPEmailWsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPEmailWsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPEmailWsClassMap::classMap();
	 ...
	 * @uses SPEmailWsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPEmailWsWsdlClass::WSDL_COMPRESSION
	 * @uses SPEmailWsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPEmailWsWsdlClass::WSDL_ENCODING
	 * @uses SPEmailWsWsdlClass::WSDL_EXCPTS
	 * @uses SPEmailWsWsdlClass::WSDL_FEATURES
	 * @uses SPEmailWsWsdlClass::WSDL_LOGIN
	 * @uses SPEmailWsWsdlClass::WSDL_PASSWD
	 * @uses SPEmailWsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPEmailWsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPEmailWsWsdlClass::WSDL_TRACE
	 * @uses SPEmailWsWsdlClass::WSDL_TYPEMAP
	 * @uses SPEmailWsWsdlClass::WSDL_URL
	 * @uses SPEmailWsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPEmailWsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPEmailWsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPEmailWsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPEmailWsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPEmailWsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPEmailWsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPEmailWsWsdlClass::offsetExists()
	 ...
	 * @uses SPEmailWsWsdlClass::getAttributeName()
	 * @uses SPEmailWsWsdlClass::__toString()
	 * @uses SPEmailWsWsdlClass::_set()
	 * @uses SPEmailWsWsdlClass::_get()
	 * @uses SPEmailWsWsdlClass::setInternArrayToIterate()
	 * @uses SPEmailWsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPEmailWsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPEmailWsWsdlClass::item()
	 * @uses SPEmailWsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPEmailWsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPEmailWsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
