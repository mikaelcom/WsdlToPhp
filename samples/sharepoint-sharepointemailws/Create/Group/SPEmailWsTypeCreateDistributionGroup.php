<?php
/**
 * Class file for SPEmailWsTypeCreateDistributionGroup
 * @date 06/07/2012
 */
/**
 * Class SPEmailWsTypeCreateDistributionGroup
 * @date 06/07/2012
 */
class SPEmailWsTypeCreateDistributionGroup extends SPEmailWsWsdlClass
{
	/**
	 * The Alias
	 * @var string
	 ...
	 * @return SPEmailWsTypeCreateDistributionGroup
	 */
