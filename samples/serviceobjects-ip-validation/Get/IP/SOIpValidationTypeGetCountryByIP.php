<?php
/**
 * Class file for SOIpValidationTypeGetCountryByIP
 * @date 08/07/2012
 */
/**
 * Class SOIpValidationTypeGetCountryByIP
 * @date 08/07/2012
 */
class SOIpValidationTypeGetCountryByIP extends SOIpValidationWsdlClass
{
	/**
	 * The IPAddress
	 * Meta informations :
	 ...
	 * @return SOIpValidationTypeGetCountryByIP
	 */
