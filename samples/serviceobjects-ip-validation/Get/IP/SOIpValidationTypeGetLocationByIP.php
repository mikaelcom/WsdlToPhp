<?php
/**
 * Class file for SOIpValidationTypeGetLocationByIP
 * @date 08/07/2012
 */
/**
 * Class SOIpValidationTypeGetLocationByIP
 * @date 08/07/2012
 */
class SOIpValidationTypeGetLocationByIP extends SOIpValidationWsdlClass
{
	/**
	 * The IPAddress
	 * Meta informations :
	 ...
	 * @return SOIpValidationTypeGetLocationByIP
	 */
