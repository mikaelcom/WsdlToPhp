<?php
/**
 * File for SOIpValidationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOIpValidationWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOIpValidationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOIpValidationWsdlClass::setLastError()
	 * @uses SOIpValidationWsdlClass::initSoapClient()
	 * @uses SOIpValidationWsdlClass::initInternArrayToIterate()
	 * @uses SOIpValidationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOIpValidationWsdlClass::classMap()
	 * @uses SOIpValidationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOIpValidationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOIpValidationClassMap::classMap();
	 ...
	 * @uses SOIpValidationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOIpValidationWsdlClass::WSDL_COMPRESSION
	 * @uses SOIpValidationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOIpValidationWsdlClass::WSDL_ENCODING
	 * @uses SOIpValidationWsdlClass::WSDL_EXCPTS
	 * @uses SOIpValidationWsdlClass::WSDL_FEATURES
	 * @uses SOIpValidationWsdlClass::WSDL_LOGIN
	 * @uses SOIpValidationWsdlClass::WSDL_PASSWD
	 * @uses SOIpValidationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOIpValidationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOIpValidationWsdlClass::WSDL_TRACE
	 * @uses SOIpValidationWsdlClass::WSDL_TYPEMAP
	 * @uses SOIpValidationWsdlClass::WSDL_URL
	 * @uses SOIpValidationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOIpValidationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::internArrayToIterateIsArray()
	 * @uses SOIpValidationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOIpValidationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOIpValidationWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOIpValidationWsdlClass::offsetGet()
	 * @uses SOIpValidationWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::getAttributeName()
	 * @uses SOIpValidationWsdlClass::__toString()
	 * @uses SOIpValidationWsdlClass::_set()
	 * @uses SOIpValidationWsdlClass::_get()
	 * @uses SOIpValidationWsdlClass::setInternArrayToIterate()
	 * @uses SOIpValidationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOIpValidationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::item()
	 * @uses SOIpValidationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOIpValidationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOIpValidationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
