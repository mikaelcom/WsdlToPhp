<?php
/**
 * File for EccRssCustomWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccRssCustomWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Rss Custom Web Services.
 * @date 03/07/2012
 */
class EccRssCustomWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccRssCustomWsdlClass::setLastError()
	 * @uses EccRssCustomWsdlClass::initSoapClient()
	 * @uses EccRssCustomWsdlClass::initInternArrayToIterate()
	 * @uses EccRssCustomWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccRssCustomWsdlClass::classMap()
	 * @uses EccRssCustomWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccRssCustomClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccRssCustomClassMap::classMap();
	 ...
	 * @uses EccRssCustomWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccRssCustomWsdlClass::WSDL_COMPRESSION
	 * @uses EccRssCustomWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccRssCustomWsdlClass::WSDL_ENCODING
	 * @uses EccRssCustomWsdlClass::WSDL_EXCPTS
	 * @uses EccRssCustomWsdlClass::WSDL_FEATURES
	 * @uses EccRssCustomWsdlClass::WSDL_LOGIN
	 * @uses EccRssCustomWsdlClass::WSDL_PASSWD
	 * @uses EccRssCustomWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccRssCustomWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccRssCustomWsdlClass::WSDL_TRACE
	 * @uses EccRssCustomWsdlClass::WSDL_TYPEMAP
	 * @uses EccRssCustomWsdlClass::WSDL_URL
	 * @uses EccRssCustomWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccRssCustomWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::internArrayToIterateIsArray()
	 * @uses EccRssCustomWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccRssCustomWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccRssCustomWsdlClass::offsetExists()
	 ...
	 * @uses EccRssCustomWsdlClass::getAttributeName()
	 * @uses EccRssCustomWsdlClass::__toString()
	 * @uses EccRssCustomWsdlClass::_set()
	 * @uses EccRssCustomWsdlClass::_get()
	 * @uses EccRssCustomWsdlClass::setInternArrayToIterate()
	 * @uses EccRssCustomWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccRssCustomWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::item()
	 * @uses EccRssCustomWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccRssCustomWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccRssCustomWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
