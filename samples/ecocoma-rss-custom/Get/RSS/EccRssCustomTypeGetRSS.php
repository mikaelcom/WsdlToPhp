<?php
/**
 * Class file for EccRssCustomTypeGetRSS
 * @date 03/07/2012
 */
/**
 * Class EccRssCustomTypeGetRSS
 * @date 03/07/2012
 */
class EccRssCustomTypeGetRSS extends EccRssCustomWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccRssCustomTypeGetRSS
	 */
	public function __construct($_KeyID = null,$_DomainID = null,$_Encoding = null,$_RssUrl1 = null,$_RssUrl2 = null,$_RssUrl3 = null,$_RssUrl4 = null,$_RssUrl5 = null)
	{
		parent::__construct(array('KeyID'=>$_KeyID,'DomainID'=>$_DomainID,'Encoding'=>$_Encoding,'RssUrl1'=>$_RssUrl1,'RssUrl2'=>$_RssUrl2,'RssUrl3'=>$_RssUrl3,'RssUrl4'=>$_RssUrl4,'RssUrl5'=>$_RssUrl5));
	}
	/**
	 * Set KeyID
	 * @param string KeyID
