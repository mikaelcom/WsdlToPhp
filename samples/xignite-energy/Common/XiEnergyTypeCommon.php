<?php
/**
 * Class file for XiEnergyTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeCommon
 * @date 08/07/2012
 */
class XiEnergyTypeCommon extends XiEnergyWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiEnergyTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiEnergyTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiEnergyTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiEnergyTypeOutcomeTypes
	 */
