<?php
/**
 * Class file for XiEnergyTypeFutureOption
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeFutureOption
 * @date 08/07/2012
 */
class XiEnergyTypeFutureOption extends XiEnergyTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
