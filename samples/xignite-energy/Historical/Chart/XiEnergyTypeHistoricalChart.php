<?php
/**
 * Class file for XiEnergyTypeHistoricalChart
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeHistoricalChart
 * @date 08/07/2012
 */
class XiEnergyTypeHistoricalChart extends XiEnergyTypeStockChart
{
	/**
	 * The Future
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiEnergyTypeHistoricalChartTypes
	 */
	public $ChartType;
	/**
	 * The StartDate
	 ...
	 * @param XiEnergyTypeHistoricalChartTypes ChartType
	...
	{
		XiEnergyWsdlClass::__construct(array('Future'=>$_Future,'ChartType'=>$_ChartType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Width'=>$_Width,'Height'=>$_Height,'Title'=>$_Title,'Style'=>$_Style,'Url'=>$_Url));
	}
	/**
	 * Set Future
	 * @param Future Future
	...
	{
		return ($this->ChartType = XiEnergyTypeHistoricalChartTypes::valueIsValid($_ChartType)?$_ChartType:null);
	}
	/**
	 * Get ChartType
