<?php
/**
 * Class file for XiEnergyTypeGetFutureOptionsByStrikePrice
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetFutureOptionsByStrikePrice
 * @date 08/07/2012
 */
class XiEnergyTypeGetFutureOptionsByStrikePrice extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiEnergyTypeGetFutureOptionsByStrikePrice
	 */
