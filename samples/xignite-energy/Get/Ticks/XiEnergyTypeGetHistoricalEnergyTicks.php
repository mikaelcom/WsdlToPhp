<?php
/**
 * Class file for XiEnergyTypeGetHistoricalEnergyTicks
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetHistoricalEnergyTicks
 * @date 08/07/2012
 */
class XiEnergyTypeGetHistoricalEnergyTicks extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiEnergyTypeHistoricalPeriods
	 */
	 ...
	 * @param int Month
	 * @param int Year
	 * @param XiEnergyTypeHistoricalPeriods HistoricalPeriod
	 * @param string StartTime
	 * @param string EndTime
	 * @param XiEnergyTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @return XiEnergyTypeGetHistoricalEnergyTicks
	 */
	public function __construct($_Symbol = null,$_Month,$_Year,$_HistoricalPeriod,$_StartTime = null,$_EndTime = null,$_TickPrecision,$_TickPeriods)
	{
		parent::__construct(array('Symbol'=>$_Symbol,'Month'=>$_Month,'Year'=>$_Year,'HistoricalPeriod'=>$_HistoricalPeriod,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'TickPrecision'=>$_TickPrecision,'TickPeriods'=>$_TickPeriods));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
	...
	{
		return ($this->HistoricalPeriod = XiEnergyTypeHistoricalPeriods::valueIsValid($_HistoricalPeriod)?$_HistoricalPeriod:null);
	}
	/**
