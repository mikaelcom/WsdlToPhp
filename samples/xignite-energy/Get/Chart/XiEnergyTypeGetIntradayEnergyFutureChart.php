<?php
/**
 * Class file for XiEnergyTypeGetIntradayEnergyFutureChart
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetIntradayEnergyFutureChart
 * @date 08/07/2012
 */
class XiEnergyTypeGetIntradayEnergyFutureChart extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiEnergyTypeGetIntradayEnergyFutureChart
	 */
