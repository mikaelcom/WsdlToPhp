<?php
/**
 * Class file for XiEnergyTypeGetHistoricalEnergyFutureChart
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetHistoricalEnergyFutureChart
 * @date 08/07/2012
 */
class XiEnergyTypeGetHistoricalEnergyFutureChart extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiEnergyTypeGetHistoricalEnergyFutureChart
	 */
