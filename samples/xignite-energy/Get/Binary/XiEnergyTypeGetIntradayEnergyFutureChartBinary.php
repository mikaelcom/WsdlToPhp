<?php
/**
 * Class file for XiEnergyTypeGetIntradayEnergyFutureChartBinary
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetIntradayEnergyFutureChartBinary
 * @date 08/07/2012
 */
class XiEnergyTypeGetIntradayEnergyFutureChartBinary extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiEnergyTypeGetIntradayEnergyFutureChartBinary
	 */
