<?php
/**
 * Class file for XiEnergyTypeGetHistoricalEnergyFutureChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetHistoricalEnergyFutureChartCustomBinary
 * @date 08/07/2012
 */
class XiEnergyTypeGetHistoricalEnergyFutureChartCustomBinary extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiEnergyTypeGetHistoricalEnergyFutureChartCustomBinary
	 */
