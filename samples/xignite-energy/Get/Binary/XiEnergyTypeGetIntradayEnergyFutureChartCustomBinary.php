<?php
/**
 * Class file for XiEnergyTypeGetIntradayEnergyFutureChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetIntradayEnergyFutureChartCustomBinary
 * @date 08/07/2012
 */
class XiEnergyTypeGetIntradayEnergyFutureChartCustomBinary extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiEnergyTypeGetIntradayEnergyFutureChartCustomBinary
	 */
