<?php
/**
 * Class file for XiEnergyTypeGetHistoricalEnergyFutureChartBinary
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetHistoricalEnergyFutureChartBinary
 * @date 08/07/2012
 */
class XiEnergyTypeGetHistoricalEnergyFutureChartBinary extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiEnergyTypeGetHistoricalEnergyFutureChartBinary
	 */
