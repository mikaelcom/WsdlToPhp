<?php
/**
 * Class file for XiEnergyTypeGetHistoricalEnergySwapStrip
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeGetHistoricalEnergySwapStrip
 * @date 08/07/2012
 */
class XiEnergyTypeGetHistoricalEnergySwapStrip extends XiEnergyWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiEnergyTypeGetHistoricalEnergySwapStrip
	 */
