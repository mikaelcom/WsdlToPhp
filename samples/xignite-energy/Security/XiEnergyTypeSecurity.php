<?php
/**
 * Class file for XiEnergyTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeSecurity
 * @date 08/07/2012
 */
class XiEnergyTypeSecurity extends XiEnergyTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiEnergyWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
