<?php
/**
 * Class file for XiEnergyTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiEnergyTypeChartDesign
 * @date 08/07/2012
 */
class XiEnergyTypeChartDesign extends XiEnergyTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiEnergyTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiEnergyTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiEnergyTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiEnergyTypeLinePattern GridHorizontalStyle
	 * @param XiEnergyTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiEnergyTypeImageFrameType FrameType
	 * @param XiEnergyTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiEnergyTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiEnergyTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiEnergyTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiEnergyTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiEnergyTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiEnergyTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiEnergyTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiEnergyTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiEnergyTypePredefinedProjection
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiEnergyTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiEnergyTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiEnergyTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiEnergyTypePredefinedLightModel
	 */
