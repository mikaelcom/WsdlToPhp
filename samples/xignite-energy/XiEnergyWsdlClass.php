<?php
/**
 * File for XiEnergyWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiEnergyWsdlClass to communicate with SOAP service
 * Documentation : Provide delayed and historical energy and related information.
 * @date 08/07/2012
 */
class XiEnergyWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiEnergyWsdlClass::setLastError()
	 * @uses XiEnergyWsdlClass::initSoapClient()
	 * @uses XiEnergyWsdlClass::initInternArrayToIterate()
	 * @uses XiEnergyWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiEnergyWsdlClass::classMap()
	 * @uses XiEnergyWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiEnergyClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiEnergyClassMap::classMap();
	 ...
	 * @uses XiEnergyWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiEnergyWsdlClass::WSDL_COMPRESSION
	 * @uses XiEnergyWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiEnergyWsdlClass::WSDL_ENCODING
	 * @uses XiEnergyWsdlClass::WSDL_EXCPTS
	 * @uses XiEnergyWsdlClass::WSDL_FEATURES
	 * @uses XiEnergyWsdlClass::WSDL_LOGIN
	 * @uses XiEnergyWsdlClass::WSDL_PASSWD
	 * @uses XiEnergyWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiEnergyWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiEnergyWsdlClass::WSDL_TRACE
	 * @uses XiEnergyWsdlClass::WSDL_TYPEMAP
	 * @uses XiEnergyWsdlClass::WSDL_URL
	 * @uses XiEnergyWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiEnergyWsdlClass::internArrayToIterateIsArray()
	 * @uses XiEnergyWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiEnergyWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiEnergyWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEnergyWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiEnergyWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEnergyWsdlClass::offsetExists()
	 ...
	 * @uses XiEnergyWsdlClass::getAttributeName()
	 * @uses XiEnergyWsdlClass::__toString()
	 * @uses XiEnergyWsdlClass::_set()
	 * @uses XiEnergyWsdlClass::_get()
	 * @uses XiEnergyWsdlClass::setInternArrayToIterate()
	 * @uses XiEnergyWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiEnergyWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiEnergyWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiEnergyWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
