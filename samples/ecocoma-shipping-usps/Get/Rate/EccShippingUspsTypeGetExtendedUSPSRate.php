<?php
/**
 * Class file for EccShippingUspsTypeGetExtendedUSPSRate
 * @date 03/07/2012
 */
/**
 * Class EccShippingUspsTypeGetExtendedUSPSRate
 * @date 03/07/2012
 */
class EccShippingUspsTypeGetExtendedUSPSRate extends EccShippingUspsWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var EccShippingUspsTypeOptions
	 */
	public $Options;
	/**
	 * Constructor
	 ...
	 * @param string Pounds
	 * @param string Ounces
	 * @param EccShippingUspsTypeOptions Options
	 * @return EccShippingUspsTypeGetExtendedUSPSRate
	 */
	public function __construct($_KeyID = null,$_DomainID = null,$_ZipOrigination = null,$_ZipDestination = null,$_Country = null,$_Pounds = null,$_Ounces = null,$_Options = null)
	{
		parent::__construct(array('KeyID'=>$_KeyID,'DomainID'=>$_DomainID,'ZipOrigination'=>$_ZipOrigination,'ZipDestination'=>$_ZipDestination,'Country'=>$_Country,'Pounds'=>$_Pounds,'Ounces'=>$_Ounces,'Options'=>$_Options));
	}
	/**
	 * Set KeyID
	 * @param string KeyID
