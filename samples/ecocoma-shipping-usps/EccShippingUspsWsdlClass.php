<?php
/**
 * File for EccShippingUspsWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccShippingUspsWsdlClass to communicate with SOAP service
 * Documentation : Cocoma USPS Shipping Web Services.
 * @date 03/07/2012
 */
class EccShippingUspsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccShippingUspsWsdlClass::setLastError()
	 * @uses EccShippingUspsWsdlClass::initSoapClient()
	 * @uses EccShippingUspsWsdlClass::initInternArrayToIterate()
	 * @uses EccShippingUspsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccShippingUspsWsdlClass::classMap()
	 * @uses EccShippingUspsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccShippingUspsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccShippingUspsClassMap::classMap();
	 ...
	 * @uses EccShippingUspsWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccShippingUspsWsdlClass::WSDL_COMPRESSION
	 * @uses EccShippingUspsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccShippingUspsWsdlClass::WSDL_ENCODING
	 * @uses EccShippingUspsWsdlClass::WSDL_EXCPTS
	 * @uses EccShippingUspsWsdlClass::WSDL_FEATURES
	 * @uses EccShippingUspsWsdlClass::WSDL_LOGIN
	 * @uses EccShippingUspsWsdlClass::WSDL_PASSWD
	 * @uses EccShippingUspsWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccShippingUspsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccShippingUspsWsdlClass::WSDL_TRACE
	 * @uses EccShippingUspsWsdlClass::WSDL_TYPEMAP
	 * @uses EccShippingUspsWsdlClass::WSDL_URL
	 * @uses EccShippingUspsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccShippingUspsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::internArrayToIterateIsArray()
	 * @uses EccShippingUspsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingUspsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccShippingUspsWsdlClass::offsetExists()
	 ...
	 * @uses EccShippingUspsWsdlClass::getAttributeName()
	 * @uses EccShippingUspsWsdlClass::__toString()
	 * @uses EccShippingUspsWsdlClass::_set()
	 * @uses EccShippingUspsWsdlClass::_get()
	 * @uses EccShippingUspsWsdlClass::setInternArrayToIterate()
	 * @uses EccShippingUspsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccShippingUspsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::item()
	 * @uses EccShippingUspsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccShippingUspsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccShippingUspsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
