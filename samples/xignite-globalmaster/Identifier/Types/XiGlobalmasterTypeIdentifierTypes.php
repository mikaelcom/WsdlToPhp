<?php
/**
 * Class file for XiGlobalmasterTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalmasterTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalmasterTypeIdentifierTypes extends XiGlobalmasterWsdlClass
{
	/**
