<?php
/**
 * Class file for XiGlobalmasterTypeGetIssuer
 * @date 08/07/2012
 */
/**
 * Class XiGlobalmasterTypeGetIssuer
 * @date 08/07/2012
 */
class XiGlobalmasterTypeGetIssuer extends XiGlobalmasterWsdlClass
{
	/**
	 * The IncludeRelated
	 * Meta informations :
	 ...
	 * @return XiGlobalmasterTypeGetIssuer
	 */
