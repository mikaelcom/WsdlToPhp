<?php
/**
 * Class file for XiGlobalmasterTypeGetSecurities
 * @date 08/07/2012
 */
/**
 * Class XiGlobalmasterTypeGetSecurities
 * @date 08/07/2012
 */
class XiGlobalmasterTypeGetSecurities extends XiGlobalmasterWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiGlobalmasterTypeGetSecurities
	 */
