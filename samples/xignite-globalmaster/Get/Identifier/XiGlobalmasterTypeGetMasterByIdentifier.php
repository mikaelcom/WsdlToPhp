<?php
/**
 * Class file for XiGlobalmasterTypeGetMasterByIdentifier
 * @date 08/07/2012
 */
/**
 * Class XiGlobalmasterTypeGetMasterByIdentifier
 * @date 08/07/2012
 */
class XiGlobalmasterTypeGetMasterByIdentifier extends XiGlobalmasterWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalmasterTypeGetMasterByIdentifier
	 */
