<?php
/**
 * Class file for XiGlobalmasterTypeGetMasterByExchange
 * @date 08/07/2012
 */
/**
 * Class XiGlobalmasterTypeGetMasterByExchange
 * @date 08/07/2012
 */
class XiGlobalmasterTypeGetMasterByExchange extends XiGlobalmasterWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @return XiGlobalmasterTypeGetMasterByExchange
	 */
