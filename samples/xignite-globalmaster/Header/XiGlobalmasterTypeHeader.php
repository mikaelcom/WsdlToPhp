<?php
/**
 * Class file for XiGlobalmasterTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobalmasterTypeHeader
 * @date 08/07/2012
 */
class XiGlobalmasterTypeHeader extends XiGlobalmasterWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobalmasterTypeHeader
	 */
