<?php
/**
 * File for XiGlobalmasterWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalmasterWsdlClass to communicate with SOAP service
 * Documentation : This web service provides multiple security-related operations including mapping of symbol, CUSIP, CIK and name, the collection of statistical information to be used in stock growth simulations, split information, and lookup services.
 * @date 08/07/2012
 */
class XiGlobalmasterWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalmasterWsdlClass::setLastError()
	 * @uses XiGlobalmasterWsdlClass::initSoapClient()
	 * @uses XiGlobalmasterWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalmasterWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalmasterWsdlClass::classMap()
	 * @uses XiGlobalmasterWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalmasterClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalmasterClassMap::classMap();
	 ...
	 * @uses XiGlobalmasterWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalmasterWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalmasterWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalmasterWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalmasterWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalmasterWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalmasterWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalmasterWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalmasterWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalmasterWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalmasterWsdlClass::WSDL_TRACE
	 * @uses XiGlobalmasterWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalmasterWsdlClass::WSDL_URL
	 * @uses XiGlobalmasterWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalmasterWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalmasterWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalmasterWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalmasterWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalmasterWsdlClass::getAttributeName()
	 * @uses XiGlobalmasterWsdlClass::__toString()
	 * @uses XiGlobalmasterWsdlClass::_set()
	 * @uses XiGlobalmasterWsdlClass::_get()
	 * @uses XiGlobalmasterWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalmasterWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalmasterWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::item()
	 * @uses XiGlobalmasterWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalmasterWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalmasterWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
