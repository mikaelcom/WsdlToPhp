<?php
/**
 * File for SPListDataRetrievalWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPListDataRetrievalWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPListDataRetrievalWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPListDataRetrievalWsdlClass::setLastError()
	 * @uses SPListDataRetrievalWsdlClass::initSoapClient()
	 * @uses SPListDataRetrievalWsdlClass::initInternArrayToIterate()
	 * @uses SPListDataRetrievalWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPListDataRetrievalWsdlClass::classMap()
	 * @uses SPListDataRetrievalWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPListDataRetrievalClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPListDataRetrievalClassMap::classMap();
	 ...
	 * @uses SPListDataRetrievalWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPListDataRetrievalWsdlClass::WSDL_COMPRESSION
	 * @uses SPListDataRetrievalWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPListDataRetrievalWsdlClass::WSDL_ENCODING
	 * @uses SPListDataRetrievalWsdlClass::WSDL_EXCPTS
	 * @uses SPListDataRetrievalWsdlClass::WSDL_FEATURES
	 * @uses SPListDataRetrievalWsdlClass::WSDL_LOGIN
	 * @uses SPListDataRetrievalWsdlClass::WSDL_PASSWD
	 * @uses SPListDataRetrievalWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPListDataRetrievalWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPListDataRetrievalWsdlClass::WSDL_TRACE
	 * @uses SPListDataRetrievalWsdlClass::WSDL_TYPEMAP
	 * @uses SPListDataRetrievalWsdlClass::WSDL_URL
	 * @uses SPListDataRetrievalWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SPListDataRetrievalWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::internArrayToIterateIsArray()
	 * @uses SPListDataRetrievalWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPListDataRetrievalWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPListDataRetrievalWsdlClass::offsetExists()
	 ...
	 * @uses SPListDataRetrievalWsdlClass::getAttributeName()
	 * @uses SPListDataRetrievalWsdlClass::__toString()
	 * @uses SPListDataRetrievalWsdlClass::_set()
	 * @uses SPListDataRetrievalWsdlClass::_get()
	 * @uses SPListDataRetrievalWsdlClass::setInternArrayToIterate()
	 * @uses SPListDataRetrievalWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPListDataRetrievalWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::item()
	 * @uses SPListDataRetrievalWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPListDataRetrievalWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPListDataRetrievalWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
