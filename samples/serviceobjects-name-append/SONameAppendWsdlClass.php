<?php
/**
 * File for SONameAppendWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SONameAppendWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SONameAppendWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SONameAppendWsdlClass::setLastError()
	 * @uses SONameAppendWsdlClass::initSoapClient()
	 * @uses SONameAppendWsdlClass::initInternArrayToIterate()
	 * @uses SONameAppendWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SONameAppendWsdlClass::classMap()
	 * @uses SONameAppendWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SONameAppendClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SONameAppendClassMap::classMap();
	 ...
	 * @uses SONameAppendWsdlClass::WSDL_CACHE_WSDL
	 * @uses SONameAppendWsdlClass::WSDL_COMPRESSION
	 * @uses SONameAppendWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SONameAppendWsdlClass::WSDL_ENCODING
	 * @uses SONameAppendWsdlClass::WSDL_EXCPTS
	 * @uses SONameAppendWsdlClass::WSDL_FEATURES
	 * @uses SONameAppendWsdlClass::WSDL_LOGIN
	 * @uses SONameAppendWsdlClass::WSDL_PASSWD
	 * @uses SONameAppendWsdlClass::WSDL_SOAP_VERSION
	 * @uses SONameAppendWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SONameAppendWsdlClass::WSDL_TRACE
	 * @uses SONameAppendWsdlClass::WSDL_TYPEMAP
	 * @uses SONameAppendWsdlClass::WSDL_URL
	 * @uses SONameAppendWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SONameAppendWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SONameAppendWsdlClass::internArrayToIterateIsArray()
	 * @uses SONameAppendWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SONameAppendWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SONameAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SONameAppendWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SONameAppendWsdlClass::getInternArrayToIterateOffset()
	 * @uses SONameAppendWsdlClass::offsetExists()
	 ...
	 * @uses SONameAppendWsdlClass::getAttributeName()
	 * @uses SONameAppendWsdlClass::__toString()
	 * @uses SONameAppendWsdlClass::_set()
	 * @uses SONameAppendWsdlClass::_get()
	 * @uses SONameAppendWsdlClass::setInternArrayToIterate()
	 * @uses SONameAppendWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SONameAppendWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SONameAppendWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SONameAppendWsdlClass::item()
	 * @uses SONameAppendWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SONameAppendWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SONameAppendWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
