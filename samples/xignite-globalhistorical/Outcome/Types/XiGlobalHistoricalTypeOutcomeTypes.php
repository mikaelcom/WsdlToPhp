<?php
/**
 * Class file for XiGlobalHistoricalTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeOutcomeTypes extends XiGlobalHistoricalWsdlClass
{
	/**
