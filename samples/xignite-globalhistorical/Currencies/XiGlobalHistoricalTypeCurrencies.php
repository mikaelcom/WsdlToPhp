<?php
/**
 * Class file for XiGlobalHistoricalTypeCurrencies
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeCurrencies
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeCurrencies extends XiGlobalHistoricalWsdlClass
{
	/**
	...
	{
		return in_array($_value,array(self::VALUE_USD,self::VALUE_AED,self::VALUE_AFA,self::VALUE_AFN,self::VALUE_ALL,self::VALUE_AMD,self::VALUE_ANG,self::VALUE_AOA,self::VALUE_ARA,self::VALUE_ARE,self::VALUE_ARS,self::VALUE_ATS,self::VALUE_AUD,self::VALUE_AUN,self::VALUE_AWG,self::VALUE_AZM,self::VALUE_BAM,self::VALUE_BBD,self::VALUE_BDT,self::VALUE_BEF,self::VALUE_BEL,self::VALUE_BGL,self::VALUE_BGN,self::VALUE_BHD,self::VALUE_BIF,self::VALUE_BMD,self::VALUE_BND,self::VALUE_BOB,self::VALUE_BOV,self::VALUE_BRC,self::VALUE_BRE,self::VALUE_BRI,self::VALUE_BRL,self::VALUE_BRR,self::VALUE_BSD,self::VALUE_BTN,self::VALUE_BWP,self::VALUE_BYR,self::VALUE_BZD,self::VALUE_CAD,self::VALUE_CDF,self::VALUE_CHF,self::VALUE_CLF,self::VALUE_CHK,self::VALUE_CLP,self::VALUE_CNY,self::VALUE_COP,self::VALUE_CRC,self::VALUE_CSD,self::VALUE_CUP,self::VALUE_CVE,self::VALUE_CYP,self::VALUE_CZK,self::VALUE_DEM,self::VALUE_DJF,self::VALUE_DKK,self::VALUE_DOP,self::VALUE_DOE,self::VALUE_DOW,self::VALUE_DZD,self::VALUE_ECS,self::VALUE_EEK,self::VALUE_EGP,self::VALUE_ERN,self::VALUE_ESP,self::VALUE_ETB,self::VALUE_EUR,self::VALUE_FIM,self::VALUE_FJD,self::VALUE_FKP,self::VALUE_FRF,self::VALUE_FRN,self::VALUE_GBP,self::VALUE_GEL,self::VALUE_GGP,self::VALUE_GHC,self::VALUE_GHS,self::VALUE_GIP,self::VALUE_GMD,self::VALUE_GNF,self::VALUE_GRD,self::VALUE_GTQ,self::VALUE_GYD,self::VALUE_HKD,self::VALUE_HNL,self::VALUE_HRD,self::VALUE_HRK,self::VALUE_HTG,self::VALUE_HUF,self::VALUE_IDR,self::VALUE_IEP,self::VALUE_ILS,self::VALUE_IMP,self::VALUE_INR,self::VALUE_IQD,self::VALUE_IRR,self::VALUE_ISK,self::VALUE_ITL,self::VALUE_JEP,self::VALUE_JMD,self::VALUE_JOD,self::VALUE_JPY,self::VALUE_KES,self::VALUE_KGS,self::VALUE_KHR,self::VALUE_KMF,self::VALUE_KPW,self::VALUE_KRU,self::VALUE_KRW,self::VALUE_KWD,self::VALUE_KYD,self::VALUE_KZT,self::VALUE_LAK,self::VALUE_LBP,self::VALUE_LKR,self::VALUE_LRD,self::VALUE_LSL,self::VALUE_LTL,self::VALUE_LUF,self::VALUE_LVL,self::VALUE_LYD,self::VALUE_M5P,self::VALUE_MAD,self::VALUE_MAL,self::VALUE_MDL,self::VALUE_MFG,self::VALUE_MGA,self::VALUE_MKD,self::VALUE_MMK,self::VALUE_MNT,self::VALUE_MOP,self::VALUE_MRO,self::VALUE_MTL,self::VALUE_MTP,self::VALUE_MUR,self::VALUE_MVR,self::VALUE_MWK,self::VALUE_MXN,self::VALUE_MXP,self::VALUE_MXV,self::VALUE_MYR,self::VALUE_MZM,self::VALUE_MZN,self::VALUE_NAD,self::VALUE_NBL,self::VALUE_NGN,self::VALUE_NIC,self::VALUE_NIO,self::VALUE_NLG,self::VALUE_NOK,self::VALUE_NPR,self::VALUE_NSO,self::VALUE_NZD,self::VALUE_OMR,self::VALUE_OSO,self::VALUE_PAB,self::VALUE_PEI,self::VALUE_PEN,self::VALUE_PES,self::VALUE_PGK,self::VALUE_PHP,self::VALUE_PKR,self::VALUE_PLN,self::VALUE_PLZ,self::VALUE_PTE,self::VALUE_PYG,self::VALUE_QAR,self::VALUE_ROL,self::VALUE_RON,self::VALUE_RSD,self::VALUE_RUB,self::VALUE_RUR,self::VALUE_RWF,self::VALUE_SAR,self::VALUE_SBD,self::VALUE_SCR,self::VALUE_SDD,self::VALUE_SDP,self::VALUE_SDR,self::VALUE_SEK,self::VALUE_SGD,self::VALUE_SHP,self::VALUE_SIT,self::VALUE_SKK,self::VALUE_SLL,self::VALUE_SOS,self::VALUE_SPL,self::VALUE_SRG,self::VALUE_STD,self::VALUE_SUR,self::VALUE_SVC,self::VALUE_SYP,self::VALUE_SZL,self::VALUE_THB,self::VALUE_TJR,self::VALUE_TJS,self::VALUE_TMM,self::VALUE_TND,self::VALUE_TOP,self::VALUE_TRL,self::VALUE_TRY,self::VALUE_TTD,self::VALUE_TVD,self::VALUE_TWD,self::VALUE_TZS,self::VALUE_UAH,self::VALUE_UGX,self::VALUE_UNK,self::VALUE_UYP,self::VALUE_UYU,self::VALUE_UZS,self::VALUE_VEB,self::VALUE_VEF,self::VALUE_VND,self::VALUE_VRL,self::VALUE_VRN,self::VALUE_VUV,self::VALUE_WST,self::VALUE_XAF,self::VALUE_XAG,self::VALUE_XAU,self::VALUE_XCD,self::VALUE_XDR,self::VALUE_XEU,self::VALUE_XOF,self::VALUE_XPD,self::VALUE_XPF,self::VALUE_XPT,self::VALUE_YER,self::VALUE_YUD,self::VALUE_YUM,self::VALUE_ZAL,self::VALUE_ZAR,self::VALUE_ZMK,self::VALUE_ZRN,self::VALUE_ZRZ,self::VALUE_ZWD,self::VALUE_BAD,self::VALUE_NOCURRENCY));
	}
	/**
