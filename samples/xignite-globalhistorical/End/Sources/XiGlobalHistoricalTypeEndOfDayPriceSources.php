<?php
/**
 * Class file for XiGlobalHistoricalTypeEndOfDayPriceSources
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeEndOfDayPriceSources
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeEndOfDayPriceSources extends XiGlobalHistoricalWsdlClass
{
	/**
