<?php
/**
 * Class file for XiGlobalHistoricalTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeIdentifierTypes extends XiGlobalHistoricalWsdlClass
{
	/**
