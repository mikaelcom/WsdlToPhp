<?php
/**
 * Class file for XiGlobalHistoricalTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeSecurity
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeSecurity extends XiGlobalHistoricalTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiGlobalHistoricalWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
