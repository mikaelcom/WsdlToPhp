<?php
/**
 * Class file for XiGlobalHistoricalTypeGetSplitRatio
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetSplitRatio
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetSplitRatio extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetSplitRatio
	 */
