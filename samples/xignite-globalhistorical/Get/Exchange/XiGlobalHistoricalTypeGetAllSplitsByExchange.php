<?php
/**
 * Class file for XiGlobalHistoricalTypeGetAllSplitsByExchange
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetAllSplitsByExchange
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetAllSplitsByExchange extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetAllSplitsByExchange
	 */
