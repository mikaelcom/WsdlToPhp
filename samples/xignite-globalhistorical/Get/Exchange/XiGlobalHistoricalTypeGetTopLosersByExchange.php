<?php
/**
 * Class file for XiGlobalHistoricalTypeGetTopLosersByExchange
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetTopLosersByExchange
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetTopLosersByExchange extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The AsOfDate
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetTopLosersByExchange
	 */
