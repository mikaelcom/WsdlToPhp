<?php
/**
 * Class file for XiGlobalHistoricalTypeGetTopMoversByExchange
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetTopMoversByExchange
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetTopMoversByExchange extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The AsOfDate
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetTopMoversByExchange
	 */
