<?php
/**
 * Class file for XiGlobalHistoricalTypeGetAllCorporateActionsByExchange
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetAllCorporateActionsByExchange
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetAllCorporateActionsByExchange extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Exchange
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetAllCorporateActionsByExchange
	 */
