<?php
/**
 * Class file for XiGlobalHistoricalTypeGetCashDividendTotal
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetCashDividendTotal
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetCashDividendTotal extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetCashDividendTotal
	 */
