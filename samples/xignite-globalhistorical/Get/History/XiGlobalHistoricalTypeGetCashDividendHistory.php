<?php
/**
 * Class file for XiGlobalHistoricalTypeGetCashDividendHistory
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetCashDividendHistory
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetCashDividendHistory extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetCashDividendHistory
	 */
