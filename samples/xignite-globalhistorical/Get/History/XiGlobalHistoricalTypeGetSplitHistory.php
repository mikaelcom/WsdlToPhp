<?php
/**
 * Class file for XiGlobalHistoricalTypeGetSplitHistory
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetSplitHistory
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetSplitHistory extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetSplitHistory
	 */
