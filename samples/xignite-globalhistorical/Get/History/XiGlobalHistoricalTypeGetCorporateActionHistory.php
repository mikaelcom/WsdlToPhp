<?php
/**
 * Class file for XiGlobalHistoricalTypeGetCorporateActionHistory
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeGetCorporateActionHistory
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeGetCorporateActionHistory extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiGlobalHistoricalTypeGetCorporateActionHistory
	 */
