<?php
/**
 * File for XiGlobalHistoricalWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalHistoricalWsdlClass to communicate with SOAP service
 * Documentation : On-demand global historical quotes.
 * @date 08/07/2012
 */
class XiGlobalHistoricalWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalHistoricalWsdlClass::setLastError()
	 * @uses XiGlobalHistoricalWsdlClass::initSoapClient()
	 * @uses XiGlobalHistoricalWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalHistoricalWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalHistoricalWsdlClass::classMap()
	 * @uses XiGlobalHistoricalWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalHistoricalClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalHistoricalClassMap::classMap();
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_TRACE
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_URL
	 * @uses XiGlobalHistoricalWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalHistoricalWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalHistoricalWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalHistoricalWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalHistoricalWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::getAttributeName()
	 * @uses XiGlobalHistoricalWsdlClass::__toString()
	 * @uses XiGlobalHistoricalWsdlClass::_set()
	 * @uses XiGlobalHistoricalWsdlClass::_get()
	 * @uses XiGlobalHistoricalWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalHistoricalWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalHistoricalWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::item()
	 * @uses XiGlobalHistoricalWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalHistoricalWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalHistoricalWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
