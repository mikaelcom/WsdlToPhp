<?php
/**
 * Class file for XiGlobalHistoricalTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobalHistoricalTypeHeader
 * @date 08/07/2012
 */
class XiGlobalHistoricalTypeHeader extends XiGlobalHistoricalWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobalHistoricalTypeHeader
	 */
