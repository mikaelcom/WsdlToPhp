<?php
/**
 * File for MaxMindWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for MaxMindWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class MaxMindWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses MaxMindWsdlClass::setLastError()
	 * @uses MaxMindWsdlClass::initSoapClient()
	 * @uses MaxMindWsdlClass::initInternArrayToIterate()
	 * @uses MaxMindWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses MaxMindWsdlClass::classMap()
	 * @uses MaxMindWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('MaxMindClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = MaxMindClassMap::classMap();
	 ...
	 * @uses MaxMindWsdlClass::WSDL_CACHE_WSDL
	 * @uses MaxMindWsdlClass::WSDL_COMPRESSION
	 * @uses MaxMindWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses MaxMindWsdlClass::WSDL_ENCODING
	 * @uses MaxMindWsdlClass::WSDL_EXCPTS
	 * @uses MaxMindWsdlClass::WSDL_FEATURES
	 * @uses MaxMindWsdlClass::WSDL_LOGIN
	 * @uses MaxMindWsdlClass::WSDL_PASSWD
	 * @uses MaxMindWsdlClass::WSDL_SOAP_VERSION
	 * @uses MaxMindWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses MaxMindWsdlClass::WSDL_TRACE
	 * @uses MaxMindWsdlClass::WSDL_TYPEMAP
	 * @uses MaxMindWsdlClass::WSDL_URL
	 * @uses MaxMindWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses MaxMindWsdlClass::internArrayToIterateIsArray()
	 * @uses MaxMindWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses MaxMindWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses MaxMindWsdlClass::getInternArrayToIterateOffset()
	 * @uses MaxMindWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses MaxMindWsdlClass::getInternArrayToIterateOffset()
	 * @uses MaxMindWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see MaxMindWsdlClass::offsetGet()
	 * @uses MaxMindWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses MaxMindWsdlClass::getAttributeName()
	 * @uses MaxMindWsdlClass::__toString()
	 * @uses MaxMindWsdlClass::_set()
	 * @uses MaxMindWsdlClass::_get()
	 * @uses MaxMindWsdlClass::setInternArrayToIterate()
	 * @uses MaxMindWsdlClass::setInternArrayToIterateIsArray()
	 * @uses MaxMindWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses MaxMindWsdlClass::getInternArrayToIterateIsArray()
	 * @uses MaxMindWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
