<?php
/**
 * Class file for SPSearchTypeGetSearchMetadataResult
 * @date 06/07/2012
 */
/**
 * Class SPSearchTypeGetSearchMetadataResult
 * @date 06/07/2012
 */
class SPSearchTypeGetSearchMetadataResult extends SPSearchWsdlClass
{
	/**
	 * The schema
	 * @var DOMDocument
