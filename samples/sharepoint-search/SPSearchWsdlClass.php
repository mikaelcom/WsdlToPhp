<?php
/**
 * File for SPSearchWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPSearchWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPSearchWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPSearchWsdlClass::setLastError()
	 * @uses SPSearchWsdlClass::initSoapClient()
	 * @uses SPSearchWsdlClass::initInternArrayToIterate()
	 * @uses SPSearchWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPSearchWsdlClass::classMap()
	 * @uses SPSearchWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPSearchClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPSearchClassMap::classMap();
	 ...
	 * @uses SPSearchWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPSearchWsdlClass::WSDL_COMPRESSION
	 * @uses SPSearchWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPSearchWsdlClass::WSDL_ENCODING
	 * @uses SPSearchWsdlClass::WSDL_EXCPTS
	 * @uses SPSearchWsdlClass::WSDL_FEATURES
	 * @uses SPSearchWsdlClass::WSDL_LOGIN
	 * @uses SPSearchWsdlClass::WSDL_PASSWD
	 * @uses SPSearchWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPSearchWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPSearchWsdlClass::WSDL_TRACE
	 * @uses SPSearchWsdlClass::WSDL_TYPEMAP
	 * @uses SPSearchWsdlClass::WSDL_URL
	 * @uses SPSearchWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPSearchWsdlClass::internArrayToIterateIsArray()
	 * @uses SPSearchWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPSearchWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPSearchWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPSearchWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPSearchWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPSearchWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SPSearchWsdlClass::offsetGet()
	 * @uses SPSearchWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SPSearchWsdlClass::getAttributeName()
	 * @uses SPSearchWsdlClass::__toString()
	 * @uses SPSearchWsdlClass::_set()
	 * @uses SPSearchWsdlClass::_get()
	 * @uses SPSearchWsdlClass::setInternArrayToIterate()
	 * @uses SPSearchWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPSearchWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPSearchWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPSearchWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
