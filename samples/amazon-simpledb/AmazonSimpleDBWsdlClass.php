<?php
/**
 * File for AmazonSimpleDBWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for AmazonSimpleDBWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class AmazonSimpleDBWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonSimpleDBWsdlClass::setLastError()
	 * @uses AmazonSimpleDBWsdlClass::initSoapClient()
	 * @uses AmazonSimpleDBWsdlClass::initInternArrayToIterate()
	 * @uses AmazonSimpleDBWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses AmazonSimpleDBWsdlClass::classMap()
	 * @uses AmazonSimpleDBWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonSimpleDBClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonSimpleDBClassMap::classMap();
	 ...
	 * @uses AmazonSimpleDBWsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonSimpleDBWsdlClass::WSDL_COMPRESSION
	 * @uses AmazonSimpleDBWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonSimpleDBWsdlClass::WSDL_ENCODING
	 * @uses AmazonSimpleDBWsdlClass::WSDL_EXCPTS
	 * @uses AmazonSimpleDBWsdlClass::WSDL_FEATURES
	 * @uses AmazonSimpleDBWsdlClass::WSDL_LOGIN
	 * @uses AmazonSimpleDBWsdlClass::WSDL_PASSWD
	 * @uses AmazonSimpleDBWsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonSimpleDBWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonSimpleDBWsdlClass::WSDL_TRACE
	 * @uses AmazonSimpleDBWsdlClass::WSDL_TYPEMAP
	 * @uses AmazonSimpleDBWsdlClass::WSDL_URL
	 * @uses AmazonSimpleDBWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses AmazonSimpleDBWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::internArrayToIterateIsArray()
	 * @uses AmazonSimpleDBWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonSimpleDBWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonSimpleDBWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see AmazonSimpleDBWsdlClass::offsetGet()
	 * @uses AmazonSimpleDBWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::getAttributeName()
	 * @uses AmazonSimpleDBWsdlClass::__toString()
	 * @uses AmazonSimpleDBWsdlClass::_set()
	 * @uses AmazonSimpleDBWsdlClass::_get()
	 * @uses AmazonSimpleDBWsdlClass::setInternArrayToIterate()
	 * @uses AmazonSimpleDBWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonSimpleDBWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::item()
	 * @uses AmazonSimpleDBWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonSimpleDBWsdlClass::getInternArrayToIterateIsArray()
	 * @uses AmazonSimpleDBWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
