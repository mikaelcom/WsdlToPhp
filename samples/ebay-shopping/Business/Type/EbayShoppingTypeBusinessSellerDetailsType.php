<?php
/**
 * Class file for EbayShoppingTypeBusinessSellerDetailsType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeBusinessSellerDetailsType
 ...
 * @date 05/07/2012
 */
class EbayShoppingTypeBusinessSellerDetailsType extends EbayShoppingWsdlClass
{
	/**
	 * The Address
	 * Meta informations :
	 ...
	 * @var EbayShoppingTypeAddressType
	 */
	public $Address;
	/**
	 * The Fax
	 ...
	 * @var EbayShoppingTypeVATDetailsType
	 */
	public $VATDetails;
	/**
	 * The any
	...
	/**
	 * Constructor
	 * @param EbayShoppingTypeAddressType Address
	 * @param string Fax
	 * @param string Email
	 ...
	 * @param EbayShoppingTypeVATDetailsType VATDetails
