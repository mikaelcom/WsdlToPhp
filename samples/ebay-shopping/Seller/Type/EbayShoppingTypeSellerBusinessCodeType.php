<?php
/**
 * Class file for EbayShoppingTypeSellerBusinessCodeType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeSellerBusinessCodeType
 * @date 05/07/2012
 */
class EbayShoppingTypeSellerBusinessCodeType extends EbayShoppingWsdlClass
{
	/**
