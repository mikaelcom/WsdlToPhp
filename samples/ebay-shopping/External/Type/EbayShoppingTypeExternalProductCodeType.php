<?php
/**
 * Class file for EbayShoppingTypeExternalProductCodeType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeExternalProductCodeType
 * @date 05/07/2012
 */
class EbayShoppingTypeExternalProductCodeType extends EbayShoppingWsdlClass
{
	/**
