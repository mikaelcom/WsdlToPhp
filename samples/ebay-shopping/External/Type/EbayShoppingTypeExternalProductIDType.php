<?php
/**
 * Class file for EbayShoppingTypeExternalProductIDType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeExternalProductIDType
 ...
 * @date 05/07/2012
 */
class EbayShoppingTypeExternalProductIDType extends EbayShoppingWsdlClass
{
	/**
	 * The Value
	 * Meta informations :
	 ...
	 * @var EbayShoppingTypeExternalProductCodeType
	 */
	public $Type;
	/**
	 * The AlternateValue
	 ...
	 * @param EbayShoppingTypeExternalProductCodeType Type
	 * @param string AlternateValue
	 * @param DOMDocument any
	 * @return EbayShoppingTypeExternalProductIDType
	 */
	...
	{
		return ($this->Type = EbayShoppingTypeExternalProductCodeType::valueIsValid($_Type)?$_Type:null);
	}
	/**
	 * Get Type
	 * @return EbayShoppingTypeExternalProductCodeType
	 */
