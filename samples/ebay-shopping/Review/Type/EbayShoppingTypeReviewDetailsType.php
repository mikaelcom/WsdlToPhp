<?php
/**
 * Class file for EbayShoppingTypeReviewDetailsType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeReviewDetailsType
 * Documentation : Contains product reviews written by eBay members.
 * @date 05/07/2012
 */
class EbayShoppingTypeReviewDetailsType extends EbayShoppingWsdlClass
{
	/**
	 * The AverageRating
	 * Meta informations :
	 ...
	 * @var EbayShoppingTypeReviewType
	 */
	public $Review;
	/**
	 * The any
	 ...
	 * @param EbayShoppingTypeReviewType Review
	...
	/**
	 * Get Review
	 * @return EbayShoppingTypeReviewType
	 */
