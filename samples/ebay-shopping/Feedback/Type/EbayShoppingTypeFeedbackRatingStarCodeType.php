<?php
/**
 * Class file for EbayShoppingTypeFeedbackRatingStarCodeType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeFeedbackRatingStarCodeType
 * @date 05/07/2012
 */
class EbayShoppingTypeFeedbackRatingStarCodeType extends EbayShoppingWsdlClass
{
	/**
