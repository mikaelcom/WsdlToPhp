<?php
/**
 * Class file for EbayShoppingTypeFeedbackRatingDetailCodeType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeFeedbackRatingDetailCodeType
 * @date 05/07/2012
 */
class EbayShoppingTypeFeedbackRatingDetailCodeType extends EbayShoppingWsdlClass
{
	/**
