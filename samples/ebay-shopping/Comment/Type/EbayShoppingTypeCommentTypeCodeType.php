<?php
/**
 * Class file for EbayShoppingTypeCommentTypeCodeType
 * @date 05/07/2012
 */
/**
 * Class EbayShoppingTypeCommentTypeCodeType
 * @date 05/07/2012
 */
class EbayShoppingTypeCommentTypeCodeType extends EbayShoppingWsdlClass
{
	/**
