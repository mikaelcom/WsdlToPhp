<?php
/**
 * File for EbayShoppingWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for EbayShoppingWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class EbayShoppingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EbayShoppingWsdlClass::setLastError()
	 * @uses EbayShoppingWsdlClass::initSoapClient()
	 * @uses EbayShoppingWsdlClass::initInternArrayToIterate()
	 * @uses EbayShoppingWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EbayShoppingWsdlClass::classMap()
	 * @uses EbayShoppingWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EbayShoppingClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EbayShoppingClassMap::classMap();
	 ...
	 * @uses EbayShoppingWsdlClass::WSDL_CACHE_WSDL
	 * @uses EbayShoppingWsdlClass::WSDL_COMPRESSION
	 * @uses EbayShoppingWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EbayShoppingWsdlClass::WSDL_ENCODING
	 * @uses EbayShoppingWsdlClass::WSDL_EXCPTS
	 * @uses EbayShoppingWsdlClass::WSDL_FEATURES
	 * @uses EbayShoppingWsdlClass::WSDL_LOGIN
	 * @uses EbayShoppingWsdlClass::WSDL_PASSWD
	 * @uses EbayShoppingWsdlClass::WSDL_SOAP_VERSION
	 * @uses EbayShoppingWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EbayShoppingWsdlClass::WSDL_TRACE
	 * @uses EbayShoppingWsdlClass::WSDL_TYPEMAP
	 * @uses EbayShoppingWsdlClass::WSDL_URL
	 * @uses EbayShoppingWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EbayShoppingWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::internArrayToIterateIsArray()
	 * @uses EbayShoppingWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::getInternArrayToIterateOffset()
	 * @uses EbayShoppingWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::getInternArrayToIterateOffset()
	 * @uses EbayShoppingWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EbayShoppingWsdlClass::offsetGet()
	 * @uses EbayShoppingWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::getAttributeName()
	 * @uses EbayShoppingWsdlClass::__toString()
	 * @uses EbayShoppingWsdlClass::_set()
	 * @uses EbayShoppingWsdlClass::_get()
	 * @uses EbayShoppingWsdlClass::setInternArrayToIterate()
	 * @uses EbayShoppingWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EbayShoppingWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::item()
	 * @uses EbayShoppingWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EbayShoppingWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EbayShoppingWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
