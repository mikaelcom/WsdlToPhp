<?php
/**
 * File for XiRatesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiRatesWsdlClass to communicate with SOAP service
 * Documentation : Provide information about interest rates.
 * @date 08/07/2012
 */
class XiRatesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiRatesWsdlClass::setLastError()
	 * @uses XiRatesWsdlClass::initSoapClient()
	 * @uses XiRatesWsdlClass::initInternArrayToIterate()
	 * @uses XiRatesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiRatesWsdlClass::classMap()
	 * @uses XiRatesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiRatesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiRatesClassMap::classMap();
	 ...
	 * @uses XiRatesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiRatesWsdlClass::WSDL_COMPRESSION
	 * @uses XiRatesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiRatesWsdlClass::WSDL_ENCODING
	 * @uses XiRatesWsdlClass::WSDL_EXCPTS
	 * @uses XiRatesWsdlClass::WSDL_FEATURES
	 * @uses XiRatesWsdlClass::WSDL_LOGIN
	 * @uses XiRatesWsdlClass::WSDL_PASSWD
	 * @uses XiRatesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiRatesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiRatesWsdlClass::WSDL_TRACE
	 * @uses XiRatesWsdlClass::WSDL_TYPEMAP
	 * @uses XiRatesWsdlClass::WSDL_URL
	 * @uses XiRatesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiRatesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiRatesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiRatesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiRatesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiRatesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiRatesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiRatesWsdlClass::offsetExists()
	 ...
	 * @uses XiRatesWsdlClass::getAttributeName()
	 * @uses XiRatesWsdlClass::__toString()
	 * @uses XiRatesWsdlClass::_set()
	 * @uses XiRatesWsdlClass::_get()
	 * @uses XiRatesWsdlClass::setInternArrayToIterate()
	 * @uses XiRatesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiRatesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiRatesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiRatesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
