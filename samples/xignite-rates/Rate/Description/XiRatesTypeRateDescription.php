<?php
/**
 * Class file for XiRatesTypeRateDescription
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeRateDescription
 * @date 08/07/2012
 */
class XiRatesTypeRateDescription extends XiRatesTypeCommon
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRatesTypeMaturityUnitTypes
	 */
	public $MaturityUnit;
	/**
	 * The MaturityCount
	 ...
	 * @param XiRatesTypeMaturityUnitTypes MaturityUnit
	...
	{
		return ($this->MaturityUnit = XiRatesTypeMaturityUnitTypes::valueIsValid($_MaturityUnit)?$_MaturityUnit:null);
	}
	/**
	 * Get MaturityUnit
	 * @return XiRatesTypeMaturityUnitTypes
	 */
