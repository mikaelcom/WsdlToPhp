<?php
/**
 * Class file for XiRatesTypeRateChart
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeRateChart
 * @date 08/07/2012
 */
class XiRatesTypeRateChart extends XiRatesTypeStockChart
{
	/**
	 * The Rate
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiRatesTypeRateTypes Rate
	...
	{
		XiRatesWsdlClass::__construct(array('Rate'=>$_Rate,'PeriodType'=>$_PeriodType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Width'=>$_Width,'Height'=>$_Height,'Title'=>$_Title,'Style'=>$_Style,'Url'=>$_Url,'Factor'=>$_Factor));
	}
	/**
	 * Set Rate
	...
	{
		return ($this->Rate = XiRatesTypeRateTypes::valueIsValid($_Rate)?$_Rate:null);
	}
	/**
	 * Get Rate
