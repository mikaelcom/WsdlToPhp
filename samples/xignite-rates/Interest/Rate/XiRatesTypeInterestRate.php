<?php
/**
 * Class file for XiRatesTypeInterestRate
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeInterestRate
 * @date 08/07/2012
 */
class XiRatesTypeInterestRate extends XiRatesTypeCommon
{
	/**
	 * The Type
	 * Meta informations :
	...
	{
		XiRatesWsdlClass::__construct(array('Type'=>$_Type,'Date'=>$_Date,'Value'=>$_Value,'Price'=>$_Price,'Spread'=>$_Spread,'Change'=>$_Change,'Text'=>$_Text,'Description'=>$_Description));
	}
	/**
	 * Set Type
