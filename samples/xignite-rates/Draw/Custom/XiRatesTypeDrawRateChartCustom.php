<?php
/**
 * Class file for XiRatesTypeDrawRateChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeDrawRateChartCustom
 * @date 08/07/2012
 */
class XiRatesTypeDrawRateChartCustom extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @return XiRatesTypeDrawRateChartCustom
	 */
	public function __construct($_RateType,$_PeriodType,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height,$_Design = null)
	{
		parent::__construct(array('RateType'=>$_RateType,'PeriodType'=>$_PeriodType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Design'=>$_Design));
	}
	/**
	 * Set RateType
