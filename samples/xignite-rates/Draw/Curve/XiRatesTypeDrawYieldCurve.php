<?php
/**
 * Class file for XiRatesTypeDrawYieldCurve
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeDrawYieldCurve
 * @date 08/07/2012
 */
class XiRatesTypeDrawYieldCurve extends XiRatesWsdlClass
{
	/**
	 * The RateFamilyType
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiRatesTypeDrawYieldCurve
	 */
