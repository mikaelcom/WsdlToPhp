<?php
/**
 * Class file for XiRatesTypeDrawYieldCurvePreset
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeDrawYieldCurvePreset
 * @date 08/07/2012
 */
class XiRatesTypeDrawYieldCurvePreset extends XiRatesWsdlClass
{
	/**
	 * The RateFamilyType
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiRatesTypeDrawYieldCurvePreset
	 */
