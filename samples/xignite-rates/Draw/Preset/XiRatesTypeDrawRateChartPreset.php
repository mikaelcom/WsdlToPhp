<?php
/**
 * Class file for XiRatesTypeDrawRateChartPreset
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeDrawRateChartPreset
 * @date 08/07/2012
 */
class XiRatesTypeDrawRateChartPreset extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiRatesTypeDrawRateChartPreset
	 */
	public function __construct($_RateType,$_PeriodType,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height,$_Preset = null)
	{
		parent::__construct(array('RateType'=>$_RateType,'PeriodType'=>$_PeriodType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Preset'=>$_Preset));
	}
	/**
	 * Set RateType
