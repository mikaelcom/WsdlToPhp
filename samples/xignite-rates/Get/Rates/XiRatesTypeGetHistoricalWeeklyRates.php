<?php
/**
 * Class file for XiRatesTypeGetHistoricalWeeklyRates
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeGetHistoricalWeeklyRates
 * @date 08/07/2012
 */
class XiRatesTypeGetHistoricalWeeklyRates extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @param string ToDate
	 * @return XiRatesTypeGetHistoricalWeeklyRates
	 */
