<?php
/**
 * Class file for XiRatesTypeGetHistoricalRates
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeGetHistoricalRates
 * @date 08/07/2012
 */
class XiRatesTypeGetHistoricalRates extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @param string ToDate
	 * @return XiRatesTypeGetHistoricalRates
	 */
