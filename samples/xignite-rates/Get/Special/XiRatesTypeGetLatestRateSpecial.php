<?php
/**
 * Class file for XiRatesTypeGetLatestRateSpecial
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeGetLatestRateSpecial
 * @date 08/07/2012
 */
class XiRatesTypeGetLatestRateSpecial extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @return XiRatesTypeGetLatestRateSpecial
	 */
