<?php
/**
 * Class file for XiRatesTypeGetTodaysRate
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeGetTodaysRate
 * @date 08/07/2012
 */
class XiRatesTypeGetTodaysRate extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @return XiRatesTypeGetTodaysRate
	 */
