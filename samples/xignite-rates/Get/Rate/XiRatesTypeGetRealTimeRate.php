<?php
/**
 * Class file for XiRatesTypeGetRealTimeRate
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeGetRealTimeRate
 * @date 08/07/2012
 */
class XiRatesTypeGetRealTimeRate extends XiRatesWsdlClass
{
	/**
	 * The RateType
	 * Meta informations :
	 ...
	 * @param string Time
	 * @return XiRatesTypeGetRealTimeRate
	 */
