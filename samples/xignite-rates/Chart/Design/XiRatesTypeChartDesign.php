<?php
/**
 * Class file for XiRatesTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeChartDesign
 * @date 08/07/2012
 */
class XiRatesTypeChartDesign extends XiRatesTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRatesTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiRatesTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiRatesTypeLinePattern GridHorizontalStyle
	 * @param XiRatesTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiRatesTypeImageFrameType FrameType
	 * @param XiRatesTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiRatesTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiRatesTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiRatesTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiRatesTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiRatesTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiRatesTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiRatesTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiRatesTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiRatesTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiRatesTypePredefinedProjection
	 */
	...
	{
		return ($this->TickPrecision = XiRatesTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	 * @return XiRatesTypeTickPeriod
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiRatesTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	...
	{
		return ($this->LightScheme = XiRatesTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiRatesTypePredefinedLightModel
	 */
