<?php
/**
 * Class file for XiRatesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeCommon
 * @date 08/07/2012
 */
class XiRatesTypeCommon extends XiRatesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiRatesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiRatesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiRatesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiRatesTypeOutcomeTypes
	 */
