<?php
/**
 * Class file for XiRatesTypeYieldCurveChart
 * @date 08/07/2012
 */
/**
 * Class XiRatesTypeYieldCurveChart
 * @date 08/07/2012
 */
class XiRatesTypeYieldCurveChart extends XiRatesTypeStockChart
{
	/**
	 * The RateFamily
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiRatesTypeRateFamilyTypes RateFamily
	...
	{
		XiRatesWsdlClass::__construct(array('RateFamily'=>$_RateFamily,'PeriodType'=>$_PeriodType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'GetLatest'=>$_GetLatest,'Width'=>$_Width,'Height'=>$_Height,'Title'=>$_Title,'Style'=>$_Style,'Url'=>$_Url));
	}
	/**
	 * Set RateFamily
	...
	{
		return ($this->RateFamily = XiRatesTypeRateFamilyTypes::valueIsValid($_RateFamily)?$_RateFamily:null);
	}
	/**
	 * Get RateFamily
