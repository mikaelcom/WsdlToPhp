<?php
/**
 * File for YandexSpellWsdlClass to communicate with SOAP service
 * @date 10/07/2012
 */
/**
 * File for YandexSpellWsdlClass to communicate with SOAP service
 ...
 * @date 10/07/2012
 */
class YandexSpellWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses YandexSpellWsdlClass::setLastError()
	 * @uses YandexSpellWsdlClass::initSoapClient()
	 * @uses YandexSpellWsdlClass::initInternArrayToIterate()
	 * @uses YandexSpellWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses YandexSpellWsdlClass::classMap()
	 * @uses YandexSpellWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('YandexSpellClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = YandexSpellClassMap::classMap();
	 ...
	 * @uses YandexSpellWsdlClass::WSDL_CACHE_WSDL
	 * @uses YandexSpellWsdlClass::WSDL_COMPRESSION
	 * @uses YandexSpellWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses YandexSpellWsdlClass::WSDL_ENCODING
	 * @uses YandexSpellWsdlClass::WSDL_EXCPTS
	 * @uses YandexSpellWsdlClass::WSDL_FEATURES
	 * @uses YandexSpellWsdlClass::WSDL_LOGIN
	 * @uses YandexSpellWsdlClass::WSDL_PASSWD
	 * @uses YandexSpellWsdlClass::WSDL_SOAP_VERSION
	 * @uses YandexSpellWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses YandexSpellWsdlClass::WSDL_TRACE
	 * @uses YandexSpellWsdlClass::WSDL_TYPEMAP
	 * @uses YandexSpellWsdlClass::WSDL_URL
	 * @uses YandexSpellWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses YandexSpellWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses YandexSpellWsdlClass::internArrayToIterateIsArray()
	 * @uses YandexSpellWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses YandexSpellWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses YandexSpellWsdlClass::getInternArrayToIterateOffset()
	 * @uses YandexSpellWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses YandexSpellWsdlClass::getInternArrayToIterateOffset()
	 * @uses YandexSpellWsdlClass::offsetExists()
	 ...
	 * @uses YandexSpellWsdlClass::getAttributeName()
	 * @uses YandexSpellWsdlClass::__toString()
	 * @uses YandexSpellWsdlClass::_set()
	 * @uses YandexSpellWsdlClass::_get()
	 * @uses YandexSpellWsdlClass::setInternArrayToIterate()
	 * @uses YandexSpellWsdlClass::setInternArrayToIterateIsArray()
	 * @uses YandexSpellWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses YandexSpellWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses YandexSpellWsdlClass::item()
	 * @uses YandexSpellWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses YandexSpellWsdlClass::getInternArrayToIterateIsArray()
	 * @uses YandexSpellWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
