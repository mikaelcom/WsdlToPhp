<?php
/**
 * File for RFUNSPSCWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFUNSPSCWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFUNSPSCWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFUNSPSCWsdlClass::setLastError()
	 * @uses RFUNSPSCWsdlClass::initSoapClient()
	 * @uses RFUNSPSCWsdlClass::initInternArrayToIterate()
	 * @uses RFUNSPSCWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFUNSPSCWsdlClass::classMap()
	 * @uses RFUNSPSCWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFUNSPSCClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFUNSPSCClassMap::classMap();
	 ...
	 * @uses RFUNSPSCWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFUNSPSCWsdlClass::WSDL_COMPRESSION
	 * @uses RFUNSPSCWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFUNSPSCWsdlClass::WSDL_ENCODING
	 * @uses RFUNSPSCWsdlClass::WSDL_EXCPTS
	 * @uses RFUNSPSCWsdlClass::WSDL_FEATURES
	 * @uses RFUNSPSCWsdlClass::WSDL_LOGIN
	 * @uses RFUNSPSCWsdlClass::WSDL_PASSWD
	 * @uses RFUNSPSCWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFUNSPSCWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFUNSPSCWsdlClass::WSDL_TRACE
	 * @uses RFUNSPSCWsdlClass::WSDL_TYPEMAP
	 * @uses RFUNSPSCWsdlClass::WSDL_URL
	 * @uses RFUNSPSCWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses RFUNSPSCWsdlClass::internArrayToIterateIsArray()
	 * @uses RFUNSPSCWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFUNSPSCWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFUNSPSCWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFUNSPSCWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFUNSPSCWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFUNSPSCWsdlClass::offsetExists()
	 ...
	 * @uses RFUNSPSCWsdlClass::getAttributeName()
	 * @uses RFUNSPSCWsdlClass::__toString()
	 * @uses RFUNSPSCWsdlClass::_set()
	 * @uses RFUNSPSCWsdlClass::_get()
	 * @uses RFUNSPSCWsdlClass::setInternArrayToIterate()
	 * @uses RFUNSPSCWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFUNSPSCWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFUNSPSCWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFUNSPSCWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
