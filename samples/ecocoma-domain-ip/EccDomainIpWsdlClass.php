<?php
/**
 * File for EccDomainIpWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccDomainIpWsdlClass to communicate with SOAP service
 * Documentation : Cocoma IP Web Services.
 * @date 03/07/2012
 */
class EccDomainIpWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccDomainIpWsdlClass::setLastError()
	 * @uses EccDomainIpWsdlClass::initSoapClient()
	 * @uses EccDomainIpWsdlClass::initInternArrayToIterate()
	 * @uses EccDomainIpWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccDomainIpWsdlClass::classMap()
	 * @uses EccDomainIpWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccDomainIpClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccDomainIpClassMap::classMap();
	 ...
	 * @uses EccDomainIpWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccDomainIpWsdlClass::WSDL_COMPRESSION
	 * @uses EccDomainIpWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccDomainIpWsdlClass::WSDL_ENCODING
	 * @uses EccDomainIpWsdlClass::WSDL_EXCPTS
	 * @uses EccDomainIpWsdlClass::WSDL_FEATURES
	 * @uses EccDomainIpWsdlClass::WSDL_LOGIN
	 * @uses EccDomainIpWsdlClass::WSDL_PASSWD
	 * @uses EccDomainIpWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccDomainIpWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccDomainIpWsdlClass::WSDL_TRACE
	 * @uses EccDomainIpWsdlClass::WSDL_TYPEMAP
	 * @uses EccDomainIpWsdlClass::WSDL_URL
	 * @uses EccDomainIpWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccDomainIpWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::internArrayToIterateIsArray()
	 * @uses EccDomainIpWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccDomainIpWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccDomainIpWsdlClass::offsetExists()
	 ...
	 * @uses EccDomainIpWsdlClass::getAttributeName()
	 * @uses EccDomainIpWsdlClass::__toString()
	 * @uses EccDomainIpWsdlClass::_set()
	 * @uses EccDomainIpWsdlClass::_get()
	 * @uses EccDomainIpWsdlClass::setInternArrayToIterate()
	 * @uses EccDomainIpWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccDomainIpWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::item()
	 * @uses EccDomainIpWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccDomainIpWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccDomainIpWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
