<?php
/**
 * Class file for XiFuturesTypeGetDelayedFutureBySession
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetDelayedFutureBySession
 * @date 08/07/2012
 */
class XiFuturesTypeGetDelayedFutureBySession extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiFuturesTypeGetDelayedFutureBySession
	 */
