<?php
/**
 * Class file for XiFuturesTypeGetIntradayFutureChart
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetIntradayFutureChart
 * @date 08/07/2012
 */
class XiFuturesTypeGetIntradayFutureChart extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiFuturesTypeGetIntradayFutureChart
	 */
