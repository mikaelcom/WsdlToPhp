<?php
/**
 * Class file for XiFuturesTypeGetDelayedFutures
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetDelayedFutures
 * @date 08/07/2012
 */
class XiFuturesTypeGetDelayedFutures extends XiFuturesWsdlClass
{
	/**
	 * The Symbols
	 * Meta informations :
	 ...
	 * @param int Month
	 * @param int Year
	 * @return XiFuturesTypeGetDelayedFutures
	 */
