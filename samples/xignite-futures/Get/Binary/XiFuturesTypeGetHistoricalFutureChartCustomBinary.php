<?php
/**
 * Class file for XiFuturesTypeGetHistoricalFutureChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetHistoricalFutureChartCustomBinary
 * @date 08/07/2012
 */
class XiFuturesTypeGetHistoricalFutureChartCustomBinary extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiFuturesTypeGetHistoricalFutureChartCustomBinary
	 */
