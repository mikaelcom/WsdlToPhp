<?php
/**
 * Class file for XiFuturesTypeGetIntradayFutureChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetIntradayFutureChartCustomBinary
 * @date 08/07/2012
 */
class XiFuturesTypeGetIntradayFutureChartCustomBinary extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiFuturesTypeGetIntradayFutureChartCustomBinary
	 */
