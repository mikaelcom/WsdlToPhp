<?php
/**
 * Class file for XiFuturesTypeGetHistoricalFutureChartBinary
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetHistoricalFutureChartBinary
 * @date 08/07/2012
 */
class XiFuturesTypeGetHistoricalFutureChartBinary extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiFuturesTypeGetHistoricalFutureChartBinary
	 */
