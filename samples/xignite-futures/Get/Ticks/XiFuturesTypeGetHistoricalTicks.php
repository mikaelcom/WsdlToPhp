<?php
/**
 * Class file for XiFuturesTypeGetHistoricalTicks
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetHistoricalTicks
 * @date 08/07/2012
 */
class XiFuturesTypeGetHistoricalTicks extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFuturesTypeHistoricalPeriods
	 */
	 ...
	 * @param int Month
	 * @param int Year
	 * @param XiFuturesTypeHistoricalPeriods HistoricalPeriod
	 * @param string StartTime
	 * @param string EndTime
	 * @param XiFuturesTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @return XiFuturesTypeGetHistoricalTicks
	 */
	...
	{
		return ($this->HistoricalPeriod = XiFuturesTypeHistoricalPeriods::valueIsValid($_HistoricalPeriod)?$_HistoricalPeriod:null);
	}
	/**
