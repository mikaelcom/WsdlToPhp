<?php
/**
 * Class file for XiFuturesTypeGetFutureOption
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetFutureOption
 * @date 08/07/2012
 */
class XiFuturesTypeGetFutureOption extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiFuturesTypeGetFutureOption
	 */
