<?php
/**
 * Class file for XiFuturesTypeGetIntradayFutureChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeGetIntradayFutureChartCustom
 * @date 08/07/2012
 */
class XiFuturesTypeGetIntradayFutureChartCustom extends XiFuturesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiFuturesTypeGetIntradayFutureChartCustom
	 */
