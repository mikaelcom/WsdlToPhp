<?php
/**
 * Class file for XiFuturesTypeMarketHeadline
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeMarketHeadline
 * @date 08/07/2012
 */
class XiFuturesTypeMarketHeadline extends XiFuturesWsdlClass
{
	/**
	 * The ReleaseId
	 * Meta informations :
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFuturesTypeReleaseSource
	 */
	public $Source;
	/**
	 * The Reference
	 ...
	 * @param XiFuturesTypeSecurity Security
	 * @param string Title
	 * @param string Date
	 * @param XiFuturesTypeReleaseSource Source
