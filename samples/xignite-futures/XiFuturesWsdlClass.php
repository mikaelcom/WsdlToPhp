<?php
/**
 * File for XiFuturesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiFuturesWsdlClass to communicate with SOAP service
 * Documentation : Provide delayed and historical commodity quote information from supported exchanges (NYMEX...).
 * @date 08/07/2012
 */
class XiFuturesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiFuturesWsdlClass::setLastError()
	 * @uses XiFuturesWsdlClass::initSoapClient()
	 * @uses XiFuturesWsdlClass::initInternArrayToIterate()
	 * @uses XiFuturesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiFuturesWsdlClass::classMap()
	 * @uses XiFuturesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiFuturesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiFuturesClassMap::classMap();
	 ...
	 * @uses XiFuturesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiFuturesWsdlClass::WSDL_COMPRESSION
	 * @uses XiFuturesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiFuturesWsdlClass::WSDL_ENCODING
	 * @uses XiFuturesWsdlClass::WSDL_EXCPTS
	 * @uses XiFuturesWsdlClass::WSDL_FEATURES
	 * @uses XiFuturesWsdlClass::WSDL_LOGIN
	 * @uses XiFuturesWsdlClass::WSDL_PASSWD
	 * @uses XiFuturesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiFuturesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiFuturesWsdlClass::WSDL_TRACE
	 * @uses XiFuturesWsdlClass::WSDL_TYPEMAP
	 * @uses XiFuturesWsdlClass::WSDL_URL
	 * @uses XiFuturesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiFuturesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiFuturesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiFuturesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiFuturesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFuturesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiFuturesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFuturesWsdlClass::offsetExists()
	 ...
	 * @uses XiFuturesWsdlClass::getAttributeName()
	 * @uses XiFuturesWsdlClass::__toString()
	 * @uses XiFuturesWsdlClass::_set()
	 * @uses XiFuturesWsdlClass::_get()
	 * @uses XiFuturesWsdlClass::setInternArrayToIterate()
	 * @uses XiFuturesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiFuturesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiFuturesWsdlClass::item()
	 * @uses XiFuturesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiFuturesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiFuturesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
