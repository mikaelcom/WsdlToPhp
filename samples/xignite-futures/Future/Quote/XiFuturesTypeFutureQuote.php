<?php
/**
 * Class file for XiFuturesTypeFutureQuote
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeFutureQuote
 * @date 08/07/2012
 */
class XiFuturesTypeFutureQuote extends XiFuturesTypeCommon
{
	/**
	 * The Future
	 * Meta informations :
	...
	{
		XiFuturesWsdlClass::__construct(array('Future'=>$_Future,'Date'=>$_Date,'Time'=>$_Time,'Open'=>$_Open,'High'=>$_High,'Low'=>$_Low,'Last'=>$_Last,'Settle'=>$_Settle,'Volume'=>$_Volume,'OpenInterest'=>$_OpenInterest,'PreviousClose'=>$_PreviousClose,'Change'=>$_Change,'PercentChange'=>$_PercentChange,'Currency'=>$_Currency));
	}
	/**
	 * Set Future
	 * @param Future Future
