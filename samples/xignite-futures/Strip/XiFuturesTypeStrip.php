<?php
/**
 * Class file for XiFuturesTypeStrip
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeStrip
 * @date 08/07/2012
 */
class XiFuturesTypeStrip extends XiFuturesTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	...
	{
		XiFuturesWsdlClass::__construct(array('Symbol'=>$_Symbol,'AsOfDate'=>$_AsOfDate,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'High'=>$_High,'Low'=>$_Low,'Average'=>$_Average,'Total'=>$_Total,'Contracts'=>$_Contracts,'Quotes'=>new XiFuturesTypeArrayOfFutureQuote($_Quotes)));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
