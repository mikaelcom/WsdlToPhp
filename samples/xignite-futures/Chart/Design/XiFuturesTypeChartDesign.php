<?php
/**
 * Class file for XiFuturesTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeChartDesign
 * @date 08/07/2012
 */
class XiFuturesTypeChartDesign extends XiFuturesTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFuturesTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFuturesTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFuturesTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiFuturesTypeLinePattern GridHorizontalStyle
	 * @param XiFuturesTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiFuturesTypeImageFrameType FrameType
	 * @param XiFuturesTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiFuturesTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiFuturesTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiFuturesTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiFuturesTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiFuturesTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiFuturesTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiFuturesTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiFuturesTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiFuturesTypePredefinedProjection
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiFuturesTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiFuturesTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiFuturesTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiFuturesTypePredefinedLightModel
	 */
