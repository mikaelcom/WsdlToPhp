<?php
/**
 * Class file for XiFuturesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeCommon
 * @date 08/07/2012
 */
class XiFuturesTypeCommon extends XiFuturesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiFuturesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiFuturesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiFuturesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiFuturesTypeOutcomeTypes
	 */
