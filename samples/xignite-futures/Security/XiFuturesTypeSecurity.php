<?php
/**
 * Class file for XiFuturesTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypeSecurity
 * @date 08/07/2012
 */
class XiFuturesTypeSecurity extends XiFuturesTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiFuturesWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
