<?php
/**
 * Class file for XiFuturesTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiFuturesTypePredefinedLightModel extends XiFuturesWsdlClass
{
	/**
