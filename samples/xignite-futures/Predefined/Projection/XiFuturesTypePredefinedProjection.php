<?php
/**
 * Class file for XiFuturesTypePredefinedProjection
 * @date 08/07/2012
 */
/**
 * Class XiFuturesTypePredefinedProjection
 * @date 08/07/2012
 */
class XiFuturesTypePredefinedProjection extends XiFuturesWsdlClass
{
	/**
