<?php
/**
 * File for XiChartWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiChartWsdlClass to communicate with SOAP service
 * Documentation : This web service provides historical charts (prices and market capitalization) for US equities.
 * @date 08/07/2012
 */
class XiChartWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiChartWsdlClass::setLastError()
	 * @uses XiChartWsdlClass::initSoapClient()
	 * @uses XiChartWsdlClass::initInternArrayToIterate()
	 * @uses XiChartWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiChartWsdlClass::classMap()
	 * @uses XiChartWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiChartClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiChartClassMap::classMap();
	 ...
	 * @uses XiChartWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiChartWsdlClass::WSDL_COMPRESSION
	 * @uses XiChartWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiChartWsdlClass::WSDL_ENCODING
	 * @uses XiChartWsdlClass::WSDL_EXCPTS
	 * @uses XiChartWsdlClass::WSDL_FEATURES
	 * @uses XiChartWsdlClass::WSDL_LOGIN
	 * @uses XiChartWsdlClass::WSDL_PASSWD
	 * @uses XiChartWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiChartWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiChartWsdlClass::WSDL_TRACE
	 * @uses XiChartWsdlClass::WSDL_TYPEMAP
	 * @uses XiChartWsdlClass::WSDL_URL
	 * @uses XiChartWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiChartWsdlClass::internArrayToIterateIsArray()
	 * @uses XiChartWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiChartWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiChartWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiChartWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiChartWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiChartWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XiChartWsdlClass::offsetGet()
	 * @uses XiChartWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XiChartWsdlClass::getAttributeName()
	 * @uses XiChartWsdlClass::__toString()
	 * @uses XiChartWsdlClass::_set()
	 * @uses XiChartWsdlClass::_get()
	 * @uses XiChartWsdlClass::setInternArrayToIterate()
	 * @uses XiChartWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiChartWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiChartWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiChartWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
