<?php
/**
 * Class file for XiChartTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeChartDesign
 * @date 08/07/2012
 */
class XiChartTypeChartDesign extends XiChartTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiChartTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiChartTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiChartTypeLinePattern GridHorizontalStyle
	 * @param XiChartTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiChartTypeImageFrameType FrameType
	 * @param XiChartTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiChartTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiChartTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiChartTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiChartTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiChartTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiChartTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiChartTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiChartTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiChartTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiChartTypePredefinedProjection
	 */
	...
	{
		return ($this->TickPrecision = XiChartTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	 * @return XiChartTypeTickPeriod
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiChartTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiChartTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiChartTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
