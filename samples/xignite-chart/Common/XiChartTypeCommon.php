<?php
/**
 * Class file for XiChartTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeCommon
 * @date 08/07/2012
 */
class XiChartTypeCommon extends XiChartWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiChartTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiChartTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiChartTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiChartTypeOutcomeTypes
	 */
