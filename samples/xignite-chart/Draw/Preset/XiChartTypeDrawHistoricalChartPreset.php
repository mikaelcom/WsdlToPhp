<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartPreset
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartPreset
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartPreset extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiChartTypeDrawHistoricalChartPreset
	 */
