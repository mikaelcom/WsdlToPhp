<?php
/**
 * Class file for XiChartTypeDrawCapitalizationChartPresetBinary
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawCapitalizationChartPresetBinary
 * @date 08/07/2012
 */
class XiChartTypeDrawCapitalizationChartPresetBinary extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiChartTypeDrawCapitalizationChartPresetBinary
	 */
