<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartCustomBinary
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartCustomBinary extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiChartTypeDrawHistoricalChartCustomBinary
	 */
	public function __construct($_Identifier = null,$_IdentifierType,$_AdditionalSymbols = null,$_PeriodType,$_Style,$_Width,$_Height,$_Design = null)
	{
		parent::__construct(array('Identifier'=>$_Identifier,'IdentifierType'=>$_IdentifierType,'AdditionalSymbols'=>$_AdditionalSymbols,'PeriodType'=>$_PeriodType,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Design'=>$_Design));
	}
	/**
	 * Set Identifier
	 * @param string Identifier
