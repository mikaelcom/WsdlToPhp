<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartByDateBinary
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartByDateBinary
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartByDateBinary extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiChartTypeDrawHistoricalChartByDateBinary
	 */
