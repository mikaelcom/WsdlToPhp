<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartBinary
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartBinary
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartBinary extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiChartTypeDrawHistoricalChartBinary
	 */
