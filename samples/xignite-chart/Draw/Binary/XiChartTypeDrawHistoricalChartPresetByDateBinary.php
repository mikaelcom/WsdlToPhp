<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartPresetByDateBinary
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartPresetByDateBinary
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartPresetByDateBinary extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiChartTypeDrawHistoricalChartPresetByDateBinary
	 */
	public function __construct($_Identifier = null,$_IdentifierType,$_AdditionalSymbols = null,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height,$_Preset = null)
	{
		parent::__construct(array('Identifier'=>$_Identifier,'IdentifierType'=>$_IdentifierType,'AdditionalSymbols'=>$_AdditionalSymbols,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Preset'=>$_Preset));
	}
	/**
	 * Set Identifier
	 * @param string Identifier
