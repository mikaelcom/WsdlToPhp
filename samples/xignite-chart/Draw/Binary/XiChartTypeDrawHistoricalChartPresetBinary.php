<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartPresetBinary
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartPresetBinary
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartPresetBinary extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiChartTypeDrawHistoricalChartPresetBinary
	 */
	public function __construct($_Identifier = null,$_IdentifierType,$_AdditionalSymbols = null,$_PeriodType,$_Style,$_Width,$_Height,$_Preset = null)
	{
		parent::__construct(array('Identifier'=>$_Identifier,'IdentifierType'=>$_IdentifierType,'AdditionalSymbols'=>$_AdditionalSymbols,'PeriodType'=>$_PeriodType,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Preset'=>$_Preset));
	}
	/**
	 * Set Identifier
	 * @param string Identifier
