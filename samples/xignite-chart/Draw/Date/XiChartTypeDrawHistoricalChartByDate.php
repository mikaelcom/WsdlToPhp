<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartByDate
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartByDate
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartByDate extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiChartTypeDrawHistoricalChartByDate
	 */
