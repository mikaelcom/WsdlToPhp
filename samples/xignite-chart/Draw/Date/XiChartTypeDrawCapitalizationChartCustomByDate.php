<?php
/**
 * Class file for XiChartTypeDrawCapitalizationChartCustomByDate
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawCapitalizationChartCustomByDate
 * @date 08/07/2012
 */
class XiChartTypeDrawCapitalizationChartCustomByDate extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiChartTypeDrawCapitalizationChartCustomByDate
	 */
