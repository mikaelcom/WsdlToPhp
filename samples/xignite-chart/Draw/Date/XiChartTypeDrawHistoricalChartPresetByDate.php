<?php
/**
 * Class file for XiChartTypeDrawHistoricalChartPresetByDate
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawHistoricalChartPresetByDate
 * @date 08/07/2012
 */
class XiChartTypeDrawHistoricalChartPresetByDate extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiChartTypeDrawHistoricalChartPresetByDate
	 */
