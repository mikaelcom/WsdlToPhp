<?php
/**
 * Class file for XiChartTypeDrawCapitalizationChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawCapitalizationChartCustom
 * @date 08/07/2012
 */
class XiChartTypeDrawCapitalizationChartCustom extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiChartTypeDrawCapitalizationChartCustom
	 */
