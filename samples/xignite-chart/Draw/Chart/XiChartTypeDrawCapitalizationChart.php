<?php
/**
 * Class file for XiChartTypeDrawCapitalizationChart
 * @date 08/07/2012
 */
/**
 * Class XiChartTypeDrawCapitalizationChart
 * @date 08/07/2012
 */
class XiChartTypeDrawCapitalizationChart extends XiChartWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Width
	 * @param int Height
	 * @return XiChartTypeDrawCapitalizationChart
	 */
