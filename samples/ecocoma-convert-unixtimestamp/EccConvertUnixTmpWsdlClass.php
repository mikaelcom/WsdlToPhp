<?php
/**
 * File for EccConvertUnixTmpWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccConvertUnixTmpWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Unix Timestamp Convert Web Services.
 * @date 03/07/2012
 */
class EccConvertUnixTmpWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccConvertUnixTmpWsdlClass::setLastError()
	 * @uses EccConvertUnixTmpWsdlClass::initSoapClient()
	 * @uses EccConvertUnixTmpWsdlClass::initInternArrayToIterate()
	 * @uses EccConvertUnixTmpWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccConvertUnixTmpWsdlClass::classMap()
	 * @uses EccConvertUnixTmpWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccConvertUnixTmpClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccConvertUnixTmpClassMap::classMap();
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_COMPRESSION
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_ENCODING
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_EXCPTS
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_FEATURES
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_LOGIN
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_PASSWD
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_TRACE
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_TYPEMAP
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_URL
	 * @uses EccConvertUnixTmpWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccConvertUnixTmpWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::internArrayToIterateIsArray()
	 * @uses EccConvertUnixTmpWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertUnixTmpWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertUnixTmpWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccConvertUnixTmpWsdlClass::offsetGet()
	 * @uses EccConvertUnixTmpWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::getAttributeName()
	 * @uses EccConvertUnixTmpWsdlClass::__toString()
	 * @uses EccConvertUnixTmpWsdlClass::_set()
	 * @uses EccConvertUnixTmpWsdlClass::_get()
	 * @uses EccConvertUnixTmpWsdlClass::setInternArrayToIterate()
	 * @uses EccConvertUnixTmpWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccConvertUnixTmpWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::item()
	 * @uses EccConvertUnixTmpWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertUnixTmpWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccConvertUnixTmpWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
