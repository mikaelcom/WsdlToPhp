<?php
/**
 * File for XWebBlogWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebBlogWsdlClass to communicate with SOAP service
 * Documentation : XWebBlog is an XML/SOAP based Web Service which provides integration and management of a Weblog (Blog) to client applications. For complete documentation please visit http://www.xwebservices.com/Web_Services/XWebBlog/.
 * @date 09/07/2012
 */
class XWebBlogWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebBlogWsdlClass::setLastError()
	 * @uses XWebBlogWsdlClass::initSoapClient()
	 * @uses XWebBlogWsdlClass::initInternArrayToIterate()
	 * @uses XWebBlogWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebBlogWsdlClass::classMap()
	 * @uses XWebBlogWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebBlogClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebBlogClassMap::classMap();
	 ...
	 * @uses XWebBlogWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebBlogWsdlClass::WSDL_COMPRESSION
	 * @uses XWebBlogWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebBlogWsdlClass::WSDL_ENCODING
	 * @uses XWebBlogWsdlClass::WSDL_EXCPTS
	 * @uses XWebBlogWsdlClass::WSDL_FEATURES
	 * @uses XWebBlogWsdlClass::WSDL_LOGIN
	 * @uses XWebBlogWsdlClass::WSDL_PASSWD
	 * @uses XWebBlogWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebBlogWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebBlogWsdlClass::WSDL_TRACE
	 * @uses XWebBlogWsdlClass::WSDL_TYPEMAP
	 * @uses XWebBlogWsdlClass::WSDL_URL
	 * @uses XWebBlogWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XWebBlogWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebBlogWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebBlogWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebBlogWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebBlogWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebBlogWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebBlogWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebBlogWsdlClass::offsetGet()
	 * @uses XWebBlogWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebBlogWsdlClass::getAttributeName()
	 * @uses XWebBlogWsdlClass::__toString()
	 * @uses XWebBlogWsdlClass::_set()
	 * @uses XWebBlogWsdlClass::_get()
	 * @uses XWebBlogWsdlClass::setInternArrayToIterate()
	 * @uses XWebBlogWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebBlogWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebBlogWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebBlogWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
