<?php
/**
 * Class file for XWebBlogTypeProcessReplyRequest
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeProcessReplyRequest
 * @date 09/07/2012
 */
class XWebBlogTypeProcessReplyRequest extends XWebBlogWsdlClass
{
	/**
	 * The Reply
	 * Meta informations :
	 ...
	 * @return XWebBlogTypeProcessReplyRequest
	 */
