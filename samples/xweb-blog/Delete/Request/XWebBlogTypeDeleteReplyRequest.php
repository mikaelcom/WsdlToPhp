<?php
/**
 * Class file for XWebBlogTypeDeleteReplyRequest
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeDeleteReplyRequest
 * @date 09/07/2012
 */
class XWebBlogTypeDeleteReplyRequest extends XWebBlogWsdlClass
{
	/**
	 * The Reply_ID
	 * Meta informations :
	 ...
	 * @return XWebBlogTypeDeleteReplyRequest
	 */
