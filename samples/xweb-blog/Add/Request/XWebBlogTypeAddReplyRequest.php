<?php
/**
 * Class file for XWebBlogTypeAddReplyRequest
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeAddReplyRequest
 * @date 09/07/2012
 */
class XWebBlogTypeAddReplyRequest extends XWebBlogWsdlClass
{
	/**
	 * The Reply
	 * Meta informations :
	 ...
	 * @return XWebBlogTypeAddReplyRequest
	 */
