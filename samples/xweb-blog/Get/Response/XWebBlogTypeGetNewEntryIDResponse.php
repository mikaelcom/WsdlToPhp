<?php
/**
 * Class file for XWebBlogTypeGetNewEntryIDResponse
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeGetNewEntryIDResponse
 * @date 09/07/2012
 */
class XWebBlogTypeGetNewEntryIDResponse extends XWebBlogWsdlClass
{
	/**
	 * The Entry_ID
	 * Meta informations :
