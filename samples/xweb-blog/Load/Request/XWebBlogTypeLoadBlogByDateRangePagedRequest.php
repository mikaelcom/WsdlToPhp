<?php
/**
 * Class file for XWebBlogTypeLoadBlogByDateRangePagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeLoadBlogByDateRangePagedRequest
 * @date 09/07/2012
 */
class XWebBlogTypeLoadBlogByDateRangePagedRequest extends XWebBlogWsdlClass
{
	/**
	 * The Date_Start
	 * Meta informations :
	 ...
	 * @return XWebBlogTypeLoadBlogByDateRangePagedRequest
	 */
