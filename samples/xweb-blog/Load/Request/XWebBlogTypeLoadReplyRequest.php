<?php
/**
 * Class file for XWebBlogTypeLoadReplyRequest
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeLoadReplyRequest
 * @date 09/07/2012
 */
class XWebBlogTypeLoadReplyRequest extends XWebBlogWsdlClass
{
	/**
	 * The Reply_ID
	 * Meta informations :
	 ...
	 * @return XWebBlogTypeLoadReplyRequest
	 */
