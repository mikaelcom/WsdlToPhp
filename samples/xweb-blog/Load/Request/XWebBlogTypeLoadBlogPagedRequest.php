<?php
/**
 * Class file for XWebBlogTypeLoadBlogPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebBlogTypeLoadBlogPagedRequest
 * @date 09/07/2012
 */
class XWebBlogTypeLoadBlogPagedRequest extends XWebBlogWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebBlogTypeLoadBlogPagedRequest
	 */
