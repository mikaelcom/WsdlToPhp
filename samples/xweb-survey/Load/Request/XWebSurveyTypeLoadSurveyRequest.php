<?php
/**
 * Class file for XWebSurveyTypeLoadSurveyRequest
 * @date 09/07/2012
 */
/**
 * Class XWebSurveyTypeLoadSurveyRequest
 * @date 09/07/2012
 */
class XWebSurveyTypeLoadSurveyRequest extends XWebSurveyWsdlClass
{
	/**
	 * The Survey_ID
	 * Meta informations :
	 ...
	 * @return XWebSurveyTypeLoadSurveyRequest
	 */
