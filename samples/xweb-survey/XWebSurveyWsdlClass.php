<?php
/**
 * File for XWebSurveyWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebSurveyWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebSurveyWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebSurveyWsdlClass::setLastError()
	 * @uses XWebSurveyWsdlClass::initSoapClient()
	 * @uses XWebSurveyWsdlClass::initInternArrayToIterate()
	 * @uses XWebSurveyWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebSurveyWsdlClass::classMap()
	 * @uses XWebSurveyWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebSurveyClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebSurveyClassMap::classMap();
	 ...
	 * @uses XWebSurveyWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebSurveyWsdlClass::WSDL_COMPRESSION
	 * @uses XWebSurveyWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebSurveyWsdlClass::WSDL_ENCODING
	 * @uses XWebSurveyWsdlClass::WSDL_EXCPTS
	 * @uses XWebSurveyWsdlClass::WSDL_FEATURES
	 * @uses XWebSurveyWsdlClass::WSDL_LOGIN
	 * @uses XWebSurveyWsdlClass::WSDL_PASSWD
	 * @uses XWebSurveyWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebSurveyWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebSurveyWsdlClass::WSDL_TRACE
	 * @uses XWebSurveyWsdlClass::WSDL_TYPEMAP
	 * @uses XWebSurveyWsdlClass::WSDL_URL
	 * @uses XWebSurveyWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebSurveyWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebSurveyWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebSurveyWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebSurveyWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebSurveyWsdlClass::offsetGet()
	 * @uses XWebSurveyWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::getAttributeName()
	 * @uses XWebSurveyWsdlClass::__toString()
	 * @uses XWebSurveyWsdlClass::_set()
	 * @uses XWebSurveyWsdlClass::_get()
	 * @uses XWebSurveyWsdlClass::setInternArrayToIterate()
	 * @uses XWebSurveyWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebSurveyWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::item()
	 * @uses XWebSurveyWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebSurveyWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebSurveyWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
