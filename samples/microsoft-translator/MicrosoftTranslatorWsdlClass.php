<?php
/**
 * File for MicrosoftTranslatorWsdlClass to communicate with SOAP service
 * @date 05/07/2012
 */
/**
 * File for MicrosoftTranslatorWsdlClass to communicate with SOAP service
 ...
 * @date 05/07/2012
 */
class MicrosoftTranslatorWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses MicrosoftTranslatorWsdlClass::setLastError()
	 * @uses MicrosoftTranslatorWsdlClass::initSoapClient()
	 * @uses MicrosoftTranslatorWsdlClass::initInternArrayToIterate()
	 * @uses MicrosoftTranslatorWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses MicrosoftTranslatorWsdlClass::classMap()
	 * @uses MicrosoftTranslatorWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('MicrosoftTranslatorClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = MicrosoftTranslatorClassMap::classMap();
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_CACHE_WSDL
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_COMPRESSION
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_ENCODING
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_EXCPTS
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_FEATURES
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_LOGIN
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_PASSWD
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_SOAP_VERSION
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_TRACE
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_TYPEMAP
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_URL
	 * @uses MicrosoftTranslatorWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses MicrosoftTranslatorWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::internArrayToIterateIsArray()
	 * @uses MicrosoftTranslatorWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::getInternArrayToIterateOffset()
	 * @uses MicrosoftTranslatorWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::getInternArrayToIterateOffset()
	 * @uses MicrosoftTranslatorWsdlClass::offsetExists()
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::getAttributeName()
	 * @uses MicrosoftTranslatorWsdlClass::__toString()
	 * @uses MicrosoftTranslatorWsdlClass::_set()
	 * @uses MicrosoftTranslatorWsdlClass::_get()
	 * @uses MicrosoftTranslatorWsdlClass::setInternArrayToIterate()
	 * @uses MicrosoftTranslatorWsdlClass::setInternArrayToIterateIsArray()
	 * @uses MicrosoftTranslatorWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::item()
	 * @uses MicrosoftTranslatorWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses MicrosoftTranslatorWsdlClass::getInternArrayToIterateIsArray()
	 * @uses MicrosoftTranslatorWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
