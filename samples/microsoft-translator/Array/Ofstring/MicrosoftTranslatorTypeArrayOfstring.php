<?php
/**
 * Class file for MicrosoftTranslatorTypeArrayOfstring
 * @date 05/07/2012
 */
/**
 * Class MicrosoftTranslatorTypeArrayOfstring
 * @date 05/07/2012
 */
class MicrosoftTranslatorTypeArrayOfstring extends MicrosoftTranslatorWsdlClass
{
	/**
	 * The string
	 * Meta informations :
