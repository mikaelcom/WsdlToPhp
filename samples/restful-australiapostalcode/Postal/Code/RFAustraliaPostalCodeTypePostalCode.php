<?php
/**
 * Class file for RFAustraliaPostalCodeTypePostalCode
 * @date 15/08/2012
 */
/**
 * Class RFAustraliaPostalCodeTypePostalCode
 * @date 15/08/2012
 */
class RFAustraliaPostalCodeTypePostalCode extends RFAustraliaPostalCodeWsdlClass
{
	/**
	 * The CountryCode
	 * Meta informations :
