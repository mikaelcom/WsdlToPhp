<?php
/**
 * File for SPImagingWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPImagingWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPImagingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPImagingWsdlClass::setLastError()
	 * @uses SPImagingWsdlClass::initSoapClient()
	 * @uses SPImagingWsdlClass::initInternArrayToIterate()
	 * @uses SPImagingWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPImagingWsdlClass::classMap()
	 * @uses SPImagingWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPImagingClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPImagingClassMap::classMap();
	 ...
	 * @uses SPImagingWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPImagingWsdlClass::WSDL_COMPRESSION
	 * @uses SPImagingWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPImagingWsdlClass::WSDL_ENCODING
	 * @uses SPImagingWsdlClass::WSDL_EXCPTS
	 * @uses SPImagingWsdlClass::WSDL_FEATURES
	 * @uses SPImagingWsdlClass::WSDL_LOGIN
	 * @uses SPImagingWsdlClass::WSDL_PASSWD
	 * @uses SPImagingWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPImagingWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPImagingWsdlClass::WSDL_TRACE
	 * @uses SPImagingWsdlClass::WSDL_TYPEMAP
	 * @uses SPImagingWsdlClass::WSDL_URL
	 * @uses SPImagingWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPImagingWsdlClass::internArrayToIterateIsArray()
	 * @uses SPImagingWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPImagingWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPImagingWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPImagingWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPImagingWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPImagingWsdlClass::offsetExists()
	 ...
	 * @uses SPImagingWsdlClass::getAttributeName()
	 * @uses SPImagingWsdlClass::__toString()
	 * @uses SPImagingWsdlClass::_set()
	 * @uses SPImagingWsdlClass::_get()
	 * @uses SPImagingWsdlClass::setInternArrayToIterate()
	 * @uses SPImagingWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPImagingWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPImagingWsdlClass::item()
	 * @uses SPImagingWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SPImagingWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPImagingWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
