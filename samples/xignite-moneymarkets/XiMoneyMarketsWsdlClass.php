<?php
/**
 * File for XiMoneyMarketsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiMoneyMarketsWsdlClass to communicate with SOAP service
 * Documentation : Provide information about money market derivatives.
 * @date 08/07/2012
 */
class XiMoneyMarketsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiMoneyMarketsWsdlClass::setLastError()
	 * @uses XiMoneyMarketsWsdlClass::initSoapClient()
	 * @uses XiMoneyMarketsWsdlClass::initInternArrayToIterate()
	 * @uses XiMoneyMarketsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiMoneyMarketsWsdlClass::classMap()
	 * @uses XiMoneyMarketsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiMoneyMarketsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiMoneyMarketsClassMap::classMap();
	 ...
	 * @uses XiMoneyMarketsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiMoneyMarketsWsdlClass::WSDL_COMPRESSION
	 * @uses XiMoneyMarketsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiMoneyMarketsWsdlClass::WSDL_ENCODING
	 * @uses XiMoneyMarketsWsdlClass::WSDL_EXCPTS
	 * @uses XiMoneyMarketsWsdlClass::WSDL_FEATURES
	 * @uses XiMoneyMarketsWsdlClass::WSDL_LOGIN
	 * @uses XiMoneyMarketsWsdlClass::WSDL_PASSWD
	 * @uses XiMoneyMarketsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiMoneyMarketsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiMoneyMarketsWsdlClass::WSDL_TRACE
	 * @uses XiMoneyMarketsWsdlClass::WSDL_TYPEMAP
	 * @uses XiMoneyMarketsWsdlClass::WSDL_URL
	 * @uses XiMoneyMarketsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiMoneyMarketsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiMoneyMarketsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiMoneyMarketsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiMoneyMarketsWsdlClass::offsetExists()
	 ...
	 * @uses XiMoneyMarketsWsdlClass::getAttributeName()
	 * @uses XiMoneyMarketsWsdlClass::__toString()
	 * @uses XiMoneyMarketsWsdlClass::_set()
	 * @uses XiMoneyMarketsWsdlClass::_get()
	 * @uses XiMoneyMarketsWsdlClass::setInternArrayToIterate()
	 * @uses XiMoneyMarketsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiMoneyMarketsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::item()
	 * @uses XiMoneyMarketsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiMoneyMarketsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiMoneyMarketsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
