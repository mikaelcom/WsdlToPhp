<?php
/**
 * Class file for XiMoneyMarketsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiMoneyMarketsTypeHeader
 * @date 08/07/2012
 */
class XiMoneyMarketsTypeHeader extends XiMoneyMarketsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiMoneyMarketsTypeHeader
	 */
