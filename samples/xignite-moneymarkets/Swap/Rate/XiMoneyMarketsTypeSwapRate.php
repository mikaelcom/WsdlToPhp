<?php
/**
 * Class file for XiMoneyMarketsTypeSwapRate
 * @date 08/07/2012
 */
/**
 * Class XiMoneyMarketsTypeSwapRate
 * @date 08/07/2012
 */
class XiMoneyMarketsTypeSwapRate extends XiMoneyMarketsTypeCommon
{
	/**
	 * The Type
	 * Meta informations :
	...
	{
		XiMoneyMarketsWsdlClass::__construct(array('Type'=>$_Type,'Date'=>$_Date,'Currency'=>$_Currency,'Bid'=>$_Bid,'Ask'=>$_Ask,'Mid'=>$_Mid,'Spread'=>$_Spread));
	}
	/**
	 * Set Type
