<?php
/**
 * Class file for XiMoneyMarketsTypeSwapRateTypes
 * @date 08/07/2012
 */
/**
 * Class XiMoneyMarketsTypeSwapRateTypes
 * @date 08/07/2012
 */
class XiMoneyMarketsTypeSwapRateTypes extends XiMoneyMarketsWsdlClass
{
	/**
	...
	/**
	 * Constant for value 'FifteenMonth'
	 * @return string 'FifteenMonth'
	 */
	const VALUE_FIFTEENMONTH = 'FifteenMonth';
	/**
	...
	/**
	 * Constant for value 'TwentyOneMonth'
	 * @return string 'TwentyOneMonth'
	 */
	const VALUE_TWENTYONEMONTH = 'TwentyOneMonth';
	/**
	...
	/**
	 * Constant for value 'ElevenYear'
	 * @return string 'ElevenYear'
	 */
	const VALUE_ELEVENYEAR = 'ElevenYear';
	/**
	...
	/**
	 * Constant for value 'ThirteenYear'
	 * @return string 'ThirteenYear'
	 */
	const VALUE_THIRTEENYEAR = 'ThirteenYear';
	/**
	 * Constant for value 'FourteenYear'
	 * @return string 'FourteenYear'
	 */
	const VALUE_FOURTEENYEAR = 'FourteenYear';
	/**
	...
	/**
	 * Constant for value 'ThirtyFiveYear'
	 * @return string 'ThirtyFiveYear'
	 */
	const VALUE_THIRTYFIVEYEAR = 'ThirtyFiveYear';
	/**
	 * Constant for value 'FortyYear'
	 * @return string 'FortyYear'
	 */
	const VALUE_FORTYYEAR = 'FortyYear';
	/**
	 * Constant for value 'FortyFiveYear'
	 * @return string 'FortyFiveYear'
	 */
	const VALUE_FORTYFIVEYEAR = 'FortyFiveYear';
	/**
	 * Constant for value 'FiftyYear'
	 * @return string 'FiftyYear'
	 */
	const VALUE_FIFTYYEAR = 'FiftyYear';
	/**
	 * Constructor
	...
	{
		return in_array($_value,array(self::VALUE_OVERNIGHT,self::VALUE_ONEWEEK,self::VALUE_TWOWEEK,self::VALUE_ONEMONTH,self::VALUE_TWOMONTH,self::VALUE_THREEMONTH,self::VALUE_FOURMONTH,self::VALUE_FIVEMONTH,self::VALUE_SIXMONTH,self::VALUE_SEVENMONTH,self::VALUE_EIGHTMONTH,self::VALUE_NINEMONTH,self::VALUE_TENMONTH,self::VALUE_ELEVENMONTH,self::VALUE_ONEYEAR,self::VALUE_FIFTEENMONTH,self::VALUE_EIGHTEENMONTH,self::VALUE_TWENTYONEMONTH,self::VALUE_TWOYEAR,self::VALUE_THREEYEAR,self::VALUE_FOURYEAR,self::VALUE_FIVEYEAR,self::VALUE_SIXYEAR,self::VALUE_SEVENYEAR,self::VALUE_EIGHTYEAR,self::VALUE_NINEYEAR,self::VALUE_TENYEAR,self::VALUE_ELEVENYEAR,self::VALUE_TWELVEYEAR,self::VALUE_THIRTEENYEAR,self::VALUE_FOURTEENYEAR,self::VALUE_FIFTEENYEAR,self::VALUE_TWENTYYEAR,self::VALUE_TWENTYFIVEYEAR,self::VALUE_THIRTYYEAR,self::VALUE_THIRTYFIVEYEAR,self::VALUE_FORTYYEAR,self::VALUE_FORTYFIVEYEAR,self::VALUE_FIFTYYEAR));
	}
	/**
