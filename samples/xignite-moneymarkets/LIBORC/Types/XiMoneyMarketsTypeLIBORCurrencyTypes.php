<?php
/**
 * Class file for XiMoneyMarketsTypeLIBORCurrencyTypes
 * @date 08/07/2012
 */
/**
 * Class XiMoneyMarketsTypeLIBORCurrencyTypes
 * @date 08/07/2012
 */
class XiMoneyMarketsTypeLIBORCurrencyTypes extends XiMoneyMarketsWsdlClass
{
	/**
	...
	{
		return in_array($_value,array(self::VALUE_USD,self::VALUE_EUR,self::VALUE_GBP,self::VALUE_CHF,self::VALUE_JPY,self::VALUE_AUD,self::VALUE_CAD,self::VALUE_DKK,self::VALUE_NZD,self::VALUE_NOK,self::VALUE_ISK,self::VALUE_SGD,self::VALUE_PLN,self::VALUE_SEK,self::VALUE_HKD,self::VALUE_BGN,self::VALUE_HUF,self::VALUE_CLP,self::VALUE_INR,self::VALUE_CZK,self::VALUE_KRW,self::VALUE_TRL,self::VALUE_MXN,self::VALUE_ILS,self::VALUE_CNY,self::VALUE_MYR,self::VALUE_PHP,self::VALUE_THB,self::VALUE_VND,self::VALUE_IDR,self::VALUE_TWD,self::VALUE_ZAR,self::VALUE_TRY,self::VALUE_KZT,self::VALUE_PKR,self::VALUE_RUB,self::VALUE_BRL,self::VALUE_SKK,self::VALUE_ARS,self::VALUE_LVL,self::VALUE_COP,self::VALUE_AED,self::VALUE_JOD,self::VALUE_EEK,self::VALUE_LTL));
	}
	/**
