<?php
/**
 * Class file for XiMoneyMarketsTypeRateDescription
 * @date 08/07/2012
 */
/**
 * Class XiMoneyMarketsTypeRateDescription
 * @date 08/07/2012
 */
class XiMoneyMarketsTypeRateDescription extends XiMoneyMarketsTypeCommon
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiMoneyMarketsTypeMaturityUnitTypes
	 */
	public $MaturityUnit;
	/**
	 * The MaturityCount
	 ...
	 * @param XiMoneyMarketsTypeMaturityUnitTypes MaturityUnit
	...
	{
		return ($this->MaturityUnit = XiMoneyMarketsTypeMaturityUnitTypes::valueIsValid($_MaturityUnit)?$_MaturityUnit:null);
	}
	/**
	 * Get MaturityUnit
