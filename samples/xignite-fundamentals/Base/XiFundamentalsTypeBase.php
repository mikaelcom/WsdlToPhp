<?php
/**
 * Class file for XiFundamentalsTypeBase
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeBase
 * @date 08/07/2012
 */
class XiFundamentalsTypeBase extends XiFundamentalsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFundamentalsTypeReportTypes
	 */
	public $ReportType;
	/**
	 * The Unit
	 ...
	 * @param XiFundamentalsTypeReportTypes ReportType
	 * @param string Unit
	 * @param int Decimals
	 * @param string Source
	 * @param string Reference
	 * @param string Description
	 * @return XiFundamentalsTypeBase
	 */
	...
	{
		XiFundamentalsWsdlClass::__construct(array('Security'=>$_Security,'Name'=>$_Name,'ValueType'=>$_ValueType,'Value'=>$_Value,'ExtendedValue'=>$_ExtendedValue,'Date'=>$_Date,'ReportDate'=>$_ReportDate,'FiscalQuarter'=>$_FiscalQuarter,'ReportType'=>$_ReportType,'Unit'=>$_Unit,'Decimals'=>$_Decimals,'Source'=>$_Source,'Reference'=>$_Reference,'Description'=>$_Description));
	}
	/**
	 * Set Security
	...
	{
		return ($this->ReportType = XiFundamentalsTypeReportTypes::valueIsValid($_ReportType)?$_ReportType:null);
	}
	/**
	 * Get ReportType
	 * @return XiFundamentalsTypeReportTypes
	 */
