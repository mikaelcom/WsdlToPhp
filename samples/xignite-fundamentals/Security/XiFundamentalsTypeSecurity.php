<?php
/**
 * Class file for XiFundamentalsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeSecurity
 * @date 08/07/2012
 */
class XiFundamentalsTypeSecurity extends XiFundamentalsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiFundamentalsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
