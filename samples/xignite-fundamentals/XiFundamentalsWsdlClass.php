<?php
/**
 * File for XiFundamentalsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiFundamentalsWsdlClass to communicate with SOAP service
 * Documentation : Provides access to hundreds of fundamental data points for thousands of US and Canadian equities.
 * @date 08/07/2012
 */
class XiFundamentalsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiFundamentalsWsdlClass::setLastError()
	 * @uses XiFundamentalsWsdlClass::initSoapClient()
	 * @uses XiFundamentalsWsdlClass::initInternArrayToIterate()
	 * @uses XiFundamentalsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiFundamentalsWsdlClass::classMap()
	 * @uses XiFundamentalsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiFundamentalsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiFundamentalsClassMap::classMap();
	 ...
	 * @uses XiFundamentalsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiFundamentalsWsdlClass::WSDL_COMPRESSION
	 * @uses XiFundamentalsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiFundamentalsWsdlClass::WSDL_ENCODING
	 * @uses XiFundamentalsWsdlClass::WSDL_EXCPTS
	 * @uses XiFundamentalsWsdlClass::WSDL_FEATURES
	 * @uses XiFundamentalsWsdlClass::WSDL_LOGIN
	 * @uses XiFundamentalsWsdlClass::WSDL_PASSWD
	 * @uses XiFundamentalsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiFundamentalsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiFundamentalsWsdlClass::WSDL_TRACE
	 * @uses XiFundamentalsWsdlClass::WSDL_TYPEMAP
	 * @uses XiFundamentalsWsdlClass::WSDL_URL
	 * @uses XiFundamentalsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiFundamentalsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiFundamentalsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundamentalsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundamentalsWsdlClass::offsetExists()
	 ...
	 * @uses XiFundamentalsWsdlClass::getAttributeName()
	 * @uses XiFundamentalsWsdlClass::__toString()
	 * @uses XiFundamentalsWsdlClass::_set()
	 * @uses XiFundamentalsWsdlClass::_get()
	 * @uses XiFundamentalsWsdlClass::setInternArrayToIterate()
	 * @uses XiFundamentalsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiFundamentalsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::item()
	 * @uses XiFundamentalsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundamentalsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiFundamentalsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
