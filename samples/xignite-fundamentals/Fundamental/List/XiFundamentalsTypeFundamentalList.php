<?php
/**
 * Class file for XiFundamentalsTypeFundamentalList
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeFundamentalList
 * @date 08/07/2012
 */
class XiFundamentalsTypeFundamentalList extends XiFundamentalsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
