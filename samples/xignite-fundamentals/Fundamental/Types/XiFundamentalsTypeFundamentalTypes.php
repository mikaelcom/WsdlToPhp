<?php
/**
 * Class file for XiFundamentalsTypeFundamentalTypes
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeFundamentalTypes
 * @date 08/07/2012
 */
class XiFundamentalsTypeFundamentalTypes extends XiFundamentalsWsdlClass
{
	/**
