<?php
/**
 * Class file for XiFundamentalsTypeExchangeTypes
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeExchangeTypes
 * @date 08/07/2012
 */
class XiFundamentalsTypeExchangeTypes extends XiFundamentalsWsdlClass
{
	/**
