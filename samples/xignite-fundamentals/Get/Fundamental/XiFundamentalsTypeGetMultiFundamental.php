<?php
/**
 * Class file for XiFundamentalsTypeGetMultiFundamental
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeGetMultiFundamental
 * @date 08/07/2012
 */
class XiFundamentalsTypeGetMultiFundamental extends XiFundamentalsWsdlClass
{
	/**
	 * The Types
	 * Meta informations :
	 ...
	 * @return XiFundamentalsTypeGetMultiFundamental
	 */
