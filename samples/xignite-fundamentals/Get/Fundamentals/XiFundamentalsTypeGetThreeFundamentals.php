<?php
/**
 * Class file for XiFundamentalsTypeGetThreeFundamentals
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeGetThreeFundamentals
 * @date 08/07/2012
 */
class XiFundamentalsTypeGetThreeFundamentals extends XiFundamentalsWsdlClass
{
	/**
	 * The Type1
	 * Meta informations :
	 ...
	 * @return XiFundamentalsTypeGetThreeFundamentals
	 */
