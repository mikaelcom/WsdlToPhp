<?php
/**
 * Class file for XiFundamentalsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeHeader
 * @date 08/07/2012
 */
class XiFundamentalsTypeHeader extends XiFundamentalsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiFundamentalsTypeHeader
	 */
