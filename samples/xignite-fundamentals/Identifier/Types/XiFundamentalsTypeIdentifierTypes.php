<?php
/**
 * Class file for XiFundamentalsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiFundamentalsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiFundamentalsTypeIdentifierTypes extends XiFundamentalsWsdlClass
{
	/**
