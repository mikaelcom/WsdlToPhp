<?php
/**
 * Class file for SOFraudProtectionTypeValidateFormAllOptional
 * @date 08/07/2012
 */
/**
 * Class SOFraudProtectionTypeValidateFormAllOptional
 * @date 08/07/2012
 */
class SOFraudProtectionTypeValidateFormAllOptional extends SOFraudProtectionWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return SOFraudProtectionTypeValidateFormAllOptional
	 */
