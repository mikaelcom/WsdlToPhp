<?php
/**
 * Class file for SOFraudProtectionTypeValidateFormAllOptionalNoSMTP
 * @date 08/07/2012
 */
/**
 * Class SOFraudProtectionTypeValidateFormAllOptionalNoSMTP
 * @date 08/07/2012
 */
class SOFraudProtectionTypeValidateFormAllOptionalNoSMTP extends SOFraudProtectionWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return SOFraudProtectionTypeValidateFormAllOptionalNoSMTP
	 */
