<?php
/**
 * Class file for SOFraudProtectionTypeValidateForm
 * @date 08/07/2012
 */
/**
 * Class SOFraudProtectionTypeValidateForm
 * @date 08/07/2012
 */
class SOFraudProtectionTypeValidateForm extends SOFraudProtectionWsdlClass
{
	/**
	 * The Name
	 * Meta informations :
	 ...
	 * @return SOFraudProtectionTypeValidateForm
	 */
