<?php
/**
 * File for SOFraudProtectionWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOFraudProtectionWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOFraudProtectionWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOFraudProtectionWsdlClass::setLastError()
	 * @uses SOFraudProtectionWsdlClass::initSoapClient()
	 * @uses SOFraudProtectionWsdlClass::initInternArrayToIterate()
	 * @uses SOFraudProtectionWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOFraudProtectionWsdlClass::classMap()
	 * @uses SOFraudProtectionWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOFraudProtectionClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOFraudProtectionClassMap::classMap();
	 ...
	 * @uses SOFraudProtectionWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOFraudProtectionWsdlClass::WSDL_COMPRESSION
	 * @uses SOFraudProtectionWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOFraudProtectionWsdlClass::WSDL_ENCODING
	 * @uses SOFraudProtectionWsdlClass::WSDL_EXCPTS
	 * @uses SOFraudProtectionWsdlClass::WSDL_FEATURES
	 * @uses SOFraudProtectionWsdlClass::WSDL_LOGIN
	 * @uses SOFraudProtectionWsdlClass::WSDL_PASSWD
	 * @uses SOFraudProtectionWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOFraudProtectionWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOFraudProtectionWsdlClass::WSDL_TRACE
	 * @uses SOFraudProtectionWsdlClass::WSDL_TYPEMAP
	 * @uses SOFraudProtectionWsdlClass::WSDL_URL
	 * @uses SOFraudProtectionWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOFraudProtectionWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::internArrayToIterateIsArray()
	 * @uses SOFraudProtectionWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFraudProtectionWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFraudProtectionWsdlClass::offsetExists()
	 ...
	 * @uses SOFraudProtectionWsdlClass::getAttributeName()
	 * @uses SOFraudProtectionWsdlClass::__toString()
	 * @uses SOFraudProtectionWsdlClass::_set()
	 * @uses SOFraudProtectionWsdlClass::_get()
	 * @uses SOFraudProtectionWsdlClass::setInternArrayToIterate()
	 * @uses SOFraudProtectionWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOFraudProtectionWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::item()
	 * @uses SOFraudProtectionWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOFraudProtectionWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOFraudProtectionWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
