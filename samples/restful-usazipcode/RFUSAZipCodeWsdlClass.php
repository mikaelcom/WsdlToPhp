<?php
/**
 * File for RFUSAZipCodeWsdlClass to communicate with SOAP service
 * @date 15/08/2012
 */
/**
 * File for RFUSAZipCodeWsdlClass to communicate with SOAP service
 ...
 * @date 15/08/2012
 */
class RFUSAZipCodeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses RFUSAZipCodeWsdlClass::setLastError()
	 * @uses RFUSAZipCodeWsdlClass::initSoapClient()
	 * @uses RFUSAZipCodeWsdlClass::initInternArrayToIterate()
	 * @uses RFUSAZipCodeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses RFUSAZipCodeWsdlClass::classMap()
	 * @uses RFUSAZipCodeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('RFUSAZipCodeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = RFUSAZipCodeClassMap::classMap();
	 ...
	 * @uses RFUSAZipCodeWsdlClass::WSDL_CACHE_WSDL
	 * @uses RFUSAZipCodeWsdlClass::WSDL_COMPRESSION
	 * @uses RFUSAZipCodeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses RFUSAZipCodeWsdlClass::WSDL_ENCODING
	 * @uses RFUSAZipCodeWsdlClass::WSDL_EXCPTS
	 * @uses RFUSAZipCodeWsdlClass::WSDL_FEATURES
	 * @uses RFUSAZipCodeWsdlClass::WSDL_LOGIN
	 * @uses RFUSAZipCodeWsdlClass::WSDL_PASSWD
	 * @uses RFUSAZipCodeWsdlClass::WSDL_SOAP_VERSION
	 * @uses RFUSAZipCodeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses RFUSAZipCodeWsdlClass::WSDL_TRACE
	 * @uses RFUSAZipCodeWsdlClass::WSDL_TYPEMAP
	 * @uses RFUSAZipCodeWsdlClass::WSDL_URL
	 * @uses RFUSAZipCodeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses RFUSAZipCodeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::internArrayToIterateIsArray()
	 * @uses RFUSAZipCodeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFUSAZipCodeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::getInternArrayToIterateOffset()
	 * @uses RFUSAZipCodeWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see RFUSAZipCodeWsdlClass::offsetGet()
	 * @uses RFUSAZipCodeWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::getAttributeName()
	 * @uses RFUSAZipCodeWsdlClass::__toString()
	 * @uses RFUSAZipCodeWsdlClass::_set()
	 * @uses RFUSAZipCodeWsdlClass::_get()
	 * @uses RFUSAZipCodeWsdlClass::setInternArrayToIterate()
	 * @uses RFUSAZipCodeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses RFUSAZipCodeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::item()
	 * @uses RFUSAZipCodeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses RFUSAZipCodeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses RFUSAZipCodeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
