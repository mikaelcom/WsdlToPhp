<?php
/**
 * Class file for RFUSAZipCodeTypeDefaultFaultContract
 * @date 15/08/2012
 */
/**
 * Class RFUSAZipCodeTypeDefaultFaultContract
 * @date 15/08/2012
 */
class RFUSAZipCodeTypeDefaultFaultContract extends RFUSAZipCodeWsdlClass
{
	/**
	 * The ErrorId
	 * @var int
	 ...
	 * @param RFUSAZipCodeTypeGuid CorrelationId
	 * @return RFUSAZipCodeTypeDefaultFaultContract
	 */
