<?php
/**
 * Class file for EccVideoMsnTypeGetVideo
 * @date 03/07/2012
 */
/**
 * Class EccVideoMsnTypeGetVideo
 * @date 03/07/2012
 */
class EccVideoMsnTypeGetVideo extends EccVideoMsnWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccVideoMsnTypeGetVideo
	 */
