<?php
/**
 * File for EccVideoMsnWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccVideoMsnWsdlClass to communicate with SOAP service
 * Documentation : Cocoma MSN Video Web Services.
 * @date 03/07/2012
 */
class EccVideoMsnWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccVideoMsnWsdlClass::setLastError()
	 * @uses EccVideoMsnWsdlClass::initSoapClient()
	 * @uses EccVideoMsnWsdlClass::initInternArrayToIterate()
	 * @uses EccVideoMsnWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccVideoMsnWsdlClass::classMap()
	 * @uses EccVideoMsnWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccVideoMsnClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccVideoMsnClassMap::classMap();
	 ...
	 * @uses EccVideoMsnWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccVideoMsnWsdlClass::WSDL_COMPRESSION
	 * @uses EccVideoMsnWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccVideoMsnWsdlClass::WSDL_ENCODING
	 * @uses EccVideoMsnWsdlClass::WSDL_EXCPTS
	 * @uses EccVideoMsnWsdlClass::WSDL_FEATURES
	 * @uses EccVideoMsnWsdlClass::WSDL_LOGIN
	 * @uses EccVideoMsnWsdlClass::WSDL_PASSWD
	 * @uses EccVideoMsnWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccVideoMsnWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccVideoMsnWsdlClass::WSDL_TRACE
	 * @uses EccVideoMsnWsdlClass::WSDL_TYPEMAP
	 * @uses EccVideoMsnWsdlClass::WSDL_URL
	 * @uses EccVideoMsnWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccVideoMsnWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::internArrayToIterateIsArray()
	 * @uses EccVideoMsnWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccVideoMsnWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccVideoMsnWsdlClass::offsetExists()
	 ...
	 * @uses EccVideoMsnWsdlClass::getAttributeName()
	 * @uses EccVideoMsnWsdlClass::__toString()
	 * @uses EccVideoMsnWsdlClass::_set()
	 * @uses EccVideoMsnWsdlClass::_get()
	 * @uses EccVideoMsnWsdlClass::setInternArrayToIterate()
	 * @uses EccVideoMsnWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccVideoMsnWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::item()
	 * @uses EccVideoMsnWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccVideoMsnWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccVideoMsnWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
