<?php
/**
 * Class file for XiCurrenciesTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeChartDesign
 * @date 08/07/2012
 */
class XiCurrenciesTypeChartDesign extends XiCurrenciesTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiCurrenciesTypeLinePattern
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiCurrenciesTypeImageFrameType
	 */
	public $FrameType;
	/**
	 * The Projection
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiCurrenciesTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiCurrenciesTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiCurrenciesTypeLinePattern GridHorizontalStyle
	 * @param XiCurrenciesTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiCurrenciesTypeImageFrameType FrameType
	 * @param XiCurrenciesTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiCurrenciesTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiCurrenciesTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiCurrenciesTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	 * Get GridHorizontalStyle
	 * @return XiCurrenciesTypeLinePattern
	 */
	...
	{
		return ($this->GridVerticalStyle = XiCurrenciesTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiCurrenciesTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiCurrenciesTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiCurrenciesTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiCurrenciesTypePredefinedProjection
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiCurrenciesTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiCurrenciesTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiCurrenciesTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiCurrenciesTypePredefinedLightModel
	 */
