<?php
/**
 * Class file for XiCurrenciesTypeGetCurrencyChartCustomBinary
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetCurrencyChartCustomBinary
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetCurrencyChartCustomBinary extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiCurrenciesTypeGetCurrencyChartCustomBinary
	 */
	public function __construct($_Symbol = null,$_PeriodType,$_StartDate = null,$_EndDate = null,$_Style,$_Width,$_Height,$_Design = null)
	{
		parent::__construct(array('Symbol'=>$_Symbol,'PeriodType'=>$_PeriodType,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'Design'=>$_Design));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
