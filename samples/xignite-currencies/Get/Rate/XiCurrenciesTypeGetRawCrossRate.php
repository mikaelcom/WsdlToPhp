<?php
/**
 * Class file for XiCurrenciesTypeGetRawCrossRate
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetRawCrossRate
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetRawCrossRate extends XiCurrenciesWsdlClass
{
	/**
	 * The From
	 * Meta informations :
	 ...
	 * @return XiCurrenciesTypeGetRawCrossRate
	 */
