<?php
/**
 * Class file for XiCurrenciesTypeGetRealTimeCrossRateGMT
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetRealTimeCrossRateGMT
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetRealTimeCrossRateGMT extends XiCurrenciesWsdlClass
{
	/**
	 * The From
	 * Meta informations :
	 ...
	 * @return XiCurrenciesTypeGetRealTimeCrossRateGMT
	 */
