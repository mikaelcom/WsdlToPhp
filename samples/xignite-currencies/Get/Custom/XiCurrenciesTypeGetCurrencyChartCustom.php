<?php
/**
 * Class file for XiCurrenciesTypeGetCurrencyChartCustom
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetCurrencyChartCustom
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetCurrencyChartCustom extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiCurrenciesTypeGetCurrencyChartCustom
	 */
