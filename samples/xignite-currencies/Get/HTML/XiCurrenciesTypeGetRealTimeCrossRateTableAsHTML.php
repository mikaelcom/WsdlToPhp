<?php
/**
 * Class file for XiCurrenciesTypeGetRealTimeCrossRateTableAsHTML
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetRealTimeCrossRateTableAsHTML
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetRealTimeCrossRateTableAsHTML extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbols
	 * Meta informations :
	 ...
	 * @return XiCurrenciesTypeGetRealTimeCrossRateTableAsHTML
	 */
