<?php
/**
 * Class file for XiCurrenciesTypeGetHistoricalHighLow
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetHistoricalHighLow
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetHistoricalHighLow extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @return XiCurrenciesTypeGetHistoricalHighLow
	 */
