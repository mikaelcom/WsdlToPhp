<?php
/**
 * Class file for XiCurrenciesTypeGetHistoricalCrossRatesBidAskAsOf
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetHistoricalCrossRatesBidAskAsOf
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetHistoricalCrossRatesBidAskAsOf extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Periods
	 * @return XiCurrenciesTypeGetHistoricalCrossRatesBidAskAsOf
	 */
