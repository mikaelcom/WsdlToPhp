<?php
/**
 * Class file for XiCurrenciesTypeGetCurrencyIntradayChart
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetCurrencyIntradayChart
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetCurrencyIntradayChart extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param string Preset
	 * @return XiCurrenciesTypeGetCurrencyIntradayChart
	 */
	public function __construct($_Symbol = null,$_StartTime = null,$_EndTime = null,$_TimeZone = null,$_Style,$_Width,$_Height,$_PeriodType = null,$_TickPeriods,$_Preset = null)
	{
		parent::__construct(array('Symbol'=>$_Symbol,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'TimeZone'=>$_TimeZone,'Style'=>$_Style,'Width'=>$_Width,'Height'=>$_Height,'PeriodType'=>$_PeriodType,'TickPeriods'=>$_TickPeriods,'Preset'=>$_Preset));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
