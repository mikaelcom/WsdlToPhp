<?php
/**
 * Class file for XiCurrenciesTypeGetCurrencyChart
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeGetCurrencyChart
 * @date 08/07/2012
 */
class XiCurrenciesTypeGetCurrencyChart extends XiCurrenciesWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiCurrenciesTypeGetCurrencyChart
	 */
