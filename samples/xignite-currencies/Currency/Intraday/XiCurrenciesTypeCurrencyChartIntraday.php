<?php
/**
 * Class file for XiCurrenciesTypeCurrencyChartIntraday
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeCurrencyChartIntraday
 * @date 08/07/2012
 */
class XiCurrenciesTypeCurrencyChartIntraday extends XiCurrenciesTypeStockChart
{
	/**
	 * The PeriodType
	 * Meta informations :
	...
	{
		XiCurrenciesWsdlClass::__construct(array('PeriodType'=>$_PeriodType,'StartTime'=>$_StartTime,'EndTime'=>$_EndTime,'Width'=>$_Width,'Height'=>$_Height,'Title'=>$_Title,'Style'=>$_Style,'Url'=>$_Url));
	}
	/**
	 * Set PeriodType
	 * @param string PeriodType
