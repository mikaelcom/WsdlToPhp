<?php
/**
 * Class file for XiCurrenciesTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeCommon
 * @date 08/07/2012
 */
class XiCurrenciesTypeCommon extends XiCurrenciesWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiCurrenciesTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiCurrenciesTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiCurrenciesTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiCurrenciesTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiCurrenciesTypeOutcomeTypes
	 */
