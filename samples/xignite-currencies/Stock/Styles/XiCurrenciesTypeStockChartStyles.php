<?php
/**
 * Class file for XiCurrenciesTypeStockChartStyles
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeStockChartStyles
 * @date 08/07/2012
 */
class XiCurrenciesTypeStockChartStyles extends XiCurrenciesWsdlClass
{
	/**
