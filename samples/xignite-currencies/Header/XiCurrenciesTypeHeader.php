<?php
/**
 * Class file for XiCurrenciesTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeHeader
 * @date 08/07/2012
 */
class XiCurrenciesTypeHeader extends XiCurrenciesWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
