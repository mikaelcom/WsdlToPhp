<?php
/**
 * File for XiCurrenciesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiCurrenciesWsdlClass to communicate with SOAP service
 * Documentation : Provide real-time currency foreign exchange information and calculations.
 * @date 08/07/2012
 */
class XiCurrenciesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiCurrenciesWsdlClass::setLastError()
	 * @uses XiCurrenciesWsdlClass::initSoapClient()
	 * @uses XiCurrenciesWsdlClass::initInternArrayToIterate()
	 * @uses XiCurrenciesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiCurrenciesWsdlClass::classMap()
	 * @uses XiCurrenciesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiCurrenciesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiCurrenciesClassMap::classMap();
	 ...
	 * @uses XiCurrenciesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiCurrenciesWsdlClass::WSDL_COMPRESSION
	 * @uses XiCurrenciesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiCurrenciesWsdlClass::WSDL_ENCODING
	 * @uses XiCurrenciesWsdlClass::WSDL_EXCPTS
	 * @uses XiCurrenciesWsdlClass::WSDL_FEATURES
	 * @uses XiCurrenciesWsdlClass::WSDL_LOGIN
	 * @uses XiCurrenciesWsdlClass::WSDL_PASSWD
	 * @uses XiCurrenciesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiCurrenciesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiCurrenciesWsdlClass::WSDL_TRACE
	 * @uses XiCurrenciesWsdlClass::WSDL_TYPEMAP
	 * @uses XiCurrenciesWsdlClass::WSDL_URL
	 * @uses XiCurrenciesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiCurrenciesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiCurrenciesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiCurrenciesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiCurrenciesWsdlClass::offsetExists()
	 ...
	 * @uses XiCurrenciesWsdlClass::getAttributeName()
	 * @uses XiCurrenciesWsdlClass::__toString()
	 * @uses XiCurrenciesWsdlClass::_set()
	 * @uses XiCurrenciesWsdlClass::_get()
	 * @uses XiCurrenciesWsdlClass::setInternArrayToIterate()
	 * @uses XiCurrenciesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiCurrenciesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::item()
	 * @uses XiCurrenciesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiCurrenciesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiCurrenciesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
