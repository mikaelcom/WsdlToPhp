<?php
/**
 * Class file for XiCurrenciesTypeAverageHistoricalCrossRate
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeAverageHistoricalCrossRate
 * @date 08/07/2012
 */
class XiCurrenciesTypeAverageHistoricalCrossRate extends XiCurrenciesTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 */
	public function __construct($_Symbol = null,$_Type,$_From = null,$_To = null,$_Date = null,$_First,$_Last,$_High,$_Low,$_Text = null,$_Bid,$_Ask,$_Average)
	{
		XiCurrenciesWsdlClass::__construct(array('Symbol'=>$_Symbol,'Type'=>$_Type,'From'=>$_From,'To'=>$_To,'Date'=>$_Date,'First'=>$_First,'Last'=>$_Last,'High'=>$_High,'Low'=>$_Low,'Text'=>$_Text,'Bid'=>$_Bid,'Ask'=>$_Ask,'Average'=>$_Average));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
