<?php
/**
 * Class file for XiCurrenciesTypePredefinedProjection
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypePredefinedProjection
 * @date 08/07/2012
 */
class XiCurrenciesTypePredefinedProjection extends XiCurrenciesWsdlClass
{
	/**
