<?php
/**
 * Class file for XiCurrenciesTypePredefinedLightModel
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypePredefinedLightModel
 * @date 08/07/2012
 */
class XiCurrenciesTypePredefinedLightModel extends XiCurrenciesWsdlClass
{
	/**
