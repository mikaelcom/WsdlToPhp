<?php
/**
 * Class file for XiCurrenciesTypeFullHistoricalCrossRates
 * @date 08/07/2012
 */
/**
 * Class XiCurrenciesTypeFullHistoricalCrossRates
 * @date 08/07/2012
 */
class XiCurrenciesTypeFullHistoricalCrossRates extends XiCurrenciesTypeCommon
{
	/**
	 * The Symbol
	 * Meta informations :
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiCurrenciesTypeArrayOfFullCrossRateItem
	 */
	public $CrossRates;
	/**
	 * Constructor
	 ...
	 * @param XiCurrenciesTypeArrayOfFullCrossRateItem CrossRates
	...
	{
		XiCurrenciesWsdlClass::__construct(array('Symbol'=>$_Symbol,'From'=>$_From,'To'=>$_To,'StartDate'=>$_StartDate,'EndDate'=>$_EndDate,'CrossRates'=>new XiCurrenciesTypeArrayOfFullCrossRateItem($_CrossRates)));
	}
	/**
	 * Set Symbol
	 * @param string Symbol
	...
	/**
	 * Set CrossRates
	 * @param ArrayOfFullCrossRateItem CrossRates
	 * @return ArrayOfFullCrossRateItem
	 */
