<?php
/**
 * File for SOCurrencyExchangeWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOCurrencyExchangeWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOCurrencyExchangeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOCurrencyExchangeWsdlClass::setLastError()
	 * @uses SOCurrencyExchangeWsdlClass::initSoapClient()
	 * @uses SOCurrencyExchangeWsdlClass::initInternArrayToIterate()
	 * @uses SOCurrencyExchangeWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOCurrencyExchangeWsdlClass::classMap()
	 * @uses SOCurrencyExchangeWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOCurrencyExchangeClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOCurrencyExchangeClassMap::classMap();
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_COMPRESSION
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_ENCODING
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_EXCPTS
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_FEATURES
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_LOGIN
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_PASSWD
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_TRACE
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_TYPEMAP
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_URL
	 * @uses SOCurrencyExchangeWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOCurrencyExchangeWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::internArrayToIterateIsArray()
	 * @uses SOCurrencyExchangeWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOCurrencyExchangeWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOCurrencyExchangeWsdlClass::offsetExists()
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::getAttributeName()
	 * @uses SOCurrencyExchangeWsdlClass::__toString()
	 * @uses SOCurrencyExchangeWsdlClass::_set()
	 * @uses SOCurrencyExchangeWsdlClass::_get()
	 * @uses SOCurrencyExchangeWsdlClass::setInternArrayToIterate()
	 * @uses SOCurrencyExchangeWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOCurrencyExchangeWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::item()
	 * @uses SOCurrencyExchangeWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOCurrencyExchangeWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOCurrencyExchangeWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
