<?php
/**
 * Class file for PPInvoiceTypeUpdateInvoiceResponse
 * @date 02/07/2012
 */
/**
 * Class PPInvoiceTypeUpdateInvoiceResponse
 * Documentation : The response object for UpdateInvoice.
 * @date 02/07/2012
 */
class PPInvoiceTypeUpdateInvoiceResponse extends PPInvoiceWsdlClass
{
	/**
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The invoice's ID.
	 * @var string
	 */
	public $invoiceID;
	/**
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The updated invoice's number.
	 * @var string
	 */
