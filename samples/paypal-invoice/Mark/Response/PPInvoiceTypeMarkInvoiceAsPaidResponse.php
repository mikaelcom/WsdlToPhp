<?php
/**
 * Class file for PPInvoiceTypeMarkInvoiceAsPaidResponse
 * @date 02/07/2012
 */
/**
 * Class PPInvoiceTypeMarkInvoiceAsPaidResponse
 * Documentation : The response object for MarkInvoiceAsPaid.
 * @date 02/07/2012
 */
class PPInvoiceTypeMarkInvoiceAsPaidResponse extends PPInvoiceWsdlClass
{
	/**
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The paid invoice ID.
	 * @var string
	 */
	public $invoiceID;
	/**
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The paid invoice number.
	 * @var string
	 */
