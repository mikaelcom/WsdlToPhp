<?php
/**
 * Class file for PPInvoiceTypeMarkInvoiceAsUnpaidResponse
 * @date 02/07/2012
 */
/**
 * Class PPInvoiceTypeMarkInvoiceAsUnpaidResponse
 * Documentation : The response object for MarkInvoiceAsUnpaid.
 * @date 02/07/2012
 */
class PPInvoiceTypeMarkInvoiceAsUnpaidResponse extends PPInvoiceWsdlClass
{
	/**
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The invoice ID of the invoice that was marked as unpaid.
	 * @var string
	 */
	public $invoiceID;
	/**
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The invoice number of the invoice that was marked as unpaid.
	 * @var string
	 */
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * 	- documentation : The URL of the details page of the invoice that was marked as unpaid.
	 * @var string
	 */
	public $invoiceURL;
	/**
