<?php
/**
 * Class file for PPInvoiceTypeCreateInvoiceResponse
 * @date 02/07/2012
 */
/**
 * Class PPInvoiceTypeCreateInvoiceResponse
 * Documentation : The response object for CreateInvoice.
 * @date 02/07/2012
 */
class PPInvoiceTypeCreateInvoiceResponse extends PPInvoiceWsdlClass
{
	/**
