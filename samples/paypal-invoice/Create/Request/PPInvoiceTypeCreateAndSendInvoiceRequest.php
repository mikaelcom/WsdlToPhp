<?php
/**
 * Class file for PPInvoiceTypeCreateAndSendInvoiceRequest
 * @date 02/07/2012
 */
/**
 * Class PPInvoiceTypeCreateAndSendInvoiceRequest
 * Documentation : The request object for CreateAndSendInvoice.
 * @date 02/07/2012
 */
class PPInvoiceTypeCreateAndSendInvoiceRequest extends PPInvoiceWsdlClass
{
	/**
	 * The requestEnvelope
	 * Meta informations :
	 ...
	 * @return PPInvoiceTypeCreateAndSendInvoiceRequest
	 */
