<?php
/**
 * Class file for XWebNewsTypeDeleteArticleRequest
 * @date 09/07/2012
 */
/**
 * Class XWebNewsTypeDeleteArticleRequest
 * @date 09/07/2012
 */
class XWebNewsTypeDeleteArticleRequest extends XWebNewsWsdlClass
{
	/**
	 * The Article_ID
	 * Meta informations :
	 ...
	 * @return XWebNewsTypeDeleteArticleRequest
	 */
