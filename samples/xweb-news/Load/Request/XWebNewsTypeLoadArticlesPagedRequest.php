<?php
/**
 * Class file for XWebNewsTypeLoadArticlesPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebNewsTypeLoadArticlesPagedRequest
 * @date 09/07/2012
 */
class XWebNewsTypeLoadArticlesPagedRequest extends XWebNewsWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebNewsTypeLoadArticlesPagedRequest
	 */
