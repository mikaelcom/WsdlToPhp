<?php
/**
 * Class file for XWebNewsTypeLoadArticlesBySourceAndDateRangePagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebNewsTypeLoadArticlesBySourceAndDateRangePagedRequest
 * @date 09/07/2012
 */
class XWebNewsTypeLoadArticlesBySourceAndDateRangePagedRequest extends XWebNewsWsdlClass
{
	/**
	 ...
	 * @return XWebNewsTypeLoadArticlesBySourceAndDateRangePagedRequest
	 */
	public function __construct($_Source_Identifier,$_Date_Start,$_Date_End,$_Page_Number,$_Page_Size)
	{
		parent::__construct(array('Source_Identifier'=>$_Source_Identifier,'Date_Start'=>$_Date_Start,'Date_End'=>$_Date_End,'Page_Number'=>$_Page_Number,'Page_Size'=>$_Page_Size));
	}
	/**
