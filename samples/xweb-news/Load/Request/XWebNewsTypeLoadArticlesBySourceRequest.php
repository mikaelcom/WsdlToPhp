<?php
/**
 * Class file for XWebNewsTypeLoadArticlesBySourceRequest
 * @date 09/07/2012
 */
/**
 * Class XWebNewsTypeLoadArticlesBySourceRequest
 * @date 09/07/2012
 */
class XWebNewsTypeLoadArticlesBySourceRequest extends XWebNewsWsdlClass
{
	/**
	 ...
	 * @return XWebNewsTypeLoadArticlesBySourceRequest
	 */
