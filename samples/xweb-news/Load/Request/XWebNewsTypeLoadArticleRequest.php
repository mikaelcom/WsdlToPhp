<?php
/**
 * Class file for XWebNewsTypeLoadArticleRequest
 * @date 09/07/2012
 */
/**
 * Class XWebNewsTypeLoadArticleRequest
 * @date 09/07/2012
 */
class XWebNewsTypeLoadArticleRequest extends XWebNewsWsdlClass
{
	/**
	 * The Article_ID
	 * Meta informations :
	 ...
	 * @return XWebNewsTypeLoadArticleRequest
	 */
