<?php
/**
 * Class file for XWebNewsTypeLoadArticlesBySourcePagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebNewsTypeLoadArticlesBySourcePagedRequest
 * @date 09/07/2012
 */
class XWebNewsTypeLoadArticlesBySourcePagedRequest extends XWebNewsWsdlClass
{
	/**
	 ...
	 * @return XWebNewsTypeLoadArticlesBySourcePagedRequest
	 */
