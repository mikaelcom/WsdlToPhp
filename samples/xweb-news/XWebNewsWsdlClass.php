<?php
/**
 * File for XWebNewsWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebNewsWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebNewsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebNewsWsdlClass::setLastError()
	 * @uses XWebNewsWsdlClass::initSoapClient()
	 * @uses XWebNewsWsdlClass::initInternArrayToIterate()
	 * @uses XWebNewsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebNewsWsdlClass::classMap()
	 * @uses XWebNewsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebNewsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebNewsClassMap::classMap();
	 ...
	 * @uses XWebNewsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebNewsWsdlClass::WSDL_COMPRESSION
	 * @uses XWebNewsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebNewsWsdlClass::WSDL_ENCODING
	 * @uses XWebNewsWsdlClass::WSDL_EXCPTS
	 * @uses XWebNewsWsdlClass::WSDL_FEATURES
	 * @uses XWebNewsWsdlClass::WSDL_LOGIN
	 * @uses XWebNewsWsdlClass::WSDL_PASSWD
	 * @uses XWebNewsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebNewsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebNewsWsdlClass::WSDL_TRACE
	 * @uses XWebNewsWsdlClass::WSDL_TYPEMAP
	 * @uses XWebNewsWsdlClass::WSDL_URL
	 * @uses XWebNewsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XWebNewsWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebNewsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebNewsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebNewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebNewsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebNewsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebNewsWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebNewsWsdlClass::offsetGet()
	 * @uses XWebNewsWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebNewsWsdlClass::getAttributeName()
	 * @uses XWebNewsWsdlClass::__toString()
	 * @uses XWebNewsWsdlClass::_set()
	 * @uses XWebNewsWsdlClass::_get()
	 * @uses XWebNewsWsdlClass::setInternArrayToIterate()
	 * @uses XWebNewsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebNewsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebNewsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebNewsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
