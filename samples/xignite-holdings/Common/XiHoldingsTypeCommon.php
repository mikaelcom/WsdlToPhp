<?php
/**
 * Class file for XiHoldingsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeCommon
 * @date 08/07/2012
 */
class XiHoldingsTypeCommon extends XiHoldingsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiHoldingsTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiHoldingsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiHoldingsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiHoldingsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiHoldingsTypeOutcomeTypes
	 */
