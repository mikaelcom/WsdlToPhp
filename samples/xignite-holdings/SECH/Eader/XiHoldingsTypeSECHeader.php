<?php
/**
 * Class file for XiHoldingsTypeSECHeader
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeSECHeader
 * @date 08/07/2012
 */
class XiHoldingsTypeSECHeader extends XiHoldingsTypeCommon
{
	/**
	 * The Number
	 * Meta informations :
	 ...
	 * @param string SROS
	 * @param XiHoldingsTypeSECFiler Filer
