<?php
/**
 * Class file for XiHoldingsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeSecurity
 * @date 08/07/2012
 */
class XiHoldingsTypeSecurity extends XiHoldingsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiHoldingsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
