<?php
/**
 * File for XiHoldingsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiHoldingsWsdlClass to communicate with SOAP service
 * Documentation : Provide information on institutional holdings.
 * @date 08/07/2012
 */
class XiHoldingsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiHoldingsWsdlClass::setLastError()
	 * @uses XiHoldingsWsdlClass::initSoapClient()
	 * @uses XiHoldingsWsdlClass::initInternArrayToIterate()
	 * @uses XiHoldingsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiHoldingsWsdlClass::classMap()
	 * @uses XiHoldingsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiHoldingsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiHoldingsClassMap::classMap();
	 ...
	 * @uses XiHoldingsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiHoldingsWsdlClass::WSDL_COMPRESSION
	 * @uses XiHoldingsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiHoldingsWsdlClass::WSDL_ENCODING
	 * @uses XiHoldingsWsdlClass::WSDL_EXCPTS
	 * @uses XiHoldingsWsdlClass::WSDL_FEATURES
	 * @uses XiHoldingsWsdlClass::WSDL_LOGIN
	 * @uses XiHoldingsWsdlClass::WSDL_PASSWD
	 * @uses XiHoldingsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiHoldingsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiHoldingsWsdlClass::WSDL_TRACE
	 * @uses XiHoldingsWsdlClass::WSDL_TYPEMAP
	 * @uses XiHoldingsWsdlClass::WSDL_URL
	 * @uses XiHoldingsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiHoldingsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiHoldingsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiHoldingsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiHoldingsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiHoldingsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiHoldingsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiHoldingsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiHoldingsWsdlClass::offsetExists()
	 ...
	 * @uses XiHoldingsWsdlClass::getAttributeName()
	 * @uses XiHoldingsWsdlClass::__toString()
	 * @uses XiHoldingsWsdlClass::_set()
	 * @uses XiHoldingsWsdlClass::_get()
	 * @uses XiHoldingsWsdlClass::setInternArrayToIterate()
	 * @uses XiHoldingsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiHoldingsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiHoldingsWsdlClass::item()
	 * @uses XiHoldingsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiHoldingsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiHoldingsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
