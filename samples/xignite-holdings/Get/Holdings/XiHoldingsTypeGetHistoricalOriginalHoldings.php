<?php
/**
 * Class file for XiHoldingsTypeGetHistoricalOriginalHoldings
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeGetHistoricalOriginalHoldings
 * @date 08/07/2012
 */
class XiHoldingsTypeGetHistoricalOriginalHoldings extends XiHoldingsWsdlClass
{
	/**
	 * The ManagerCIK
	 * Meta informations :
	 ...
	 * @return XiHoldingsTypeGetHistoricalOriginalHoldings
	 */
