<?php
/**
 * Class file for XiHoldingsTypeGetHistoricalAmendedHoldings
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeGetHistoricalAmendedHoldings
 * @date 08/07/2012
 */
class XiHoldingsTypeGetHistoricalAmendedHoldings extends XiHoldingsWsdlClass
{
	/**
	 * The ManagerCIK
	 * Meta informations :
	 ...
	 * @return XiHoldingsTypeGetHistoricalAmendedHoldings
	 */
