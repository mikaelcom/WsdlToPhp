<?php
/**
 * Class file for XiHoldingsTypeGetFivePercentHoldings
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeGetFivePercentHoldings
 * @date 08/07/2012
 */
class XiHoldingsTypeGetFivePercentHoldings extends XiHoldingsWsdlClass
{
	/**
	 * The ManagerCIK
	 * Meta informations :
	 ...
	 * @return XiHoldingsTypeGetFivePercentHoldings
	 */
