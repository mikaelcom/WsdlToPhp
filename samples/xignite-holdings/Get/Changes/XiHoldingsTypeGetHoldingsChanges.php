<?php
/**
 * Class file for XiHoldingsTypeGetHoldingsChanges
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeGetHoldingsChanges
 * @date 08/07/2012
 */
class XiHoldingsTypeGetHoldingsChanges extends XiHoldingsWsdlClass
{
	/**
	 * The FromDate
	 * Meta informations :
	 ...
	 * @param string ToDate
	 * @return XiHoldingsTypeGetHoldingsChanges
	 */
