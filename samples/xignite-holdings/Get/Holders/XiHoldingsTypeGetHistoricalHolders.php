<?php
/**
 * Class file for XiHoldingsTypeGetHistoricalHolders
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeGetHistoricalHolders
 * @date 08/07/2012
 */
class XiHoldingsTypeGetHistoricalHolders extends XiHoldingsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHoldingsTypeGetHistoricalHolders
	 */
