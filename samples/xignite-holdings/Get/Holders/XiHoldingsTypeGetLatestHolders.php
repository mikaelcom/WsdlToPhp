<?php
/**
 * Class file for XiHoldingsTypeGetLatestHolders
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeGetLatestHolders
 * @date 08/07/2012
 */
class XiHoldingsTypeGetLatestHolders extends XiHoldingsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiHoldingsTypeGetLatestHolders
	 */
