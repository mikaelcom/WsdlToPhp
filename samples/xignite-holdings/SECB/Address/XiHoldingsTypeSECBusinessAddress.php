<?php
/**
 * Class file for XiHoldingsTypeSECBusinessAddress
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeSECBusinessAddress
 * @date 08/07/2012
 */
class XiHoldingsTypeSECBusinessAddress extends XiHoldingsWsdlClass
{
	/**
	 * The Street1
	 * Meta informations :
