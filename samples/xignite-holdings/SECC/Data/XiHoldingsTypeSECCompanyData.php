<?php
/**
 * Class file for XiHoldingsTypeSECCompanyData
 * @date 08/07/2012
 */
/**
 * Class XiHoldingsTypeSECCompanyData
 * @date 08/07/2012
 */
class XiHoldingsTypeSECCompanyData extends XiHoldingsWsdlClass
{
	/**
	 ...
	 * @param XiHoldingsTypeSICCode SICCode
