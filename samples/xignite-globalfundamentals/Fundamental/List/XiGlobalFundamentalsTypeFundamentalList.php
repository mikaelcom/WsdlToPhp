<?php
/**
 * Class file for XiGlobalFundamentalsTypeFundamentalList
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeFundamentalList
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeFundamentalList extends XiGlobalFundamentalsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
