<?php
/**
 * Class file for XiGlobalFundamentalsTypeOutcomeTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeOutcomeTypes
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeOutcomeTypes extends XiGlobalFundamentalsWsdlClass
{
	/**
