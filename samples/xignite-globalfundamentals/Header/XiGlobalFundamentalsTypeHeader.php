<?php
/**
 * Class file for XiGlobalFundamentalsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeHeader
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeHeader extends XiGlobalFundamentalsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
	 ...
	 * @param string Tracer
	 * @return XiGlobalFundamentalsTypeHeader
	 */
