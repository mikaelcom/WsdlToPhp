<?php
/**
 * Class file for XiGlobalFundamentalsTypeIdentifierTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeIdentifierTypes
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeIdentifierTypes extends XiGlobalFundamentalsWsdlClass
{
	/**
