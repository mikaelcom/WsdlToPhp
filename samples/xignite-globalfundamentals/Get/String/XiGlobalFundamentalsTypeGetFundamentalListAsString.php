<?php
/**
 * Class file for XiGlobalFundamentalsTypeGetFundamentalListAsString
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeGetFundamentalListAsString
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeGetFundamentalListAsString extends XiGlobalFundamentalsWsdlClass
{
	/**
	 * The Types
	 * Meta informations :
	 ...
	 * @return XiGlobalFundamentalsTypeGetFundamentalListAsString
	 */
