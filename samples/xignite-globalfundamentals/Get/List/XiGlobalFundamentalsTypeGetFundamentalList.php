<?php
/**
 * Class file for XiGlobalFundamentalsTypeGetFundamentalList
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeGetFundamentalList
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeGetFundamentalList extends XiGlobalFundamentalsWsdlClass
{
	/**
	 * The Types
	 * Meta informations :
	 ...
	 * @return XiGlobalFundamentalsTypeGetFundamentalList
	 */
