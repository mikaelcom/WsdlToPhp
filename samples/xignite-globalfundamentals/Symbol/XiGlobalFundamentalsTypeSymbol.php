<?php
/**
 * Class file for XiGlobalFundamentalsTypeSymbol
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeSymbol
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeSymbol extends XiGlobalFundamentalsWsdlClass
{
	/**
	 * The Symbol
	 * Meta informations :
