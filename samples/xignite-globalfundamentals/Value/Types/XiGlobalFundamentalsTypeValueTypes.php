<?php
/**
 * Class file for XiGlobalFundamentalsTypeValueTypes
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeValueTypes
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeValueTypes extends XiGlobalFundamentalsWsdlClass
{
	/**
