<?php
/**
 * Class file for XiGlobalFundamentalsTypeBase
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeBase
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeBase extends XiGlobalFundamentalsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiGlobalFundamentalsTypeReportTypes
	 */
	public $ReportType;
	/**
	 * The Unit
	 ...
	 * @param string Value
	 * @param string ExtendedValue
	 * @param string Date
	 * @param string ReportDate
	 * @param string FiscalQuarter
	 * @param XiGlobalFundamentalsTypeReportTypes ReportType
	 * @param string Unit
	 * @param int Decimals
	 * @param string Source
	 * @param string Reference
	 * @param string Description
	 * @return XiGlobalFundamentalsTypeBase
	 */
	public function __construct($_Security = null,$_Name = null,$_ValueType,$_Value = null,$_ExtendedValue = null,$_Date = null,$_ReportDate = null,$_FiscalQuarter = null,$_ReportType,$_Unit = null,$_Decimals,$_Source = null,$_Reference = null,$_Description = null)
	{
		XiGlobalFundamentalsWsdlClass::__construct(array('Security'=>$_Security,'Name'=>$_Name,'ValueType'=>$_ValueType,'Value'=>$_Value,'ExtendedValue'=>$_ExtendedValue,'Date'=>$_Date,'ReportDate'=>$_ReportDate,'FiscalQuarter'=>$_FiscalQuarter,'ReportType'=>$_ReportType,'Unit'=>$_Unit,'Decimals'=>$_Decimals,'Source'=>$_Source,'Reference'=>$_Reference,'Description'=>$_Description));
	}
	/**
	 * Set Security
	...
	{
		return ($this->ReportType = XiGlobalFundamentalsTypeReportTypes::valueIsValid($_ReportType)?$_ReportType:null);
	}
	/**
	 * Get ReportType
