<?php
/**
 * File for XiGlobalFundamentalsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiGlobalFundamentalsWsdlClass to communicate with SOAP service
 * Documentation : Provides access to fundamental data points for thousands of global companies.
 * @date 08/07/2012
 */
class XiGlobalFundamentalsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiGlobalFundamentalsWsdlClass::setLastError()
	 * @uses XiGlobalFundamentalsWsdlClass::initSoapClient()
	 * @uses XiGlobalFundamentalsWsdlClass::initInternArrayToIterate()
	 * @uses XiGlobalFundamentalsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiGlobalFundamentalsWsdlClass::classMap()
	 * @uses XiGlobalFundamentalsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiGlobalFundamentalsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiGlobalFundamentalsClassMap::classMap();
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_COMPRESSION
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_ENCODING
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_EXCPTS
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_FEATURES
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_LOGIN
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_PASSWD
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_TRACE
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_TYPEMAP
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_URL
	 * @uses XiGlobalFundamentalsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiGlobalFundamentalsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiGlobalFundamentalsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalFundamentalsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiGlobalFundamentalsWsdlClass::offsetExists()
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::getAttributeName()
	 * @uses XiGlobalFundamentalsWsdlClass::__toString()
	 * @uses XiGlobalFundamentalsWsdlClass::_set()
	 * @uses XiGlobalFundamentalsWsdlClass::_get()
	 * @uses XiGlobalFundamentalsWsdlClass::setInternArrayToIterate()
	 * @uses XiGlobalFundamentalsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiGlobalFundamentalsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::item()
	 * @uses XiGlobalFundamentalsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiGlobalFundamentalsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiGlobalFundamentalsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
