<?php
/**
 * Class file for XiGlobalFundamentalsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiGlobalFundamentalsTypeSecurity
 * @date 08/07/2012
 */
class XiGlobalFundamentalsTypeSecurity extends XiGlobalFundamentalsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiGlobalFundamentalsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
