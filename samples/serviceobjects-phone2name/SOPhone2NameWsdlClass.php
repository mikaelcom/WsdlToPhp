<?php
/**
 * File for SOPhone2NameWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOPhone2NameWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOPhone2NameWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOPhone2NameWsdlClass::setLastError()
	 * @uses SOPhone2NameWsdlClass::initSoapClient()
	 * @uses SOPhone2NameWsdlClass::initInternArrayToIterate()
	 * @uses SOPhone2NameWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOPhone2NameWsdlClass::classMap()
	 * @uses SOPhone2NameWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOPhone2NameClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOPhone2NameClassMap::classMap();
	 ...
	 * @uses SOPhone2NameWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOPhone2NameWsdlClass::WSDL_COMPRESSION
	 * @uses SOPhone2NameWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOPhone2NameWsdlClass::WSDL_ENCODING
	 * @uses SOPhone2NameWsdlClass::WSDL_EXCPTS
	 * @uses SOPhone2NameWsdlClass::WSDL_FEATURES
	 * @uses SOPhone2NameWsdlClass::WSDL_LOGIN
	 * @uses SOPhone2NameWsdlClass::WSDL_PASSWD
	 * @uses SOPhone2NameWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOPhone2NameWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOPhone2NameWsdlClass::WSDL_TRACE
	 * @uses SOPhone2NameWsdlClass::WSDL_TYPEMAP
	 * @uses SOPhone2NameWsdlClass::WSDL_URL
	 * @uses SOPhone2NameWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOPhone2NameWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::internArrayToIterateIsArray()
	 * @uses SOPhone2NameWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPhone2NameWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOPhone2NameWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOPhone2NameWsdlClass::offsetGet()
	 * @uses SOPhone2NameWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::getAttributeName()
	 * @uses SOPhone2NameWsdlClass::__toString()
	 * @uses SOPhone2NameWsdlClass::_set()
	 * @uses SOPhone2NameWsdlClass::_get()
	 * @uses SOPhone2NameWsdlClass::setInternArrayToIterate()
	 * @uses SOPhone2NameWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOPhone2NameWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::item()
	 * @uses SOPhone2NameWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOPhone2NameWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOPhone2NameWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
