<?php
/**
 * Class file for SOPhone2NameTypeGetNameFromPhone
 * @date 08/07/2012
 */
/**
 * Class SOPhone2NameTypeGetNameFromPhone
 * @date 08/07/2012
 */
class SOPhone2NameTypeGetNameFromPhone extends SOPhone2NameWsdlClass
{
	/**
	 * The PhoneNumber
	 * Meta informations :
	 ...
	 * @return SOPhone2NameTypeGetNameFromPhone
	 */
