<?php
/**
 * Class file for XiFundsTypeChartDesign
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeChartDesign
 * @date 08/07/2012
 */
class XiFundsTypeChartDesign extends XiFundsTypeCommon
{
	/**
	 * The Secure
	 * Meta informations :
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFundsTypePredefinedProjection
	 */
	public $Projection;
	/**
	 * The MarginTop
	 ...
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFundsTypePredefinedLightModel
	 */
	public $LightScheme;
	/**
	 * The FontSizeLegend
	 ...
	 * @param XiFundsTypeLinePattern GridHorizontalStyle
	 * @param XiFundsTypeLinePattern GridVerticalStyle
	 ...
	 * @param XiFundsTypeImageFrameType FrameType
	 * @param XiFundsTypePredefinedProjection Projection
	 * @param int MarginTop
	 ...
	 * @param XiFundsTypeTickPeriod TickPrecision
	 * @param int TickPeriods
	 * @param XiFundsTypeHorzAlign WaterMarkHorizontalAlign
	 * @param XiFundsTypePredefinedLightModel LightScheme
	...
	{
		return ($this->GridHorizontalStyle = XiFundsTypeLinePattern::valueIsValid($_GridHorizontalStyle)?$_GridHorizontalStyle:null);
	}
	/**
	...
	{
		return ($this->GridVerticalStyle = XiFundsTypeLinePattern::valueIsValid($_GridVerticalStyle)?$_GridVerticalStyle:null);
	}
	/**
	...
	{
		return ($this->FrameType = XiFundsTypeImageFrameType::valueIsValid($_FrameType)?$_FrameType:null);
	}
	/**
	 * Get FrameType
	 * @return XiFundsTypeImageFrameType
	 */
	...
	{
		return ($this->Projection = XiFundsTypePredefinedProjection::valueIsValid($_Projection)?$_Projection:null);
	}
	/**
	 * Get Projection
	 * @return XiFundsTypePredefinedProjection
	 */
	...
	{
		return ($this->TickPrecision = XiFundsTypeTickPeriod::valueIsValid($_TickPrecision)?$_TickPrecision:null);
	}
	/**
	 * Get TickPrecision
	 * @return XiFundsTypeTickPeriod
	 */
	...
	{
		return ($this->WaterMarkHorizontalAlign = XiFundsTypeHorzAlign::valueIsValid($_WaterMarkHorizontalAlign)?$_WaterMarkHorizontalAlign:null);
	}
	/**
	 * Get WaterMarkHorizontalAlign
	 * @return XiFundsTypeHorzAlign
	 */
	...
	{
		return ($this->LightScheme = XiFundsTypePredefinedLightModel::valueIsValid($_LightScheme)?$_LightScheme:null);
	}
	/**
	 * Get LightScheme
	 * @return XiFundsTypePredefinedLightModel
	 */
