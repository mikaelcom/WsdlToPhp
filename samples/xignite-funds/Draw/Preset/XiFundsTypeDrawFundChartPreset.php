<?php
/**
 * Class file for XiFundsTypeDrawFundChartPreset
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeDrawFundChartPreset
 * @date 08/07/2012
 */
class XiFundsTypeDrawFundChartPreset extends XiFundsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @param int Height
	 * @param string Preset
	 * @return XiFundsTypeDrawFundChartPreset
	 */
