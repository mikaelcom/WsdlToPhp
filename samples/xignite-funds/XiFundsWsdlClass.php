<?php
/**
 * File for XiFundsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiFundsWsdlClass to communicate with SOAP service
 * Documentation : This web service provides historical US mutual fund pricing.
 * @date 08/07/2012
 */
class XiFundsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiFundsWsdlClass::setLastError()
	 * @uses XiFundsWsdlClass::initSoapClient()
	 * @uses XiFundsWsdlClass::initInternArrayToIterate()
	 * @uses XiFundsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiFundsWsdlClass::classMap()
	 * @uses XiFundsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiFundsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiFundsClassMap::classMap();
	 ...
	 * @uses XiFundsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiFundsWsdlClass::WSDL_COMPRESSION
	 * @uses XiFundsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiFundsWsdlClass::WSDL_ENCODING
	 * @uses XiFundsWsdlClass::WSDL_EXCPTS
	 * @uses XiFundsWsdlClass::WSDL_FEATURES
	 * @uses XiFundsWsdlClass::WSDL_LOGIN
	 * @uses XiFundsWsdlClass::WSDL_PASSWD
	 * @uses XiFundsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiFundsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiFundsWsdlClass::WSDL_TRACE
	 * @uses XiFundsWsdlClass::WSDL_TYPEMAP
	 * @uses XiFundsWsdlClass::WSDL_URL
	 * @uses XiFundsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XiFundsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiFundsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiFundsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiFundsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiFundsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFundsWsdlClass::offsetExists()
	 ...
	 * @uses XiFundsWsdlClass::getAttributeName()
	 * @uses XiFundsWsdlClass::__toString()
	 * @uses XiFundsWsdlClass::_set()
	 * @uses XiFundsWsdlClass::_get()
	 * @uses XiFundsWsdlClass::setInternArrayToIterate()
	 * @uses XiFundsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiFundsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiFundsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiFundsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
