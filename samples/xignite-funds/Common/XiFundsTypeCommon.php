<?php
/**
 * Class file for XiFundsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeCommon
 * @date 08/07/2012
 */
class XiFundsTypeCommon extends XiFundsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	...
	/**
	 * Constructor
	 * @param XiFundsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiFundsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiFundsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiFundsTypeOutcomeTypes
	 */
