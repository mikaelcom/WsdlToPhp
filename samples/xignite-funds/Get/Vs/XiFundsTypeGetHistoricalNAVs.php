<?php
/**
 * Class file for XiFundsTypeGetHistoricalNAVs
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetHistoricalNAVs
 * @date 08/07/2012
 */
class XiFundsTypeGetHistoricalNAVs extends XiFundsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiFundsTypeGetHistoricalNAVs
	 */
