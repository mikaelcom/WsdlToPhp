<?php
/**
 * Class file for XiFundsTypeGetNewSymbols
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetNewSymbols
 * @date 08/07/2012
 */
class XiFundsTypeGetNewSymbols extends XiFundsWsdlClass
{
	/**
	 * The FromDate
	 * Meta informations :
	 ...
	 * @param string ToDate
	 * @return XiFundsTypeGetNewSymbols
	 */
