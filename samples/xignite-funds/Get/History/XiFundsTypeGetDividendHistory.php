<?php
/**
 * Class file for XiFundsTypeGetDividendHistory
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetDividendHistory
 * @date 08/07/2012
 */
class XiFundsTypeGetDividendHistory extends XiFundsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundsTypeGetDividendHistory
	 */
