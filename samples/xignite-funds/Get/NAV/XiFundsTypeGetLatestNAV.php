<?php
/**
 * Class file for XiFundsTypeGetLatestNAV
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetLatestNAV
 * @date 08/07/2012
 */
class XiFundsTypeGetLatestNAV extends XiFundsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundsTypeGetLatestNAV
	 */
