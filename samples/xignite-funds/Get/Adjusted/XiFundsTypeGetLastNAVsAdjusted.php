<?php
/**
 * Class file for XiFundsTypeGetLastNAVsAdjusted
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetLastNAVsAdjusted
 * @date 08/07/2012
 */
class XiFundsTypeGetLastNAVsAdjusted extends XiFundsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiFundsTypeGetLastNAVsAdjusted
	 */
