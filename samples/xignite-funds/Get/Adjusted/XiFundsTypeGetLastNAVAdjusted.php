<?php
/**
 * Class file for XiFundsTypeGetLastNAVAdjusted
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetLastNAVAdjusted
 * @date 08/07/2012
 */
class XiFundsTypeGetLastNAVAdjusted extends XiFundsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundsTypeGetLastNAVAdjusted
	 */
