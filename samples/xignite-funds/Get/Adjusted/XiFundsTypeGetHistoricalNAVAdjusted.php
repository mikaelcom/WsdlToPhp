<?php
/**
 * Class file for XiFundsTypeGetHistoricalNAVAdjusted
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeGetHistoricalNAVAdjusted
 * @date 08/07/2012
 */
class XiFundsTypeGetHistoricalNAVAdjusted extends XiFundsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFundsTypeGetHistoricalNAVAdjusted
	 */
