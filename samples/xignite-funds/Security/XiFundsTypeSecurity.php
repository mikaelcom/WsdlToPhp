<?php
/**
 * Class file for XiFundsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiFundsTypeSecurity
 * @date 08/07/2012
 */
class XiFundsTypeSecurity extends XiFundsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiFundsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
