<?php
/**
 * File for XWebForumWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebForumWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebForumWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebForumWsdlClass::setLastError()
	 * @uses XWebForumWsdlClass::initSoapClient()
	 * @uses XWebForumWsdlClass::initInternArrayToIterate()
	 * @uses XWebForumWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebForumWsdlClass::classMap()
	 * @uses XWebForumWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebForumClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebForumClassMap::classMap();
	 ...
	 * @uses XWebForumWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebForumWsdlClass::WSDL_COMPRESSION
	 * @uses XWebForumWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebForumWsdlClass::WSDL_ENCODING
	 * @uses XWebForumWsdlClass::WSDL_EXCPTS
	 * @uses XWebForumWsdlClass::WSDL_FEATURES
	 * @uses XWebForumWsdlClass::WSDL_LOGIN
	 * @uses XWebForumWsdlClass::WSDL_PASSWD
	 * @uses XWebForumWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebForumWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebForumWsdlClass::WSDL_TRACE
	 * @uses XWebForumWsdlClass::WSDL_TYPEMAP
	 * @uses XWebForumWsdlClass::WSDL_URL
	 * @uses XWebForumWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XWebForumWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebForumWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebForumWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebForumWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebForumWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebForumWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebForumWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebForumWsdlClass::offsetGet()
	 * @uses XWebForumWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebForumWsdlClass::getAttributeName()
	 * @uses XWebForumWsdlClass::__toString()
	 * @uses XWebForumWsdlClass::_set()
	 * @uses XWebForumWsdlClass::_get()
	 * @uses XWebForumWsdlClass::setInternArrayToIterate()
	 * @uses XWebForumWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebForumWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebForumWsdlClass::item()
	 * @uses XWebForumWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebForumWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebForumWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
