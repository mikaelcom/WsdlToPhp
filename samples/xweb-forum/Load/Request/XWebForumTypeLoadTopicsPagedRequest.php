<?php
/**
 * Class file for XWebForumTypeLoadTopicsPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebForumTypeLoadTopicsPagedRequest
 * @date 09/07/2012
 */
class XWebForumTypeLoadTopicsPagedRequest extends XWebForumWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebForumTypeLoadTopicsPagedRequest
	 */
