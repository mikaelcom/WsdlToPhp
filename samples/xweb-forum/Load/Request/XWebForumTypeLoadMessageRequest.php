<?php
/**
 * Class file for XWebForumTypeLoadMessageRequest
 * @date 09/07/2012
 */
/**
 * Class XWebForumTypeLoadMessageRequest
 * @date 09/07/2012
 */
class XWebForumTypeLoadMessageRequest extends XWebForumWsdlClass
{
	/**
	 * The Message_ID
	 * Meta informations :
	 ...
	 * @return XWebForumTypeLoadMessageRequest
	 */
