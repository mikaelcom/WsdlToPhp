<?php
/**
 * Class file for XWebForumTypeLoadMessagesPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebForumTypeLoadMessagesPagedRequest
 * @date 09/07/2012
 */
class XWebForumTypeLoadMessagesPagedRequest extends XWebForumWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebForumTypeLoadMessagesPagedRequest
	 */
