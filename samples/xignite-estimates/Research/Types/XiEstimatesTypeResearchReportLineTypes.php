<?php
/**
 * Class file for XiEstimatesTypeResearchReportLineTypes
 * @date 08/07/2012
 */
/**
 * Class XiEstimatesTypeResearchReportLineTypes
 * @date 08/07/2012
 */
class XiEstimatesTypeResearchReportLineTypes extends XiEstimatesWsdlClass
{
	/**
