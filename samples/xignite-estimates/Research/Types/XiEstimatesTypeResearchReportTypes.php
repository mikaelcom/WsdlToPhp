<?php
/**
 * Class file for XiEstimatesTypeResearchReportTypes
 * @date 08/07/2012
 */
/**
 * Class XiEstimatesTypeResearchReportTypes
 * @date 08/07/2012
 */
class XiEstimatesTypeResearchReportTypes extends XiEstimatesWsdlClass
{
	/**
