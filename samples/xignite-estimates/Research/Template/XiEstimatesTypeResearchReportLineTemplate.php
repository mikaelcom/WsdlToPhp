<?php
/**
 * Class file for XiEstimatesTypeResearchReportLineTemplate
 * @date 08/07/2012
 */
/**
 * Class XiEstimatesTypeResearchReportLineTemplate
 * @date 08/07/2012
 */
class XiEstimatesTypeResearchReportLineTemplate extends XiEstimatesWsdlClass
{
	/**
	...
	{
		parent::__construct(array('ResearchReportLineType'=>$_ResearchReportLineType,'Name'=>$_Name,'Description'=>$_Description,'Values'=>new XiEstimatesTypeArrayOfString($_Values)));
	}
	/**
