<?php
/**
 * Class file for XiEstimatesTypeEstimatesResearchFieldList
 * @date 08/07/2012
 */
/**
 * Class XiEstimatesTypeEstimatesResearchFieldList
 * @date 08/07/2012
 */
class XiEstimatesTypeEstimatesResearchFieldList extends XiEstimatesTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
