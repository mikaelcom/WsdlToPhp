<?php
/**
 * File for XiEstimatesWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiEstimatesWsdlClass to communicate with SOAP service
 * Documentation : Zacks Estimates
 * @date 08/07/2012
 */
class XiEstimatesWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiEstimatesWsdlClass::setLastError()
	 * @uses XiEstimatesWsdlClass::initSoapClient()
	 * @uses XiEstimatesWsdlClass::initInternArrayToIterate()
	 * @uses XiEstimatesWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiEstimatesWsdlClass::classMap()
	 * @uses XiEstimatesWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiEstimatesClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiEstimatesClassMap::classMap();
	 ...
	 * @uses XiEstimatesWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiEstimatesWsdlClass::WSDL_COMPRESSION
	 * @uses XiEstimatesWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiEstimatesWsdlClass::WSDL_ENCODING
	 * @uses XiEstimatesWsdlClass::WSDL_EXCPTS
	 * @uses XiEstimatesWsdlClass::WSDL_FEATURES
	 * @uses XiEstimatesWsdlClass::WSDL_LOGIN
	 * @uses XiEstimatesWsdlClass::WSDL_PASSWD
	 * @uses XiEstimatesWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiEstimatesWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiEstimatesWsdlClass::WSDL_TRACE
	 * @uses XiEstimatesWsdlClass::WSDL_TYPEMAP
	 * @uses XiEstimatesWsdlClass::WSDL_URL
	 * @uses XiEstimatesWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiEstimatesWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::internArrayToIterateIsArray()
	 * @uses XiEstimatesWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEstimatesWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiEstimatesWsdlClass::offsetExists()
	 ...
	 * @uses XiEstimatesWsdlClass::getAttributeName()
	 * @uses XiEstimatesWsdlClass::__toString()
	 * @uses XiEstimatesWsdlClass::_set()
	 * @uses XiEstimatesWsdlClass::_get()
	 * @uses XiEstimatesWsdlClass::setInternArrayToIterate()
	 * @uses XiEstimatesWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiEstimatesWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::item()
	 * @uses XiEstimatesWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiEstimatesWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiEstimatesWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
