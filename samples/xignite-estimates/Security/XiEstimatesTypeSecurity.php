<?php
/**
 * Class file for XiEstimatesTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiEstimatesTypeSecurity
 * @date 08/07/2012
 */
class XiEstimatesTypeSecurity extends XiEstimatesTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiEstimatesWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
