<?php
/**
 * Class file for XiEstimatesTypeGetMultiResearchField
 * @date 08/07/2012
 */
/**
 * Class XiEstimatesTypeGetMultiResearchField
 * @date 08/07/2012
 */
class XiEstimatesTypeGetMultiResearchField extends XiEstimatesWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiEstimatesTypeGetMultiResearchField
	 */
