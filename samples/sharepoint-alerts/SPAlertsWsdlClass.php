<?php
/**
 * File for SPAlertsWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPAlertsWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPAlertsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPAlertsWsdlClass::setLastError()
	 * @uses SPAlertsWsdlClass::initSoapClient()
	 * @uses SPAlertsWsdlClass::initInternArrayToIterate()
	 * @uses SPAlertsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPAlertsWsdlClass::classMap()
	 * @uses SPAlertsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPAlertsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPAlertsClassMap::classMap();
	 ...
	 * @uses SPAlertsWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPAlertsWsdlClass::WSDL_COMPRESSION
	 * @uses SPAlertsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPAlertsWsdlClass::WSDL_ENCODING
	 * @uses SPAlertsWsdlClass::WSDL_EXCPTS
	 * @uses SPAlertsWsdlClass::WSDL_FEATURES
	 * @uses SPAlertsWsdlClass::WSDL_LOGIN
	 * @uses SPAlertsWsdlClass::WSDL_PASSWD
	 * @uses SPAlertsWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPAlertsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPAlertsWsdlClass::WSDL_TRACE
	 * @uses SPAlertsWsdlClass::WSDL_TYPEMAP
	 * @uses SPAlertsWsdlClass::WSDL_URL
	 * @uses SPAlertsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPAlertsWsdlClass::internArrayToIterateIsArray()
	 * @uses SPAlertsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPAlertsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPAlertsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPAlertsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPAlertsWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPAlertsWsdlClass::offsetExists()
	 ...
	 * @uses SPAlertsWsdlClass::getAttributeName()
	 * @uses SPAlertsWsdlClass::__toString()
	 * @uses SPAlertsWsdlClass::_set()
	 * @uses SPAlertsWsdlClass::_get()
	 * @uses SPAlertsWsdlClass::setInternArrayToIterate()
	 * @uses SPAlertsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPAlertsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPAlertsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPAlertsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
