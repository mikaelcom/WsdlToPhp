<?php
/**
 * File for XWebLeadWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebLeadWsdlClass to communicate with SOAP service
 ...
 * @date 09/07/2012
 */
class XWebLeadWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebLeadWsdlClass::setLastError()
	 * @uses XWebLeadWsdlClass::initSoapClient()
	 * @uses XWebLeadWsdlClass::initInternArrayToIterate()
	 * @uses XWebLeadWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebLeadWsdlClass::classMap()
	 * @uses XWebLeadWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebLeadClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebLeadClassMap::classMap();
	 ...
	 * @uses XWebLeadWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebLeadWsdlClass::WSDL_COMPRESSION
	 * @uses XWebLeadWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebLeadWsdlClass::WSDL_ENCODING
	 * @uses XWebLeadWsdlClass::WSDL_EXCPTS
	 * @uses XWebLeadWsdlClass::WSDL_FEATURES
	 * @uses XWebLeadWsdlClass::WSDL_LOGIN
	 * @uses XWebLeadWsdlClass::WSDL_PASSWD
	 * @uses XWebLeadWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebLeadWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebLeadWsdlClass::WSDL_TRACE
	 * @uses XWebLeadWsdlClass::WSDL_TYPEMAP
	 * @uses XWebLeadWsdlClass::WSDL_URL
	 * @uses XWebLeadWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses XWebLeadWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebLeadWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebLeadWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebLeadWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebLeadWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebLeadWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebLeadWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebLeadWsdlClass::offsetGet()
	 * @uses XWebLeadWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebLeadWsdlClass::getAttributeName()
	 * @uses XWebLeadWsdlClass::__toString()
	 * @uses XWebLeadWsdlClass::_set()
	 * @uses XWebLeadWsdlClass::_get()
	 * @uses XWebLeadWsdlClass::setInternArrayToIterate()
	 * @uses XWebLeadWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebLeadWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebLeadWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebLeadWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
