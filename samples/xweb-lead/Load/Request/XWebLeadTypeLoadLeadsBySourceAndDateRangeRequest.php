<?php
/**
 * Class file for XWebLeadTypeLoadLeadsBySourceAndDateRangeRequest
 * @date 09/07/2012
 */
/**
 * Class XWebLeadTypeLoadLeadsBySourceAndDateRangeRequest
 * @date 09/07/2012
 */
class XWebLeadTypeLoadLeadsBySourceAndDateRangeRequest extends XWebLeadWsdlClass
{
	/**
	 ...
	 * @return XWebLeadTypeLoadLeadsBySourceAndDateRangeRequest
	 */
