<?php
/**
 * Class file for XWebLeadTypeLoadLeadsBySourceAndDateRangePagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebLeadTypeLoadLeadsBySourceAndDateRangePagedRequest
 * @date 09/07/2012
 */
class XWebLeadTypeLoadLeadsBySourceAndDateRangePagedRequest extends XWebLeadWsdlClass
{
	/**
	 ...
	 * @return XWebLeadTypeLoadLeadsBySourceAndDateRangePagedRequest
	 */
