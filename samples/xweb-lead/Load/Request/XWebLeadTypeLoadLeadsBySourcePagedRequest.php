<?php
/**
 * Class file for XWebLeadTypeLoadLeadsBySourcePagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebLeadTypeLoadLeadsBySourcePagedRequest
 * @date 09/07/2012
 */
class XWebLeadTypeLoadLeadsBySourcePagedRequest extends XWebLeadWsdlClass
{
	/**
	 ...
	 * @return XWebLeadTypeLoadLeadsBySourcePagedRequest
	 */
