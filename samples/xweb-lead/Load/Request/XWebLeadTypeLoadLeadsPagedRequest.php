<?php
/**
 * Class file for XWebLeadTypeLoadLeadsPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebLeadTypeLoadLeadsPagedRequest
 * @date 09/07/2012
 */
class XWebLeadTypeLoadLeadsPagedRequest extends XWebLeadWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebLeadTypeLoadLeadsPagedRequest
	 */
