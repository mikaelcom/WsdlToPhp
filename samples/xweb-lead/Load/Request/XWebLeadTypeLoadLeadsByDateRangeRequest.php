<?php
/**
 * Class file for XWebLeadTypeLoadLeadsByDateRangeRequest
 * @date 09/07/2012
 */
/**
 * Class XWebLeadTypeLoadLeadsByDateRangeRequest
 * @date 09/07/2012
 */
class XWebLeadTypeLoadLeadsByDateRangeRequest extends XWebLeadWsdlClass
{
	/**
	 * The Date_Start
	 * Meta informations :
	 ...
	 * @return XWebLeadTypeLoadLeadsByDateRangeRequest
	 */
