<?php
/**
 * Class file for XWebLeadTypeLoadLeadsByDateRangePagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebLeadTypeLoadLeadsByDateRangePagedRequest
 * @date 09/07/2012
 */
class XWebLeadTypeLoadLeadsByDateRangePagedRequest extends XWebLeadWsdlClass
{
	/**
	 * The Date_Start
	 * Meta informations :
	 ...
	 * @return XWebLeadTypeLoadLeadsByDateRangePagedRequest
	 */
