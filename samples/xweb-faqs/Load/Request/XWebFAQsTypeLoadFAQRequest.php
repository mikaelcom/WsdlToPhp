<?php
/**
 * Class file for XWebFAQsTypeLoadFAQRequest
 * @date 09/07/2012
 */
/**
 * Class XWebFAQsTypeLoadFAQRequest
 * @date 09/07/2012
 */
class XWebFAQsTypeLoadFAQRequest extends XWebFAQsWsdlClass
{
	/**
	 * The FAQ_ID
	 * Meta informations :
	 ...
	 * @return XWebFAQsTypeLoadFAQRequest
	 */
