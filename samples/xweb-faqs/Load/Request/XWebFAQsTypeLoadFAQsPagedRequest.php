<?php
/**
 * Class file for XWebFAQsTypeLoadFAQsPagedRequest
 * @date 09/07/2012
 */
/**
 * Class XWebFAQsTypeLoadFAQsPagedRequest
 * @date 09/07/2012
 */
class XWebFAQsTypeLoadFAQsPagedRequest extends XWebFAQsWsdlClass
{
	/**
	 * The Page_Number
	 * Meta informations :
	 ...
	 * @return XWebFAQsTypeLoadFAQsPagedRequest
	 */
