<?php
/**
 * Class file for XWebFAQsTypeDeleteFAQRequest
 * @date 09/07/2012
 */
/**
 * Class XWebFAQsTypeDeleteFAQRequest
 * @date 09/07/2012
 */
class XWebFAQsTypeDeleteFAQRequest extends XWebFAQsWsdlClass
{
	/**
	 * The FAQ_ID
	 * Meta informations :
	 ...
	 * @return XWebFAQsTypeDeleteFAQRequest
	 */
