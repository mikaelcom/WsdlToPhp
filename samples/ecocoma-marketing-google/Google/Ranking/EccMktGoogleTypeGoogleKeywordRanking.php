<?php
/**
 * Class file for EccMktGoogleTypeGoogleKeywordRanking
 * @date 03/07/2012
 */
/**
 * Class EccMktGoogleTypeGoogleKeywordRanking
 * @date 03/07/2012
 */
class EccMktGoogleTypeGoogleKeywordRanking extends EccMktGoogleWsdlClass
{
	/**
	 * The Url
	 * Meta informations :
