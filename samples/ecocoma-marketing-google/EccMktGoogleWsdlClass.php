<?php
/**
 * File for EccMktGoogleWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccMktGoogleWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Google Web Services.
 * @date 03/07/2012
 */
class EccMktGoogleWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccMktGoogleWsdlClass::setLastError()
	 * @uses EccMktGoogleWsdlClass::initSoapClient()
	 * @uses EccMktGoogleWsdlClass::initInternArrayToIterate()
	 * @uses EccMktGoogleWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccMktGoogleWsdlClass::classMap()
	 * @uses EccMktGoogleWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccMktGoogleClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccMktGoogleClassMap::classMap();
	 ...
	 * @uses EccMktGoogleWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccMktGoogleWsdlClass::WSDL_COMPRESSION
	 * @uses EccMktGoogleWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccMktGoogleWsdlClass::WSDL_ENCODING
	 * @uses EccMktGoogleWsdlClass::WSDL_EXCPTS
	 * @uses EccMktGoogleWsdlClass::WSDL_FEATURES
	 * @uses EccMktGoogleWsdlClass::WSDL_LOGIN
	 * @uses EccMktGoogleWsdlClass::WSDL_PASSWD
	 * @uses EccMktGoogleWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccMktGoogleWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccMktGoogleWsdlClass::WSDL_TRACE
	 * @uses EccMktGoogleWsdlClass::WSDL_TYPEMAP
	 * @uses EccMktGoogleWsdlClass::WSDL_URL
	 * @uses EccMktGoogleWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccMktGoogleWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::internArrayToIterateIsArray()
	 * @uses EccMktGoogleWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccMktGoogleWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccMktGoogleWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccMktGoogleWsdlClass::offsetGet()
	 * @uses EccMktGoogleWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::getAttributeName()
	 * @uses EccMktGoogleWsdlClass::__toString()
	 * @uses EccMktGoogleWsdlClass::_set()
	 * @uses EccMktGoogleWsdlClass::_get()
	 * @uses EccMktGoogleWsdlClass::setInternArrayToIterate()
	 * @uses EccMktGoogleWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccMktGoogleWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::item()
	 * @uses EccMktGoogleWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktGoogleWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccMktGoogleWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
