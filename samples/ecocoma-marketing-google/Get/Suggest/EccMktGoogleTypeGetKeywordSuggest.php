<?php
/**
 * Class file for EccMktGoogleTypeGetKeywordSuggest
 * @date 03/07/2012
 */
/**
 * Class EccMktGoogleTypeGetKeywordSuggest
 * @date 03/07/2012
 */
class EccMktGoogleTypeGetKeywordSuggest extends EccMktGoogleWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccMktGoogleTypeGetKeywordSuggest
	 */
