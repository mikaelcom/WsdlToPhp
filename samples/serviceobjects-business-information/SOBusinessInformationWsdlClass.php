<?php
/**
 * File for SOBusinessInformationWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOBusinessInformationWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOBusinessInformationWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOBusinessInformationWsdlClass::setLastError()
	 * @uses SOBusinessInformationWsdlClass::initSoapClient()
	 * @uses SOBusinessInformationWsdlClass::initInternArrayToIterate()
	 * @uses SOBusinessInformationWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOBusinessInformationWsdlClass::classMap()
	 * @uses SOBusinessInformationWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOBusinessInformationClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOBusinessInformationClassMap::classMap();
	 ...
	 * @uses SOBusinessInformationWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOBusinessInformationWsdlClass::WSDL_COMPRESSION
	 * @uses SOBusinessInformationWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOBusinessInformationWsdlClass::WSDL_ENCODING
	 * @uses SOBusinessInformationWsdlClass::WSDL_EXCPTS
	 * @uses SOBusinessInformationWsdlClass::WSDL_FEATURES
	 * @uses SOBusinessInformationWsdlClass::WSDL_LOGIN
	 * @uses SOBusinessInformationWsdlClass::WSDL_PASSWD
	 * @uses SOBusinessInformationWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOBusinessInformationWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOBusinessInformationWsdlClass::WSDL_TRACE
	 * @uses SOBusinessInformationWsdlClass::WSDL_TYPEMAP
	 * @uses SOBusinessInformationWsdlClass::WSDL_URL
	 * @uses SOBusinessInformationWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOBusinessInformationWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::internArrayToIterateIsArray()
	 * @uses SOBusinessInformationWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOBusinessInformationWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOBusinessInformationWsdlClass::offsetExists()
	 ...
	 * @uses SOBusinessInformationWsdlClass::getAttributeName()
	 * @uses SOBusinessInformationWsdlClass::__toString()
	 * @uses SOBusinessInformationWsdlClass::_set()
	 * @uses SOBusinessInformationWsdlClass::_get()
	 * @uses SOBusinessInformationWsdlClass::setInternArrayToIterate()
	 * @uses SOBusinessInformationWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOBusinessInformationWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::item()
	 * @uses SOBusinessInformationWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOBusinessInformationWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOBusinessInformationWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
