<?php
/**
 * Class file for SOBusinessInformationTypeError
 * @date 08/07/2012
 */
/**
 * Class SOBusinessInformationTypeError
 * @date 08/07/2012
 */
class SOBusinessInformationTypeError extends SOBusinessInformationWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
