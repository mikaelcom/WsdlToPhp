<?php
/**
 * Class file for XWebACHDirectoryTypeGetParticipantsByZipCodeResponse
 * @date 09/07/2012
 */
/**
 * Class XWebACHDirectoryTypeGetParticipantsByZipCodeResponse
 * @date 09/07/2012
 */
class XWebACHDirectoryTypeGetParticipantsByZipCodeResponse extends XWebACHDirectoryWsdlClass
{
	/**
	 * The Directory
