<?php
/**
 * Class file for XWebACHDirectoryTypeGetParticipantsByServicingFRBNumberResponse
 * @date 09/07/2012
 */
/**
 * Class XWebACHDirectoryTypeGetParticipantsByServicingFRBNumberResponse
 * @date 09/07/2012
 */
class XWebACHDirectoryTypeGetParticipantsByServicingFRBNumberResponse extends XWebACHDirectoryWsdlClass
{
	/**
	 * The Directory
