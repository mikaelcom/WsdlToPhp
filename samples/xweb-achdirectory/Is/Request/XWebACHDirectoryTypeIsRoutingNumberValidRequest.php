<?php
/**
 * Class file for XWebACHDirectoryTypeIsRoutingNumberValidRequest
 * @date 09/07/2012
 */
/**
 * Class XWebACHDirectoryTypeIsRoutingNumberValidRequest
 * @date 09/07/2012
 */
class XWebACHDirectoryTypeIsRoutingNumberValidRequest extends XWebACHDirectoryWsdlClass
{
	/**
	 * The Routing_Number
	 * @var Routing_Number
	 ...
	 * @return XWebACHDirectoryTypeIsRoutingNumberValidRequest
	 */
