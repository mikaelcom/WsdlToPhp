<?php
/**
 * File for XWebACHDirectoryWsdlClass to communicate with SOAP service
 * @date 09/07/2012
 */
/**
 * File for XWebACHDirectoryWsdlClass to communicate with SOAP service
 * Documentation : XML/SOAP based Web Services which provides a standards-based approach to lookup FedACH Participant RDFIs.
 * @date 09/07/2012
 */
class XWebACHDirectoryWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XWebACHDirectoryWsdlClass::setLastError()
	 * @uses XWebACHDirectoryWsdlClass::initSoapClient()
	 * @uses XWebACHDirectoryWsdlClass::initInternArrayToIterate()
	 * @uses XWebACHDirectoryWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XWebACHDirectoryWsdlClass::classMap()
	 * @uses XWebACHDirectoryWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XWebACHDirectoryClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XWebACHDirectoryClassMap::classMap();
	 ...
	 * @uses XWebACHDirectoryWsdlClass::WSDL_CACHE_WSDL
	 * @uses XWebACHDirectoryWsdlClass::WSDL_COMPRESSION
	 * @uses XWebACHDirectoryWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XWebACHDirectoryWsdlClass::WSDL_ENCODING
	 * @uses XWebACHDirectoryWsdlClass::WSDL_EXCPTS
	 * @uses XWebACHDirectoryWsdlClass::WSDL_FEATURES
	 * @uses XWebACHDirectoryWsdlClass::WSDL_LOGIN
	 * @uses XWebACHDirectoryWsdlClass::WSDL_PASSWD
	 * @uses XWebACHDirectoryWsdlClass::WSDL_SOAP_VERSION
	 * @uses XWebACHDirectoryWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XWebACHDirectoryWsdlClass::WSDL_TRACE
	 * @uses XWebACHDirectoryWsdlClass::WSDL_TYPEMAP
	 * @uses XWebACHDirectoryWsdlClass::WSDL_URL
	 * @uses XWebACHDirectoryWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XWebACHDirectoryWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::internArrayToIterateIsArray()
	 * @uses XWebACHDirectoryWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebACHDirectoryWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::getInternArrayToIterateOffset()
	 * @uses XWebACHDirectoryWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see XWebACHDirectoryWsdlClass::offsetGet()
	 * @uses XWebACHDirectoryWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::getAttributeName()
	 * @uses XWebACHDirectoryWsdlClass::__toString()
	 * @uses XWebACHDirectoryWsdlClass::_set()
	 * @uses XWebACHDirectoryWsdlClass::_get()
	 * @uses XWebACHDirectoryWsdlClass::setInternArrayToIterate()
	 * @uses XWebACHDirectoryWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XWebACHDirectoryWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::item()
	 * @uses XWebACHDirectoryWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XWebACHDirectoryWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XWebACHDirectoryWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
