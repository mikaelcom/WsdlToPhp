<?php
/**
 * Class file for EbayFindTypeFindItemsByImageResponse
 * @date 04/07/2012
 */
/**
 * Class EbayFindTypeFindItemsByImageResponse
 * Documentation : Response container for the findItemsByImage call.
 * @date 04/07/2012
 */
class EbayFindTypeFindItemsByImageResponse extends EbayFindTypeBaseFindingServiceResponse
{
	/**
