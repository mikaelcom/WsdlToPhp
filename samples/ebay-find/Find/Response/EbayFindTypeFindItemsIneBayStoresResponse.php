<?php
/**
 * Class file for EbayFindTypeFindItemsIneBayStoresResponse
 * @date 04/07/2012
 */
/**
 * Class EbayFindTypeFindItemsIneBayStoresResponse
 * Documentation : Response container for the findItemsIneBayStores call.
 * @date 04/07/2012
 */
class EbayFindTypeFindItemsIneBayStoresResponse extends EbayFindTypeBaseFindingServiceResponse
{
	/**
