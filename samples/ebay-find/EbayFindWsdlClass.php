<?php
/**
 * File for EbayFindWsdlClass to communicate with SOAP service
 * @date 04/07/2012
 */
/**
 * File for EbayFindWsdlClass to communicate with SOAP service
 ...
 * @date 04/07/2012
 */
class EbayFindWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EbayFindWsdlClass::setLastError()
	 * @uses EbayFindWsdlClass::initSoapClient()
	 * @uses EbayFindWsdlClass::initInternArrayToIterate()
	 * @uses EbayFindWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EbayFindWsdlClass::classMap()
	 * @uses EbayFindWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EbayFindClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EbayFindClassMap::classMap();
	 ...
	 * @uses EbayFindWsdlClass::WSDL_CACHE_WSDL
	 * @uses EbayFindWsdlClass::WSDL_COMPRESSION
	 * @uses EbayFindWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EbayFindWsdlClass::WSDL_ENCODING
	 * @uses EbayFindWsdlClass::WSDL_EXCPTS
	 * @uses EbayFindWsdlClass::WSDL_FEATURES
	 * @uses EbayFindWsdlClass::WSDL_LOGIN
	 * @uses EbayFindWsdlClass::WSDL_PASSWD
	 * @uses EbayFindWsdlClass::WSDL_SOAP_VERSION
	 * @uses EbayFindWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EbayFindWsdlClass::WSDL_TRACE
	 * @uses EbayFindWsdlClass::WSDL_TYPEMAP
	 * @uses EbayFindWsdlClass::WSDL_URL
	 * @uses EbayFindWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses EbayFindWsdlClass::internArrayToIterateIsArray()
	 * @uses EbayFindWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EbayFindWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EbayFindWsdlClass::getInternArrayToIterateOffset()
	 * @uses EbayFindWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EbayFindWsdlClass::getInternArrayToIterateOffset()
	 * @uses EbayFindWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EbayFindWsdlClass::offsetGet()
	 * @uses EbayFindWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EbayFindWsdlClass::getAttributeName()
	 * @uses EbayFindWsdlClass::__toString()
	 * @uses EbayFindWsdlClass::_set()
	 * @uses EbayFindWsdlClass::_get()
	 * @uses EbayFindWsdlClass::setInternArrayToIterate()
	 * @uses EbayFindWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EbayFindWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EbayFindWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EbayFindWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
