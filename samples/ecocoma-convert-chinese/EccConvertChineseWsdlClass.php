<?php
/**
 * File for EccConvertChineseWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccConvertChineseWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Chinese Convert Web Services.
 * @date 03/07/2012
 */
class EccConvertChineseWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccConvertChineseWsdlClass::setLastError()
	 * @uses EccConvertChineseWsdlClass::initSoapClient()
	 * @uses EccConvertChineseWsdlClass::initInternArrayToIterate()
	 * @uses EccConvertChineseWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccConvertChineseWsdlClass::classMap()
	 * @uses EccConvertChineseWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccConvertChineseClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccConvertChineseClassMap::classMap();
	 ...
	 * @uses EccConvertChineseWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccConvertChineseWsdlClass::WSDL_COMPRESSION
	 * @uses EccConvertChineseWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccConvertChineseWsdlClass::WSDL_ENCODING
	 * @uses EccConvertChineseWsdlClass::WSDL_EXCPTS
	 * @uses EccConvertChineseWsdlClass::WSDL_FEATURES
	 * @uses EccConvertChineseWsdlClass::WSDL_LOGIN
	 * @uses EccConvertChineseWsdlClass::WSDL_PASSWD
	 * @uses EccConvertChineseWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccConvertChineseWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccConvertChineseWsdlClass::WSDL_TRACE
	 * @uses EccConvertChineseWsdlClass::WSDL_TYPEMAP
	 * @uses EccConvertChineseWsdlClass::WSDL_URL
	 * @uses EccConvertChineseWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccConvertChineseWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::internArrayToIterateIsArray()
	 * @uses EccConvertChineseWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertChineseWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccConvertChineseWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccConvertChineseWsdlClass::offsetGet()
	 * @uses EccConvertChineseWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::getAttributeName()
	 * @uses EccConvertChineseWsdlClass::__toString()
	 * @uses EccConvertChineseWsdlClass::_set()
	 * @uses EccConvertChineseWsdlClass::_get()
	 * @uses EccConvertChineseWsdlClass::setInternArrayToIterate()
	 * @uses EccConvertChineseWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccConvertChineseWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::item()
	 * @uses EccConvertChineseWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccConvertChineseWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccConvertChineseWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
