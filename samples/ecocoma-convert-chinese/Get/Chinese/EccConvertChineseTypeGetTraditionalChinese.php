<?php
/**
 * Class file for EccConvertChineseTypeGetTraditionalChinese
 * @date 03/07/2012
 */
/**
 * Class EccConvertChineseTypeGetTraditionalChinese
 * @date 03/07/2012
 */
class EccConvertChineseTypeGetTraditionalChinese extends EccConvertChineseWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Source
	 * @return EccConvertChineseTypeGetTraditionalChinese
	 */
