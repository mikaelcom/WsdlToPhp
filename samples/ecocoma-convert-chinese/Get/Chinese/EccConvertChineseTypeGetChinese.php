<?php
/**
 * Class file for EccConvertChineseTypeGetChinese
 * @date 03/07/2012
 */
/**
 * Class EccConvertChineseTypeGetChinese
 * @date 03/07/2012
 */
class EccConvertChineseTypeGetChinese extends EccConvertChineseWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Source
	 * @return EccConvertChineseTypeGetChinese
	 */
