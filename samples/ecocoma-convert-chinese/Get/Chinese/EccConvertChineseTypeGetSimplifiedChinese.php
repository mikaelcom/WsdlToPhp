<?php
/**
 * Class file for EccConvertChineseTypeGetSimplifiedChinese
 * @date 03/07/2012
 */
/**
 * Class EccConvertChineseTypeGetSimplifiedChinese
 * @date 03/07/2012
 */
class EccConvertChineseTypeGetSimplifiedChinese extends EccConvertChineseWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Source
	 * @return EccConvertChineseTypeGetSimplifiedChinese
	 */
