<?php
/**
 * Class file for XiScreenerTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiScreenerTypeCommon
 * @date 08/07/2012
 */
class XiScreenerTypeCommon extends XiScreenerWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiScreenerTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiScreenerTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiScreenerTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiScreenerTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiScreenerTypeOutcomeTypes
	 */
