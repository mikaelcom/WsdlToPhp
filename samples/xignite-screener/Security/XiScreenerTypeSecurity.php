<?php
/**
 * Class file for XiScreenerTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiScreenerTypeSecurity
 * @date 08/07/2012
 */
class XiScreenerTypeSecurity extends XiScreenerTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiScreenerWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
