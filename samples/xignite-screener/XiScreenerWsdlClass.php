<?php
/**
 * File for XiScreenerWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiScreenerWsdlClass to communicate with SOAP service
 * Documentation : This web service provides screening and filtering functionality for equities.
 * @date 08/07/2012
 */
class XiScreenerWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiScreenerWsdlClass::setLastError()
	 * @uses XiScreenerWsdlClass::initSoapClient()
	 * @uses XiScreenerWsdlClass::initInternArrayToIterate()
	 * @uses XiScreenerWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiScreenerWsdlClass::classMap()
	 * @uses XiScreenerWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiScreenerClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiScreenerClassMap::classMap();
	 ...
	 * @uses XiScreenerWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiScreenerWsdlClass::WSDL_COMPRESSION
	 * @uses XiScreenerWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiScreenerWsdlClass::WSDL_ENCODING
	 * @uses XiScreenerWsdlClass::WSDL_EXCPTS
	 * @uses XiScreenerWsdlClass::WSDL_FEATURES
	 * @uses XiScreenerWsdlClass::WSDL_LOGIN
	 * @uses XiScreenerWsdlClass::WSDL_PASSWD
	 * @uses XiScreenerWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiScreenerWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiScreenerWsdlClass::WSDL_TRACE
	 * @uses XiScreenerWsdlClass::WSDL_TYPEMAP
	 * @uses XiScreenerWsdlClass::WSDL_URL
	 * @uses XiScreenerWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiScreenerWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiScreenerWsdlClass::internArrayToIterateIsArray()
	 * @uses XiScreenerWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiScreenerWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiScreenerWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiScreenerWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiScreenerWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiScreenerWsdlClass::offsetExists()
	 ...
	 * @uses XiScreenerWsdlClass::getAttributeName()
	 * @uses XiScreenerWsdlClass::__toString()
	 * @uses XiScreenerWsdlClass::_set()
	 * @uses XiScreenerWsdlClass::_get()
	 * @uses XiScreenerWsdlClass::setInternArrayToIterate()
	 * @uses XiScreenerWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiScreenerWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiScreenerWsdlClass::item()
	 * @uses XiScreenerWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiScreenerWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiScreenerWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
