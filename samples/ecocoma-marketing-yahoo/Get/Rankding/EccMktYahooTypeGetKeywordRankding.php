<?php
/**
 * Class file for EccMktYahooTypeGetKeywordRankding
 * @date 03/07/2012
 */
/**
 * Class EccMktYahooTypeGetKeywordRankding
 * @date 03/07/2012
 */
class EccMktYahooTypeGetKeywordRankding extends EccMktYahooWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @param string Url
	 * @return EccMktYahooTypeGetKeywordRankding
	 */
