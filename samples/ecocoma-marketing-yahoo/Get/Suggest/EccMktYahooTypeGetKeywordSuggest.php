<?php
/**
 * Class file for EccMktYahooTypeGetKeywordSuggest
 * @date 03/07/2012
 */
/**
 * Class EccMktYahooTypeGetKeywordSuggest
 * @date 03/07/2012
 */
class EccMktYahooTypeGetKeywordSuggest extends EccMktYahooWsdlClass
{
	/**
	 * The KeyID
	 * Meta informations :
	 ...
	 * @return EccMktYahooTypeGetKeywordSuggest
	 */
