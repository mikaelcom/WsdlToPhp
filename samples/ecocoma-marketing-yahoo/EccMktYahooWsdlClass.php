<?php
/**
 * File for EccMktYahooWsdlClass to communicate with SOAP service
 * @date 03/07/2012
 */
/**
 * File for EccMktYahooWsdlClass to communicate with SOAP service
 * Documentation : Cocoma Yahoo Web Services.
 * @date 03/07/2012
 */
class EccMktYahooWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses EccMktYahooWsdlClass::setLastError()
	 * @uses EccMktYahooWsdlClass::initSoapClient()
	 * @uses EccMktYahooWsdlClass::initInternArrayToIterate()
	 * @uses EccMktYahooWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses EccMktYahooWsdlClass::classMap()
	 * @uses EccMktYahooWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('EccMktYahooClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = EccMktYahooClassMap::classMap();
	 ...
	 * @uses EccMktYahooWsdlClass::WSDL_CACHE_WSDL
	 * @uses EccMktYahooWsdlClass::WSDL_COMPRESSION
	 * @uses EccMktYahooWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses EccMktYahooWsdlClass::WSDL_ENCODING
	 * @uses EccMktYahooWsdlClass::WSDL_EXCPTS
	 * @uses EccMktYahooWsdlClass::WSDL_FEATURES
	 * @uses EccMktYahooWsdlClass::WSDL_LOGIN
	 * @uses EccMktYahooWsdlClass::WSDL_PASSWD
	 * @uses EccMktYahooWsdlClass::WSDL_SOAP_VERSION
	 * @uses EccMktYahooWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses EccMktYahooWsdlClass::WSDL_TRACE
	 * @uses EccMktYahooWsdlClass::WSDL_TYPEMAP
	 * @uses EccMktYahooWsdlClass::WSDL_URL
	 * @uses EccMktYahooWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses EccMktYahooWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::internArrayToIterateIsArray()
	 * @uses EccMktYahooWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccMktYahooWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::getInternArrayToIterateOffset()
	 * @uses EccMktYahooWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see EccMktYahooWsdlClass::offsetGet()
	 * @uses EccMktYahooWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::getAttributeName()
	 * @uses EccMktYahooWsdlClass::__toString()
	 * @uses EccMktYahooWsdlClass::_set()
	 * @uses EccMktYahooWsdlClass::_get()
	 * @uses EccMktYahooWsdlClass::setInternArrayToIterate()
	 * @uses EccMktYahooWsdlClass::setInternArrayToIterateIsArray()
	 * @uses EccMktYahooWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::item()
	 * @uses EccMktYahooWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses EccMktYahooWsdlClass::getInternArrayToIterateIsArray()
	 * @uses EccMktYahooWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
