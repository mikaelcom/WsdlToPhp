<?php
/**
 * Class file for EccMktYahooTypeYahooKeywordRanking
 * @date 03/07/2012
 */
/**
 * Class EccMktYahooTypeYahooKeywordRanking
 * @date 03/07/2012
 */
class EccMktYahooTypeYahooKeywordRanking extends EccMktYahooWsdlClass
{
	/**
	 * The Url
	 * Meta informations :
