<?php
/**
 * Class file for SOGeoCoderTypeGetDistanceToWater
 * @date 05/07/2012
 */
/**
 * Class SOGeoCoderTypeGetDistanceToWater
 * @date 05/07/2012
 */
class SOGeoCoderTypeGetDistanceToWater extends SOGeoCoderWsdlClass
{
	/**
	 * The Latitude
	 * Meta informations :
	 ...
	 * @return SOGeoCoderTypeGetDistanceToWater
	 */
