<?php
/**
 * Class file for SOGeoCoderTypeGetZipInfo
 * @date 05/07/2012
 */
/**
 * Class SOGeoCoderTypeGetZipInfo
 * @date 05/07/2012
 */
class SOGeoCoderTypeGetZipInfo extends SOGeoCoderWsdlClass
{
	/**
	 * The PostalCode
	 * Meta informations :
	 ...
	 * @return SOGeoCoderTypeGetZipInfo
	 */
