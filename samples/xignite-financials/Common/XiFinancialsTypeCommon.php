<?php
/**
 * Class file for XiFinancialsTypeCommon
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeCommon
 * @date 08/07/2012
 */
class XiFinancialsTypeCommon extends XiFinancialsWsdlClass
{
	/**
	 * The Outcome
	 * Meta informations :
	 * 	- minOccurs : 1
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeOutcomeTypes
	 */
	public $Outcome;
	/**
	 * The Message
	...
	/**
	 * Constructor
	 * @param XiFinancialsTypeOutcomeTypes Outcome
	 * @param string Message
	 * @param string Identity
	 * @param double Delay
	 * @return XiFinancialsTypeCommon
	 */
	...
	{
		return ($this->Outcome = XiFinancialsTypeOutcomeTypes::valueIsValid($_Outcome)?$_Outcome:null);
	}
	/**
	 * Get Outcome
	 * @return XiFinancialsTypeOutcomeTypes
	 */
