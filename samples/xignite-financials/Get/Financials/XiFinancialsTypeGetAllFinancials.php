<?php
/**
 * Class file for XiFinancialsTypeGetAllFinancials
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetAllFinancials
 * @date 08/07/2012
 */
class XiFinancialsTypeGetAllFinancials extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetAllFinancials
	 */
