<?php
/**
 * Class file for XiFinancialsTypeGetFinancialServicesItem
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetFinancialServicesItem
 * @date 08/07/2012
 */
class XiFinancialsTypeGetFinancialServicesItem extends XiFinancialsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetFinancialServicesItem
	 */
