<?php
/**
 * Class file for XiFinancialsTypeGetFinancialServicesItems
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetFinancialServicesItems
 * @date 08/07/2012
 */
class XiFinancialsTypeGetFinancialServicesItems extends XiFinancialsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetFinancialServicesItems
	 */
