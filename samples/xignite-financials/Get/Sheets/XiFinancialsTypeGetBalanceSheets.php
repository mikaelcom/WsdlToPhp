<?php
/**
 * Class file for XiFinancialsTypeGetBalanceSheets
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetBalanceSheets
 * @date 08/07/2012
 */
class XiFinancialsTypeGetBalanceSheets extends XiFinancialsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetBalanceSheets
	 */
