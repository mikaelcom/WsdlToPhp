<?php
/**
 * Class file for XiFinancialsTypeGetFinancialServicesItemList
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetFinancialServicesItemList
 * @date 08/07/2012
 */
class XiFinancialsTypeGetFinancialServicesItemList extends XiFinancialsWsdlClass
{
	/**
	 * The Types
	 * Meta informations :
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeArrayOfFinancialServicesItemTypes
	 */
	public $Types;
	/**
	 * The Identifier
	...
	/**
	 * Constructor
	 * @param XiFinancialsTypeArrayOfFinancialServicesItemTypes Types
	 * @param string Identifier
	 * @param XiFinancialsTypeIdentifierTypes IdentifierType
	 * @param XiFinancialsTypeReportTypes ReportType
	 * @param string AsOfDate
	 * @return XiFinancialsTypeGetFinancialServicesItemList
	 */
	public function __construct($_Types = null,$_Identifier = null,$_IdentifierType,$_ReportType,$_AsOfDate = null)
	{
		parent::__construct(array('Types'=>new XiFinancialsTypeArrayOfFinancialServicesItemTypes($_Types),'Identifier'=>$_Identifier,'IdentifierType'=>$_IdentifierType,'ReportType'=>$_ReportType,'AsOfDate'=>$_AsOfDate));
	}
	/**
	 * Set Types
	 * @param ArrayOfFinancialServicesItemTypes Types
	 * @return ArrayOfFinancialServicesItemTypes
	 */
