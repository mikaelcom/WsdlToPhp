<?php
/**
 * Class file for XiFinancialsTypeGetStandardItemRange
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetStandardItemRange
 * @date 08/07/2012
 */
class XiFinancialsTypeGetStandardItemRange extends XiFinancialsWsdlClass
{
	/**
	 * The Type
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetStandardItemRange
	 */
