<?php
/**
 * Class file for XiFinancialsTypeGetLastBalanceSheetInDateRange
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetLastBalanceSheetInDateRange
 * @date 08/07/2012
 */
class XiFinancialsTypeGetLastBalanceSheetInDateRange extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetLastBalanceSheetInDateRange
	 */
