<?php
/**
 * Class file for XiFinancialsTypeGetOtherRatios
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetOtherRatios
 * @date 08/07/2012
 */
class XiFinancialsTypeGetOtherRatios extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetOtherRatios
	 */
