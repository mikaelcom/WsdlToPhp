<?php
/**
 * Class file for XiFinancialsTypeGetIndustryRatios
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetIndustryRatios
 * @date 08/07/2012
 */
class XiFinancialsTypeGetIndustryRatios extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetIndustryRatios
	 */
