<?php
/**
 * Class file for XiFinancialsTypeGetNormalizedRatios
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetNormalizedRatios
 * @date 08/07/2012
 */
class XiFinancialsTypeGetNormalizedRatios extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetNormalizedRatios
	 */
