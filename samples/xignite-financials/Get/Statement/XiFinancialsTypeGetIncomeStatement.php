<?php
/**
 * Class file for XiFinancialsTypeGetIncomeStatement
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetIncomeStatement
 * @date 08/07/2012
 */
class XiFinancialsTypeGetIncomeStatement extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetIncomeStatement
	 */
