<?php
/**
 * Class file for XiFinancialsTypeGetCashFlowStatement
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetCashFlowStatement
 * @date 08/07/2012
 */
class XiFinancialsTypeGetCashFlowStatement extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetCashFlowStatement
	 */
