<?php
/**
 * Class file for XiFinancialsTypeGetFinancialServicesIncomeStatement
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetFinancialServicesIncomeStatement
 * @date 08/07/2012
 */
class XiFinancialsTypeGetFinancialServicesIncomeStatement extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetFinancialServicesIncomeStatement
	 */
