<?php
/**
 * Class file for XiFinancialsTypeGetFinancialServicesBalanceSheet
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetFinancialServicesBalanceSheet
 * @date 08/07/2012
 */
class XiFinancialsTypeGetFinancialServicesBalanceSheet extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetFinancialServicesBalanceSheet
	 */
