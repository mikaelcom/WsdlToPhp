<?php
/**
 * Class file for XiFinancialsTypeGetBalanceSheet
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetBalanceSheet
 * @date 08/07/2012
 */
class XiFinancialsTypeGetBalanceSheet extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetBalanceSheet
	 */
