<?php
/**
 * Class file for XiFinancialsTypeGetReportDate
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetReportDate
 * @date 08/07/2012
 */
class XiFinancialsTypeGetReportDate extends XiFinancialsWsdlClass
{
	/**
	 * The Identifier
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetReportDate
	 */
