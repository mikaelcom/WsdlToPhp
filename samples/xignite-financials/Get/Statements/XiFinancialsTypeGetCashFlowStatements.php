<?php
/**
 * Class file for XiFinancialsTypeGetCashFlowStatements
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeGetCashFlowStatements
 * @date 08/07/2012
 */
class XiFinancialsTypeGetCashFlowStatements extends XiFinancialsWsdlClass
{
	/**
	 * The Identifiers
	 * Meta informations :
	 ...
	 * @return XiFinancialsTypeGetCashFlowStatements
	 */
