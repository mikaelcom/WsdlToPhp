<?php
/**
 * Class file for XiFinancialsTypeHeader
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeHeader
 * @date 08/07/2012
 */
class XiFinancialsTypeHeader extends XiFinancialsWsdlClass
{
	/**
	 * The Username
	 * Meta informations :
