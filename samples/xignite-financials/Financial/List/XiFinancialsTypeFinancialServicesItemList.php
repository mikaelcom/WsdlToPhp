<?php
/**
 * Class file for XiFinancialsTypeFinancialServicesItemList
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeFinancialServicesItemList
 * @date 08/07/2012
 */
class XiFinancialsTypeFinancialServicesItemList extends XiFinancialsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * @param XiFinancialsTypeArrayOfFinancialServicesItem Financials
	...
	{
		XiFinancialsWsdlClass::__construct(array('Security'=>$_Security,'ReportDate'=>$_ReportDate,'FiscalQuarter'=>$_FiscalQuarter,'ReportType'=>$_ReportType,'Financials'=>new XiFinancialsTypeArrayOfFinancialServicesItem($_Financials)));
	}
	/**
	 * Set Security
	...
	/**
	 * Set Financials
	 * @param ArrayOfFinancialServicesItem Financials
