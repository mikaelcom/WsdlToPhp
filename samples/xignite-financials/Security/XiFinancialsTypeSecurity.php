<?php
/**
 * Class file for XiFinancialsTypeSecurity
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeSecurity
 * @date 08/07/2012
 */
class XiFinancialsTypeSecurity extends XiFinancialsTypeCommon
{
	/**
	 * The CIK
	 * Meta informations :
	...
	{
		XiFinancialsWsdlClass::__construct(array('CIK'=>$_CIK,'Cusip'=>$_Cusip,'Symbol'=>$_Symbol,'ISIN'=>$_ISIN,'Valoren'=>$_Valoren,'Name'=>$_Name,'Market'=>$_Market,'CategoryOrIndustry'=>$_CategoryOrIndustry));
	}
	/**
	 * Set CIK
	 * @param string CIK
