<?php
/**
 * Class file for XiFinancialsTypeBalanceSheetFinancialServices
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeBalanceSheetFinancialServices
 * @date 08/07/2012
 */
class XiFinancialsTypeBalanceSheetFinancialServices extends XiFinancialsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeAssetsFinancialServices
	 */
	public $Assets;
	/**
	 * The Liabilities
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeLiabilitiesFinancialServices
	 */
	public $Liabilities;
	/**
	 ...
	 * @param XiFinancialsTypeAssetsFinancialServices Assets
	 * @param XiFinancialsTypeLiabilitiesFinancialServices Liabilities
	...
	/**
	 * Set Assets
	 * @param AssetsFinancialServices Assets
	 * @return AssetsFinancialServices
	 */
	...
	/**
	 * Set Liabilities
	 * @param LiabilitiesFinancialServices Liabilities
	 * @return LiabilitiesFinancialServices
	 */
