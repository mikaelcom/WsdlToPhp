<?php
/**
 * Class file for XiFinancialsTypeNonOperatingExpenses
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeNonOperatingExpenses
 * @date 08/07/2012
 */
class XiFinancialsTypeNonOperatingExpenses extends XiFinancialsWsdlClass
{
	/**
	 * The InterestExpense
	 * Meta informations :
