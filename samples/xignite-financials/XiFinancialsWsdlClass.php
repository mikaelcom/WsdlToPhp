<?php
/**
 * File for XiFinancialsWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for XiFinancialsWsdlClass to communicate with SOAP service
 * Documentation : Provides access to financial statement information for US and Canadian companies.
 * @date 08/07/2012
 */
class XiFinancialsWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses XiFinancialsWsdlClass::setLastError()
	 * @uses XiFinancialsWsdlClass::initSoapClient()
	 * @uses XiFinancialsWsdlClass::initInternArrayToIterate()
	 * @uses XiFinancialsWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses XiFinancialsWsdlClass::classMap()
	 * @uses XiFinancialsWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('XiFinancialsClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = XiFinancialsClassMap::classMap();
	 ...
	 * @uses XiFinancialsWsdlClass::WSDL_CACHE_WSDL
	 * @uses XiFinancialsWsdlClass::WSDL_COMPRESSION
	 * @uses XiFinancialsWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses XiFinancialsWsdlClass::WSDL_ENCODING
	 * @uses XiFinancialsWsdlClass::WSDL_EXCPTS
	 * @uses XiFinancialsWsdlClass::WSDL_FEATURES
	 * @uses XiFinancialsWsdlClass::WSDL_LOGIN
	 * @uses XiFinancialsWsdlClass::WSDL_PASSWD
	 * @uses XiFinancialsWsdlClass::WSDL_SOAP_VERSION
	 * @uses XiFinancialsWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses XiFinancialsWsdlClass::WSDL_TRACE
	 * @uses XiFinancialsWsdlClass::WSDL_TYPEMAP
	 * @uses XiFinancialsWsdlClass::WSDL_URL
	 * @uses XiFinancialsWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses XiFinancialsWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::internArrayToIterateIsArray()
	 * @uses XiFinancialsWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFinancialsWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::getInternArrayToIterateOffset()
	 * @uses XiFinancialsWsdlClass::offsetExists()
	 ...
	 * @uses XiFinancialsWsdlClass::getAttributeName()
	 * @uses XiFinancialsWsdlClass::__toString()
	 * @uses XiFinancialsWsdlClass::_set()
	 * @uses XiFinancialsWsdlClass::_get()
	 * @uses XiFinancialsWsdlClass::setInternArrayToIterate()
	 * @uses XiFinancialsWsdlClass::setInternArrayToIterateIsArray()
	 * @uses XiFinancialsWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::item()
	 * @uses XiFinancialsWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses XiFinancialsWsdlClass::getInternArrayToIterateIsArray()
	 * @uses XiFinancialsWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
