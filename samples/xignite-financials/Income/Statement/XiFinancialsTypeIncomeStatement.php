<?php
/**
 * Class file for XiFinancialsTypeIncomeStatement
 * @date 08/07/2012
 */
/**
 * Class XiFinancialsTypeIncomeStatement
 * @date 08/07/2012
 */
class XiFinancialsTypeIncomeStatement extends XiFinancialsTypeCommon
{
	/**
	 * The Security
	 * Meta informations :
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeOperatingRevenue
	 */
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeOperatingExpenses
	 */
	 ...
	 * 	- minOccurs : 0
	 * 	- maxOccurs : 1
	 * @var XiFinancialsTypeNonOperatingExpenses
	 */
	 ...
	 * @param XiFinancialsTypeOperatingRevenue OperatingRevenue
	 * @param XiFinancialsTypeOperatingExpenses OperatingExpenses
	 * @param XiFinancialsTypeNonOperatingExpenses NonOperatingExpenses
	 ...
	 * @param OperatingRevenue OperatingRevenue
	 ...
	 * @param OperatingExpenses OperatingExpenses
	 ...
	 * @param NonOperatingExpenses NonOperatingExpenses
	 ...
	 * @return XiFinancialsTypeNonOperatingExpenses
	 */
