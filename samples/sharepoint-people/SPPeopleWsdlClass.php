<?php
/**
 * File for SPPeopleWsdlClass to communicate with SOAP service
 * @date 06/07/2012
 */
/**
 * File for SPPeopleWsdlClass to communicate with SOAP service
 ...
 * @date 06/07/2012
 */
class SPPeopleWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SPPeopleWsdlClass::setLastError()
	 * @uses SPPeopleWsdlClass::initSoapClient()
	 * @uses SPPeopleWsdlClass::initInternArrayToIterate()
	 * @uses SPPeopleWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SPPeopleWsdlClass::classMap()
	 * @uses SPPeopleWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SPPeopleClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SPPeopleClassMap::classMap();
	 ...
	 * @uses SPPeopleWsdlClass::WSDL_CACHE_WSDL
	 * @uses SPPeopleWsdlClass::WSDL_COMPRESSION
	 * @uses SPPeopleWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SPPeopleWsdlClass::WSDL_ENCODING
	 * @uses SPPeopleWsdlClass::WSDL_EXCPTS
	 * @uses SPPeopleWsdlClass::WSDL_FEATURES
	 * @uses SPPeopleWsdlClass::WSDL_LOGIN
	 * @uses SPPeopleWsdlClass::WSDL_PASSWD
	 * @uses SPPeopleWsdlClass::WSDL_SOAP_VERSION
	 * @uses SPPeopleWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SPPeopleWsdlClass::WSDL_TRACE
	 * @uses SPPeopleWsdlClass::WSDL_TYPEMAP
	 * @uses SPPeopleWsdlClass::WSDL_URL
	 * @uses SPPeopleWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses SPPeopleWsdlClass::internArrayToIterateIsArray()
	 * @uses SPPeopleWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SPPeopleWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SPPeopleWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPPeopleWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SPPeopleWsdlClass::getInternArrayToIterateOffset()
	 * @uses SPPeopleWsdlClass::offsetExists()
	 ...
	 * @uses SPPeopleWsdlClass::getAttributeName()
	 * @uses SPPeopleWsdlClass::__toString()
	 * @uses SPPeopleWsdlClass::_set()
	 * @uses SPPeopleWsdlClass::_get()
	 * @uses SPPeopleWsdlClass::setInternArrayToIterate()
	 * @uses SPPeopleWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SPPeopleWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SPPeopleWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SPPeopleWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
