<?php
/**
 * Class file for SOFastQuoteTypeGetStockInfo
 * @date 08/07/2012
 */
/**
 * Class SOFastQuoteTypeGetStockInfo
 * @date 08/07/2012
 */
class SOFastQuoteTypeGetStockInfo extends SOFastQuoteWsdlClass
{
	/**
	 * The Ticker
	 * Meta informations :
	 ...
	 * @return SOFastQuoteTypeGetStockInfo
	 */
