<?php
/**
 * File for SOFastQuoteWsdlClass to communicate with SOAP service
 * @date 08/07/2012
 */
/**
 * File for SOFastQuoteWsdlClass to communicate with SOAP service
 ...
 * @date 08/07/2012
 */
class SOFastQuoteWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses SOFastQuoteWsdlClass::setLastError()
	 * @uses SOFastQuoteWsdlClass::initSoapClient()
	 * @uses SOFastQuoteWsdlClass::initInternArrayToIterate()
	 * @uses SOFastQuoteWsdlClass::_set()
	 * @param array values
	 * @return Lists
	 */
	...
	/**
	 * Init SoapClient
	 * @uses SOFastQuoteWsdlClass::classMap()
	 * @uses SOFastQuoteWsdlClass::getDefaultWsdlOptions()
	 * @param array WSDL options
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('SOFastQuoteClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = SOFastQuoteClassMap::classMap();
	 ...
	 * @uses SOFastQuoteWsdlClass::WSDL_CACHE_WSDL
	 * @uses SOFastQuoteWsdlClass::WSDL_COMPRESSION
	 * @uses SOFastQuoteWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses SOFastQuoteWsdlClass::WSDL_ENCODING
	 * @uses SOFastQuoteWsdlClass::WSDL_EXCPTS
	 * @uses SOFastQuoteWsdlClass::WSDL_FEATURES
	 * @uses SOFastQuoteWsdlClass::WSDL_LOGIN
	 * @uses SOFastQuoteWsdlClass::WSDL_PASSWD
	 * @uses SOFastQuoteWsdlClass::WSDL_SOAP_VERSION
	 * @uses SOFastQuoteWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses SOFastQuoteWsdlClass::WSDL_TRACE
	 * @uses SOFastQuoteWsdlClass::WSDL_TYPEMAP
	 * @uses SOFastQuoteWsdlClass::WSDL_URL
	 * @uses SOFastQuoteWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	...
	/**
	 * Alias to count
	 * @uses SOFastQuoteWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::internArrayToIterateIsArray()
	 * @uses SOFastQuoteWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFastQuoteWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::getInternArrayToIterateOffset()
	 * @uses SOFastQuoteWsdlClass::offsetExists()
	...
	/**
	 * Alias to offsetGet
	 * @see SOFastQuoteWsdlClass::offsetGet()
	 * @uses SOFastQuoteWsdlClass::offsetGet()
	 * @param int
	 * @return mixed
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::getAttributeName()
	 * @uses SOFastQuoteWsdlClass::__toString()
	 * @uses SOFastQuoteWsdlClass::_set()
	 * @uses SOFastQuoteWsdlClass::_get()
	 * @uses SOFastQuoteWsdlClass::setInternArrayToIterate()
	 * @uses SOFastQuoteWsdlClass::setInternArrayToIterateIsArray()
	 * @uses SOFastQuoteWsdlClass::setInternArrayToIterateOffset()
	 * @param mixed value
	 * @return bool true|false
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::item()
	 * @uses SOFastQuoteWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses SOFastQuoteWsdlClass::getInternArrayToIterateIsArray()
	 * @uses SOFastQuoteWsdlClass::getInternArrayToIterate()
	 * @param int
	 * @return bool true|false
	 */
